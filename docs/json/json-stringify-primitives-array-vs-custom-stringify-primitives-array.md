...
```typescript
JSON stringify: 17954.888 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12904.884 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/20/2026 1:55:15`

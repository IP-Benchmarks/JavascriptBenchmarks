...
```typescript
JSON stringify: 10013.567 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7088.119 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/15/2022 0:54:14`

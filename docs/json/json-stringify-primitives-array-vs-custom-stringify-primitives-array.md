...
```typescript
JSON stringify: 17565.659 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13921.281 ops/s (100 runs over 100 unique samples each)
```

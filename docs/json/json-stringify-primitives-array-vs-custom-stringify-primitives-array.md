...
```typescript
JSON stringify: 17652.739 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14055.965 ops/s (100 runs over 100 unique samples each)
```

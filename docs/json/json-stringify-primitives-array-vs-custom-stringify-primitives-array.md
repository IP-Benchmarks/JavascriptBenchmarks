...
```typescript
JSON stringify: 12462.515 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8413.375 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/20/2023 1:4:34`

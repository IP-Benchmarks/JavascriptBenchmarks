...
```typescript
JSON stringify: 16086.372 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13977.772 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/5/2025 1:40:53`

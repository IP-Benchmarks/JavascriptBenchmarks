...
```typescript
JSON stringify: 10436.741 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7078.439 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/29/2022 1:7:46`

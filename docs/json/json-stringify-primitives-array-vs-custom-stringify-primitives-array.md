...
```typescript
JSON stringify: 15691.449 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13766.125 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/18/2024 1:5:40`

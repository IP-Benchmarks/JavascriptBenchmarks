...
```typescript
JSON stringify: 11669.869 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9238.818 ops/s (100 runs over 100 unique samples each)
```

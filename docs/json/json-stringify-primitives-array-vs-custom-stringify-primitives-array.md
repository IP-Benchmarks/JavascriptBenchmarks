...
```typescript
JSON stringify: 16082.752 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13415.925 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/2/2024 1:8:39`

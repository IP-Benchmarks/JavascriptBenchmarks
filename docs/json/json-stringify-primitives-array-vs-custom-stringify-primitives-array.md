...
```typescript
JSON stringify: 10324.592 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6861.979 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/18/2023 1:4:50`

...
```typescript
JSON stringify: 10123.482 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6562.259 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/6/2023 1:16:50`

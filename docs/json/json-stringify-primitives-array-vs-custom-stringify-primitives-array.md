...
```typescript
JSON stringify: 17398.155 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13712.815 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/24/2025 1:7:58`

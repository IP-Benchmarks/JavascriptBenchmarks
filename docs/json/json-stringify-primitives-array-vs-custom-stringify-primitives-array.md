...
```typescript
JSON stringify: 15468.709 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13323.790 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/14/2024 1:5:15`

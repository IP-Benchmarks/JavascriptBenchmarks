...
```typescript
JSON stringify: 17634.536 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13245.662 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/27/2025 1:44:2`

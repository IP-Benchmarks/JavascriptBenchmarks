...
```typescript
JSON stringify: 12513.582 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9832.439 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/8/2023 0:57:40`

...
```typescript
JSON stringify: 17614.417 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14038.963 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/28/2025 1:15:52`

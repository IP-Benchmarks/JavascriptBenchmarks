...
```typescript
JSON stringify: 11755.498 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7549.496 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/23/2023 1:4:59`

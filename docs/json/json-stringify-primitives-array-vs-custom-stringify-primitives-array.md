...
```typescript
JSON stringify: 17417.363 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14137.283 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/23/2024 1:10:57`

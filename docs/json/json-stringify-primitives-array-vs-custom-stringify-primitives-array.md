...
```typescript
JSON stringify: 11579.694 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8332.398 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/12/2022 1:14:21`

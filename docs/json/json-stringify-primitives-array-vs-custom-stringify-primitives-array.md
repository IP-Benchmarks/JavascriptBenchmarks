...
```typescript
JSON stringify: 11976.492 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9973.711 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/22/2022 1:38:7`

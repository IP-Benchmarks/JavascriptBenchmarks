...
```typescript
JSON stringify: 17564.667 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14031.034 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/27/2024 1:9:16`

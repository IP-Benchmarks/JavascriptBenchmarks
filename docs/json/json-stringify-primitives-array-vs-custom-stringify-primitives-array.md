...
```typescript
JSON stringify: 17340.454 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12973.775 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/26/2026 1:45:10`

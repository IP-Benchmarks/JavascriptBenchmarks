...
```typescript
JSON stringify: 17899.490 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13789.288 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/28/2025 1:15:29`

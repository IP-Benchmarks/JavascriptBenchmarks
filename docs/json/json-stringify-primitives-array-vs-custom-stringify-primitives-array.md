...
```typescript
JSON stringify: 17599.237 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13939.618 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/31/2025 1:8:1`

...
```typescript
JSON stringify: 12025.555 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8153.783 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/23/2022 1:7:32`

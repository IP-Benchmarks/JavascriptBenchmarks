...
```typescript
JSON stringify: 18114.617 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13653.551 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/24/2025 1:27:34`

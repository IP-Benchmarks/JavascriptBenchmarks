...
```typescript
JSON stringify: 15690.380 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13139.651 ops/s (100 runs over 100 unique samples each)
```

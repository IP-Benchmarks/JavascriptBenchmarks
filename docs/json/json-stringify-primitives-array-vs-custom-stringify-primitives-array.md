...
```typescript
JSON stringify: 17684.107 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14119.718 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/21/2025 1:7:15`

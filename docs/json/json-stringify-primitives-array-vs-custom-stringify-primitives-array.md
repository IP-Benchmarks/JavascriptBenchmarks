...
```typescript
JSON stringify: 12618.147 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9596.898 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/26/2023 1:5:39`

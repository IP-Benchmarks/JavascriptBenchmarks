...
```typescript
JSON stringify: 28439.336 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14874.370 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/7/2026 2:48:38`

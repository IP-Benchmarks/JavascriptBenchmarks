...
```typescript
JSON stringify: 11452.516 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9689.986 ops/s (100 runs over 100 unique samples each)
```

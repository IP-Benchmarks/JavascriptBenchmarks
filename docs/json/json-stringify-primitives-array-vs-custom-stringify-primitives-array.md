...
```typescript
JSON stringify: 24414.106 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13026.871 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/24/2026 1:5:26`

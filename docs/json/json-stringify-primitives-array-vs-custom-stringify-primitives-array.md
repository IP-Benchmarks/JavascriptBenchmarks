...
```typescript
JSON stringify: 9930.817 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6389.842 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/28/2023 0:51:58`

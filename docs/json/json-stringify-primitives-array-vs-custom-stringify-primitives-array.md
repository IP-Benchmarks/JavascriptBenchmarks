...
```typescript
JSON stringify: 18052.955 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14224.753 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/11/2025 1:25:12`

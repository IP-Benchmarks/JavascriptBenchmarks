...
```typescript
JSON stringify: 18298.008 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13882.953 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/16/2025 1:26:19`

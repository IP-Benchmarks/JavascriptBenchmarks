...
#### **JSON stringify** is **_`1.61x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10208.153 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6337.516 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/2/2023 0:52:19`

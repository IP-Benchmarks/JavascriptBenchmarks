...
```typescript
JSON stringify: 10369.765 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6987.163 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/30/2022 1:41:30`

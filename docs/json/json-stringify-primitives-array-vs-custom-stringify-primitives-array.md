...
```typescript
JSON stringify: 11759.950 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8197.860 ops/s (100 runs over 100 unique samples each)
```

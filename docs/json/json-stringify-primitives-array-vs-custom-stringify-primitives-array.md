...
```typescript
JSON stringify: 17868.426 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13874.097 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/4/2026 1:51:38`

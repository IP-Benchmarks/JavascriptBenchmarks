...
```typescript
JSON stringify: 17823.600 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13803.669 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/19/2026 1:41:22`

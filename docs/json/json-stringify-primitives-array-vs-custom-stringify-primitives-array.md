...
```typescript
JSON stringify: 18332.184 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13512.419 ops/s (100 runs over 100 unique samples each)
```

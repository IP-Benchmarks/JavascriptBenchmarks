...
```typescript
JSON stringify: 17461.106 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13358.000 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/19/2026 2:56:20`

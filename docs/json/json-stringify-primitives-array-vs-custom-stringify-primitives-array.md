...
```typescript
JSON stringify: 11673.875 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8297.685 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/9/2022 1:47:51`

...
```typescript
JSON stringify: 12447.072 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8309.025 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/22/2023 0:59:23`

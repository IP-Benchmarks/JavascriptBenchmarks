...
```typescript
JSON stringify: 18077.725 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14104.988 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/7/2025 1:37:44`

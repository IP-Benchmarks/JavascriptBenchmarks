...
```typescript
JSON stringify: 11599.621 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9545.062 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/27/2023 1:6:55`

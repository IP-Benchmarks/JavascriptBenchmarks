...
```typescript
JSON stringify: 12115.445 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8314.412 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/13/2022 1:16:49`

...
```typescript
JSON stringify: 15380.698 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13189.784 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/20/2024 0:57:28`

...
```typescript
JSON stringify: 12586.192 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9921.467 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/8/2023 1:9:22`

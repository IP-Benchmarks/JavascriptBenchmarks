...
#### **JSON stringify** is **_`1.15x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15941.071 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13837.687 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/12/2023 0:56:45`

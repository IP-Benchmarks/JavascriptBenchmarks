...
```typescript
JSON stringify: 17237.579 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13905.373 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/27/2025 1:13:53`

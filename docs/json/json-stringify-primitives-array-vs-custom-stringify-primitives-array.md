...
```typescript
JSON stringify: 15560.335 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13322.747 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/23/2024 1:8:42`

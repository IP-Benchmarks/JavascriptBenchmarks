...
```typescript
JSON stringify: 15815.022 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13094.610 ops/s (100 runs over 100 unique samples each)
```

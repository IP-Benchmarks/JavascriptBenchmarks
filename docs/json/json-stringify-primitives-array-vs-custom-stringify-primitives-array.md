...
```typescript
JSON stringify: 17465.963 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13690.349 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/2/2025 1:8:47`

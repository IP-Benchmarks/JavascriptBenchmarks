...
```typescript
JSON stringify: 24284.408 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13226.395 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/28/2026 9:24:13`

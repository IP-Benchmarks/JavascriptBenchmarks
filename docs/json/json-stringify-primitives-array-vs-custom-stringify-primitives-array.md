...
```typescript
JSON stringify: 9651.575 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6424.825 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/20/2022 1:2:53`

...
```typescript
JSON stringify: 10754.475 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7816.951 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/7/2022 0:45:53`

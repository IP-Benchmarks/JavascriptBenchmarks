...
```typescript
JSON stringify: 11128.724 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8179.245 ops/s (100 runs over 100 unique samples each)
```

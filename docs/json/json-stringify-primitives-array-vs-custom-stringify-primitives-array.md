...
```typescript
JSON stringify: 10028.873 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6046.863 ops/s (100 runs over 100 unique samples each)
```

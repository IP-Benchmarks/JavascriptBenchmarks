...
```typescript
JSON stringify: 17009.561 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13653.266 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/20/2025 1:11:21`

...
```typescript
JSON stringify: 11758.279 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9441.930 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/14/2022 1:15:13`

...
```typescript
JSON stringify: 11497.188 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7913.409 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/9/2022 1:9:25`

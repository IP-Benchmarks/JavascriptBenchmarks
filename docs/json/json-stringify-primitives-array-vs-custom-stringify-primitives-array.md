...
```typescript
JSON stringify: 24880.850 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13557.565 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/1/2026 3:29:14`

...
```typescript
JSON stringify: 12411.381 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8615.480 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/24/2023 1:0:33`

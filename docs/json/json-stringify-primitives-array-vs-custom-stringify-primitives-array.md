...
```typescript
JSON stringify: 8994.455 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6350.032 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/14/2022 1:4:14`

...
```typescript
JSON stringify: 17498.106 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13759.593 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/29/2025 1:16:17`

...
```typescript
JSON stringify: 24354.651 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13889.235 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/5/2026 2:52:39`

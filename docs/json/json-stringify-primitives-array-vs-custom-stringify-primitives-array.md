...
```typescript
JSON stringify: 10502.538 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7606.433 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/28/2022 1:28:6`

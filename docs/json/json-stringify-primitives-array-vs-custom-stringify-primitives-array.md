...
```typescript
JSON stringify: 15903.333 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13196.766 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 15716.476 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13172.819 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/9/2024 1:0:6`

...
```typescript
JSON stringify: 12388.766 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8299.465 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/11/2023 0:58:24`

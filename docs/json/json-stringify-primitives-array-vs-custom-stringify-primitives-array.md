...
```typescript
JSON stringify: 17148.184 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13918.980 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/27/2025 1:19:9`

...
```typescript
JSON stringify: 17448.567 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13828.389 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/16/2025 1:15:56`

...
```typescript
JSON stringify: 15859.152 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13578.467 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/18/2024 0:55:34`

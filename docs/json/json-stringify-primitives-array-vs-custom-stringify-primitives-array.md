...
```typescript
JSON stringify: 13526.750 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8863.086 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/18/2022 1:14:46`

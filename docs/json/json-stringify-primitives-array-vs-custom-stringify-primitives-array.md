...
```typescript
JSON stringify: 9604.794 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6184.171 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/1/2023 1:12:7`

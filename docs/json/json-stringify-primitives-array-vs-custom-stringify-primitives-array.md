...
```typescript
JSON stringify: 18043.252 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12773.469 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/28/2026 2:41:35`

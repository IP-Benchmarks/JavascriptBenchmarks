...
```typescript
JSON stringify: 11950.966 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8347.748 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/7/2022 0:52:9`

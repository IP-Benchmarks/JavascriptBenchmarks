...
```typescript
JSON stringify: 12052.000 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7089.092 ops/s (100 runs over 100 unique samples each)
```

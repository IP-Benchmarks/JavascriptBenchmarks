...
```typescript
JSON stringify: 11625.396 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8174.275 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 11357.394 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9627.068 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/1/2022 0:58:52`

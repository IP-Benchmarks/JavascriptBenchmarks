...
```typescript
JSON stringify: 10204.117 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7192.888 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/25/2022 0:56:34`

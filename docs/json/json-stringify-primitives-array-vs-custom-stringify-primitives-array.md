...
```typescript
JSON stringify: 24110.839 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14056.285 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/24/2026 2:57:2`

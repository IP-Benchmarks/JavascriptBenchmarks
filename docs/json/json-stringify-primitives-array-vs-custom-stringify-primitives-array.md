...
```typescript
JSON stringify: 10024.371 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6764.248 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/21/2023 1:3:7`

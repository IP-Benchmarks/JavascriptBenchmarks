...
```typescript
JSON stringify: 11656.729 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8298.891 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/12/2022 0:52:3`

...
```typescript
JSON stringify: 17839.403 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14001.751 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/19/2025 1:24:0`

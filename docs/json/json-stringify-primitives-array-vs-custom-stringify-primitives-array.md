...
```typescript
JSON stringify: 17992.060 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13867.549 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/4/2025 1:12:14`

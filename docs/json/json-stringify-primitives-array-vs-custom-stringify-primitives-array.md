...
```typescript
JSON stringify: 11563.310 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8069.211 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/2/2022 1:46:50`

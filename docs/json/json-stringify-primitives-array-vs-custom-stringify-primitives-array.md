...
```typescript
JSON stringify: 15188.825 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13097.494 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/3/2023 0:58:5`

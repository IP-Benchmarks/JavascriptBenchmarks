...
```typescript
JSON stringify: 17600.467 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13763.562 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/16/2024 1:9:47`

...
```typescript
JSON stringify: 12220.773 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7959.601 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/12/2023 0:47:48`

...
```typescript
JSON stringify: 17395.780 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14202.056 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/5/2025 1:21:12`

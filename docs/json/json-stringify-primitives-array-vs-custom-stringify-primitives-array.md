...
```typescript
JSON stringify: 23771.517 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13100.502 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/10/2026 3:0:5`

...
#### **JSON stringify** is **_`1.32x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 17614.648 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13342.727 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/10/2025 1:23:46`

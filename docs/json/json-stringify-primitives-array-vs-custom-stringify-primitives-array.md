...
```typescript
JSON stringify: 18139.748 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13164.895 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/15/2026 2:1:53`

...
```typescript
JSON stringify: 9447.574 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6686.090 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/24/2022 0:56:1`

...
```typescript
JSON stringify: 15717.079 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13236.607 ops/s (100 runs over 100 unique samples each)
```

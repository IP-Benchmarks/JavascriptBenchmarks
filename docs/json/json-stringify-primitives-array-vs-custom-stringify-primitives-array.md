...
```typescript
JSON stringify: 16089.436 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13381.664 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/3/2024 0:54:36`

...
```typescript
JSON stringify: 12146.505 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9802.428 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/4/2023 1:1:46`

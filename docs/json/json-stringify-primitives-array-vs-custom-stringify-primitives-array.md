...
```typescript
JSON stringify: 17939.469 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13811.017 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/24/2025 1:14:19`

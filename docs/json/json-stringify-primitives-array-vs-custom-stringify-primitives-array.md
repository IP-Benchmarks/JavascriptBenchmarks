...
```typescript
JSON stringify: 10700.602 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7167.414 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/13/2021 0:44:43`

...
#### **JSON stringify** is **_`1.54x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10306.388 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6685.821 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/15/2023 0:54:32`

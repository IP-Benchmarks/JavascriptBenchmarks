...
```typescript
JSON stringify: 15482.041 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12732.541 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/19/2024 1:13:9`

...
```typescript
JSON stringify: 18620.973 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14693.266 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/7/2026 1:47:32`

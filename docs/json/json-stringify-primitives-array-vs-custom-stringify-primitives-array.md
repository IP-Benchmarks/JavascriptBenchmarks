...
```typescript
JSON stringify: 10253.836 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6879.441 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/30/2021 0:45:28`

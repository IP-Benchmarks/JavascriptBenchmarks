...
```typescript
JSON stringify: 12009.083 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8024.883 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/21/2022 1:10:9`

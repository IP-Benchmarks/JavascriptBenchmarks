...
```typescript
JSON stringify: 18239.689 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13167.896 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/12/2025 1:21:29`

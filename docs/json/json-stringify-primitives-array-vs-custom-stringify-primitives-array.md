...
```typescript
JSON stringify: 11436.691 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8122.489 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/2/2022 1:17:2`

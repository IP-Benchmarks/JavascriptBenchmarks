...
```typescript
JSON stringify: 18012.807 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13782.012 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/21/2026 1:49:26`

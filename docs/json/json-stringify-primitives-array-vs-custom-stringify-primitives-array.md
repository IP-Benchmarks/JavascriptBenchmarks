...
```typescript
JSON stringify: 16073.022 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13374.336 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/23/2023 0:54:29`

...
```typescript
JSON stringify: 11396.729 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8253.983 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/10/2022 1:15:7`

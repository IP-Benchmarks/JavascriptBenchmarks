...
```typescript
JSON stringify: 16953.707 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13182.690 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/4/2025 1:8:1`

...
```typescript
JSON stringify: 17903.839 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13906.864 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/1/2025 1:22:24`

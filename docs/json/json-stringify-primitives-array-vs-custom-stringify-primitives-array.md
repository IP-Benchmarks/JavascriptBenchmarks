...
#### **JSON stringify** is **_`1.67x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 23299.022 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13983.374 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/1/2026 2:32:12`

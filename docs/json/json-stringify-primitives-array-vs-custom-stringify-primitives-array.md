...
```typescript
JSON stringify: 17369.923 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13522.056 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/23/2025 1:7:45`

...
```typescript
JSON stringify: 13237.943 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7591.992 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/22/2023 0:50:35`

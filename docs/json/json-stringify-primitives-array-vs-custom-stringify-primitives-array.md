...
```typescript
JSON stringify: 11575.393 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8089.864 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/7/2022 1:44:41`

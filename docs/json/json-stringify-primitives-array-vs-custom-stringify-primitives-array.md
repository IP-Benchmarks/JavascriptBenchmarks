...
```typescript
JSON stringify: 9903.650 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6646.511 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/21/2022 1:18:49`

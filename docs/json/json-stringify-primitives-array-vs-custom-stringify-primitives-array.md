...
```typescript
JSON stringify: 24186.802 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14045.885 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/9/2026 2:51:33`

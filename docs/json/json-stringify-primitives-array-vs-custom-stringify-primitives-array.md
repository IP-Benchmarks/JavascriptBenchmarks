...
```typescript
JSON stringify: 12365.242 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8473.624 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/19/2023 1:10:7`

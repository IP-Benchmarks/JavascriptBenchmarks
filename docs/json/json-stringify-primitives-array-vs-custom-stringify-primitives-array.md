...
```typescript
JSON stringify: 15613.191 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13253.269 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/11/2024 1:5:25`

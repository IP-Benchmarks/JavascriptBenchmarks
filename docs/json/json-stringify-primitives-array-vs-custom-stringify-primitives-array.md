...
```typescript
JSON stringify: 10316.293 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7432.741 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/8/2022 1:17:21`

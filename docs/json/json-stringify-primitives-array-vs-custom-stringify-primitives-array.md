...
```typescript
JSON stringify: 17761.714 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13957.457 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/6/2025 1:19:19`

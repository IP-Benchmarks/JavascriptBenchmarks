...
#### **JSON stringify** is **_`1.23x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15232.031 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12350.268 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/10/2024 1:12:25`

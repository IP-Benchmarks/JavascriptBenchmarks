...
```typescript
JSON stringify: 18290.587 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14074.768 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/20/2025 1:17:57`

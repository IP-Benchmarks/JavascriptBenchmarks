...
```typescript
JSON stringify: 16945.282 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13208.091 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/8/2025 1:7:2`

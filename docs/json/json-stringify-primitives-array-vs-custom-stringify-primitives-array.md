...
```typescript
JSON stringify: 15955.015 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13534.542 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/11/2024 1:0:40`

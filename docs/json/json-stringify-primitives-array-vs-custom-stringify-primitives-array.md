...
```typescript
JSON stringify: 18105.807 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14065.884 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/21/2025 1:17:2`

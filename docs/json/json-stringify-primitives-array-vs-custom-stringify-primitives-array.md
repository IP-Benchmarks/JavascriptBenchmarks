...
```typescript
JSON stringify: 17639.197 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13902.311 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/1/2026 2:4:33`

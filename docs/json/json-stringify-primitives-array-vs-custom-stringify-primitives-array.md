...
```typescript
JSON stringify: 12345.253 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9308.467 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/25/2023 1:21:18`

...
```typescript
JSON stringify: 17319.793 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13912.764 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/2/2025 1:18:8`

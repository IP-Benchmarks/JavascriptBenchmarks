...
#### **JSON stringify** is **_`1.38x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 18568.896 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13477.545 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/27/2025 1:23:32`

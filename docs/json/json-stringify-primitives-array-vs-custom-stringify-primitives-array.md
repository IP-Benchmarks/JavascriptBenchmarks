...
```typescript
JSON stringify: 17695.366 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13640.544 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/12/2025 1:16:4`

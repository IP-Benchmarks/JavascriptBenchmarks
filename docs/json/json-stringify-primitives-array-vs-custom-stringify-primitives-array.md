...
```typescript
JSON stringify: 17777.452 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13623.255 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/3/2026 2:5:30`

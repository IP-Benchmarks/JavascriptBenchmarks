...
#### **JSON stringify** is **_`1.27x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 17709.660 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13941.788 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/21/2025 1:17:40`

...
```typescript
JSON stringify: 17656.561 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14138.711 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/25/2025 1:15:1`

...
```typescript
JSON stringify: 17699.467 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13737.638 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/20/2026 1:27:3`

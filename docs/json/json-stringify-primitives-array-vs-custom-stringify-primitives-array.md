...
```typescript
JSON stringify: 17868.867 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13731.136 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/7/2026 2:38:58`

...
#### **JSON stringify** is **_`1.83x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 24282.689 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13303.219 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/31/2026 2:32:43`

...
```typescript
JSON stringify: 15477.838 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13267.233 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/26/2024 1:13:28`

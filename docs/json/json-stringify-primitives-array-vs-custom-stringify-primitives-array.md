...
```typescript
JSON stringify: 16889.798 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14492.830 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/10/2025 1:15:11`

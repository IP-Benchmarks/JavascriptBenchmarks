...
```typescript
JSON stringify: 17799.033 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14204.798 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/29/2025 1:13:20`

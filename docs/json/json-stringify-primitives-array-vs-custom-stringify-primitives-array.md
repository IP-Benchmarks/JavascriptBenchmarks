...
```typescript
JSON stringify: 10433.655 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7124.998 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/10/2023 0:58:44`

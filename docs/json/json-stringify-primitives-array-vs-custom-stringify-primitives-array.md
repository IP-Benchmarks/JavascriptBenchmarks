...
```typescript
JSON stringify: 15272.941 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13226.426 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/22/2024 0:52:14`

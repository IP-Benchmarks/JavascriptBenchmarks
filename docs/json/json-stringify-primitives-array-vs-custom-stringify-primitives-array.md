...
```typescript
JSON stringify: 11954.741 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9944.123 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/29/2022 1:16:37`

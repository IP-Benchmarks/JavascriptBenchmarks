...
```typescript
JSON stringify: 23665.763 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13991.543 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/25/2026 1:4:29`

...
```typescript
JSON stringify: 24389.092 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13168.825 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/7/2026 2:30:37`

...
```typescript
JSON stringify: 15746.393 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13054.374 ops/s (100 runs over 100 unique samples each)
```

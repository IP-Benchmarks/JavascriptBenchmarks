...
```typescript
JSON stringify: 10160.216 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7097.559 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/21/2022 0:58:31`

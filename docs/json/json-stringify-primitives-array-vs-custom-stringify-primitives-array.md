...
```typescript
JSON stringify: 12340.024 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8969.580 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/22/2023 1:7:51`

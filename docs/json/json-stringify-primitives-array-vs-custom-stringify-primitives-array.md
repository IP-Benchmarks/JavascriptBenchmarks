...
```typescript
JSON stringify: 11847.541 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9949.187 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17496.088 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14172.576 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/12/2025 1:12:13`

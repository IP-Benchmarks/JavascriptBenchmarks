...
```typescript
JSON stringify: 18018.749 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14194.382 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/18/2025 1:21:36`

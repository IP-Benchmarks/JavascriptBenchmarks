...
```typescript
JSON stringify: 15870.792 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13482.849 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/31/2024 0:57:39`

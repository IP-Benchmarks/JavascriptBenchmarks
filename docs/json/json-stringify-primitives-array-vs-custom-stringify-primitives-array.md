...
#### **JSON stringify** is **_`1.70x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 11907.052 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6999.797 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/30/2023 0:50:45`

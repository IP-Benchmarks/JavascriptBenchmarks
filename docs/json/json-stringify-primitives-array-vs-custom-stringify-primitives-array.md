...
```typescript
JSON stringify: 12290.683 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8509.238 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/27/2022 1:23:3`

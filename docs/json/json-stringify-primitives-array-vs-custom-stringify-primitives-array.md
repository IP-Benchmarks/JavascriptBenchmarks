...
```typescript
JSON stringify: 11634.810 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7979.325 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/13/2022 1:40:48`

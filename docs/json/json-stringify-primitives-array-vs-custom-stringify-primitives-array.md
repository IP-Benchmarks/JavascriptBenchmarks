...
```typescript
JSON stringify: 24772.757 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13489.104 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/20/2026 3:19:19`

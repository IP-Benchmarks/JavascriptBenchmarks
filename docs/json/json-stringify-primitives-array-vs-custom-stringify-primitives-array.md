...
```typescript
JSON stringify: 17613.222 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13834.856 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/22/2025 1:12:27`

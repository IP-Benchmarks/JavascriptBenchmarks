...
```typescript
JSON stringify: 17877.122 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13908.408 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/13/2025 1:23:7`

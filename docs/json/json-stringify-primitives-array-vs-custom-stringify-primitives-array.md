...
```typescript
JSON stringify: 15822.277 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13151.929 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/3/2024 0:51:30`

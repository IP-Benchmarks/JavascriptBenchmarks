...
```typescript
JSON stringify: 12150.039 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7748.294 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/5/2023 0:50:5`

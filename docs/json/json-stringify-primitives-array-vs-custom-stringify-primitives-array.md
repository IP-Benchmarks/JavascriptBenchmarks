...
```typescript
JSON stringify: 17239.216 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13030.486 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/28/2024 1:7:49`

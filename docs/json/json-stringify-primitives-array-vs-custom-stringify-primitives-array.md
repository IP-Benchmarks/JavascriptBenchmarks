...
```typescript
JSON stringify: 12081.054 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8282.616 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/1/2022 1:26:46`

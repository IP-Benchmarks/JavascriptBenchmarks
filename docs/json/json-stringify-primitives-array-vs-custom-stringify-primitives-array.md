...
```typescript
JSON stringify: 15949.769 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12683.983 ops/s (100 runs over 100 unique samples each)
```

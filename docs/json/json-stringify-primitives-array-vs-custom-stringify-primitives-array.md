...
```typescript
JSON stringify: 23395.961 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 16843.491 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/5/2026 2:31:57`

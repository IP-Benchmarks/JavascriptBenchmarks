...
```typescript
JSON stringify: 10039.898 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6701.853 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/3/2023 1:7:51`

...
```typescript
JSON stringify: 17925.564 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14069.018 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/10/2025 1:42:28`

...
```typescript
JSON stringify: 15632.759 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13415.892 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/29/2024 0:57:49`

...
```typescript
JSON stringify: 11180.873 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8175.898 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/4/2022 0:44:54`

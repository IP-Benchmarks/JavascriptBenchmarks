...
```typescript
JSON stringify: 15726.144 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13605.586 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/26/2023 0:53:4`

...
```typescript
JSON stringify: 10706.563 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7532.263 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/2/2022 1:14:51`

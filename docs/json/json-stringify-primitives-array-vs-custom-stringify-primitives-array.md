...
```typescript
JSON stringify: 15386.098 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12994.300 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/15/2024 3:16:25`

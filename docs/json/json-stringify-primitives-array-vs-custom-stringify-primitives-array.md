...
```typescript
JSON stringify: 15300.118 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13356.186 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/14/2024 0:58:16`

...
```typescript
JSON stringify: 18224.256 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13835.992 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/9/2025 1:21:58`

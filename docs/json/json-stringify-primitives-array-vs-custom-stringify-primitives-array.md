...
```typescript
JSON stringify: 17371.423 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13664.447 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/21/2025 1:18:53`

...
```typescript
JSON stringify: 17661.834 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13541.002 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/2/2025 1:25:4`

...
```typescript
JSON stringify: 12244.082 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7931.276 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/22/2023 1:0:22`

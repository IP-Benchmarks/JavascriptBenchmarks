...
```typescript
JSON stringify: 11738.490 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7966.475 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/17/2022 1:44:28`

...
```typescript
JSON stringify: 9483.281 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7005.094 ops/s (100 runs over 100 unique samples each)
```

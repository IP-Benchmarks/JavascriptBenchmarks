...
```typescript
JSON stringify: 11600.138 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8243.954 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/26/2022 1:17:6`

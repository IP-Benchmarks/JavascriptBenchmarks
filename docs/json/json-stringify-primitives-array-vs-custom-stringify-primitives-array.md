...
```typescript
JSON stringify: 18298.238 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14155.712 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/30/2025 1:27:8`

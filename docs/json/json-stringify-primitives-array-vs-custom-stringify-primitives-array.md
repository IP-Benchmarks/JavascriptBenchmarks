...
```typescript
JSON stringify: 10067.161 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7025.587 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/14/2023 1:6:45`

...
```typescript
JSON stringify: 9365.139 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6545.337 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/11/2022 1:38:40`

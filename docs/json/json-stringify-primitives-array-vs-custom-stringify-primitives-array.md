...
```typescript
JSON stringify: 24185.512 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12896.486 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/30/2026 2:49:23`

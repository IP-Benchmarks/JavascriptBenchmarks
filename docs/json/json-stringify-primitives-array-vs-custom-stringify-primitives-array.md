...
```typescript
JSON stringify: 15438.934 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12361.871 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/10/2024 0:53:2`

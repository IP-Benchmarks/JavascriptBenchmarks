...
```typescript
JSON stringify: 11578.146 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9642.641 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/10/2022 1:16:58`

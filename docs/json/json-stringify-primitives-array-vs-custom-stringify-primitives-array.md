...
```typescript
JSON stringify: 12561.879 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8387.252 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/21/2023 1:8:6`

...
```typescript
JSON stringify: 13611.805 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9121.336 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/17/2022 1:27:19`

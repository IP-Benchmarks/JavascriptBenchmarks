...
```typescript
JSON stringify: 11623.108 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8168.657 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/7/2022 1:6:7`

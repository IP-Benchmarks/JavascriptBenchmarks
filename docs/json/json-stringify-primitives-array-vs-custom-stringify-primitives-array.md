...
```typescript
JSON stringify: 12385.848 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8103.612 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/23/2022 1:5:38`

...
```typescript
JSON stringify: 12663.036 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8420.552 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/7/2023 1:11:42`

...
```typescript
JSON stringify: 17948.145 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13911.636 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/2/2025 1:12:49`

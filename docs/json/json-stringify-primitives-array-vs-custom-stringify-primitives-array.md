...
```typescript
JSON stringify: 16031.112 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13683.785 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/22/2024 0:57:40`

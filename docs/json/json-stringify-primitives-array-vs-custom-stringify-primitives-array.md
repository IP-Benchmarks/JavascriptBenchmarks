...
```typescript
JSON stringify: 12480.639 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9838.643 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/23/2023 1:0:9`

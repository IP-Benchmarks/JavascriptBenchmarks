...
```typescript
JSON stringify: 15859.131 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13389.366 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/10/2024 1:2:10`

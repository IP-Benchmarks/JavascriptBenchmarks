...
```typescript
JSON stringify: 17560.299 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13657.567 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/21/2025 1:41:17`

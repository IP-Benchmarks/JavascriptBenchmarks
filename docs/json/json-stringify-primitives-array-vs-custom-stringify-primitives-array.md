...
```typescript
JSON stringify: 15787.906 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13137.921 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/10/2024 0:50:27`

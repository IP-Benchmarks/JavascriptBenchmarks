...
```typescript
JSON stringify: 15303.509 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12747.469 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/9/2023 0:52:58`

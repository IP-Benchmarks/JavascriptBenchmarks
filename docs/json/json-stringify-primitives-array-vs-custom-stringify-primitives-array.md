...
```typescript
JSON stringify: 17760.802 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14199.562 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/30/2025 1:19:57`

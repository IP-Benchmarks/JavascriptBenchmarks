...
```typescript
JSON stringify: 8545.341 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 5730.520 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/23/2022 1:48:4`

...
```typescript
JSON stringify: 11107.873 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8957.396 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/6/2022 1:12:53`

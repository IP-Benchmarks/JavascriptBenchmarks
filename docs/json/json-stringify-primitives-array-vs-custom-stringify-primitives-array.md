...
```typescript
JSON stringify: 17860.216 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13930.795 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/2/2025 1:22:47`

...
```typescript
JSON stringify: 11396.488 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9560.032 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/11/2022 1:27:5`

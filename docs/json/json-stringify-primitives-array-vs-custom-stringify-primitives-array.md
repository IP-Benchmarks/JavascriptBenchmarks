...
```typescript
JSON stringify: 10126.000 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6106.731 ops/s (100 runs over 100 unique samples each)
```

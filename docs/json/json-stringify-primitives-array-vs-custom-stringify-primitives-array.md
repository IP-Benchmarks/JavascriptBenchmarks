...
```typescript
JSON stringify: 17688.887 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13734.945 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/11/2026 2:6:33`

...
```typescript
JSON stringify: 16286.448 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13369.545 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/18/2023 0:56:23`

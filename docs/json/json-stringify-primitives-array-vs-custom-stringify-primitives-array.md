...
```typescript
JSON stringify: 17020.071 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13463.176 ops/s (100 runs over 100 unique samples each)
```

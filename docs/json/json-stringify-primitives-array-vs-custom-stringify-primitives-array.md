...
```typescript
JSON stringify: 16357.912 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13960.749 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/3/2024 0:54:51`

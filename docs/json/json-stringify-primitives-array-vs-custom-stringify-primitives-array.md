...
```typescript
JSON stringify: 17561.182 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13779.116 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/13/2025 1:20:16`

...
```typescript
JSON stringify: 11123.224 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8268.028 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/17/2022 1:14:10`

...
```typescript
JSON stringify: 9083.194 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6365.199 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/3/2022 1:3:51`

...
```typescript
JSON stringify: 15086.177 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12602.815 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/9/2024 0:55:12`

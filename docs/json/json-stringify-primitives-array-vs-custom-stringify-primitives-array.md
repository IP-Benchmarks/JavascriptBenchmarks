...
```typescript
JSON stringify: 15950.602 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12869.702 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/5/2024 1:3:3`

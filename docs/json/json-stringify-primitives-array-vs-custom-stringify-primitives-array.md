...
```typescript
JSON stringify: 12056.648 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8204.405 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/19/2022 1:41:30`

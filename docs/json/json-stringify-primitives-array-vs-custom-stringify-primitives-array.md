...
```typescript
JSON stringify: 10734.704 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7029.146 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/24/2023 1:5:55`

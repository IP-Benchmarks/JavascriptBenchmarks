...
```typescript
JSON stringify: 15415.092 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13537.420 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/1/2024 0:56:40`

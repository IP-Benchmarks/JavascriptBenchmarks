...
```typescript
JSON stringify: 17394.889 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13889.870 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/21/2025 1:20:36`

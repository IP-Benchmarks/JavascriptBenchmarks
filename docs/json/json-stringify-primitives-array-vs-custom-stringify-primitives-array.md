...
```typescript
JSON stringify: 17993.062 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13915.347 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/15/2025 1:26:48`

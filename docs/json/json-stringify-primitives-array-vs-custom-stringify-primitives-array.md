...
```typescript
JSON stringify: 17877.731 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14089.953 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/30/2025 1:12:6`

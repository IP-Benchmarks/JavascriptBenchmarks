...
```typescript
JSON stringify: 9394.805 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6502.653 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/28/2022 1:5:40`

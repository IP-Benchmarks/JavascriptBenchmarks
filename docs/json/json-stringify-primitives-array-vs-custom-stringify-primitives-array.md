...
```typescript
JSON stringify: 11556.211 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9914.366 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/12/2023 1:9:11`

...
```typescript
JSON stringify: 18461.301 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13421.154 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/6/2026 2:12:35`

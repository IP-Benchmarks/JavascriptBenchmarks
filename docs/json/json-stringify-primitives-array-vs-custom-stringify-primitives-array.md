...
```typescript
JSON stringify: 15619.301 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13209.189 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/9/2024 1:6:13`

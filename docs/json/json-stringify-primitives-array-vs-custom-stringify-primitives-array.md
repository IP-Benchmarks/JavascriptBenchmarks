...
```typescript
JSON stringify: 11611.760 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8043.707 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/2/2022 0:48:29`

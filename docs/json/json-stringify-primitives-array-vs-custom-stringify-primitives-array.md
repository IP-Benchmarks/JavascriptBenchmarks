...
```typescript
JSON stringify: 12072.171 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7622.263 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/28/2023 1:3:13`

...
```typescript
JSON stringify: 12342.009 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9755.208 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/1/2023 0:54:14`

...
```typescript
JSON stringify: 11912.333 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8010.006 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/23/2022 1:40:15`

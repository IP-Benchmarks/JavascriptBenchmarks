...
```typescript
JSON stringify: 15916.412 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13149.421 ops/s (100 runs over 100 unique samples each)
```

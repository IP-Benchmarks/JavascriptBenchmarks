...
#### **JSON stringify** is **_`1.58x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 11480.675 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7260.587 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/14/2023 0:50:59`

...
```typescript
JSON stringify: 9343.576 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6590.964 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/9/2022 0:50:14`

...
```typescript
JSON stringify: 24564.851 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14383.964 ops/s (100 runs over 100 unique samples each)
```

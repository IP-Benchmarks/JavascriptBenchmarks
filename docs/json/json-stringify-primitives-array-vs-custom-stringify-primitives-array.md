...
```typescript
JSON stringify: 17369.425 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14045.128 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/29/2025 1:21:13`

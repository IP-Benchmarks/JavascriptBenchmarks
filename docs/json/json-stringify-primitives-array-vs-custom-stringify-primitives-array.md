...
```typescript
JSON stringify: 10693.443 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7210.423 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/20/2022 1:18:25`

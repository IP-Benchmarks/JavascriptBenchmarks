...
```typescript
JSON stringify: 15785.300 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13303.668 ops/s (100 runs over 100 unique samples each)
```

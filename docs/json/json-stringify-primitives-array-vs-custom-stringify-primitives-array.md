...
#### **JSON stringify** is **_`2.02x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 26071.249 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12893.406 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/8/2026 2:59:0`

...
```typescript
JSON stringify: 18424.657 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14193.630 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/14/2025 1:12:11`

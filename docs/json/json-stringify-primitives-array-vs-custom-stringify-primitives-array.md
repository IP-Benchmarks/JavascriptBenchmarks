...
```typescript
JSON stringify: 15690.875 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13587.321 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/19/2023 0:55:9`

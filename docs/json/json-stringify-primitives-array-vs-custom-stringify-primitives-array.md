...
```typescript
JSON stringify: 17516.257 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13453.792 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/9/2026 2:0:39`

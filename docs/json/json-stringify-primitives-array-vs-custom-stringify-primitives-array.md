...
```typescript
JSON stringify: 9387.492 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6688.102 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/10/2022 1:3:40`

...
```typescript
JSON stringify: 15873.101 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13344.789 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 29563.744 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 15465.363 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/2/2026 2:30:18`

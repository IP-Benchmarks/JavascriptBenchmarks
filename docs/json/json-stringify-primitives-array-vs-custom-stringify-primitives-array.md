...
```typescript
JSON stringify: 18059.889 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12820.542 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/7/2026 1:49:34`

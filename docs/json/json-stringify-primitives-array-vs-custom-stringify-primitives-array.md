...
```typescript
JSON stringify: 15519.364 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13115.999 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/6/2024 0:55:57`

...
```typescript
JSON stringify: 15966.227 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13643.731 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/11/2024 1:6:46`

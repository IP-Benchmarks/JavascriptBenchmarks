...
#### **JSON stringify** is **_`1.12x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 14892.721 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13281.120 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/21/2024 1:12:20`

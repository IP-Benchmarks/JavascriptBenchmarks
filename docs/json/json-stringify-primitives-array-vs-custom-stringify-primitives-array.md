...
#### **JSON stringify** is **_`1.63x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10769.213 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6600.001 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/29/2023 0:55:9`

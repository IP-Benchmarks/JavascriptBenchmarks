...
```typescript
JSON stringify: 17387.846 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13962.937 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/12/2025 1:21:48`

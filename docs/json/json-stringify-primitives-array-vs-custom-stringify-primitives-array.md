...
```typescript
JSON stringify: 11691.051 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9943.848 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/4/2023 1:1:54`

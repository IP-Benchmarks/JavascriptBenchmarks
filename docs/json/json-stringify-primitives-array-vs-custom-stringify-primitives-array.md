...
```typescript
JSON stringify: 9772.777 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6544.644 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/26/2023 1:2:33`

...
```typescript
JSON stringify: 17714.674 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12680.054 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/2/2026 1:26:28`

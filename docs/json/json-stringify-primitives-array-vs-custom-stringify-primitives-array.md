...
```typescript
JSON stringify: 11644.551 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8208.285 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/22/2022 0:49:26`

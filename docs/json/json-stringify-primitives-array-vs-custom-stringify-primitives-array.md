...
```typescript
JSON stringify: 17870.285 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13994.027 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/7/2025 1:39:20`

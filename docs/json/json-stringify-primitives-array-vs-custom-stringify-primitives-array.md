...
```typescript
JSON stringify: 18530.854 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13866.164 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/22/2026 1:57:43`

...
```typescript
JSON stringify: 13055.715 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8888.312 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/4/2022 1:3:5`

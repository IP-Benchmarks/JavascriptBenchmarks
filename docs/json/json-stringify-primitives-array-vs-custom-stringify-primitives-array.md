...
```typescript
JSON stringify: 10858.578 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7467.949 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/9/2022 0:49:28`

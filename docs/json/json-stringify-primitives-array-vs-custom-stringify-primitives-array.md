...
```typescript
JSON stringify: 15994.926 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12959.478 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/26/2024 0:58:45`

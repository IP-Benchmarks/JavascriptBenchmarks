...
```typescript
JSON stringify: 15575.078 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13312.844 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/20/2024 0:53:52`

...
```typescript
JSON stringify: 9803.870 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6187.239 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/18/2023 0:49:16`

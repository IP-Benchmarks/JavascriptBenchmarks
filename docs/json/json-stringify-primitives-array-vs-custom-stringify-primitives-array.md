...
```typescript
JSON stringify: 10220.595 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7020.773 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/15/2022 1:14:34`

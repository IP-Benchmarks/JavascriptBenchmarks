...
```typescript
JSON stringify: 24897.497 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13238.783 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/24/2026 2:26:1`

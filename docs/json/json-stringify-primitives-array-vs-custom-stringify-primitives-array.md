...
```typescript
JSON stringify: 12560.251 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10114.761 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/25/2023 0:52:11`

...
```typescript
JSON stringify: 18155.584 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14029.056 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/16/2025 1:24:28`

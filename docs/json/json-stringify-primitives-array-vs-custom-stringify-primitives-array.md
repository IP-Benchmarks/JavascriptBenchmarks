...
```typescript
JSON stringify: 15426.290 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12989.115 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/4/2024 0:59:17`

...
```typescript
JSON stringify: 10147.759 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6931.733 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/13/2023 1:11:15`

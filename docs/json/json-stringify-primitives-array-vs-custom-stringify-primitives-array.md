...
```typescript
JSON stringify: 17741.501 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13533.538 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/29/2025 1:15:28`

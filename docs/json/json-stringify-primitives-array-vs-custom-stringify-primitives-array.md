...
```typescript
JSON stringify: 11692.289 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8044.677 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/26/2022 1:22:9`

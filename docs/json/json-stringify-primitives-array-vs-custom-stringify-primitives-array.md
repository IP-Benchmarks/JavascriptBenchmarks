...
```typescript
JSON stringify: 16960.341 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14012.776 ops/s (100 runs over 100 unique samples each)
```

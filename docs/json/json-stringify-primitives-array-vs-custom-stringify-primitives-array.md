...
```typescript
JSON stringify: 17353.598 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13924.404 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/11/2025 1:13:3`

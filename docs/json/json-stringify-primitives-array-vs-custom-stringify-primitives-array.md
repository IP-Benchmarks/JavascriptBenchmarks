...
```typescript
JSON stringify: 11603.835 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8059.592 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/12/2022 1:53:44`

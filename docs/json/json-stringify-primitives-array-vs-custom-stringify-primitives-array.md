...
```typescript
JSON stringify: 15816.938 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13500.110 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/4/2024 0:54:57`

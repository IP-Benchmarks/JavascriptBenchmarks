...
```typescript
JSON stringify: 15900.997 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13314.659 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/23/2024 0:54:18`

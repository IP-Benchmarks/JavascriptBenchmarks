...
```typescript
JSON stringify: 31373.026 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 17130.247 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/7/2026 3:37:37`

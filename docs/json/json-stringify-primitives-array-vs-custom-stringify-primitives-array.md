...
```typescript
JSON stringify: 11352.177 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9722.063 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/24/2022 0:57:53`

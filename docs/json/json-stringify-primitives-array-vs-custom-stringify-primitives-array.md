...
```typescript
JSON stringify: 17823.691 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13933.359 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/28/2026 1:39:22`

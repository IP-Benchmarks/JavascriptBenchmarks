...
```typescript
JSON stringify: 17541.129 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13022.051 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/17/2026 1:56:24`

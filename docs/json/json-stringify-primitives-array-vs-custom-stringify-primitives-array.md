...
```typescript
JSON stringify: 9073.428 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6480.057 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/3/2022 0:43:47`

...
```typescript
JSON stringify: 18263.167 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12996.281 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/7/2026 2:8:30`

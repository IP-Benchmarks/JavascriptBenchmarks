...
```typescript
JSON stringify: 12392.986 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9641.034 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/1/2023 1:21:17`

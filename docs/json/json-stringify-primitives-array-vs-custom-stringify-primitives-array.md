...
```typescript
JSON stringify: 12203.292 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8070.222 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/25/2023 0:50:40`

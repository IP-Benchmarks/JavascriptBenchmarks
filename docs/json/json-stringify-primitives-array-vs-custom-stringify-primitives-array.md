...
```typescript
JSON stringify: 18014.708 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12720.672 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/5/2026 1:54:28`

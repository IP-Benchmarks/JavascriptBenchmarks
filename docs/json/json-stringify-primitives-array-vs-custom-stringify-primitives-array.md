...
```typescript
JSON stringify: 24483.457 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13661.041 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/19/2026 3:3:16`

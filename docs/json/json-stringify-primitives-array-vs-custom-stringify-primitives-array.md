...
```typescript
JSON stringify: 11767.399 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9951.979 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/11/2023 0:59:21`

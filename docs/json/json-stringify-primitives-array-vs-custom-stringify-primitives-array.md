...
```typescript
JSON stringify: 18157.047 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13458.373 ops/s (100 runs over 100 unique samples each)
```

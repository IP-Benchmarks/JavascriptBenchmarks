...
```typescript
JSON stringify: 13336.085 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8631.737 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/16/2022 1:11:39`

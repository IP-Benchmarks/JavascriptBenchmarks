...
```typescript
JSON stringify: 10150.033 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6396.155 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/19/2023 0:47:33`

...
```typescript
JSON stringify: 17836.605 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14276.014 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/3/2025 1:13:43`

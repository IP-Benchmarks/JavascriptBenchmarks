...
```typescript
JSON stringify: 17137.118 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13903.131 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/13/2025 1:20:18`

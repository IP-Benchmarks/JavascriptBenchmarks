...
```typescript
JSON stringify: 17691.407 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13318.428 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/11/2025 1:39:39`

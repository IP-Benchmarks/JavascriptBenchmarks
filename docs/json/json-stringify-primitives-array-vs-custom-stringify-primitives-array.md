...
#### **JSON stringify** is **_`1.08x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 14430.440 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13395.213 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/27/2024 0:59:53`

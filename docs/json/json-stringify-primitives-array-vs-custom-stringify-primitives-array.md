...
```typescript
JSON stringify: 12415.386 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9150.638 ops/s (100 runs over 100 unique samples each)
```

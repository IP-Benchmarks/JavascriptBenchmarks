...
```typescript
JSON stringify: 9854.615 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6132.636 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/7/2023 0:51:32`

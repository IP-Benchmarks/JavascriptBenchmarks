...
```typescript
JSON stringify: 12032.919 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8435.027 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/8/2022 1:17:56`

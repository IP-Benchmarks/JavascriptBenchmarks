...
```typescript
JSON stringify: 17956.771 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14049.865 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/11/2026 1:44:15`

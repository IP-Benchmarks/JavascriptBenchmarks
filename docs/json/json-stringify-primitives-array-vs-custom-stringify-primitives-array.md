...
```typescript
JSON stringify: 11927.673 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8048.895 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/12/2022 1:16:57`

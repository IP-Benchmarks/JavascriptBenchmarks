...
```typescript
JSON stringify: 17281.888 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13308.344 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/29/2026 2:9:33`

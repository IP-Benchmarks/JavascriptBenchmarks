...
```typescript
JSON stringify: 11601.471 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8220.769 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/11/2022 1:19:15`

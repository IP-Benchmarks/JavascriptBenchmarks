...
```typescript
JSON stringify: 10119.024 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6437.180 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/21/2023 1:6:48`

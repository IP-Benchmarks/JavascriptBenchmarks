...
```typescript
JSON stringify: 11625.129 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8010.673 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/11/2022 0:49:35`

...
```typescript
JSON stringify: 15587.726 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12668.064 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/1/2024 0:58:29`

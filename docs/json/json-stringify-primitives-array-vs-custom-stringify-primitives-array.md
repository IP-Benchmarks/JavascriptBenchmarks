...
```typescript
JSON stringify: 10089.373 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7306.362 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/6/2022 1:3:59`

...
```typescript
JSON stringify: 16061.013 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13459.411 ops/s (100 runs over 100 unique samples each)
```

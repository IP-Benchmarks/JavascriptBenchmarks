...
```typescript
JSON stringify: 17640.358 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13758.073 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/28/2025 1:18:9`

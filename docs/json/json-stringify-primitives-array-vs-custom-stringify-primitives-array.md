...
```typescript
JSON stringify: 12131.385 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8112.262 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/1/2023 1:22:15`

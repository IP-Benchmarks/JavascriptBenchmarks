...
```typescript
JSON stringify: 11644.880 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9962.954 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/9/2022 1:0:9`

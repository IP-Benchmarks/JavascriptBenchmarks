...
```typescript
JSON stringify: 26107.899 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 15166.216 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/2/2026 3:41:0`

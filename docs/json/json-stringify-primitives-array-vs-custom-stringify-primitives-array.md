...
```typescript
JSON stringify: 17980.397 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14086.764 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/18/2024 1:12:37`

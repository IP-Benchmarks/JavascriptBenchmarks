...
```typescript
JSON stringify: 15054.126 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13424.383 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/2/2024 0:52:27`

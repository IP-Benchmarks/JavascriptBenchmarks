...
#### **JSON stringify** is **_`1.93x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 23797.390 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12315.236 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/13/2026 2:31:31`

...
```typescript
JSON stringify: 12085.342 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8363.814 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/1/2022 1:26:42`

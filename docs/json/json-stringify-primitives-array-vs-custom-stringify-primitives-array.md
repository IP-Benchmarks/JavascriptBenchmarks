...
```typescript
JSON stringify: 17812.992 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14181.761 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/12/2025 1:9:0`

...
```typescript
JSON stringify: 11076.701 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8050.523 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/20/2022 0:52:33`

...
```typescript
JSON stringify: 17069.646 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14171.427 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/4/2025 1:21:39`

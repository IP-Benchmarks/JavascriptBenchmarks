...
```typescript
JSON stringify: 17555.143 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14074.423 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/6/2025 1:15:8`

...
```typescript
JSON stringify: 17303.187 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13796.303 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/30/2025 1:15:20`

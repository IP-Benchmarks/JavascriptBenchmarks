...
```typescript
JSON stringify: 11436.805 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7814.229 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/3/2023 1:6:57`

...
```typescript
JSON stringify: 11438.289 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9749.279 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/3/2022 0:56:3`

...
```typescript
JSON stringify: 10147.944 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6351.674 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/20/2023 0:51:56`

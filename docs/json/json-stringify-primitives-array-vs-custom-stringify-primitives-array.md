...
```typescript
JSON stringify: 10009.585 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6877.465 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/16/2022 1:1:44`

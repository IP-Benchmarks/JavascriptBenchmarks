...
```typescript
JSON stringify: 15711.008 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13287.960 ops/s (100 runs over 100 unique samples each)
```

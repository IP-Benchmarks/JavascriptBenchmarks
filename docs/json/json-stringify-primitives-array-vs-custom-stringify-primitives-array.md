...
```typescript
JSON stringify: 10938.064 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7220.082 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/16/2022 0:50:0`

...
```typescript
JSON stringify: 24330.101 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14148.871 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/3/2026 3:50:34`

...
```typescript
JSON stringify: 15848.074 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13266.410 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/25/2024 1:9:52`

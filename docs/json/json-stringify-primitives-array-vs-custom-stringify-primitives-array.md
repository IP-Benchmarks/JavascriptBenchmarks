...
```typescript
JSON stringify: 9695.222 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6386.283 ops/s (100 runs over 100 unique samples each)
```

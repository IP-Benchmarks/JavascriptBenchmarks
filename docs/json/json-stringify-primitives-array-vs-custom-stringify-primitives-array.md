...
```typescript
JSON stringify: 9080.964 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6479.526 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/28/2022 1:4:33`

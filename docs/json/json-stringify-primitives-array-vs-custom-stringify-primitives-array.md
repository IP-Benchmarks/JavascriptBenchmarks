...
```typescript
JSON stringify: 15706.544 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11981.658 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/29/2024 0:51:30`

...
```typescript
JSON stringify: 15833.451 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13273.728 ops/s (100 runs over 100 unique samples each)
```

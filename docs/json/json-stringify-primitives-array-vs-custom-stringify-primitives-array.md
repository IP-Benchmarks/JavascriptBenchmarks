...
```typescript
JSON stringify: 11830.604 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8109.186 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/26/2021 0:48:44`

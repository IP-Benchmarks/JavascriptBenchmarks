...
```typescript
JSON stringify: 10138.276 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6610.873 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/8/2023 0:53:4`

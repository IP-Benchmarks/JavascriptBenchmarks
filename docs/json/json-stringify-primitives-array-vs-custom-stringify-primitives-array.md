...
```typescript
JSON stringify: 12880.633 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8325.557 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/18/2022 0:49:42`

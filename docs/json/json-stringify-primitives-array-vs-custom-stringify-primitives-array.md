...
```typescript
JSON stringify: 16108.480 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13177.886 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/16/2024 0:53:10`

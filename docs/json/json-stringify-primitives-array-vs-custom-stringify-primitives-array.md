...
```typescript
JSON stringify: 17803.677 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13940.166 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/31/2024 1:9:3`

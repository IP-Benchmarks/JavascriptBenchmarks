...
```typescript
JSON stringify: 17164.503 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14243.636 ops/s (100 runs over 100 unique samples each)
```

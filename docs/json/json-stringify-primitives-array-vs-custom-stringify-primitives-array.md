...
```typescript
JSON stringify: 12527.830 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8430.267 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/27/2023 1:1:18`

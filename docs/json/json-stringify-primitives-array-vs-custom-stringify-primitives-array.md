...
```typescript
JSON stringify: 15240.105 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12449.207 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/22/2024 0:56:48`

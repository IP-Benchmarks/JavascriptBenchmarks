...
```typescript
JSON stringify: 16090.812 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13366.099 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/17/2024 0:51:24`

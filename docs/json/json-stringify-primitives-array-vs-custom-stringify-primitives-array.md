...
```typescript
JSON stringify: 17677.369 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13587.471 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/2/2026 1:55:29`

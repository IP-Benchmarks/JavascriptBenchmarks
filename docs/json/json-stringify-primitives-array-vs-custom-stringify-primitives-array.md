...
```typescript
JSON stringify: 17624.452 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13835.108 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/18/2025 1:5:25`

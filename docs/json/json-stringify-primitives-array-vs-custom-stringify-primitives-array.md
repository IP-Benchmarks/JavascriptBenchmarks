...
```typescript
JSON stringify: 16061.709 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13360.498 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/26/2023 0:57:47`

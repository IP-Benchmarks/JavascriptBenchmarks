...
```typescript
JSON stringify: 17363.962 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13936.235 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/3/2026 1:57:15`

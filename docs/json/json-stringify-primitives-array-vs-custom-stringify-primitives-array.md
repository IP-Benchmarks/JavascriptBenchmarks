...
```typescript
JSON stringify: 15941.823 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12643.255 ops/s (100 runs over 100 unique samples each)
```

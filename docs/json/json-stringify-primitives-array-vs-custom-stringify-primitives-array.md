...
```typescript
JSON stringify: 17347.557 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13305.156 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/9/2026 1:27:25`

...
```typescript
JSON stringify: 12346.197 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8119.938 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/10/2023 0:58:14`

...
```typescript
JSON stringify: 15715.932 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13328.991 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/22/2024 1:13:5`

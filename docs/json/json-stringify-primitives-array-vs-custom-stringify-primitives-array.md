...
#### **JSON stringify** is **_`1.91x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 24482.567 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12813.434 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/24/2026 2:57:55`

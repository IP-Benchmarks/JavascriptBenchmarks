...
```typescript
JSON stringify: 11896.298 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8019.094 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/19/2023 0:51:43`

...
```typescript
JSON stringify: 15430.019 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13125.381 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/2/2024 1:5:53`

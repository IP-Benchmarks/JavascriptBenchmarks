...
```typescript
JSON stringify: 15967.195 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12581.777 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/8/2024 1:8:38`

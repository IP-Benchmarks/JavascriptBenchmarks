...
```typescript
JSON stringify: 10082.458 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6077.888 ops/s (100 runs over 100 unique samples each)
```

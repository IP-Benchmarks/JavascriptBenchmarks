...
```typescript
JSON stringify: 12599.171 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9928.053 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/5/2023 0:50:9`

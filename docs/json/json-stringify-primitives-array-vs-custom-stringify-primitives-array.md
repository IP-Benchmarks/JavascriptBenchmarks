...
```typescript
JSON stringify: 9746.868 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 5806.557 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/5/2023 0:55:28`

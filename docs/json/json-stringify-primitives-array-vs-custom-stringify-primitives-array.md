...
```typescript
JSON stringify: 15962.637 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13388.413 ops/s (100 runs over 100 unique samples each)
```

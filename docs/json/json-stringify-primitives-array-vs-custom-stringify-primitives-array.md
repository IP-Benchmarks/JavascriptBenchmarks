...
```typescript
JSON stringify: 17709.873 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14172.664 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/5/2025 1:13:34`

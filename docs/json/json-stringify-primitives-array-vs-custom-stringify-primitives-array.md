...
```typescript
JSON stringify: 18276.009 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14132.420 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/16/2025 1:19:46`

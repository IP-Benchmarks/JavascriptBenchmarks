...
```typescript
JSON stringify: 12217.776 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8551.475 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/13/2023 1:5:0`

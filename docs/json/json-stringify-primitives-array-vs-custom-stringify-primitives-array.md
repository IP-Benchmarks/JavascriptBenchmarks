...
```typescript
JSON stringify: 15366.157 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13034.098 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/24/2024 1:9:5`

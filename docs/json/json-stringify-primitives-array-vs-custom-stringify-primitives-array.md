...
```typescript
JSON stringify: 17339.879 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13995.686 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/3/2026 1:21:55`

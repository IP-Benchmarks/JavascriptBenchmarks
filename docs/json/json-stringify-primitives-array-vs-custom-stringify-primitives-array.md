...
```typescript
JSON stringify: 17464.226 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14062.985 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/10/2025 1:24:14`

...
```typescript
JSON stringify: 17644.331 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13961.456 ops/s (100 runs over 100 unique samples each)
```

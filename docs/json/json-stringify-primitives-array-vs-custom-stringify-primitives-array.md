...
```typescript
JSON stringify: 15994.524 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13256.574 ops/s (100 runs over 100 unique samples each)
```

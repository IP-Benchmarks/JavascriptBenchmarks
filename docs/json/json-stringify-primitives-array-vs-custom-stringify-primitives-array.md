...
```typescript
JSON stringify: 17437.332 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13941.951 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/15/2025 1:17:4`

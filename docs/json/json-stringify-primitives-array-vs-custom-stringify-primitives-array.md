...
```typescript
JSON stringify: 17673.406 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14130.240 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/2/2026 2:30:54`

...
```typescript
JSON stringify: 17186.127 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13565.863 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/21/2024 1:8:25`

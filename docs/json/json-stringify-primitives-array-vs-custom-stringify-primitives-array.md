...
```typescript
JSON stringify: 17773.072 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14044.239 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/6/2025 1:18:16`

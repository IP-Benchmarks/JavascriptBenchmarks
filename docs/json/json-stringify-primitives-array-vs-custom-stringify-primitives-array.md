...
```typescript
JSON stringify: 17790.783 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13795.032 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/17/2025 1:15:31`

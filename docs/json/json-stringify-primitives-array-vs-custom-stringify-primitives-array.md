...
```typescript
JSON stringify: 15393.012 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12200.758 ops/s (100 runs over 100 unique samples each)
```

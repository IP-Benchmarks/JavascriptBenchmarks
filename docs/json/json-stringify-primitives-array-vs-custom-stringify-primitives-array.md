...
```typescript
JSON stringify: 15942.088 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13483.721 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/21/2024 0:57:43`

...
```typescript
JSON stringify: 12149.316 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7939.191 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/28/2023 0:59:6`

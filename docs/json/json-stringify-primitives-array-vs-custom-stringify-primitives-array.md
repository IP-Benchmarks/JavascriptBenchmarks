...
```typescript
JSON stringify: 17725.776 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13924.708 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/10/2025 1:11:42`

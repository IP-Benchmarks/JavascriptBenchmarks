...
```typescript
JSON stringify: 12525.558 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9854.019 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/18/2023 0:59:7`

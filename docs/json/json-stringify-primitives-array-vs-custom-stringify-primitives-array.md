...
```typescript
JSON stringify: 17884.739 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13972.304 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/7/2025 1:13:0`

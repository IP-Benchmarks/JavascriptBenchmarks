...
```typescript
JSON stringify: 17906.219 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14053.460 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/2/2026 2:3:55`

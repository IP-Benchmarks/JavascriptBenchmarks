...
```typescript
JSON stringify: 12184.954 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8187.955 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/8/2023 0:58:51`

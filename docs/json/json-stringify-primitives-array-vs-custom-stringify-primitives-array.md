...
```typescript
JSON stringify: 11773.101 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9824.834 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/9/2022 1:4:35`

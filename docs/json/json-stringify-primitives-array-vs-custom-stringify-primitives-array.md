...
```typescript
JSON stringify: 10367.519 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6312.024 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/23/2022 1:18:38`

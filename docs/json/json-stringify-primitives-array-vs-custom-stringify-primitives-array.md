...
```typescript
JSON stringify: 17412.172 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13573.762 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/26/2026 1:53:31`

...
```typescript
JSON stringify: 17919.452 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13720.164 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/8/2025 1:22:40`

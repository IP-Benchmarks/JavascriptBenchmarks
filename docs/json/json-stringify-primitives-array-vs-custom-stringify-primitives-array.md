...
```typescript
JSON stringify: 12201.685 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8114.357 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/30/2023 0:50:34`

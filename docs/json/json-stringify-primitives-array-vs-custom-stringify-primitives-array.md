...
```typescript
JSON stringify: 17703.171 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13633.848 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/13/2024 1:16:25`

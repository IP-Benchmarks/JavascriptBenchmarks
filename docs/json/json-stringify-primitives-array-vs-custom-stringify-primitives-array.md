...
```typescript
JSON stringify: 11314.341 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8064.917 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/9/2022 1:10:51`

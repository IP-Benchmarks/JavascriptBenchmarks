...
```typescript
JSON stringify: 12436.748 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8475.650 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/31/2023 1:8:23`

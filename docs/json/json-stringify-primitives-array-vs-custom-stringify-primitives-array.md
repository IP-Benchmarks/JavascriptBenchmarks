...
```typescript
JSON stringify: 15215.785 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13186.799 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/8/2024 1:1:3`

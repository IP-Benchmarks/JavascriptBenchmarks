...
```typescript
JSON stringify: 17238.313 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14059.562 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/19/2025 1:9:42`

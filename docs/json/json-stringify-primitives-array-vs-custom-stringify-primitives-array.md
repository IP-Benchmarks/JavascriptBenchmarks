...
```typescript
JSON stringify: 17934.992 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12543.788 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/14/2025 1:38:20`

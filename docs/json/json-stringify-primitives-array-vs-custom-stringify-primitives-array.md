...
#### **JSON stringify** is **_`1.56x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 11820.572 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7597.217 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/30/2022 1:17:53`

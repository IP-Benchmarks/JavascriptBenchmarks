...
```typescript
JSON stringify: 12553.372 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9446.478 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/18/2023 1:2:56`

...
```typescript
JSON stringify: 12247.118 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8063.800 ops/s (100 runs over 100 unique samples each)
```

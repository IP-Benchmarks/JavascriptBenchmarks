...
```typescript
JSON stringify: 17716.944 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14098.884 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/14/2025 1:19:41`

...
```typescript
JSON stringify: 15942.477 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13415.284 ops/s (100 runs over 100 unique samples each)
```

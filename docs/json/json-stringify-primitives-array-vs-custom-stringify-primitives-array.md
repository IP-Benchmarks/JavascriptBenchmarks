...
```typescript
JSON stringify: 11700.375 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7796.971 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/20/2022 1:17:15`

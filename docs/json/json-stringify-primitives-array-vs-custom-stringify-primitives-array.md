...
```typescript
JSON stringify: 15530.852 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13363.403 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/19/2024 1:6:33`

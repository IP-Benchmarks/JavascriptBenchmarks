...
```typescript
JSON stringify: 17565.767 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13913.767 ops/s (100 runs over 100 unique samples each)
```

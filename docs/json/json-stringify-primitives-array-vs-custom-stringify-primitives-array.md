...
```typescript
JSON stringify: 15146.061 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13285.322 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/16/2024 1:9:55`

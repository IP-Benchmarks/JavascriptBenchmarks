...
```typescript
JSON stringify: 12455.923 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10042.823 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/25/2023 1:1:12`

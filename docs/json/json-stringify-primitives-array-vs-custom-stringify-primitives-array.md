...
```typescript
JSON stringify: 17402.113 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13866.071 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17307.557 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13922.423 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/17/2024 1:15:28`

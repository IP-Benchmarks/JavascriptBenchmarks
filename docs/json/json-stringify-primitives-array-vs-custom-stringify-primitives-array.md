...
```typescript
JSON stringify: 15904.296 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13563.633 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/10/2024 1:0:40`

...
```typescript
JSON stringify: 24609.214 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13474.180 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/2/2026 2:47:18`

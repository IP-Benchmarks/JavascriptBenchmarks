...
```typescript
JSON stringify: 17545.475 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14094.320 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/25/2025 1:17:38`

...
```typescript
JSON stringify: 11387.889 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8307.496 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/25/2022 1:7:42`

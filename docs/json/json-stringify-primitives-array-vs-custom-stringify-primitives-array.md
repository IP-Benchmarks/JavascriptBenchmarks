...
```typescript
JSON stringify: 16082.817 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13111.758 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/17/2024 0:56:18`

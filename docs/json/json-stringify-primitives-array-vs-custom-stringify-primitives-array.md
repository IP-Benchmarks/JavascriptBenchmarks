...
```typescript
JSON stringify: 15447.667 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13311.981 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/8/2024 1:20:51`

...
#### **JSON stringify** is **_`1.97x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 23504.686 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11934.798 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/4/2026 2:11:45`

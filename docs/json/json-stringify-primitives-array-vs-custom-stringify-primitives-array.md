...
```typescript
JSON stringify: 17633.615 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13820.866 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/11/2025 1:24:36`

...
```typescript
JSON stringify: 17729.132 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13797.548 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/31/2025 1:25:49`

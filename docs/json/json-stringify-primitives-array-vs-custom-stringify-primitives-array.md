...
```typescript
JSON stringify: 12608.965 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8320.641 ops/s (100 runs over 100 unique samples each)
```

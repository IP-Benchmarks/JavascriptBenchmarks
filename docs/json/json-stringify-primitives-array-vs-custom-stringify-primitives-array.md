...
```typescript
JSON stringify: 11608.535 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9873.644 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/9/2023 1:3:29`

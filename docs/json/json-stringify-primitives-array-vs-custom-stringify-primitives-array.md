...
```typescript
JSON stringify: 9592.814 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6494.230 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/15/2022 1:46:10`

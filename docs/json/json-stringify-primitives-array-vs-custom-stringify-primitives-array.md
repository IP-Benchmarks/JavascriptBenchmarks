...
```typescript
JSON stringify: 16115.074 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13584.940 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 14529.578 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13238.505 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/30/2024 1:10:4`

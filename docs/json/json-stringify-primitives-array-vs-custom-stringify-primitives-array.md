...
```typescript
JSON stringify: 17906.566 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13946.213 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/30/2025 1:25:8`

...
```typescript
JSON stringify: 12196.342 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9716.059 ops/s (100 runs over 100 unique samples each)
```

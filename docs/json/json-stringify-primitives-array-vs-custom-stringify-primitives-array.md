...
```typescript
JSON stringify: 10819.747 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8184.283 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/3/2023 1:0:40`

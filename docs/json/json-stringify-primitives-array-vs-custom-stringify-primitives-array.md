...
```typescript
JSON stringify: 17529.746 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14118.748 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/22/2025 1:19:52`

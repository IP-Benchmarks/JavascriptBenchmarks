...
```typescript
JSON stringify: 12478.862 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8427.411 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/19/2023 1:0:34`

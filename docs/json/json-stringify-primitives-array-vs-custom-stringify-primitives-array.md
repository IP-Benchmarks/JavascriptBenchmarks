...
```typescript
JSON stringify: 10100.882 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6612.074 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/8/2023 0:55:34`

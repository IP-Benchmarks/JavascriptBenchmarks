...
```typescript
JSON stringify: 17640.747 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13456.440 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/7/2025 1:9:53`

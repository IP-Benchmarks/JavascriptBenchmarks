...
```typescript
JSON stringify: 12152.137 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8355.287 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/17/2023 1:2:25`

...
```typescript
JSON stringify: 10260.803 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7659.427 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/5/2022 1:17:33`

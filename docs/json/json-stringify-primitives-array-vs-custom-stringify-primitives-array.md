...
```typescript
JSON stringify: 17558.718 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13765.514 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/24/2026 1:25:2`

...
```typescript
JSON stringify: 18806.730 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13816.681 ops/s (100 runs over 100 unique samples each)
```

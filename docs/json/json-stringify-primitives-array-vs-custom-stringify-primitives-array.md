...
```typescript
JSON stringify: 17861.685 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13216.383 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/31/2025 1:37:53`

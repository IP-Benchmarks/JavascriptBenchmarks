...
```typescript
JSON stringify: 12009.772 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8091.912 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/27/2022 1:18:43`

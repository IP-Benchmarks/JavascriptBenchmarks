...
```typescript
JSON stringify: 17701.177 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14134.684 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/6/2026 1:55:30`

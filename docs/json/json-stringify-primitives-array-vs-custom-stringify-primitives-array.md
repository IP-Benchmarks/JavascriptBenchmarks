...
```typescript
JSON stringify: 17404.710 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14106.268 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/11/2025 1:9:58`

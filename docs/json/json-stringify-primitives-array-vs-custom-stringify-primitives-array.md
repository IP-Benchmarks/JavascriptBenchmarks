...
```typescript
JSON stringify: 15338.179 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12372.532 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/22/2024 1:3:18`

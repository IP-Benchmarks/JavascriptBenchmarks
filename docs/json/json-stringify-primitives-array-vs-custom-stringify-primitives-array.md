...
```typescript
JSON stringify: 17622.550 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13920.803 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/8/2025 1:9:52`

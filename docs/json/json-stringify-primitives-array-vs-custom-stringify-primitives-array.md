...
```typescript
JSON stringify: 11882.591 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9887.175 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/7/2023 1:1:17`

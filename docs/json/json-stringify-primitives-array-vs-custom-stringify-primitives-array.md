...
```typescript
JSON stringify: 17719.111 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13819.612 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/23/2025 1:38:9`

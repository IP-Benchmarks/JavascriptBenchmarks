...
```typescript
JSON stringify: 10521.575 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7310.019 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/15/2022 1:23:23`

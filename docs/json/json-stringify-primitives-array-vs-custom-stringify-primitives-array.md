...
```typescript
JSON stringify: 17912.582 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13686.786 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/12/2025 1:19:46`

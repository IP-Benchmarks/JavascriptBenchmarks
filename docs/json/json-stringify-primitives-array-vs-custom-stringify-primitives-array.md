...
```typescript
JSON stringify: 15741.575 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13269.431 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/16/2024 0:51:6`

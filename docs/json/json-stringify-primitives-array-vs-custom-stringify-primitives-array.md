...
```typescript
JSON stringify: 17577.548 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13164.203 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/12/2026 1:40:58`

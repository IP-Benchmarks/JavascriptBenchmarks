...
```typescript
JSON stringify: 10065.649 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7363.305 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/9/2022 1:39:43`

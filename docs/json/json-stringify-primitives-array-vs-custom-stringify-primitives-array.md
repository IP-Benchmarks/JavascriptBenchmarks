...
```typescript
JSON stringify: 17099.066 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12784.621 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/6/2025 1:39:28`

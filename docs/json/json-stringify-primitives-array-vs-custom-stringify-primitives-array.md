...
```typescript
JSON stringify: 17258.566 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13617.048 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/18/2025 1:24:55`

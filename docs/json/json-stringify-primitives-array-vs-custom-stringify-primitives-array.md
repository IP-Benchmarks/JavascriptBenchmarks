...
```typescript
JSON stringify: 17668.466 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13850.717 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/29/2025 1:18:16`

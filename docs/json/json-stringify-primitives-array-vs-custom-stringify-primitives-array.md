...
```typescript
JSON stringify: 22955.796 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 16017.396 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/11/2026 2:52:42`

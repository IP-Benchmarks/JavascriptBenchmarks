...
```typescript
JSON stringify: 12430.593 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7879.426 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/20/2023 1:7:41`

...
```typescript
JSON stringify: 17383.212 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14056.925 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/10/2025 1:12:58`

...
```typescript
JSON stringify: 12559.750 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10000.335 ops/s (100 runs over 100 unique samples each)
```

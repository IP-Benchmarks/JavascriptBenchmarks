...
#### **JSON stringify** is **_`1.22x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15669.331 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12793.983 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/20/2023 0:55:31`

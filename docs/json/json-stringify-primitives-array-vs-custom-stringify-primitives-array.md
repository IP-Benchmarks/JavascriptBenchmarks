...
```typescript
JSON stringify: 15933.597 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13118.883 ops/s (100 runs over 100 unique samples each)
```

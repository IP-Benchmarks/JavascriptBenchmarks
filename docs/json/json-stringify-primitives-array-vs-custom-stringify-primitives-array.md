...
```typescript
JSON stringify: 17218.828 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14007.296 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/14/2025 1:9:14`

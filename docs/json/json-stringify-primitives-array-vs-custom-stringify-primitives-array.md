...
```typescript
JSON stringify: 12423.589 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9790.270 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/29/2023 1:6:52`

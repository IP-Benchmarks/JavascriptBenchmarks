...
```typescript
JSON stringify: 11997.033 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8219.938 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/4/2022 1:11:44`

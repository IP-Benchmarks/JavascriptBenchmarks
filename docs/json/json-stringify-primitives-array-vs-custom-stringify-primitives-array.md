...
```typescript
JSON stringify: 10030.039 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6804.755 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/29/2022 1:23:24`

...
```typescript
JSON stringify: 16004.091 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13526.654 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/5/2024 0:57:27`

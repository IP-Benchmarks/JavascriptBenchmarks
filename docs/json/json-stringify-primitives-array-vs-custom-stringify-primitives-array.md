...
```typescript
JSON stringify: 11982.410 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9928.223 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 15498.925 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12585.342 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/26/2024 0:53:14`

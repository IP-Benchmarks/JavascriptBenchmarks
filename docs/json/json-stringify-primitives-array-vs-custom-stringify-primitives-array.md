...
```typescript
JSON stringify: 11080.428 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7625.218 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/15/2023 1:4:30`

...
```typescript
JSON stringify: 12169.002 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8725.521 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/25/2022 1:36:35`

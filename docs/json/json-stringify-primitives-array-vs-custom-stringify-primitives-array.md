...
```typescript
JSON stringify: 17878.667 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13833.970 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/18/2026 1:59:23`

...
```typescript
JSON stringify: 24300.607 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13713.555 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/18/2026 3:7:3`

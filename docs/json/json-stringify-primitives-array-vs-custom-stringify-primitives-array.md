...
```typescript
JSON stringify: 12275.875 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8533.805 ops/s (100 runs over 100 unique samples each)
```

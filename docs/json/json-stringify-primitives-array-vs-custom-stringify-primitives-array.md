...
```typescript
JSON stringify: 24933.656 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13542.936 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/15/2026 3:59:50`

...
```typescript
JSON stringify: 11811.934 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7982.704 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/9/2022 1:25:37`

...
```typescript
JSON stringify: 10177.613 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6692.478 ops/s (100 runs over 100 unique samples each)
```

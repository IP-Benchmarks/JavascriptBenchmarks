...
```typescript
JSON stringify: 12250.937 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8326.363 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/7/2023 1:17:32`

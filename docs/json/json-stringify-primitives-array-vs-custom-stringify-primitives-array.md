...
```typescript
JSON stringify: 9077.791 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6466.688 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/22/2022 0:42:56`

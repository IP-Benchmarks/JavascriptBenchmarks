...
```typescript
JSON stringify: 17915.369 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14134.883 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/28/2025 1:14:15`

...
```typescript
JSON stringify: 24139.702 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13012.084 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/4/2026 2:38:5`

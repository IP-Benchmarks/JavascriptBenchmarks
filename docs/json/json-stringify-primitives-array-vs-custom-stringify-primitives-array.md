...
```typescript
JSON stringify: 12638.765 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8230.601 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/26/2023 1:12:52`

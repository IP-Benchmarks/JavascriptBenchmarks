...
#### **JSON stringify** is **_`1.13x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15419.704 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13686.769 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/17/2024 1:16:37`

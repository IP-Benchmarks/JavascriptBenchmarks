...
```typescript
JSON stringify: 11569.378 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8286.176 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/28/2022 0:52:46`

...
```typescript
JSON stringify: 17933.608 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13962.503 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/14/2025 1:23:21`

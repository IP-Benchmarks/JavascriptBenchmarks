...
```typescript
JSON stringify: 15447.449 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13341.705 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/24/2024 1:9:0`

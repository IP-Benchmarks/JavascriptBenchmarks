...
```typescript
JSON stringify: 15521.194 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13324.461 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/27/2024 1:14:55`

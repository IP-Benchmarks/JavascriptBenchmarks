...
```typescript
JSON stringify: 9541.641 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6208.264 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/9/2023 1:0:30`

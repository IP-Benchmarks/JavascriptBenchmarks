...
```typescript
JSON stringify: 16013.040 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12165.875 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/2/2024 1:8:12`

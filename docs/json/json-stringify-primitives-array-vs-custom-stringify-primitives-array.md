...
```typescript
JSON stringify: 17737.167 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14028.822 ops/s (100 runs over 100 unique samples each)
```

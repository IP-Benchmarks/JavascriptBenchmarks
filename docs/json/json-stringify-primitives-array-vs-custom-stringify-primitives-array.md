...
```typescript
JSON stringify: 15525.143 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13242.994 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/10/2024 1:5:47`

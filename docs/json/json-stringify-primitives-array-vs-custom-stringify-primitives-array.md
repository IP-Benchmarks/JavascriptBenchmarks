...
```typescript
JSON stringify: 17302.591 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12900.031 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/21/2026 3:25:59`

...
```typescript
JSON stringify: 17808.246 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13200.697 ops/s (100 runs over 100 unique samples each)
```

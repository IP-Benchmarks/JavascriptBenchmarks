...
```typescript
JSON stringify: 23808.757 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13698.460 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/3/2026 2:51:50`

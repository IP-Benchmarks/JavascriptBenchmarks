...
```typescript
JSON stringify: 18041.163 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14031.233 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/21/2025 1:38:26`

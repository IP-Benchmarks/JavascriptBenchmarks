...
```typescript
JSON stringify: 9607.064 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6610.273 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/27/2022 1:42:20`

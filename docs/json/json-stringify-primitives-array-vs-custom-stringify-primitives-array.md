...
```typescript
JSON stringify: 15682.472 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12911.082 ops/s (100 runs over 100 unique samples each)
```

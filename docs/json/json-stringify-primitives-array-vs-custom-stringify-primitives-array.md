...
```typescript
JSON stringify: 15955.267 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13629.788 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/28/2024 0:55:14`

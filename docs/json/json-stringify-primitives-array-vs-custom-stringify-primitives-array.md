...
```typescript
JSON stringify: 15533.611 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13343.727 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/21/2024 0:57:56`

...
```typescript
JSON stringify: 11727.248 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9660.758 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 15689.147 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13096.036 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/31/2024 1:10:35`

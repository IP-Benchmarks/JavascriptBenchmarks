...
```typescript
JSON stringify: 9806.541 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6890.625 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/15/2022 1:49:20`

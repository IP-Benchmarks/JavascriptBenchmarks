...
```typescript
JSON stringify: 15880.910 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13519.979 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/12/2024 1:3:43`

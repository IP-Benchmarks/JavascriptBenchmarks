...
```typescript
JSON stringify: 9875.526 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6168.276 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/20/2023 0:51:40`

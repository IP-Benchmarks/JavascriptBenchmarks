...
```typescript
JSON stringify: 15838.068 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13103.566 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 18180.625 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14190.528 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/19/2025 1:22:17`

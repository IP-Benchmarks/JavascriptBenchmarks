...
```typescript
JSON stringify: 17792.697 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14090.317 ops/s (100 runs over 100 unique samples each)
```

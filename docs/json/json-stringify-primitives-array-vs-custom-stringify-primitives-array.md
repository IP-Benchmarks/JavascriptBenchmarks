...
#### **JSON stringify** is **_`1.69x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 23985.409 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14159.413 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/23/2026 2:28:54`

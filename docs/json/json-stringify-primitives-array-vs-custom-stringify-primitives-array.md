...
```typescript
JSON stringify: 24719.093 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13286.749 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/21/2026 2:25:4`

...
```typescript
JSON stringify: 17387.421 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13594.811 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/17/2025 1:12:36`

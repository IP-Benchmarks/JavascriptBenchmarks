...
```typescript
JSON stringify: 9508.897 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6366.876 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/10/2022 1:46:12`

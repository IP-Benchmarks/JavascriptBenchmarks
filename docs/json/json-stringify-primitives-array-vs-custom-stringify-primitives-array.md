...
```typescript
JSON stringify: 9333.618 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6497.751 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/10/2022 1:28:2`

...
```typescript
JSON stringify: 17856.382 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12201.682 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/19/2026 1:58:23`

...
```typescript
JSON stringify: 17249.293 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14294.700 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 11526.046 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8458.327 ops/s (100 runs over 100 unique samples each)
```

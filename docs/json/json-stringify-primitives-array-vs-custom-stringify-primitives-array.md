...
```typescript
JSON stringify: 24369.010 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14477.973 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/27/2026 2:38:57`

...
```typescript
JSON stringify: 17478.961 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13773.818 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/15/2026 1:25:27`

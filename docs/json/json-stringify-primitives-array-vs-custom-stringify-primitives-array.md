...
```typescript
JSON stringify: 12495.882 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8264.039 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/25/2023 1:5:42`

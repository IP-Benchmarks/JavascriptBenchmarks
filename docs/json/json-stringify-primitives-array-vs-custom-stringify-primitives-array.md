...
```typescript
JSON stringify: 12026.277 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8131.653 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/31/2023 1:7:26`

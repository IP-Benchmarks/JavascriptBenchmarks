...
```typescript
JSON stringify: 9251.699 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6520.383 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/22/2022 1:8:40`

...
```typescript
JSON stringify: 17347.983 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13800.310 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/14/2025 1:14:29`

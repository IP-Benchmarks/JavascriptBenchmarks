...
```typescript
JSON stringify: 17025.698 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13873.296 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/23/2025 1:12:57`

...
```typescript
JSON stringify: 15769.112 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12704.499 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/10/2024 0:55:34`

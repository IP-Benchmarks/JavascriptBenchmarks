...
```typescript
JSON stringify: 17711.458 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13686.569 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/13/2026 1:23:49`

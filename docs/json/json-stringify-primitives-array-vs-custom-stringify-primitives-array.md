...
```typescript
JSON stringify: 17816.930 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12977.764 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/16/2026 2:41:19`

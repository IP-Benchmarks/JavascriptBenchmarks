...
```typescript
JSON stringify: 17322.431 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13672.522 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/4/2025 1:7:55`

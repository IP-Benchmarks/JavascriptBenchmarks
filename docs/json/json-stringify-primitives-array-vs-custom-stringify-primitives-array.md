...
```typescript
JSON stringify: 17243.141 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13242.933 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/20/2025 1:21:9`

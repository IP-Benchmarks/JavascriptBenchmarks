...
```typescript
JSON stringify: 16223.681 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13856.881 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/24/2024 0:57:5`

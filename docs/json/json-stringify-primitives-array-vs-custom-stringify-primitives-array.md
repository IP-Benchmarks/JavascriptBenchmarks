...
```typescript
JSON stringify: 17448.224 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13733.625 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/11/2025 1:22:30`

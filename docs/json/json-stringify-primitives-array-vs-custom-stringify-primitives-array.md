...
```typescript
JSON stringify: 17179.954 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13192.564 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/21/2025 1:20:48`

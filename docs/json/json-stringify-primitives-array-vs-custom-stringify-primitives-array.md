...
```typescript
JSON stringify: 15319.762 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13235.709 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/1/2024 0:57:50`

...
```typescript
JSON stringify: 10101.659 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6656.705 ops/s (100 runs over 100 unique samples each)
```

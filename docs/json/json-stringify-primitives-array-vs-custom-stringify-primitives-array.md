...
```typescript
JSON stringify: 11117.290 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8007.288 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/30/2022 1:8:31`

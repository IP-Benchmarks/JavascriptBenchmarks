...
```typescript
JSON stringify: 17975.795 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13935.394 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/9/2025 1:15:0`

...
```typescript
JSON stringify: 15471.777 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13195.830 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/22/2024 1:2:42`

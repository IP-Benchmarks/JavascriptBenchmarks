...
```typescript
JSON stringify: 12118.467 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7472.480 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/20/2023 0:52:6`

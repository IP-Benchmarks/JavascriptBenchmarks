...
```typescript
JSON stringify: 12221.652 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8168.008 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/20/2023 1:6:10`

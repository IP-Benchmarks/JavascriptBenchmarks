...
```typescript
JSON stringify: 8918.677 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6274.563 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/1/2022 0:47:15`

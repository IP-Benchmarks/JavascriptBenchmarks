...
```typescript
JSON stringify: 11582.352 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8082.564 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/14/2022 1:53:59`

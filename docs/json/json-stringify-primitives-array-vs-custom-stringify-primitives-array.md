...
```typescript
JSON stringify: 10053.507 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6518.089 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/13/2023 0:52:4`

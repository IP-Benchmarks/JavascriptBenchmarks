...
```typescript
JSON stringify: 12318.130 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9565.259 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/12/2023 0:49:30`

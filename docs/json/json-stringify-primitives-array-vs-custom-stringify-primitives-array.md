...
```typescript
JSON stringify: 35380.149 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 18375.666 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/17/2026 1:4:19`

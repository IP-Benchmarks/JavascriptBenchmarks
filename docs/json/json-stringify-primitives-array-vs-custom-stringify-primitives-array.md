...
```typescript
JSON stringify: 17651.234 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13856.666 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/23/2026 1:27:24`

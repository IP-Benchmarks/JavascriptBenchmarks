...
```typescript
JSON stringify: 12606.637 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9684.135 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/9/2023 1:20:16`

...
```typescript
JSON stringify: 9490.094 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 5989.517 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/26/2022 1:4:39`

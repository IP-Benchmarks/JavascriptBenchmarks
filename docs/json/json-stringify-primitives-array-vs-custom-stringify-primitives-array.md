...
```typescript
JSON stringify: 11983.108 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7913.142 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/4/2023 1:15:50`

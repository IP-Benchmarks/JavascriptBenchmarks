...
```typescript
JSON stringify: 11620.014 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8031.324 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/15/2022 0:57:8`

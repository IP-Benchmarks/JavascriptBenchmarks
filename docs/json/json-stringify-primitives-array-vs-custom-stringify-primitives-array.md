...
```typescript
JSON stringify: 11974.554 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8155.296 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/18/2023 1:6:5`

...
```typescript
JSON stringify: 17465.383 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14084.441 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/20/2025 1:21:28`

...
```typescript
JSON stringify: 17232.080 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13392.246 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/17/2025 1:18:17`

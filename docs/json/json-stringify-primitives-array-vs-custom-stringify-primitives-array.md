...
```typescript
JSON stringify: 24827.576 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13542.087 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/9/2026 2:42:12`

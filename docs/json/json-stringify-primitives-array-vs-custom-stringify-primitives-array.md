...
```typescript
JSON stringify: 10227.493 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6309.054 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/9/2023 1:1:3`

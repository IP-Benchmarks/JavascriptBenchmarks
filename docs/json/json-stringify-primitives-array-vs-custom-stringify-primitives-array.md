...
```typescript
JSON stringify: 13377.778 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9021.763 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/3/2022 1:25:8`

...
```typescript
JSON stringify: 17899.536 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14007.438 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/5/2026 1:43:50`

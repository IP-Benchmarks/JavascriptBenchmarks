...
```typescript
JSON stringify: 12232.957 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8202.526 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/23/2023 1:9:42`

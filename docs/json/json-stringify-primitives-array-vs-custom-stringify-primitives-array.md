...
```typescript
JSON stringify: 17796.188 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13012.759 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/24/2025 1:25:55`

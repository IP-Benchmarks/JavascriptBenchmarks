...
```typescript
JSON stringify: 10816.140 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7230.906 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/18/2022 1:1:14`

...
```typescript
JSON stringify: 17967.792 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14139.172 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/6/2026 1:26:14`

...
```typescript
JSON stringify: 15580.804 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13175.219 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/8/2024 1:1:40`

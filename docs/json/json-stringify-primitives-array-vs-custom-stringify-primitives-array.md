...
```typescript
JSON stringify: 11746.032 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9458.082 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/28/2022 1:19:10`

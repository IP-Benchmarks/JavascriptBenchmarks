...
```typescript
JSON stringify: 12613.198 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11145.984 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/1/2022 1:27:43`

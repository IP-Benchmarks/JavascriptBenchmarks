...
```typescript
JSON stringify: 15343.091 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13433.909 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/2/2024 0:55:16`

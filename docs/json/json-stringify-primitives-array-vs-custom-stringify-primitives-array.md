...
```typescript
JSON stringify: 17927.759 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14027.112 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/8/2025 0:57:56`

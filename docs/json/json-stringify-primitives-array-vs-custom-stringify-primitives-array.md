...
```typescript
JSON stringify: 15815.821 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13189.980 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/6/2024 1:4:47`

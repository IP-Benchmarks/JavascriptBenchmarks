...
```typescript
JSON stringify: 11449.305 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7714.088 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/19/2022 1:21:27`

...
```typescript
JSON stringify: 10199.723 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7019.091 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/24/2022 1:2:20`

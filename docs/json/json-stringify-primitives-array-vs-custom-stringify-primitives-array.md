...
```typescript
JSON stringify: 15606.619 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12561.105 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/14/2024 1:12:35`

...
```typescript
JSON stringify: 16027.487 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13109.124 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/24/2023 0:53:20`

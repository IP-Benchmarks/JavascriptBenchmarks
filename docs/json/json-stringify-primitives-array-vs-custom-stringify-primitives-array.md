...
```typescript
JSON stringify: 17532.543 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13943.438 ops/s (100 runs over 100 unique samples each)
```

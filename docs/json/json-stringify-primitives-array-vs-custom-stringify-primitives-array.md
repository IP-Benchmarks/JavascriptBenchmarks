...
```typescript
JSON stringify: 12714.750 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8854.383 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/7/2022 1:17:1`

...
```typescript
JSON stringify: 16060.935 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13747.864 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/6/2024 0:52:7`

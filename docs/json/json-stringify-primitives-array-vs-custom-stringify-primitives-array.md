...
```typescript
JSON stringify: 17599.300 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13848.571 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/26/2025 1:14:41`

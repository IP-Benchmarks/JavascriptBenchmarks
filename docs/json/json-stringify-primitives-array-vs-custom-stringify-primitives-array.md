...
```typescript
JSON stringify: 10605.822 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6898.755 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/19/2023 1:7:16`

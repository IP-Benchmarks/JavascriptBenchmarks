...
```typescript
JSON stringify: 15158.229 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12608.709 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/5/2024 1:15:55`

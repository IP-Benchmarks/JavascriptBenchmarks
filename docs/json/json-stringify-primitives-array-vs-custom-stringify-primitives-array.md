...
```typescript
JSON stringify: 11286.400 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6768.805 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/7/2023 0:54:32`

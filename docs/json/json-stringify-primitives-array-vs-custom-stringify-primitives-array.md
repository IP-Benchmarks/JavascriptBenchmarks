...
```typescript
JSON stringify: 15620.737 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12892.558 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/16/2024 0:56:26`

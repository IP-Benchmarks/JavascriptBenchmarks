...
```typescript
JSON stringify: 15779.467 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12806.381 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/29/2024 0:55:18`

...
```typescript
JSON stringify: 14802.355 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12721.111 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/27/2024 0:53:28`

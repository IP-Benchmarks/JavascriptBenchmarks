...
```typescript
JSON stringify: 15601.615 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13409.435 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/23/2024 1:0:54`

...
```typescript
JSON stringify: 17775.376 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13864.592 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/4/2025 1:22:26`

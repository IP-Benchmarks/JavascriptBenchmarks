...
#### **JSON stringify** is **_`2.07x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 22559.480 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10915.481 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/23/2026 1:7:42`

...
```typescript
JSON stringify: 15992.284 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13044.987 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/26/2024 1:0:11`

...
```typescript
JSON stringify: 18637.807 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14165.739 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/15/2025 1:24:1`

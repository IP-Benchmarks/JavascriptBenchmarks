...
```typescript
JSON stringify: 17269.034 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13755.233 ops/s (100 runs over 100 unique samples each)
```

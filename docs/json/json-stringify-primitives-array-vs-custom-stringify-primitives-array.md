...
```typescript
JSON stringify: 11522.780 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9468.257 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/15/2023 1:6:35`

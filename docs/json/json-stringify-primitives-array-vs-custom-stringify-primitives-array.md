...
```typescript
JSON stringify: 17717.689 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13873.424 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/13/2025 1:19:37`

...
```typescript
JSON stringify: 15533.030 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13069.477 ops/s (100 runs over 100 unique samples each)
```

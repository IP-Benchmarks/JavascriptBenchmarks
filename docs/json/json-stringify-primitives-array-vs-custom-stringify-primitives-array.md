...
```typescript
JSON stringify: 12235.111 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8299.633 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/9/2023 0:49:20`

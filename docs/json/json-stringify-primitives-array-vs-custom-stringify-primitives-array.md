...
```typescript
JSON stringify: 15784.868 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12995.734 ops/s (100 runs over 100 unique samples each)
```

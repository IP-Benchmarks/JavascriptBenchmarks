...
```typescript
JSON stringify: 9290.139 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6364.134 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/21/2022 1:17:58`

...
```typescript
JSON stringify: 9838.911 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6647.628 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/12/2022 1:1:0`

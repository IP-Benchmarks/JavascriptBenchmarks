...
```typescript
JSON stringify: 10138.862 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7420.034 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/1/2022 1:19:6`

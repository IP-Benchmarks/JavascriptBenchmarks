...
```typescript
JSON stringify: 17899.035 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14055.327 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/20/2025 1:12:47`

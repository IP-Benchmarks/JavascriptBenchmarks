...
```typescript
JSON stringify: 11273.745 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7994.127 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/15/2022 1:5:27`

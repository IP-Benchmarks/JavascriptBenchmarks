...
```typescript
JSON stringify: 12038.619 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8260.410 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/28/2022 1:39:8`

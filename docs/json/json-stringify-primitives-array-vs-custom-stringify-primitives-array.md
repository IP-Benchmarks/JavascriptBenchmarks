...
```typescript
JSON stringify: 11147.010 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7469.090 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/26/2022 1:24:51`

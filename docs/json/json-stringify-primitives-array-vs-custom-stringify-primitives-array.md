...
```typescript
JSON stringify: 24300.450 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13954.692 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/6/2026 2:55:26`

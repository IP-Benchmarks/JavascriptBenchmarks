...
```typescript
JSON stringify: 11818.599 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7826.236 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/28/2021 0:45:47`

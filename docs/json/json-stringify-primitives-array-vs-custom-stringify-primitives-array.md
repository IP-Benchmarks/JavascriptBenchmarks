...
```typescript
JSON stringify: 25645.524 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14049.569 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/15/2026 3:19:4`

...
```typescript
JSON stringify: 12248.024 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8124.123 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/13/2023 0:57:24`

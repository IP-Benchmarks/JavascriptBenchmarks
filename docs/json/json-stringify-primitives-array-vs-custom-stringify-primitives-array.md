...
```typescript
JSON stringify: 17934.019 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13988.416 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/23/2025 1:15:21`

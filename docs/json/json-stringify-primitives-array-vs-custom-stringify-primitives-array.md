...
```typescript
JSON stringify: 17696.253 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14137.556 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/14/2025 1:6:19`

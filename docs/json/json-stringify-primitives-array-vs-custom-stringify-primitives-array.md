...
```typescript
JSON stringify: 11648.250 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8283.869 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/21/2022 1:1:58`

...
```typescript
JSON stringify: 10048.719 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6890.606 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/10/2022 0:57:9`

...
```typescript
JSON stringify: 15683.597 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12384.752 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/8/2025 1:17:51`

...
```typescript
JSON stringify: 12728.174 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9517.327 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/19/2023 0:52:18`

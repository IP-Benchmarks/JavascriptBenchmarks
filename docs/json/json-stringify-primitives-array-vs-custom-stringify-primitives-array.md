...
```typescript
JSON stringify: 15153.486 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12927.601 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/21/2024 0:56:12`

...
```typescript
JSON stringify: 12309.723 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9995.941 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/24/2023 1:1:40`

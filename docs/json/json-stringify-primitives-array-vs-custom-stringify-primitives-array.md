...
```typescript
JSON stringify: 18473.347 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13480.646 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/3/2025 1:12:49`

...
```typescript
JSON stringify: 11396.923 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8026.946 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/14/2022 1:27:31`

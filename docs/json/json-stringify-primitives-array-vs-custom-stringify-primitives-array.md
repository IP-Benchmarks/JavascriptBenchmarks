...
```typescript
JSON stringify: 18013.833 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13919.016 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/3/2025 1:45:28`

...
```typescript
JSON stringify: 18276.744 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14100.352 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/27/2025 1:23:1`

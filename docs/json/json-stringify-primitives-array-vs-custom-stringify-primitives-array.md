...
```typescript
JSON stringify: 17494.903 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13993.672 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/16/2025 1:20:6`

...
```typescript
JSON stringify: 15781.755 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13079.337 ops/s (100 runs over 100 unique samples each)
```

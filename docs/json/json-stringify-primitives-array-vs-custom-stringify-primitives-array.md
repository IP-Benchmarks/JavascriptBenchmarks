...
```typescript
JSON stringify: 9536.463 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6483.579 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/14/2022 1:10:26`

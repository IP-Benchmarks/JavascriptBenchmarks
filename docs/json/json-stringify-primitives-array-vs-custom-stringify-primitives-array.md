...
```typescript
JSON stringify: 15182.886 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13214.883 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/5/2023 0:55:51`

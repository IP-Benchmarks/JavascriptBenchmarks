...
```typescript
JSON stringify: 16898.629 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13830.763 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/17/2025 1:16:17`

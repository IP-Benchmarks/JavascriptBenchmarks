...
```typescript
JSON stringify: 15870.768 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13329.778 ops/s (100 runs over 100 unique samples each)
```

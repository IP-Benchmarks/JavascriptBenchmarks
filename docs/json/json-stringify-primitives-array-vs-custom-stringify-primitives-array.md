...
```typescript
JSON stringify: 16019.281 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13203.780 ops/s (100 runs over 100 unique samples each)
```

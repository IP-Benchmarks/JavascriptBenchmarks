...
#### **JSON stringify** is **_`1.68x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 23706.374 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14143.773 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/31/2026 3:30:50`

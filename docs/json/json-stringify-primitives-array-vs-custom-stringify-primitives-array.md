...
```typescript
JSON stringify: 16284.405 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13508.149 ops/s (100 runs over 100 unique samples each)
```

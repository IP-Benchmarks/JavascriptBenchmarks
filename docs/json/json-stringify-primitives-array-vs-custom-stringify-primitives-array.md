...
```typescript
JSON stringify: 14973.214 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13350.979 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/14/2024 1:8:46`

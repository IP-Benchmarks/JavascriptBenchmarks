...
```typescript
JSON stringify: 13427.913 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9264.787 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/3/2022 0:45:50`

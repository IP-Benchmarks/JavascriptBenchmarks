...
```typescript
JSON stringify: 11301.656 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8015.513 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/11/2022 1:9:47`

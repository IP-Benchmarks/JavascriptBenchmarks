...
```typescript
JSON stringify: 17885.971 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14016.802 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/29/2025 1:41:25`

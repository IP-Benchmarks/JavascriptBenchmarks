...
```typescript
JSON stringify: 9693.893 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6702.577 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/30/2022 2:4:27`

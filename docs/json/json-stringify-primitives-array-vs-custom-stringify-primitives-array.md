...
```typescript
JSON stringify: 11912.563 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8306.141 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/25/2021 0:44:7`

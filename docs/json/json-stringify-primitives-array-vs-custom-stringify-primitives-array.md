...
```typescript
JSON stringify: 17810.837 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13809.949 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/20/2026 2:56:27`

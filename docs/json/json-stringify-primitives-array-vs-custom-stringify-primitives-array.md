...
```typescript
JSON stringify: 17724.536 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13847.460 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/28/2025 1:7:44`

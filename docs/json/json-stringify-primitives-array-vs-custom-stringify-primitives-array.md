...
```typescript
JSON stringify: 10288.942 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6951.162 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/28/2023 1:0:46`

...
```typescript
JSON stringify: 24321.887 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14050.839 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/5/2026 2:48:55`

...
```typescript
JSON stringify: 17851.473 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13421.271 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/17/2026 1:23:45`

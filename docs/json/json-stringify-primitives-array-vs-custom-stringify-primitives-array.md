...
```typescript
JSON stringify: 12385.558 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8211.569 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/12/2023 0:59:17`

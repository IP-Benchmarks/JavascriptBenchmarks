...
```typescript
JSON stringify: 10715.245 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6884.163 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/1/2023 1:7:25`

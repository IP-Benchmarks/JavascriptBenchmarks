...
```typescript
JSON stringify: 15598.042 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12944.946 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/11/2024 0:54:36`

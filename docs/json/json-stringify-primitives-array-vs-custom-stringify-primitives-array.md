...
```typescript
JSON stringify: 15937.280 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13461.416 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/7/2024 0:42:13`

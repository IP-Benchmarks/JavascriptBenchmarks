...
```typescript
JSON stringify: 17588.276 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13615.629 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/31/2026 1:47:29`

...
```typescript
JSON stringify: 11680.835 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9743.997 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/22/2022 1:19:9`

...
```typescript
JSON stringify: 11544.462 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8376.637 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/23/2021 0:45:54`

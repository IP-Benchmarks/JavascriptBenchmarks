...
```typescript
JSON stringify: 9892.289 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7429.037 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/29/2022 0:41:28`

...
```typescript
JSON stringify: 12229.298 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7702.418 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/6/2023 0:54:0`

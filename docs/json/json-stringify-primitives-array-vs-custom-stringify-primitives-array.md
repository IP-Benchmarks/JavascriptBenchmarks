...
```typescript
JSON stringify: 17192.200 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12757.074 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/9/2025 1:3:12`

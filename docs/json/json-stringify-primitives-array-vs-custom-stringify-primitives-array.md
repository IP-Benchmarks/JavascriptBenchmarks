...
```typescript
JSON stringify: 11366.854 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7461.249 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 10152.232 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6597.051 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/6/2023 0:55:49`

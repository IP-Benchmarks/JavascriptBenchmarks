...
```typescript
JSON stringify: 25094.464 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13341.802 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/6/2026 2:52:32`

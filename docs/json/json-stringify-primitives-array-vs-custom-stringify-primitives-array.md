...
```typescript
JSON stringify: 17503.512 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13669.390 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/18/2025 1:11:59`

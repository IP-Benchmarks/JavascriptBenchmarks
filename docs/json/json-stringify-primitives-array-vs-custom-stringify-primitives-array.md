...
```typescript
JSON stringify: 10507.821 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7352.316 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/3/2022 1:3:22`

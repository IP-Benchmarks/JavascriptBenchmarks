...
```typescript
JSON stringify: 12208.257 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8287.858 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/16/2023 1:1:30`

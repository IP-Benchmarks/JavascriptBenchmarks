...
```typescript
JSON stringify: 11640.300 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8342.822 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/22/2022 1:28:1`

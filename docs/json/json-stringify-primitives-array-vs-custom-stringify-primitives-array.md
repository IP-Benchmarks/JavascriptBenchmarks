...
```typescript
JSON stringify: 10259.904 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6564.645 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/10/2023 0:53:3`

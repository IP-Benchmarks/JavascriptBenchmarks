...
#### **JSON stringify** is **_`1.40x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 12097.834 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8627.222 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/19/2022 1:15:23`

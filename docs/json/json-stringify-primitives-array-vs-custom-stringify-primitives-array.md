...
```typescript
JSON stringify: 11246.080 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7748.151 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/2/2022 1:39:43`

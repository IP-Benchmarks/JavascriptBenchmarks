...
```typescript
JSON stringify: 12276.816 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8045.779 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/26/2023 0:52:10`

...
```typescript
JSON stringify: 11906.585 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8011.125 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/1/2022 1:28:28`

...
```typescript
JSON stringify: 15405.912 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13457.250 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/14/2024 0:52:47`

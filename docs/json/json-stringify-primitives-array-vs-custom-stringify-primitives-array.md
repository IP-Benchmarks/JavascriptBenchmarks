...
```typescript
JSON stringify: 16574.255 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13516.896 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/27/2025 1:11:6`

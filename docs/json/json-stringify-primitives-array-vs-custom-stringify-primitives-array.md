...
```typescript
JSON stringify: 9819.266 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 5793.702 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/12/2023 0:58:40`

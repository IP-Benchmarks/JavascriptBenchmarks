...
```typescript
JSON stringify: 15352.012 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13021.497 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/4/2024 1:11:14`

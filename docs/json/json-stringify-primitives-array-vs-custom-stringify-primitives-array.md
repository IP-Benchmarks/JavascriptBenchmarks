...
```typescript
JSON stringify: 16070.062 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13597.736 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/1/2024 0:59:54`

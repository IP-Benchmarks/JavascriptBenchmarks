...
```typescript
JSON stringify: 10455.322 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6712.628 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/29/2023 0:52:4`

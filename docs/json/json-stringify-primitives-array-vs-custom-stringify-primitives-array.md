...
```typescript
JSON stringify: 15217.270 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13125.262 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/6/2024 0:51:53`

...
```typescript
JSON stringify: 10745.550 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6918.255 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/27/2023 1:15:51`

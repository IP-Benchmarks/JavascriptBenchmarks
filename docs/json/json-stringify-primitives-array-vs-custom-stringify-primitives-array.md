...
```typescript
JSON stringify: 16887.438 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13626.623 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/25/2025 1:4:10`

...
```typescript
JSON stringify: 17710.880 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14051.509 ops/s (100 runs over 100 unique samples each)
```

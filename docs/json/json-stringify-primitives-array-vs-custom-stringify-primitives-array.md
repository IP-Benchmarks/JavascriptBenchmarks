...
```typescript
JSON stringify: 30679.205 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 17532.870 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/6/2026 2:50:59`

...
```typescript
JSON stringify: 17872.499 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12635.298 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/9/2026 2:2:4`

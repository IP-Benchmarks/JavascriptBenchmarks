...
```typescript
JSON stringify: 17212.982 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14169.449 ops/s (100 runs over 100 unique samples each)
```

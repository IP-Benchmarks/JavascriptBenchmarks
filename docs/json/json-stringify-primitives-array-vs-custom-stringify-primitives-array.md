...
```typescript
JSON stringify: 24153.969 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13157.816 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/9/2026 1:24:53`

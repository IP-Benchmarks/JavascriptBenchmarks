...
```typescript
JSON stringify: 11595.238 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7917.380 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/17/2022 0:55:43`

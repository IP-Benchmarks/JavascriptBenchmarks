...
```typescript
JSON stringify: 18003.091 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14117.682 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/22/2025 1:17:52`

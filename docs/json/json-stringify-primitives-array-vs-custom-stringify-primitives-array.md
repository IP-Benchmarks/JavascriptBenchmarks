...
```typescript
JSON stringify: 17341.796 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12797.540 ops/s (100 runs over 100 unique samples each)
```

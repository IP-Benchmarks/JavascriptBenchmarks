...
```typescript
JSON stringify: 15881.727 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13441.526 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/4/2023 0:55:39`

...
```typescript
JSON stringify: 17627.713 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12900.314 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/22/2026 3:25:38`

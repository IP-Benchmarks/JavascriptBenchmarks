...
```typescript
JSON stringify: 10246.572 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6830.851 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/10/2023 1:9:12`

...
```typescript
JSON stringify: 15394.247 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12746.439 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/1/2024 1:0:29`

...
```typescript
JSON stringify: 24421.916 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12914.355 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/18/2026 1:2:20`

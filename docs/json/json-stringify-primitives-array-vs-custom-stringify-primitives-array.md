...
```typescript
JSON stringify: 17754.811 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13871.797 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/29/2025 1:17:33`

...
#### **JSON stringify** is **_`1.43x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 17074.660 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11937.829 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/27/2025 1:18:52`

...
```typescript
JSON stringify: 11273.162 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8297.492 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/9/2022 1:8:25`

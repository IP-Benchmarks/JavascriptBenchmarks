...
```typescript
JSON stringify: 17030.514 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13502.303 ops/s (100 runs over 100 unique samples each)
```

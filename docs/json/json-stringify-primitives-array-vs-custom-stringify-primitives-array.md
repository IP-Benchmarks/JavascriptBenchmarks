...
```typescript
JSON stringify: 11434.912 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7598.179 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/13/2022 1:20:37`

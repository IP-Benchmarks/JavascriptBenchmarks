...
```typescript
JSON stringify: 22478.399 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 15559.040 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/4/2026 1:58:6`

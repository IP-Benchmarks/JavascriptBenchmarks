...
```typescript
JSON stringify: 10409.303 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7193.600 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/15/2022 1:22:38`

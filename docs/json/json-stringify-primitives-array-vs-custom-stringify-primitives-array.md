...
```typescript
JSON stringify: 9580.973 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6592.369 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/25/2022 0:54:37`

...
```typescript
JSON stringify: 17875.930 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13169.108 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/28/2025 1:42:41`

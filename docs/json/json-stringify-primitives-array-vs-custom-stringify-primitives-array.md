...
```typescript
JSON stringify: 9521.853 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6812.220 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/8/2022 1:22:57`

...
```typescript
JSON stringify: 15559.626 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13359.906 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/16/2024 1:3:0`

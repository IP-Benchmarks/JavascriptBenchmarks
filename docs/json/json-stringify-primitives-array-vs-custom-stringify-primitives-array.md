...
```typescript
JSON stringify: 12364.821 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9649.685 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/10/2023 0:53:56`

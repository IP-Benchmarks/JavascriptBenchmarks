...
```typescript
JSON stringify: 18063.890 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13981.008 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/5/2025 1:19:42`

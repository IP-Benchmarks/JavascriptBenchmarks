...
```typescript
JSON stringify: 15750.271 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13101.497 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/29/2024 0:52:55`

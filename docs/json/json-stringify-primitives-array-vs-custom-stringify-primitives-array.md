...
```typescript
JSON stringify: 17494.026 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14007.691 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/15/2025 1:18:47`

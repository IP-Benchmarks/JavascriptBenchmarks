...
```typescript
JSON stringify: 14873.701 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12240.989 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/22/2024 1:10:0`

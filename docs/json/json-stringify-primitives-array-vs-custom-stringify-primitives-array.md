...
```typescript
JSON stringify: 24330.550 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13550.284 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/26/2026 2:53:29`

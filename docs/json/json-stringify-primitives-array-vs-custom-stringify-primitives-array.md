...
```typescript
JSON stringify: 15279.909 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12892.803 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 9309.325 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6199.854 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/3/2022 1:21:25`

...
```typescript
JSON stringify: 15702.467 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13598.875 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/31/2024 0:50:55`

...
```typescript
JSON stringify: 17728.406 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13889.018 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/19/2025 1:24:21`

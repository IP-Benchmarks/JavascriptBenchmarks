...
```typescript
JSON stringify: 10184.370 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6876.312 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/17/2023 1:9:30`

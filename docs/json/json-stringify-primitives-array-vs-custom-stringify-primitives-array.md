...
```typescript
JSON stringify: 31556.760 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 16757.940 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/14/2026 2:10:41`

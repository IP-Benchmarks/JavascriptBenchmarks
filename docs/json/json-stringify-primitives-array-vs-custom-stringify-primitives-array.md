...
```typescript
JSON stringify: 11496.191 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7663.685 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/24/2022 1:42:53`

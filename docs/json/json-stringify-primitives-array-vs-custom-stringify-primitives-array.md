...
```typescript
JSON stringify: 24388.210 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14206.177 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/8/2026 1:19:22`

...
```typescript
JSON stringify: 17611.941 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13457.025 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/6/2025 1:38:0`

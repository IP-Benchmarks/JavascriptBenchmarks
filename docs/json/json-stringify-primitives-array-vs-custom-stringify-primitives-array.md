...
```typescript
JSON stringify: 15576.958 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12960.312 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/30/2024 1:3:58`

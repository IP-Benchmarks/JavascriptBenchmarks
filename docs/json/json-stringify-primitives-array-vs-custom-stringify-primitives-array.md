...
```typescript
JSON stringify: 15409.714 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11536.590 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/29/2024 1:10:59`

...
```typescript
JSON stringify: 16321.747 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13771.533 ops/s (100 runs over 100 unique samples each)
```

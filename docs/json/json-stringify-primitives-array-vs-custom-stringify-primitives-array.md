...
```typescript
JSON stringify: 15603.683 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13549.006 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/24/2024 1:0:46`

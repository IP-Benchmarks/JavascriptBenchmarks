...
```typescript
JSON stringify: 11649.288 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8284.922 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/20/2022 1:41:23`

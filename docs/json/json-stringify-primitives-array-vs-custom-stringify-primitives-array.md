...
```typescript
JSON stringify: 10058.868 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6904.030 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/3/2022 1:24:11`

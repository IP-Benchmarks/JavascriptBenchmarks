...
```typescript
JSON stringify: 10425.362 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7434.310 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/13/2022 1:7:7`

...
```typescript
JSON stringify: 17771.292 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13864.091 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/25/2024 1:8:52`

...
```typescript
JSON stringify: 10948.773 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8087.934 ops/s (100 runs over 100 unique samples each)
```

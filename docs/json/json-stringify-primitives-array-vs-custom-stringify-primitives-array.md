...
```typescript
JSON stringify: 11626.400 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8133.914 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/7/2022 1:43:57`

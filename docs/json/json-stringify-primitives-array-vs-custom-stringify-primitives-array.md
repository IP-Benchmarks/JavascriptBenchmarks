...
#### **JSON stringify** is **_`1.87x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 24854.586 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13303.246 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/16/2026 2:22:4`

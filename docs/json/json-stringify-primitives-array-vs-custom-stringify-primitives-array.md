...
```typescript
JSON stringify: 16000.981 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13532.448 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/6/2024 0:54:25`

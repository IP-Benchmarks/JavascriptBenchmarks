...
```typescript
JSON stringify: 17795.425 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13621.151 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/30/2026 2:11:50`

...
```typescript
JSON stringify: 15704.781 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13508.179 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/18/2024 0:59:35`

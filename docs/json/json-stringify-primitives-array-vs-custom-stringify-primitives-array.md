...
```typescript
JSON stringify: 11339.640 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8151.744 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/19/2022 1:15:49`

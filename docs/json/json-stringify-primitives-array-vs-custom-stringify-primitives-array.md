...
```typescript
JSON stringify: 24710.755 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14387.523 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/4/2026 3:43:40`

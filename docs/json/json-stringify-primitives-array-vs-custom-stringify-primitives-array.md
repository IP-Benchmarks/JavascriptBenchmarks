...
```typescript
JSON stringify: 17649.366 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13906.254 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/18/2025 1:19:32`

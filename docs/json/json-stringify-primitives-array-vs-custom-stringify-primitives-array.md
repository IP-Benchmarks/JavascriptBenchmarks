...
```typescript
JSON stringify: 17315.361 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14143.885 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/11/2025 1:23:50`

...
```typescript
JSON stringify: 12638.467 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9828.297 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/25/2023 1:0:7`

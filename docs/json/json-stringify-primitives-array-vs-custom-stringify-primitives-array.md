...
```typescript
JSON stringify: 15711.080 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13464.261 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/10/2024 0:59:55`

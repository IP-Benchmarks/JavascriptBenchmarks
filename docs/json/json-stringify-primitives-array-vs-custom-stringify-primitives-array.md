...
```typescript
JSON stringify: 15778.757 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12816.326 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/12/2024 0:51:30`

...
```typescript
JSON stringify: 18523.307 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13215.266 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/15/2026 2:12:28`

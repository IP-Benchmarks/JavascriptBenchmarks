...
```typescript
JSON stringify: 9805.522 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6661.331 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/19/2022 1:26:50`

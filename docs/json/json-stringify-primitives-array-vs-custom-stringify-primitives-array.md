...
```typescript
JSON stringify: 10739.547 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7820.274 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/15/2021 0:44:10`

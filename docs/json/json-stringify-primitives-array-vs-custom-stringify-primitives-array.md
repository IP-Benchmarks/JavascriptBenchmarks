...
```typescript
JSON stringify: 16074.601 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13448.472 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/11/2023 0:56:3`

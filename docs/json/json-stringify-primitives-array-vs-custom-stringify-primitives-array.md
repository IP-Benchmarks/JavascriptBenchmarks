...
```typescript
JSON stringify: 15624.672 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12661.165 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/17/2024 0:53:52`

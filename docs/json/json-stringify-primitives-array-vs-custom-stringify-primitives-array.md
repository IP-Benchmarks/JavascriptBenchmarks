...
```typescript
JSON stringify: 23538.556 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13753.887 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17907.363 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14012.687 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/18/2025 1:28:14`

...
```typescript
JSON stringify: 17950.677 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13803.214 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/27/2026 2:7:5`

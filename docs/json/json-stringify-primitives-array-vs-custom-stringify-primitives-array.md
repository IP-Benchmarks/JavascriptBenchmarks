...
```typescript
JSON stringify: 11737.938 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9717.756 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17891.816 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13846.907 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/4/2026 1:51:38`

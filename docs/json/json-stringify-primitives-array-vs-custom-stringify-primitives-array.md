...
```typescript
JSON stringify: 10686.690 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6454.321 ops/s (100 runs over 100 unique samples each)
```

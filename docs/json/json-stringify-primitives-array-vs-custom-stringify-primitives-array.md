...
```typescript
JSON stringify: 9715.658 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6743.713 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/6/2022 1:24:38`

...
```typescript
JSON stringify: 11455.917 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7859.427 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/31/2022 1:44:0`

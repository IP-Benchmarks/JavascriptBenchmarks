...
```typescript
JSON stringify: 15835.866 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13016.566 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/14/2024 1:2:21`

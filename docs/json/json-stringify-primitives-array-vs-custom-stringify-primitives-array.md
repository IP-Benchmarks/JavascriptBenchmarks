...
```typescript
JSON stringify: 17870.017 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13737.120 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/28/2025 1:21:21`

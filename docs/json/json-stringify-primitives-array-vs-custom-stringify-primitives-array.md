...
```typescript
JSON stringify: 17889.831 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14161.922 ops/s (100 runs over 100 unique samples each)
```

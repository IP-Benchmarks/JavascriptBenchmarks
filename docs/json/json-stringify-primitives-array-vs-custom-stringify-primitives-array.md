...
```typescript
JSON stringify: 17606.539 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12483.629 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/17/2026 2:24:14`

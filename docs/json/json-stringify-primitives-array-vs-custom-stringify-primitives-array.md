...
```typescript
JSON stringify: 15693.973 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13339.235 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/13/2024 1:8:48`

...
```typescript
JSON stringify: 15415.252 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12573.534 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/7/2024 0:55:1`

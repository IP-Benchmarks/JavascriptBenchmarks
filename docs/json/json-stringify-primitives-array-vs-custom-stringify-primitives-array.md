...
```typescript
JSON stringify: 15773.891 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13422.550 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/12/2024 0:56:22`

...
```typescript
JSON stringify: 15628.806 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12680.223 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/28/2024 0:56:48`

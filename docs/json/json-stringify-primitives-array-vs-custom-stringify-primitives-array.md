...
```typescript
JSON stringify: 17948.861 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14161.682 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/15/2026 2:55:7`

...
```typescript
JSON stringify: 10688.631 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7504.543 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/30/2022 1:17:56`

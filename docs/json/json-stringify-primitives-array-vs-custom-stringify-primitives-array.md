...
```typescript
JSON stringify: 16149.420 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13387.453 ops/s (100 runs over 100 unique samples each)
```

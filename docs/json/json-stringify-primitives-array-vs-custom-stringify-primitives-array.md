...
```typescript
JSON stringify: 16006.178 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12517.496 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/12/2024 0:52:42`

...
```typescript
JSON stringify: 24649.899 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13331.651 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/19/2026 2:27:0`

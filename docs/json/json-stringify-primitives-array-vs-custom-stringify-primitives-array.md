...
```typescript
JSON stringify: 17724.005 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14110.929 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/22/2024 1:14:59`

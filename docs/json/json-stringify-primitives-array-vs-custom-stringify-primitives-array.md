...
```typescript
JSON stringify: 15791.736 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13782.390 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/16/2024 1:1:36`

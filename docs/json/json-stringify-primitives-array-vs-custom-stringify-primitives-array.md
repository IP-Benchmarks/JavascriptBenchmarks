...
```typescript
JSON stringify: 17487.912 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13938.818 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/25/2025 1:19:50`

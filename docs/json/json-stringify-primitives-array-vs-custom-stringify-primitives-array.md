...
```typescript
JSON stringify: 17498.186 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13722.037 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/1/2025 1:44:18`

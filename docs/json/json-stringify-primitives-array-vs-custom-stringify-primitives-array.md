...
```typescript
JSON stringify: 18891.969 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14584.865 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/7/2026 1:26:32`

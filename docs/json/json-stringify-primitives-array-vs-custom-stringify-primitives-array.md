...
```typescript
JSON stringify: 18139.769 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14181.620 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/17/2025 1:27:27`

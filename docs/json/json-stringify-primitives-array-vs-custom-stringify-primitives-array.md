...
```typescript
JSON stringify: 12380.270 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9608.546 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/7/2023 1:11:37`

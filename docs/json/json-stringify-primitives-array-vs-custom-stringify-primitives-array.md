...
```typescript
JSON stringify: 17461.755 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13670.555 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/13/2026 1:53:27`

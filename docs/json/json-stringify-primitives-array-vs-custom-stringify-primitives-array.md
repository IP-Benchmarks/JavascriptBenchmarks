...
```typescript
JSON stringify: 22913.880 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 16260.612 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/12/2026 2:44:35`

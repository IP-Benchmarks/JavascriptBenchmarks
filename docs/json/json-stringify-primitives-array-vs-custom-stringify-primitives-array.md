...
```typescript
JSON stringify: 10144.034 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7514.966 ops/s (100 runs over 100 unique samples each)
```

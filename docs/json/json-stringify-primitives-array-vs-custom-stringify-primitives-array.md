...
```typescript
JSON stringify: 15716.246 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13195.253 ops/s (100 runs over 100 unique samples each)
```

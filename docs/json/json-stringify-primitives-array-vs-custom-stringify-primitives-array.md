...
```typescript
JSON stringify: 24093.145 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13114.137 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/1/2026 3:33:52`

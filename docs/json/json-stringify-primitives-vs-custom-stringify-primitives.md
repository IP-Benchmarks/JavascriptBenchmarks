...
```typescript
Custom stringify for primitives: 8192384.715 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6041425.816 ops/s (100 runs over 1000 unique samples each)
```

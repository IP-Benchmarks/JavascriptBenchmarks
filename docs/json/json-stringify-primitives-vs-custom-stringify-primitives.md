...
```typescript
Custom stringify for primitives: 10049899.762 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7266346.628 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/16/2026 1:27:48`

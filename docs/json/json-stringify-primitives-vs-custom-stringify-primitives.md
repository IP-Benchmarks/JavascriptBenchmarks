...
```typescript
Custom stringify for primitives: 5604822.883 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4025622.443 ops/s (100 runs over 1000 unique samples each)
```

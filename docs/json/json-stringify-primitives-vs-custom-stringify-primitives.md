...
```typescript
Custom stringify for primitives: 5362868.869 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4365977.925 ops/s (100 runs over 1000 unique samples each)
```

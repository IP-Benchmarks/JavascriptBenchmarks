...
```typescript
Custom stringify for primitives: 5869180.430 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4531564.886 ops/s (100 runs over 1000 unique samples each)
```

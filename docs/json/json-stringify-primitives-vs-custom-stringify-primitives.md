...
```typescript
Custom stringify for primitives: 8398386.536 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5484199.417 ops/s (100 runs over 1000 unique samples each)
```

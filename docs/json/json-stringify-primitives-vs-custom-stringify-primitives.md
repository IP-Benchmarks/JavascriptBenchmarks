...
```typescript
Custom stringify for primitives: 5729571.227 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3703040.311 ops/s (100 runs over 1000 unique samples each)
```

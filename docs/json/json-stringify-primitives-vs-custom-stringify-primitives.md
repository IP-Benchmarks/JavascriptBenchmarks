...
```typescript
Custom stringify for primitives: 11067316.510 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5547578.446 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9658404.449 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6596288.664 ops/s (100 runs over 1000 unique samples each)
```

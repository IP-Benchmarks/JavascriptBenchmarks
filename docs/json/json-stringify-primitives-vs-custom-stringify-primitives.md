...
```typescript
Custom stringify for primitives: 4153961.085 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3444707.976 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9084426.115 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6239962.240 ops/s (100 runs over 1000 unique samples each)
```

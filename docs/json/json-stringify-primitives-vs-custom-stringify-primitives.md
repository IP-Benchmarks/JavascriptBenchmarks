...
```typescript
Custom stringify for primitives: 9556011.462 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7044670.041 ops/s (100 runs over 1000 unique samples each)
```

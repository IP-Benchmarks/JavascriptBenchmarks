...
```typescript
Custom stringify for primitives: 5416051.899 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4391989.836 ops/s (100 runs over 1000 unique samples each)
```

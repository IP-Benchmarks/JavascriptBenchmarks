...
```typescript
Custom stringify for primitives: 5435090.694 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4349825.305 ops/s (100 runs over 1000 unique samples each)
```

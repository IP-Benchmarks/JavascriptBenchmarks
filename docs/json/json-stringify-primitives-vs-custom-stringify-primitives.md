...
```typescript
Custom stringify for primitives: 7835461.575 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6009206.585 ops/s (100 runs over 1000 unique samples each)
```

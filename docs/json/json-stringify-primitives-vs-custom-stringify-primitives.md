...
```typescript
Custom stringify for primitives: 9710827.106 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5777808.593 ops/s (100 runs over 1000 unique samples each)
```

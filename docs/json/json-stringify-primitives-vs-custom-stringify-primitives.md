...
```typescript
Custom stringify for primitives: 5865394.016 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4434481.446 ops/s (100 runs over 1000 unique samples each)
```

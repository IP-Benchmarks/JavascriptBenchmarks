...
```typescript
Custom stringify for primitives: 4969832.124 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4173416.298 ops/s (100 runs over 1000 unique samples each)
```

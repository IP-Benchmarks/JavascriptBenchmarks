...
```typescript
Custom stringify for primitives: 10131994.559 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6391570.899 ops/s (100 runs over 1000 unique samples each)
```

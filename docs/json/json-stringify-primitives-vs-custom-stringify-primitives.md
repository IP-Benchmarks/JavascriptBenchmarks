...
```typescript
Custom stringify for primitives: 4402661.038 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3155230.361 ops/s (100 runs over 1000 unique samples each)
```

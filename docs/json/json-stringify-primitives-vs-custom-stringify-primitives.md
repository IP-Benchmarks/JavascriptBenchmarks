...
```typescript
Custom stringify for primitives: 5827560.844 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4366520.872 ops/s (100 runs over 1000 unique samples each)
```

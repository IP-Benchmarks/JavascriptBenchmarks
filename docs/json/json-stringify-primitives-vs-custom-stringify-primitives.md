...
```typescript
Custom stringify for primitives: 8517715.613 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6019863.989 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10519618.668 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5640427.698 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10593221.461 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6621794.737 ops/s (100 runs over 1000 unique samples each)
```

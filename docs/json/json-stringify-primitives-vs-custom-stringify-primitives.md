...
```typescript
Custom stringify for primitives: 10378051.666 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6172847.508 ops/s (100 runs over 1000 unique samples each)
```

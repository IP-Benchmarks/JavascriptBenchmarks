...
```typescript
Custom stringify for primitives: 5219714.759 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4249956.067 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/30/2023 1:11:23`

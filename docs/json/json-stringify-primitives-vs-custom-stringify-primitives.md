...
```typescript
Custom stringify for primitives: 10213603.212 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7027915.583 ops/s (100 runs over 1000 unique samples each)
```

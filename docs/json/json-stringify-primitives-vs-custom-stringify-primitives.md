...
```typescript
Custom stringify for primitives: 8446259.110 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6151578.207 ops/s (100 runs over 1000 unique samples each)
```

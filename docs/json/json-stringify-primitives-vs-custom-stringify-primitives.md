...
```typescript
Custom stringify for primitives: 4720676.843 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3762951.231 ops/s (100 runs over 1000 unique samples each)
```

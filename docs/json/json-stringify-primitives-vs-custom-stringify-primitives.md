...
```typescript
Custom stringify for primitives: 10493064.924 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6737967.842 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/24/2026 2:27:10`

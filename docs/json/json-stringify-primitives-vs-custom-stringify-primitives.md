...
```typescript
Custom stringify for primitives: 10498952.204 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6661869.233 ops/s (100 runs over 1000 unique samples each)
```

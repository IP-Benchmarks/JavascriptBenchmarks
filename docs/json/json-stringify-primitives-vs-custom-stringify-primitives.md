...
```typescript
Custom stringify for primitives: 12088176.965 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 8094309.061 ops/s (100 runs over 1000 unique samples each)
```

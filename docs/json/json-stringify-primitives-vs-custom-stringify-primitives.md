...
```typescript
Custom stringify for primitives: 5950913.414 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4379972.610 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6445361.318 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4687183.029 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/15/2022 0:46:42`

...
```typescript
Custom stringify for primitives: 8829704.748 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4674132.787 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/28/2024 0:51:35`

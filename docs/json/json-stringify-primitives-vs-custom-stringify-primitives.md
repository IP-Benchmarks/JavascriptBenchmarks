...
```typescript
Custom stringify for primitives: 8804294.097 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6035050.728 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6348589.225 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4269593.216 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10641934.244 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5810822.739 ops/s (100 runs over 1000 unique samples each)
```

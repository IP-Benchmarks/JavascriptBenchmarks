...
```typescript
Custom stringify for primitives: 6378950.891 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4494865.852 ops/s (100 runs over 1000 unique samples each)
```

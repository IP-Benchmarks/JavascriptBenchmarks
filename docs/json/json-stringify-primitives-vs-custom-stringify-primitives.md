...
```typescript
Custom stringify for primitives: 10429500.384 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6908496.753 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7565712.372 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5557434.587 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/20/2024 1:6:31`

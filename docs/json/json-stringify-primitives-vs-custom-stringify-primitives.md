...
```typescript
Custom stringify for primitives: 9740805.921 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5703124.537 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4533311.659 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3297388.936 ops/s (100 runs over 1000 unique samples each)
```

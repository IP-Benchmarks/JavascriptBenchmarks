...
```typescript
Custom stringify for primitives: 4973874.475 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3375691.168 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4282737.049 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3469747.858 ops/s (100 runs over 1000 unique samples each)
```

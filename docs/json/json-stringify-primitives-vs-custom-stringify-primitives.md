...
```typescript
Custom stringify for primitives: 10452443.421 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6033027.447 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/29/2025 1:20:28`

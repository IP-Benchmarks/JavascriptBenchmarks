...
```typescript
Custom stringify for primitives: 8626190.332 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4671475.233 ops/s (100 runs over 1000 unique samples each)
```

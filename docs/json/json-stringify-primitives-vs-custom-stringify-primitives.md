...
```typescript
Custom stringify for primitives: 10195334.452 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6821352.197 ops/s (100 runs over 1000 unique samples each)
```

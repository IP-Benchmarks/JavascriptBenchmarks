...
```typescript
Custom stringify for primitives: 5166122.079 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4041854.209 ops/s (100 runs over 1000 unique samples each)
```

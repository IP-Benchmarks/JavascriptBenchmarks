...
```typescript
Custom stringify for primitives: 10309538.746 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6918394.766 ops/s (100 runs over 1000 unique samples each)
```

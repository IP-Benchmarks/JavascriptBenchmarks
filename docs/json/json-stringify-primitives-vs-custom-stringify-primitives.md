...
```typescript
Custom stringify for primitives: 10400848.709 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5933208.918 ops/s (100 runs over 1000 unique samples each)
```

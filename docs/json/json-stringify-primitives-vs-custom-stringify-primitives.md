...
```typescript
Custom stringify for primitives: 8933919.017 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5199194.395 ops/s (100 runs over 1000 unique samples each)
```

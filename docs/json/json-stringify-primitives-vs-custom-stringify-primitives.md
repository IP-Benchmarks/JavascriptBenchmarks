...
```typescript
Custom stringify for primitives: 12609678.988 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7556826.580 ops/s (100 runs over 1000 unique samples each)
```

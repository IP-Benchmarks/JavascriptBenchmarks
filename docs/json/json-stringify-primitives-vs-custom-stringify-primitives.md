...
```typescript
Custom stringify for primitives: 5802994.938 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4264865.188 ops/s (100 runs over 1000 unique samples each)
```

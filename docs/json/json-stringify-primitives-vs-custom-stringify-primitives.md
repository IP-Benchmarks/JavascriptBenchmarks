...
#### **Custom stringify for primitives** is **_`1.29x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5358550.243 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4166711.633 ops/s (100 runs over 1000 unique samples each)
```

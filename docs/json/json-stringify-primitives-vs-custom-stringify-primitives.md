...
#### **Custom stringify for primitives** is **_`1.13x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 4964586.610 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4410884.281 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9672366.012 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5307760.684 ops/s (100 runs over 1000 unique samples each)
```

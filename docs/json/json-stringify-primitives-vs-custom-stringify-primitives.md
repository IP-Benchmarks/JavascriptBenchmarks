...
```typescript
Custom stringify for primitives: 5952745.558 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4623887.019 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9081715.093 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4753966.543 ops/s (100 runs over 1000 unique samples each)
```

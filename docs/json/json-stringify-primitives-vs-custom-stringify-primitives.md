...
```typescript
Custom stringify for primitives: 4631305.905 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3464938.753 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5835023.350 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4309535.303 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/2/2023 1:1:18`

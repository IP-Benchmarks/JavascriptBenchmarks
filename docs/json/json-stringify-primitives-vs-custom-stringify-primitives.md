...
#### **Custom stringify for primitives** is **_`1.24x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5909010.923 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4781591.028 ops/s (100 runs over 1000 unique samples each)
```

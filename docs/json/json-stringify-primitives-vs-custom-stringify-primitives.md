...
```typescript
Custom stringify for primitives: 5128098.621 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4068454.183 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5566183.256 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4235565.194 ops/s (100 runs over 1000 unique samples each)
```

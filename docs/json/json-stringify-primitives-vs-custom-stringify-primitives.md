...
```typescript
Custom stringify for primitives: 4438042.421 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3660760.274 ops/s (100 runs over 1000 unique samples each)
```

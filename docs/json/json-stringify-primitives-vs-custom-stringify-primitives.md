...
```typescript
Custom stringify for primitives: 8408817.892 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5736485.587 ops/s (100 runs over 1000 unique samples each)
```

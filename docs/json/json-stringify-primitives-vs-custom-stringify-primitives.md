...
```typescript
Custom stringify for primitives: 5698163.817 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4283173.446 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4565308.658 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3267148.100 ops/s (100 runs over 1000 unique samples each)
```

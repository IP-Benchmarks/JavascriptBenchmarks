...
```typescript
Custom stringify for primitives: 10032609.996 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7033435.475 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8593748.993 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6051629.477 ops/s (100 runs over 1000 unique samples each)
```

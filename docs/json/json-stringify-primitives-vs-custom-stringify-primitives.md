...
```typescript
Custom stringify for primitives: 5641605.075 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4254011.990 ops/s (100 runs over 1000 unique samples each)
```

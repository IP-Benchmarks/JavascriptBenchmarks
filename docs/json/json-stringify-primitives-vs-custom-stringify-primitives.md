...
```typescript
Custom stringify for primitives: 9803766.823 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6453396.122 ops/s (100 runs over 1000 unique samples each)
```

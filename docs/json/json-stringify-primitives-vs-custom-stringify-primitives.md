...
```typescript
Custom stringify for primitives: 5691484.975 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3586292.988 ops/s (100 runs over 1000 unique samples each)
```

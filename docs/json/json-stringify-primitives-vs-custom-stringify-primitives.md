...
```typescript
Custom stringify for primitives: 8690844.998 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5930417.933 ops/s (100 runs over 1000 unique samples each)
```

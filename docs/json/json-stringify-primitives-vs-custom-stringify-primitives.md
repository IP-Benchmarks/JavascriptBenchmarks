...
```typescript
Custom stringify for primitives: 9676672.378 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6630201.443 ops/s (100 runs over 1000 unique samples each)
```

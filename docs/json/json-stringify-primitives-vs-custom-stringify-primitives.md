...
```typescript
Custom stringify for primitives: 8808494.348 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5981005.762 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7452924.349 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5684483.430 ops/s (100 runs over 1000 unique samples each)
```

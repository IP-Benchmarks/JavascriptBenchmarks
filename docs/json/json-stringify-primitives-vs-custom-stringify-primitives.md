...
```typescript
Custom stringify for primitives: 6717339.138 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4378947.073 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/22/2022 1:1:8`

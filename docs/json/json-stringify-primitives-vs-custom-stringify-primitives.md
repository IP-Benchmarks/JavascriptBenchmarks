...
```typescript
Custom stringify for primitives: 10486293.471 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6842831.252 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/5/2025 1:12:21`

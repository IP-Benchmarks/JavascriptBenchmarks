...
```typescript
Custom stringify for primitives: 5866113.126 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4387102.096 ops/s (100 runs over 1000 unique samples each)
```

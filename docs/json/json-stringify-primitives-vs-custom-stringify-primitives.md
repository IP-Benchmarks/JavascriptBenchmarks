...
```typescript
Custom stringify for primitives: 5960615.117 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3596337.705 ops/s (100 runs over 1000 unique samples each)
```

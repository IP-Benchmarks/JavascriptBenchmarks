...
```typescript
Custom stringify for primitives: 8735437.916 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5927938.439 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.46x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10189770.204 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6993725.928 ops/s (100 runs over 1000 unique samples each)
```

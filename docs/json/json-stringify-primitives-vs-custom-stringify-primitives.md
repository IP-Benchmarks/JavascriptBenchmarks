...
```typescript
Custom stringify for primitives: 5965479.798 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4147509.321 ops/s (100 runs over 1000 unique samples each)
```

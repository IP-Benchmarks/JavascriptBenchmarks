...
```typescript
Custom stringify for primitives: 10413865.771 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5293553.759 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10215360.224 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6321359.856 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/10/2025 1:10:13`

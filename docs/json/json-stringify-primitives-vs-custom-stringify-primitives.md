...
```typescript
Custom stringify for primitives: 6388253.790 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4171784.576 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9833299.031 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6731378.550 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5210735.700 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4266043.801 ops/s (100 runs over 1000 unique samples each)
```

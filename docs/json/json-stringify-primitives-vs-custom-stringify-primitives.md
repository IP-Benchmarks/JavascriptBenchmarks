...
```typescript
Custom stringify for primitives: 8642387.262 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6444792.649 ops/s (100 runs over 1000 unique samples each)
```

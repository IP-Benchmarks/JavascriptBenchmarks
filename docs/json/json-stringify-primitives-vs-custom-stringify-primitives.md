...
#### **Custom stringify for primitives** is **_`1.74x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 8739131.255 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5028300.280 ops/s (100 runs over 1000 unique samples each)
```

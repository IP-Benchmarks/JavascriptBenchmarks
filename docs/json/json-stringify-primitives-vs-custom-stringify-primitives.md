...
```typescript
Custom stringify for primitives: 10001224.150 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5886965.552 ops/s (100 runs over 1000 unique samples each)
```

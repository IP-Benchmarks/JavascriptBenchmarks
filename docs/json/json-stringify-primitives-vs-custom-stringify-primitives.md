...
```typescript
Custom stringify for primitives: 5789031.037 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4431372.094 ops/s (100 runs over 1000 unique samples each)
```

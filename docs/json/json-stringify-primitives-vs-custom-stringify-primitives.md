...
```typescript
Custom stringify for primitives: 8244090.371 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6034783.770 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7351993.528 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4912038.409 ops/s (100 runs over 1000 unique samples each)
```

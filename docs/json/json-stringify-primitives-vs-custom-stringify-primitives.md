...
```typescript
Custom stringify for primitives: 4462725.354 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3347660.091 ops/s (100 runs over 1000 unique samples each)
```

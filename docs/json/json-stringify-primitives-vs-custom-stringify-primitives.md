...
```typescript
Custom stringify for primitives: 10348096.514 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6855486.885 ops/s (100 runs over 1000 unique samples each)
```

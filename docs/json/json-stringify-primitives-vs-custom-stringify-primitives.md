...
```typescript
Custom stringify for primitives: 10335172.753 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6813048.186 ops/s (100 runs over 1000 unique samples each)
```

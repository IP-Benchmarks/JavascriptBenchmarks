...
```typescript
Custom stringify for primitives: 10202362.847 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6279383.591 ops/s (100 runs over 1000 unique samples each)
```

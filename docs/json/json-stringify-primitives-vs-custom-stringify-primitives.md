...
```typescript
Custom stringify for primitives: 8162862.159 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5534850.297 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8392110.980 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5779231.394 ops/s (100 runs over 1000 unique samples each)
```

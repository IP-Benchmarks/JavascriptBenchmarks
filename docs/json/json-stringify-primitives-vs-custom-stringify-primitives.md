...
```typescript
Custom stringify for primitives: 10401725.022 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6569468.749 ops/s (100 runs over 1000 unique samples each)
```

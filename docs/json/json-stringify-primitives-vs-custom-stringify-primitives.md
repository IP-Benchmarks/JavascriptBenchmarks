...
```typescript
Custom stringify for primitives: 4643514.598 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3766601.626 ops/s (100 runs over 1000 unique samples each)
```

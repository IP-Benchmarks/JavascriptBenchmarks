...
```typescript
Custom stringify for primitives: 4064664.421 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3493330.184 ops/s (100 runs over 1000 unique samples each)
```

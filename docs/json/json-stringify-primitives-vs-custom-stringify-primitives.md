...
```typescript
Custom stringify for primitives: 4929530.877 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3833543.552 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9612561.850 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6776790.874 ops/s (100 runs over 1000 unique samples each)
```

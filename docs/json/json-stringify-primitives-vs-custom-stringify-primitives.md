...
```typescript
Custom stringify for primitives: 6989250.392 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6128567.040 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/23/2024 1:2:20`

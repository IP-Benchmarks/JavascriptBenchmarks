...
```typescript
Custom stringify for primitives: 8193942.760 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6245520.007 ops/s (100 runs over 1000 unique samples each)
```

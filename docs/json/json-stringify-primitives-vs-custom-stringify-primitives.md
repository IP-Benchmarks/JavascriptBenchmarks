...
```typescript
Custom stringify for primitives: 4627453.655 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3990148.801 ops/s (100 runs over 1000 unique samples each)
```

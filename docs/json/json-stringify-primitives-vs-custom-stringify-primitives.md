...
```typescript
Custom stringify for primitives: 8671864.116 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4773308.423 ops/s (100 runs over 1000 unique samples each)
```

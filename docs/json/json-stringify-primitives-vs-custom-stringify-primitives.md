...
```typescript
Custom stringify for primitives: 5418127.755 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4440534.603 ops/s (100 runs over 1000 unique samples each)
```

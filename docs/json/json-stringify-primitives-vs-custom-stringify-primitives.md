...
```typescript
Custom stringify for primitives: 10074819.641 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5922263.423 ops/s (100 runs over 1000 unique samples each)
```

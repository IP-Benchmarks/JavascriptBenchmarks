...
```typescript
Custom stringify for primitives: 10231605.696 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5247404.083 ops/s (100 runs over 1000 unique samples each)
```

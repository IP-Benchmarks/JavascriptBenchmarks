...
```typescript
Custom stringify for primitives: 10117027.706 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6727603.505 ops/s (100 runs over 1000 unique samples each)
```

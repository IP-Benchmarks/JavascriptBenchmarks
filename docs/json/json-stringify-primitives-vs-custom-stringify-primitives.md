...
```typescript
Custom stringify for primitives: 5651536.222 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4399171.108 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9092596.181 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5877420.748 ops/s (100 runs over 1000 unique samples each)
```

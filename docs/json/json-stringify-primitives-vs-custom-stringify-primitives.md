...
```typescript
Custom stringify for primitives: 5123528.265 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4335307.603 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/7/2023 0:50:33`

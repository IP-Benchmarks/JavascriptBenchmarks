...
```typescript
Custom stringify for primitives: 10372957.617 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6772876.202 ops/s (100 runs over 1000 unique samples each)
```

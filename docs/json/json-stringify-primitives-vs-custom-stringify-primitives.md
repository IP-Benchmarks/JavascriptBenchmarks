...
```typescript
Custom stringify for primitives: 9627997.292 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4988375.837 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10121708.484 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6543733.900 ops/s (100 runs over 1000 unique samples each)
```

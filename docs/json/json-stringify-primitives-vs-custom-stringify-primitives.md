...
```typescript
Custom stringify for primitives: 10566892.657 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5608407.631 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/15/2026 2:8:48`

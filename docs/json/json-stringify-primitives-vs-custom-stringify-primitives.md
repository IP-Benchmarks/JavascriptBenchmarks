...
```typescript
Custom stringify for primitives: 10271787.385 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5195560.913 ops/s (100 runs over 1000 unique samples each)
```

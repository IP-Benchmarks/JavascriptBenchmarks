...
```typescript
Custom stringify for primitives: 4892985.274 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3454986.399 ops/s (100 runs over 1000 unique samples each)
```

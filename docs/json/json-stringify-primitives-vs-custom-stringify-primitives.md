...
#### **Custom stringify for primitives** is **_`2.07x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10942579.580 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5295650.894 ops/s (100 runs over 1000 unique samples each)
```

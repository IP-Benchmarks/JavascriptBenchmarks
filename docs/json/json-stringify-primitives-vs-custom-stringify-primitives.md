...
```typescript
Custom stringify for primitives: 9447371.293 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6925229.338 ops/s (100 runs over 1000 unique samples each)
```

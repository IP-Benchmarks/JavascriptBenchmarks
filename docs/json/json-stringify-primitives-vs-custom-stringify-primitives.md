...
```typescript
Custom stringify for primitives: 9692435.752 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5953510.702 ops/s (100 runs over 1000 unique samples each)
```

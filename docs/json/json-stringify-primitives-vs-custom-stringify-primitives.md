...
```typescript
Custom stringify for primitives: 7922411.075 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5629411.241 ops/s (100 runs over 1000 unique samples each)
```

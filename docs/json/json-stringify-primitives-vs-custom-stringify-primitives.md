...
```typescript
Custom stringify for primitives: 6479689.607 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4019733.030 ops/s (100 runs over 1000 unique samples each)
```

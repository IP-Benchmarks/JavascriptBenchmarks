...
```typescript
Custom stringify for primitives: 9853542.851 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6842810.649 ops/s (100 runs over 1000 unique samples each)
```

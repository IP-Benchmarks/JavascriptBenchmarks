...
```typescript
Custom stringify for primitives: 9760333.069 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6693690.882 ops/s (100 runs over 1000 unique samples each)
```

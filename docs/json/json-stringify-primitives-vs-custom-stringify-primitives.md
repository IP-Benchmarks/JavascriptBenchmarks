...
```typescript
Custom stringify for primitives: 6157918.717 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4362089.932 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/14/2023 0:59:46`

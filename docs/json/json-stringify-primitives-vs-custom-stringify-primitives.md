...
```typescript
Custom stringify for primitives: 9645526.887 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6320208.830 ops/s (100 runs over 1000 unique samples each)
```

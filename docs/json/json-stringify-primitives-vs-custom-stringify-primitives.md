...
```typescript
Custom stringify for primitives: 8232616.193 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4391071.843 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/12/2024 0:59:30`

...
```typescript
Custom stringify for primitives: 9605348.873 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5687446.492 ops/s (100 runs over 1000 unique samples each)
```

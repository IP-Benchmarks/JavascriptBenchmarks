...
```typescript
Custom stringify for primitives: 8008225.411 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6062311.960 ops/s (100 runs over 1000 unique samples each)
```

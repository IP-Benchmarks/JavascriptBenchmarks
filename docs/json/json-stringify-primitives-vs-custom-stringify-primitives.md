...
```typescript
Custom stringify for primitives: 5457436.606 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4224728.519 ops/s (100 runs over 1000 unique samples each)
```

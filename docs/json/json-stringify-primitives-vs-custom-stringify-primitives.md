...
```typescript
Custom stringify for primitives: 5483639.151 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3049337.829 ops/s (100 runs over 1000 unique samples each)
```

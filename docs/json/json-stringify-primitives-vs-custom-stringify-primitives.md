...
```typescript
Custom stringify for primitives: 8429188.662 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5491941.783 ops/s (100 runs over 1000 unique samples each)
```

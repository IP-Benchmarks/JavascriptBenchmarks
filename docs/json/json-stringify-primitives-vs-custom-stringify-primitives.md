...
```typescript
Custom stringify for primitives: 8211292.991 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6310641.717 ops/s (100 runs over 1000 unique samples each)
```

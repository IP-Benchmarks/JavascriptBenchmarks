...
```typescript
Custom stringify for primitives: 6216526.338 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4310675.189 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8179160.921 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6400840.610 ops/s (100 runs over 1000 unique samples each)
```

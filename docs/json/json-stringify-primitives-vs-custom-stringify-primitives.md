...
```typescript
Custom stringify for primitives: 9925845.004 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5986879.275 ops/s (100 runs over 1000 unique samples each)
```

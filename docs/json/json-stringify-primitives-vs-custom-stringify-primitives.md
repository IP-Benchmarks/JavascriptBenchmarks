...
```typescript
Custom stringify for primitives: 9865800.450 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5780138.669 ops/s (100 runs over 1000 unique samples each)
```

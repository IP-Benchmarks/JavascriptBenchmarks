...
```typescript
Custom stringify for primitives: 9225777.376 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5279346.037 ops/s (100 runs over 1000 unique samples each)
```

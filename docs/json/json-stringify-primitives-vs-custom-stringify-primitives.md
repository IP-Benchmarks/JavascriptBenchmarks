...
```typescript
Custom stringify for primitives: 8245961.874 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6517009.626 ops/s (100 runs over 1000 unique samples each)
```

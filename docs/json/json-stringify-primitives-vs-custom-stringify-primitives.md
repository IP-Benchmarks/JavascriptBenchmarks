...
```typescript
Custom stringify for primitives: 9742643.208 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6137717.742 ops/s (100 runs over 1000 unique samples each)
```

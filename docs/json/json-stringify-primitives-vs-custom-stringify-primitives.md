...
```typescript
Custom stringify for primitives: 7117594.260 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4634009.197 ops/s (100 runs over 1000 unique samples each)
```

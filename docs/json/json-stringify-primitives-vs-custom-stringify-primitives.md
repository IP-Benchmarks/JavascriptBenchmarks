...
```typescript
Custom stringify for primitives: 7691516.058 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4814800.388 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5530759.625 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4379249.869 ops/s (100 runs over 1000 unique samples each)
```

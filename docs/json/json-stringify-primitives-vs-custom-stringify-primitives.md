...
```typescript
Custom stringify for primitives: 8636962.144 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6003670.166 ops/s (100 runs over 1000 unique samples each)
```

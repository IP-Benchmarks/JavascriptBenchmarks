...
```typescript
Custom stringify for primitives: 10219051.500 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5950580.193 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9765802.387 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6729917.573 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10269730.360 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6614621.939 ops/s (100 runs over 1000 unique samples each)
```

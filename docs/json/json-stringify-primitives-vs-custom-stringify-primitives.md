...
```typescript
Custom stringify for primitives: 5378149.815 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4523122.861 ops/s (100 runs over 1000 unique samples each)
```

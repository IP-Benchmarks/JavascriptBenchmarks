...
```typescript
Custom stringify for primitives: 8659882.341 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4488226.394 ops/s (100 runs over 1000 unique samples each)
```

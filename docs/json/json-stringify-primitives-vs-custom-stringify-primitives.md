...
```typescript
Custom stringify for primitives: 10200415.728 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6067739.148 ops/s (100 runs over 1000 unique samples each)
```

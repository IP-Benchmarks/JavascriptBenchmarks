...
```typescript
Custom stringify for primitives: 8812582.889 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6203112.609 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/26/2024 0:52:48`

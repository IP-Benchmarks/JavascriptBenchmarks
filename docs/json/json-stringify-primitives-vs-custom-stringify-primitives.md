...
```typescript
Custom stringify for primitives: 8634149.255 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6321083.349 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6475305.000 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5812623.682 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/19/2024 0:51:58`

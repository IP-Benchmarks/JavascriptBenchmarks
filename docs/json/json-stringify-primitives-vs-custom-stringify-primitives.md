...
```typescript
Custom stringify for primitives: 10284050.620 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6779664.234 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6440438.120 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4235064.547 ops/s (100 runs over 1000 unique samples each)
```

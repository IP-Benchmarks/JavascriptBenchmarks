...
```typescript
Custom stringify for primitives: 10155764.031 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6705851.190 ops/s (100 runs over 1000 unique samples each)
```

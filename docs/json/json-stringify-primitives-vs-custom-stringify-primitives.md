...
```typescript
Custom stringify for primitives: 9816888.523 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5266243.359 ops/s (100 runs over 1000 unique samples each)
```

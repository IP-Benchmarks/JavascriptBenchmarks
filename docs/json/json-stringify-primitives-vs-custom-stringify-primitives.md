...
```typescript
Custom stringify for primitives: 5768074.825 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3763828.494 ops/s (100 runs over 1000 unique samples each)
```

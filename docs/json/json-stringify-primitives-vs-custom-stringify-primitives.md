...
```typescript
Custom stringify for primitives: 6139656.560 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4291289.099 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/10/2022 1:42:45`

...
```typescript
Custom stringify for primitives: 4917506.614 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4326306.848 ops/s (100 runs over 1000 unique samples each)
```

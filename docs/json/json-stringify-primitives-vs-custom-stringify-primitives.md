...
```typescript
Custom stringify for primitives: 5105124.468 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3826260.090 ops/s (100 runs over 1000 unique samples each)
```

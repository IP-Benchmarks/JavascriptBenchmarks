...
```typescript
Custom stringify for primitives: 4006636.593 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3333597.576 ops/s (100 runs over 1000 unique samples each)
```

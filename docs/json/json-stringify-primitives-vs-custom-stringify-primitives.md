...
```typescript
Custom stringify for primitives: 8331618.405 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4828268.160 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/9/2024 0:50:4`

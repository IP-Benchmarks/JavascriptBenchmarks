...
```typescript
Custom stringify for primitives: 5225197.386 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3918679.408 ops/s (100 runs over 1000 unique samples each)
```

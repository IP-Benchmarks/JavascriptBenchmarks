...
```typescript
Custom stringify for primitives: 9367231.345 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5740999.734 ops/s (100 runs over 1000 unique samples each)
```

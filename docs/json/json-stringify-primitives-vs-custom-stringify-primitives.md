...
```typescript
Custom stringify for primitives: 5348862.151 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4272085.905 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/2/2023 1:11:22`

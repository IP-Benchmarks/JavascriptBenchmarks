...
```typescript
Custom stringify for primitives: 4263109.392 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3219074.121 ops/s (100 runs over 1000 unique samples each)
```

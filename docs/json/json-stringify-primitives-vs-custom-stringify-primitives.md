...
```typescript
Custom stringify for primitives: 5478122.897 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4289234.768 ops/s (100 runs over 1000 unique samples each)
```

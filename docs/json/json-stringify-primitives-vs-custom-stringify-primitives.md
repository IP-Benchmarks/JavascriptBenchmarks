...
#### **Custom stringify for primitives** is **_`2.01x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10558737.783 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5261356.572 ops/s (100 runs over 1000 unique samples each)
```

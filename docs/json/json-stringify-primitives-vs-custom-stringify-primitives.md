...
#### **Custom stringify for primitives** is **_`1.31x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 4675365.965 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3573626.224 ops/s (100 runs over 1000 unique samples each)
```

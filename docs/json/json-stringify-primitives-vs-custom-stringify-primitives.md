...
```typescript
Custom stringify for primitives: 10604006.321 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5544336.591 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5423136.718 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4406700.952 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/2/2023 1:4:39`

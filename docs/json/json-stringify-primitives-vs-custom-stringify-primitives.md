...
```typescript
Custom stringify for primitives: 8637244.125 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6037428.554 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/13/2024 0:43:51`

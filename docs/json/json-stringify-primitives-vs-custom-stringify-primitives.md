...
```typescript
Custom stringify for primitives: 4351464.289 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3641746.004 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9128471.090 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6548621.221 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5560027.981 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4253984.846 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/16/2022 1:49:58`

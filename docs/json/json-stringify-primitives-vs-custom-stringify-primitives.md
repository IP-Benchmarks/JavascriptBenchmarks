...
```typescript
Custom stringify for primitives: 10180571.784 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6936948.686 ops/s (100 runs over 1000 unique samples each)
```

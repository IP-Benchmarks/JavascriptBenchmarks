...
```typescript
Custom stringify for primitives: 10631148.990 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6117420.210 ops/s (100 runs over 1000 unique samples each)
```

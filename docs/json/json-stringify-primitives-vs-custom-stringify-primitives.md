...
```typescript
Custom stringify for primitives: 8793705.816 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4931162.452 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/13/2024 0:55:24`

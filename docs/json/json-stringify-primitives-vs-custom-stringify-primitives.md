...
#### **Custom stringify for primitives** is **_`2.02x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10144368.567 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5015608.825 ops/s (100 runs over 1000 unique samples each)
```

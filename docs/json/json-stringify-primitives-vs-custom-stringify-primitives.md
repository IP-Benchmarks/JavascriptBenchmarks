...
```typescript
Custom stringify for primitives: 10619988.560 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4919923.812 ops/s (100 runs over 1000 unique samples each)
```

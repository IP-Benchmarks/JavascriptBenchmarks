...
```typescript
Custom stringify for primitives: 8531501.630 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5275158.046 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/27/2024 1:8:48`

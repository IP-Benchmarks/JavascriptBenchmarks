...
```typescript
Custom stringify for primitives: 9871398.383 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6671130.097 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4289195.949 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3466963.753 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4486882.174 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3692226.622 ops/s (100 runs over 1000 unique samples each)
```

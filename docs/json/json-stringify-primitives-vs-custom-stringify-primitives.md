...
```typescript
Custom stringify for primitives: 10451274.538 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6528789.087 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9637342.002 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5588146.558 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7752898.379 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5888824.762 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4621355.264 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3942724.825 ops/s (100 runs over 1000 unique samples each)
```

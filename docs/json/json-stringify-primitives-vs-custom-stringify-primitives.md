...
```typescript
Custom stringify for primitives: 6105318.452 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4290889.160 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.40x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 4817259.896 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3450124.891 ops/s (100 runs over 1000 unique samples each)
```

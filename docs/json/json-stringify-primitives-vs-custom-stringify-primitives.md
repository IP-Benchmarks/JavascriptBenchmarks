...
```typescript
Custom stringify for primitives: 5882171.979 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4366276.833 ops/s (100 runs over 1000 unique samples each)
```

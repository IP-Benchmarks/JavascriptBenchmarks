...
```typescript
Custom stringify for primitives: 9775014.359 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6340532.501 ops/s (100 runs over 1000 unique samples each)
```

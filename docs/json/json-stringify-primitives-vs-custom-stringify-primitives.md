...
```typescript
Custom stringify for primitives: 5393176.014 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3896245.476 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6169214.902 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4203937.727 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/14/2022 1:20:23`

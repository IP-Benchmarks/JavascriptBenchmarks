...
```typescript
Custom stringify for primitives: 5910964.095 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4235918.103 ops/s (100 runs over 1000 unique samples each)
```

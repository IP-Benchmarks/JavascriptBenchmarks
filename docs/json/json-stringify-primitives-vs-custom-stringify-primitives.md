...
```typescript
Custom stringify for primitives: 4797471.157 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3522037.282 ops/s (100 runs over 1000 unique samples each)
```

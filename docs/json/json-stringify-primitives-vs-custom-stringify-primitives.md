...
```typescript
Custom stringify for primitives: 4313638.439 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3527490.528 ops/s (100 runs over 1000 unique samples each)
```

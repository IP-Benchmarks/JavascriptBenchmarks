...
```typescript
Custom stringify for primitives: 8643492.826 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4647252.830 ops/s (100 runs over 1000 unique samples each)
```

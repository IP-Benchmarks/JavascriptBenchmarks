...
```typescript
Custom stringify for primitives: 7768966.482 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5162015.000 ops/s (100 runs over 1000 unique samples each)
```

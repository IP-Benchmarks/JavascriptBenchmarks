...
```typescript
Custom stringify for primitives: 9114400.215 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5299869.535 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.99x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10561633.893 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5320657.116 ops/s (100 runs over 1000 unique samples each)
```

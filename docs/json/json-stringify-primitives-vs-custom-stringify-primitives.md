...
```typescript
Custom stringify for primitives: 6386156.856 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4300455.633 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/24/2022 1:26:37`

...
```typescript
Custom stringify for primitives: 5354663.743 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3985538.077 ops/s (100 runs over 1000 unique samples each)
```

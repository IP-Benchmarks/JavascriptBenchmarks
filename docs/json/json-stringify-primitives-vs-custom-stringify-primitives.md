...
```typescript
Custom stringify for primitives: 10228918.072 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6944188.860 ops/s (100 runs over 1000 unique samples each)
```

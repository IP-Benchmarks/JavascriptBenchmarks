...
```typescript
Custom stringify for primitives: 9919677.396 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6874460.999 ops/s (100 runs over 1000 unique samples each)
```

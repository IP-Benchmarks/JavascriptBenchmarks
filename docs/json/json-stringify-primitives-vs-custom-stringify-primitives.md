...
```typescript
Custom stringify for primitives: 9996598.158 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6795642.987 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8732917.432 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5994138.690 ops/s (100 runs over 1000 unique samples each)
```

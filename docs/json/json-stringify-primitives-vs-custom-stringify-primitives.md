...
```typescript
Custom stringify for primitives: 4093507.501 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3243278.095 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/25/2022 1:18:39`

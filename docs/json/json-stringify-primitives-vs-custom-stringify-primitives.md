...
```typescript
Custom stringify for primitives: 8847740.212 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5209685.952 ops/s (100 runs over 1000 unique samples each)
```

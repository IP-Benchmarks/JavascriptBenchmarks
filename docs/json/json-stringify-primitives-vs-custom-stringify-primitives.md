...
```typescript
Custom stringify for primitives: 8983303.808 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4799741.120 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/3/2024 0:52:26`

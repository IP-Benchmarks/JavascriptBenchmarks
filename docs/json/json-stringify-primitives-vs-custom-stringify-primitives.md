...
```typescript
Custom stringify for primitives: 10439374.481 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5898369.443 ops/s (100 runs over 1000 unique samples each)
```

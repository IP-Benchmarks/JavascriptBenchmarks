...
#### **Custom stringify for primitives** is **_`2.08x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10317393.991 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4949432.147 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10599211.588 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5784754.269 ops/s (100 runs over 1000 unique samples each)
```

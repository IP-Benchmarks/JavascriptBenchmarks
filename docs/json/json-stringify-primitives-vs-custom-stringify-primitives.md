...
```typescript
Custom stringify for primitives: 10106852.678 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6629441.469 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7292201.958 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4617047.320 ops/s (100 runs over 1000 unique samples each)
```

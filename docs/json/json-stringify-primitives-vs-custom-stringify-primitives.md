...
#### **Custom stringify for primitives** is **_`1.59x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10619828.409 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6698105.789 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/16/2025 1:24:55`

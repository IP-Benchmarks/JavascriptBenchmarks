...
```typescript
Custom stringify for primitives: 10076670.362 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6810515.654 ops/s (100 runs over 1000 unique samples each)
```

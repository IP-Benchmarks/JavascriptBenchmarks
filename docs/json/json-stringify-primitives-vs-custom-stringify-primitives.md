...
```typescript
Custom stringify for primitives: 10305073.456 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6653490.538 ops/s (100 runs over 1000 unique samples each)
```

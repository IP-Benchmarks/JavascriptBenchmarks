...
```typescript
Custom stringify for primitives: 4401753.888 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3964697.540 ops/s (100 runs over 1000 unique samples each)
```

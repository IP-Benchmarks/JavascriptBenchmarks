...
```typescript
Custom stringify for primitives: 6032290.853 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4013313.123 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8103079.599 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5999829.968 ops/s (100 runs over 1000 unique samples each)
```

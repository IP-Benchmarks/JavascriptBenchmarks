...
```typescript
Custom stringify for primitives: 4020755.946 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3579317.900 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7977830.566 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6362256.448 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10595941.161 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6750910.833 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8958670.954 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5594910.467 ops/s (100 runs over 1000 unique samples each)
```

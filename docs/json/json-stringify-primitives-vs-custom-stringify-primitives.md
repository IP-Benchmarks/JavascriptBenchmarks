...
```typescript
Custom stringify for primitives: 6246794.224 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3858881.179 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/5/2022 0:55:27`

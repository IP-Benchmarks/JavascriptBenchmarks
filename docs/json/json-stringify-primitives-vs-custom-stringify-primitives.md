...
```typescript
Custom stringify for primitives: 6048834.662 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4470729.153 ops/s (100 runs over 1000 unique samples each)
```

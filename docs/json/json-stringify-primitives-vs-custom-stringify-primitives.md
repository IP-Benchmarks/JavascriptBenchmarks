...
```typescript
Custom stringify for primitives: 10230796.539 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6802283.336 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/8/2026 2:23:1`

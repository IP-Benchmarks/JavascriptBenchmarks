...
#### **Custom stringify for primitives** is **_`2.77x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 9231471.672 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3335940.927 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/19/2023 0:58:26`

...
```typescript
Custom stringify for primitives: 8221768.728 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6031754.898 ops/s (100 runs over 1000 unique samples each)
```

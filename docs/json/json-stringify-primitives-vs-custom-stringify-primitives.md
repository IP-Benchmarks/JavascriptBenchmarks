...
```typescript
Custom stringify for primitives: 9974845.435 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6568857.258 ops/s (100 runs over 1000 unique samples each)
```

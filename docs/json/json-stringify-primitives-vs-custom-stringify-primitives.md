...
```typescript
Custom stringify for primitives: 5469046.181 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4536880.872 ops/s (100 runs over 1000 unique samples each)
```

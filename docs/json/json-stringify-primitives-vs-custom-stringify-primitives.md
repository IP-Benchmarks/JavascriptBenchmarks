...
```typescript
Custom stringify for primitives: 7724959.909 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6700228.109 ops/s (100 runs over 1000 unique samples each)
```

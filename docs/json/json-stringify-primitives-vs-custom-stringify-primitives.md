...
```typescript
Custom stringify for primitives: 8676042.809 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5977681.487 ops/s (100 runs over 1000 unique samples each)
```

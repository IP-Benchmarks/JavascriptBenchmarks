...
```typescript
Custom stringify for primitives: 8160335.579 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4750503.553 ops/s (100 runs over 1000 unique samples each)
```

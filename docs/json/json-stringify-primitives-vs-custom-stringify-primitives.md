...
```typescript
Custom stringify for primitives: 10238719.849 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6971385.460 ops/s (100 runs over 1000 unique samples each)
```

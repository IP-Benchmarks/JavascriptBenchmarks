...
```typescript
Custom stringify for primitives: 8660193.572 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5962689.662 ops/s (100 runs over 1000 unique samples each)
```

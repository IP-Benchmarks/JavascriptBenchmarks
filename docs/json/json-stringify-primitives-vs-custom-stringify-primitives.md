...
```typescript
Custom stringify for primitives: 8573784.401 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5596060.149 ops/s (100 runs over 1000 unique samples each)
```

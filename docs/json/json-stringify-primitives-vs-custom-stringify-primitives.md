...
```typescript
Custom stringify for primitives: 8506813.489 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5306086.933 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10343360.256 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5965070.931 ops/s (100 runs over 1000 unique samples each)
```

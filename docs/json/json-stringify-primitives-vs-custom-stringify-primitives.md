...
```typescript
Custom stringify for primitives: 8326307.322 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5317004.318 ops/s (100 runs over 1000 unique samples each)
```

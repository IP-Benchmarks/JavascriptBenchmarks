...
```typescript
Custom stringify for primitives: 7884776.294 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4634302.124 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/26/2024 0:52:19`

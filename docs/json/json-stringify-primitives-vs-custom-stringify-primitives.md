...
```typescript
Custom stringify for primitives: 10440890.620 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6927814.802 ops/s (100 runs over 1000 unique samples each)
```

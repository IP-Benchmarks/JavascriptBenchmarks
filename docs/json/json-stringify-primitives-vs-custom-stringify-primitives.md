...
```typescript
Custom stringify for primitives: 8375841.429 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6171309.630 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5744465.825 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4162098.245 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/15/2022 1:42:22`

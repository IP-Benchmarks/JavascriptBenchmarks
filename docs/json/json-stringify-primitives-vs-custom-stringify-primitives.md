...
```typescript
Custom stringify for primitives: 6702310.897 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4186491.097 ops/s (100 runs over 1000 unique samples each)
```

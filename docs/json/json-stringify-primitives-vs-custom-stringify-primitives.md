...
```typescript
Custom stringify for primitives: 9717127.613 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5244170.960 ops/s (100 runs over 1000 unique samples each)
```

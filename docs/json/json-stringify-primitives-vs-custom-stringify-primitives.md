...
```typescript
Custom stringify for primitives: 8316447.482 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4953898.035 ops/s (100 runs over 1000 unique samples each)
```

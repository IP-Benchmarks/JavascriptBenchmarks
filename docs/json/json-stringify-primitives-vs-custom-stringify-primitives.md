...
```typescript
Custom stringify for primitives: 8591322.148 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4524870.497 ops/s (100 runs over 1000 unique samples each)
```

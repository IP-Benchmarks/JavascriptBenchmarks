...
```typescript
Custom stringify for primitives: 8943578.272 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5984676.833 ops/s (100 runs over 1000 unique samples each)
```

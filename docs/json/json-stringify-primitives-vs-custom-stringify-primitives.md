...
```typescript
Custom stringify for primitives: 10871315.263 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6890832.333 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10392239.491 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5462525.410 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9696947.130 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6876792.565 ops/s (100 runs over 1000 unique samples each)
```

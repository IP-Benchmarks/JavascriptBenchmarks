...
```typescript
Custom stringify for primitives: 5250006.628 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4476290.966 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9567426.968 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5931733.225 ops/s (100 runs over 1000 unique samples each)
```

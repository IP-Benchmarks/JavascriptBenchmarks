...
```typescript
Custom stringify for primitives: 9410818.753 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6708846.076 ops/s (100 runs over 1000 unique samples each)
```

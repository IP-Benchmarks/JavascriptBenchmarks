...
```typescript
Custom stringify for primitives: 5795602.321 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4057222.910 ops/s (100 runs over 1000 unique samples each)
```

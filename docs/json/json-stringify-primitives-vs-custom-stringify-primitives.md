...
```typescript
Custom stringify for primitives: 8675399.265 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4572975.753 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/23/2024 0:57:22`

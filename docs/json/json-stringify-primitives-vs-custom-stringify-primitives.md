...
```typescript
Custom stringify for primitives: 8180725.978 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4478435.171 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5869079.500 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4248144.665 ops/s (100 runs over 1000 unique samples each)
```

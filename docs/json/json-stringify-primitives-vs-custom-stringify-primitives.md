...
```typescript
Custom stringify for primitives: 9514520.633 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4874856.819 ops/s (100 runs over 1000 unique samples each)
```

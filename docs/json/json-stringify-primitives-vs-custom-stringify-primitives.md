...
```typescript
Custom stringify for primitives: 6090473.373 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4332571.480 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7495666.941 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6372412.858 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/7/2024 1:4:23`

...
```typescript
Custom stringify for primitives: 5544655.379 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4741394.168 ops/s (100 runs over 1000 unique samples each)
```

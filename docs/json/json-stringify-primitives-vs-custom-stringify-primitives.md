...
```typescript
Custom stringify for primitives: 9756843.841 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7182931.229 ops/s (100 runs over 1000 unique samples each)
```

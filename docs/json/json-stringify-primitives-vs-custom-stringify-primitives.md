...
```typescript
Custom stringify for primitives: 6285578.733 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4171245.304 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9207778.400 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6062313.429 ops/s (100 runs over 1000 unique samples each)
```

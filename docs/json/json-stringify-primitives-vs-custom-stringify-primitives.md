...
```typescript
Custom stringify for primitives: 8125180.428 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5822108.841 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/19/2024 0:53:33`

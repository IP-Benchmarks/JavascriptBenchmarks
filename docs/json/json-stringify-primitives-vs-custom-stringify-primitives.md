...
```typescript
Custom stringify for primitives: 9875482.022 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6798132.118 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9930064.541 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5207227.069 ops/s (100 runs over 1000 unique samples each)
```

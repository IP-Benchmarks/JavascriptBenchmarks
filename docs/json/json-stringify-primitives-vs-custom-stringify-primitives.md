...
```typescript
Custom stringify for primitives: 6289837.078 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4309888.945 ops/s (100 runs over 1000 unique samples each)
```

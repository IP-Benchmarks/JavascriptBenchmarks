...
```typescript
Custom stringify for primitives: 10403111.196 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7073818.193 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5641567.203 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3857262.614 ops/s (100 runs over 1000 unique samples each)
```

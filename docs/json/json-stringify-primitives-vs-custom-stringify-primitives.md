...
```typescript
Custom stringify for primitives: 10195631.743 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6370087.293 ops/s (100 runs over 1000 unique samples each)
```

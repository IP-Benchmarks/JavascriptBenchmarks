...
```typescript
Custom stringify for primitives: 6465486.168 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4161158.161 ops/s (100 runs over 1000 unique samples each)
```

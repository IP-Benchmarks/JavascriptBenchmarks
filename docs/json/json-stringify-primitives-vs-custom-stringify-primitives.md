...
```typescript
Custom stringify for primitives: 10110222.658 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6259658.653 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/6/2026 2:36:45`

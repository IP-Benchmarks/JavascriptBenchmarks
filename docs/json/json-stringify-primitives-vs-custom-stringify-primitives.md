...
```typescript
Custom stringify for primitives: 5217670.246 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3900668.387 ops/s (100 runs over 1000 unique samples each)
```

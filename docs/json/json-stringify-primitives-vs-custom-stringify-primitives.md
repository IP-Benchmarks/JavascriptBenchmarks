...
```typescript
Custom stringify for primitives: 5491249.666 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4122354.618 ops/s (100 runs over 1000 unique samples each)
```

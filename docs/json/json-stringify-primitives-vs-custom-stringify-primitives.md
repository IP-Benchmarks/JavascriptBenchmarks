...
```typescript
Custom stringify for primitives: 8576063.075 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4856861.257 ops/s (100 runs over 1000 unique samples each)
```

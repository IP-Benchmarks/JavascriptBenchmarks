...
```typescript
Custom stringify for primitives: 5627829.705 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4446308.732 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4396294.276 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3441976.096 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/17/2023 1:4:36`

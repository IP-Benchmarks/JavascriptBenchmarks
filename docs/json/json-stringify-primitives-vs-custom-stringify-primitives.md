...
```typescript
Custom stringify for primitives: 9434259.532 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5791052.904 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/25/2026 2:24:44`

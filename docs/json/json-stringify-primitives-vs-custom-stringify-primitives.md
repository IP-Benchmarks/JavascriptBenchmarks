...
```typescript
Custom stringify for primitives: 10252720.329 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 9000166.143 ops/s (100 runs over 1000 unique samples each)
```

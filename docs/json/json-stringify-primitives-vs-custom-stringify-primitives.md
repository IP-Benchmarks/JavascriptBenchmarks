...
```typescript
Custom stringify for primitives: 8775028.795 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6763164.855 ops/s (100 runs over 1000 unique samples each)
```

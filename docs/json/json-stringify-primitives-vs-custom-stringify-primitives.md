...
```typescript
Custom stringify for primitives: 8182167.119 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4728980.697 ops/s (100 runs over 1000 unique samples each)
```

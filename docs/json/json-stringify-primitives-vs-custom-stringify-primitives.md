...
```typescript
Custom stringify for primitives: 10427238.366 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5935980.686 ops/s (100 runs over 1000 unique samples each)
```

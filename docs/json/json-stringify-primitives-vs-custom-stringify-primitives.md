...
```typescript
Custom stringify for primitives: 5152324.613 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3834349.654 ops/s (100 runs over 1000 unique samples each)
```

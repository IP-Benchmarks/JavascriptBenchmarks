...
```typescript
Custom stringify for primitives: 8138085.073 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6063729.062 ops/s (100 runs over 1000 unique samples each)
```

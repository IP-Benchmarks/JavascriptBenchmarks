...
```typescript
Custom stringify for primitives: 9486158.509 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6821368.948 ops/s (100 runs over 1000 unique samples each)
```

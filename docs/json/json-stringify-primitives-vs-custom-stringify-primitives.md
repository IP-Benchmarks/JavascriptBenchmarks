...
```typescript
Custom stringify for primitives: 9930839.646 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6807495.134 ops/s (100 runs over 1000 unique samples each)
```

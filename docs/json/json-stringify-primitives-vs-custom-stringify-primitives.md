...
```typescript
Custom stringify for primitives: 10273294.284 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5368420.182 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10574297.499 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7429333.296 ops/s (100 runs over 1000 unique samples each)
```

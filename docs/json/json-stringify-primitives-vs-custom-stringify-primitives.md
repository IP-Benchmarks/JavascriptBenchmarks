...
```typescript
Custom stringify for primitives: 3893971.517 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3095873.730 ops/s (100 runs over 1000 unique samples each)
```

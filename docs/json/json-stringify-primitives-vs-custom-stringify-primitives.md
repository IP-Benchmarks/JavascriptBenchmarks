...
```typescript
Custom stringify for primitives: 9113322.066 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5140781.853 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5399411.766 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4055006.488 ops/s (100 runs over 1000 unique samples each)
```

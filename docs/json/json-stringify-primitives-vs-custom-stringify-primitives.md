...
```typescript
Custom stringify for primitives: 4165475.514 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3286340.094 ops/s (100 runs over 1000 unique samples each)
```

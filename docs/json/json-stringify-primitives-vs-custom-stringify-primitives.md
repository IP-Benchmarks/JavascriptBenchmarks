...
```typescript
Custom stringify for primitives: 4337506.969 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3518906.133 ops/s (100 runs over 1000 unique samples each)
```

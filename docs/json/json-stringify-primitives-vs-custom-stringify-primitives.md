...
```typescript
Custom stringify for primitives: 5795438.747 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4308286.506 ops/s (100 runs over 1000 unique samples each)
```

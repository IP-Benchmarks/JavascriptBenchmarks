...
```typescript
Custom stringify for primitives: 5240022.369 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4463536.876 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8362035.319 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5798930.549 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6137544.458 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4398701.661 ops/s (100 runs over 1000 unique samples each)
```

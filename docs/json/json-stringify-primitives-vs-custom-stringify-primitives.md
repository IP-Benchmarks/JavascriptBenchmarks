...
```typescript
Custom stringify for primitives: 9855825.049 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5545329.967 ops/s (100 runs over 1000 unique samples each)
```

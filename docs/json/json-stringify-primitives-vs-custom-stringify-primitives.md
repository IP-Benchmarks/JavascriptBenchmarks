...
```typescript
Custom stringify for primitives: 8872664.925 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5040542.596 ops/s (100 runs over 1000 unique samples each)
```

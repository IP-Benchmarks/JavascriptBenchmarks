...
```typescript
Custom stringify for primitives: 10614050.413 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5791594.566 ops/s (100 runs over 1000 unique samples each)
```

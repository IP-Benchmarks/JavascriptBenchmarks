...
```typescript
Custom stringify for primitives: 10552940.302 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6712070.693 ops/s (100 runs over 1000 unique samples each)
```

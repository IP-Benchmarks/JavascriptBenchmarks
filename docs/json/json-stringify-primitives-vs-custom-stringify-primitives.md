...
```typescript
Custom stringify for primitives: 6069934.262 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4292311.753 ops/s (100 runs over 1000 unique samples each)
```

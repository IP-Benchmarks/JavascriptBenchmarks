...
```typescript
Custom stringify for primitives: 8340447.036 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6151683.410 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/22/2024 0:55:42`

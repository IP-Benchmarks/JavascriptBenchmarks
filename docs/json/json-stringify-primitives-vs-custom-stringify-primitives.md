...
```typescript
Custom stringify for primitives: 5667318.220 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4271401.431 ops/s (100 runs over 1000 unique samples each)
```

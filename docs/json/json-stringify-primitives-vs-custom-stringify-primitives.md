...
```typescript
Custom stringify for primitives: 5985508.964 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4415413.006 ops/s (100 runs over 1000 unique samples each)
```

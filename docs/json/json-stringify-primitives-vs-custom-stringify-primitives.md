...
```typescript
Custom stringify for primitives: 10662623.400 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6763020.319 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5105983.365 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3527698.592 ops/s (100 runs over 1000 unique samples each)
```

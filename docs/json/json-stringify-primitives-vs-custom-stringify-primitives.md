...
```typescript
Custom stringify for primitives: 4276308.363 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3010613.526 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10157767.396 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6600078.039 ops/s (100 runs over 1000 unique samples each)
```

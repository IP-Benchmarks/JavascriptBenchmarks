...
```typescript
Custom stringify for primitives: 5632579.515 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4302994.311 ops/s (100 runs over 1000 unique samples each)
```

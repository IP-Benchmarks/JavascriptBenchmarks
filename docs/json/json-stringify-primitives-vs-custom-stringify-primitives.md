...
```typescript
Custom stringify for primitives: 8645689.867 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5810932.811 ops/s (100 runs over 1000 unique samples each)
```

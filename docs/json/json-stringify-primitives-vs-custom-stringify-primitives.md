...
```typescript
Custom stringify for primitives: 4376195.632 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3633727.664 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9433008.284 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5733362.742 ops/s (100 runs over 1000 unique samples each)
```

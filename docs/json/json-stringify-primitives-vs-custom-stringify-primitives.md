...
#### **Custom stringify for primitives** is **_`1.84x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 7986233.653 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4336718.243 ops/s (100 runs over 1000 unique samples each)
```

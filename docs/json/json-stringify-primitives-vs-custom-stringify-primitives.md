...
```typescript
Custom stringify for primitives: 8643684.842 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6115382.840 ops/s (100 runs over 1000 unique samples each)
```

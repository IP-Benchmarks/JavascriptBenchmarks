...
```typescript
Custom stringify for primitives: 10465309.644 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5825600.625 ops/s (100 runs over 1000 unique samples each)
```

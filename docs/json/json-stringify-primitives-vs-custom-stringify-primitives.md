...
```typescript
Custom stringify for primitives: 6232557.023 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4053981.355 ops/s (100 runs over 1000 unique samples each)
```

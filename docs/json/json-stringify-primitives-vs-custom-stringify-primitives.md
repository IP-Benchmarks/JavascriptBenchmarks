...
```typescript
Custom stringify for primitives: 5311254.943 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4147923.411 ops/s (100 runs over 1000 unique samples each)
```

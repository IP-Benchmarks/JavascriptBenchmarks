...
```typescript
Custom stringify for primitives: 5216516.472 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4382019.749 ops/s (100 runs over 1000 unique samples each)
```

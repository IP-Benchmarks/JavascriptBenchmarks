...
```typescript
Custom stringify for primitives: 8245171.833 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6124201.251 ops/s (100 runs over 1000 unique samples each)
```

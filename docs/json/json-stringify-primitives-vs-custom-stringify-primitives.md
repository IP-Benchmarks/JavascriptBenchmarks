...
```typescript
Custom stringify for primitives: 11056600.840 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7879868.567 ops/s (100 runs over 1000 unique samples each)
```

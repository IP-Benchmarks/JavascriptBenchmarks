...
```typescript
Custom stringify for primitives: 10286981.054 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5941066.757 ops/s (100 runs over 1000 unique samples each)
```

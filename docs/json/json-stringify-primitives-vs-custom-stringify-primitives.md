...
```typescript
Custom stringify for primitives: 10534107.703 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6887436.084 ops/s (100 runs over 1000 unique samples each)
```

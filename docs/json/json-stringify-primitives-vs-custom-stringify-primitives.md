...
```typescript
Custom stringify for primitives: 10765793.500 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6833100.029 ops/s (100 runs over 1000 unique samples each)
```

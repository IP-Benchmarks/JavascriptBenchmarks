...
```typescript
Custom stringify for primitives: 9078165.822 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7633260.314 ops/s (100 runs over 1000 unique samples each)
```

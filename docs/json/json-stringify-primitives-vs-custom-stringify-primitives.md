...
```typescript
Custom stringify for primitives: 10426201.210 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6736717.299 ops/s (100 runs over 1000 unique samples each)
```

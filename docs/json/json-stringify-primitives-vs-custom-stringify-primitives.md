...
```typescript
Custom stringify for primitives: 8482377.904 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5455305.529 ops/s (100 runs over 1000 unique samples each)
```

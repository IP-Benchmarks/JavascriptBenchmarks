...
```typescript
Custom stringify for primitives: 8927654.753 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6126072.240 ops/s (100 runs over 1000 unique samples each)
```

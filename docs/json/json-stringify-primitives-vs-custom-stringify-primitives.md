...
```typescript
Custom stringify for primitives: 10088472.881 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5747853.507 ops/s (100 runs over 1000 unique samples each)
```

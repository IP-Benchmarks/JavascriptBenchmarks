...
```typescript
Custom stringify for primitives: 5448507.519 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4508495.946 ops/s (100 runs over 1000 unique samples each)
```

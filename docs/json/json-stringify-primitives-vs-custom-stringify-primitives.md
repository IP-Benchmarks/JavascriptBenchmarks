...
```typescript
Custom stringify for primitives: 5191840.047 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3807999.739 ops/s (100 runs over 1000 unique samples each)
```

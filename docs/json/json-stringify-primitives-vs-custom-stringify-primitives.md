...
```typescript
Custom stringify for primitives: 4850259.867 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3026804.411 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4411532.064 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3640589.500 ops/s (100 runs over 1000 unique samples each)
```

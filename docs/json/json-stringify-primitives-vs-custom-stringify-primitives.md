...
```typescript
Custom stringify for primitives: 9006762.998 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5428206.219 ops/s (100 runs over 1000 unique samples each)
```

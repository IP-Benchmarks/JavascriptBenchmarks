...
```typescript
Custom stringify for primitives: 10661961.756 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6700523.519 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5718269.551 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3911198.124 ops/s (100 runs over 1000 unique samples each)
```

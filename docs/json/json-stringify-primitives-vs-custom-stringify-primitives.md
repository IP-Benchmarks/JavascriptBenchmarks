...
```typescript
Custom stringify for primitives: 10150284.091 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5670988.849 ops/s (100 runs over 1000 unique samples each)
```

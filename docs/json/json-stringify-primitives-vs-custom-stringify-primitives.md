...
```typescript
Custom stringify for primitives: 4701787.041 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3950471.673 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5367783.338 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4344089.038 ops/s (100 runs over 1000 unique samples each)
```

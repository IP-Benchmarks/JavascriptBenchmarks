...
```typescript
Custom stringify for primitives: 4327468.546 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3463175.757 ops/s (100 runs over 1000 unique samples each)
```

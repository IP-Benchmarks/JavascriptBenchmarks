...
```typescript
Custom stringify for primitives: 6329703.224 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4891843.540 ops/s (100 runs over 1000 unique samples each)
```

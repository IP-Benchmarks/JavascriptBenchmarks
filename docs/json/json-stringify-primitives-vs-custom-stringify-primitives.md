...
```typescript
Custom stringify for primitives: 8032133.027 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4717103.285 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5668234.386 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4215164.239 ops/s (100 runs over 1000 unique samples each)
```

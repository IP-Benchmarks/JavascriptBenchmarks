...
```typescript
Custom stringify for primitives: 6408013.197 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4416417.661 ops/s (100 runs over 1000 unique samples each)
```

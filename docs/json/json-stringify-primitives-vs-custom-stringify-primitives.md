...
```typescript
Custom stringify for primitives: 5602065.146 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4180297.397 ops/s (100 runs over 1000 unique samples each)
```

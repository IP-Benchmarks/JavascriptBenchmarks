...
```typescript
Custom stringify for primitives: 8652137.950 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6418678.046 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9718837.907 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5497729.520 ops/s (100 runs over 1000 unique samples each)
```

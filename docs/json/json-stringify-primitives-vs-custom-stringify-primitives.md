...
```typescript
Custom stringify for primitives: 9161093.058 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7242446.997 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/27/2026 2:33:49`

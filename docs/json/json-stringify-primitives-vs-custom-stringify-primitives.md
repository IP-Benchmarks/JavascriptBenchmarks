...
```typescript
Custom stringify for primitives: 6405668.145 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4231568.883 ops/s (100 runs over 1000 unique samples each)
```

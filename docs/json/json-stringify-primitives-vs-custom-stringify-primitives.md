...
```typescript
Custom stringify for primitives: 8593859.031 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5878552.628 ops/s (100 runs over 1000 unique samples each)
```

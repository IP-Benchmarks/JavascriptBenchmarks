...
```typescript
Custom stringify for primitives: 7449164.667 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4670838.099 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/17/2024 0:56:14`

...
```typescript
Custom stringify for primitives: 9770233.421 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5183030.695 ops/s (100 runs over 1000 unique samples each)
```

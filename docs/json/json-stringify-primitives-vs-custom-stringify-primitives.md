...
```typescript
Custom stringify for primitives: 10149916.294 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6521606.146 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7976401.969 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5998013.699 ops/s (100 runs over 1000 unique samples each)
```

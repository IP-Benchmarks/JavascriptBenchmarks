...
```typescript
Custom stringify for primitives: 9703044.156 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6299471.323 ops/s (100 runs over 1000 unique samples each)
```

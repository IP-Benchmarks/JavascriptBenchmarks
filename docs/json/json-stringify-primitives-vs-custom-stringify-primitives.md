...
```typescript
Custom stringify for primitives: 5646970.280 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3937666.426 ops/s (100 runs over 1000 unique samples each)
```

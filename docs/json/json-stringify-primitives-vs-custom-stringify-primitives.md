...
```typescript
Custom stringify for primitives: 10603609.405 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6793140.911 ops/s (100 runs over 1000 unique samples each)
```

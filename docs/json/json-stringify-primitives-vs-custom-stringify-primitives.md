...
```typescript
Custom stringify for primitives: 9127558.731 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4911262.089 ops/s (100 runs over 1000 unique samples each)
```

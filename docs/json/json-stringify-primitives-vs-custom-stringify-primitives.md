...
```typescript
Custom stringify for primitives: 4691661.648 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3473525.759 ops/s (100 runs over 1000 unique samples each)
```

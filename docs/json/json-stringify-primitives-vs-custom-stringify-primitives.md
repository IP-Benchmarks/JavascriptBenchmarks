...
```typescript
Custom stringify for primitives: 6273850.829 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4448371.863 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/23/2022 0:44:15`

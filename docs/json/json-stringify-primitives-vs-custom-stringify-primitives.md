...
```typescript
Custom stringify for primitives: 8847098.342 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6159250.754 ops/s (100 runs over 1000 unique samples each)
```

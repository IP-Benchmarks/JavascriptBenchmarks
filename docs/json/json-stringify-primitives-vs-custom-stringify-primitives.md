...
```typescript
Custom stringify for primitives: 5393816.281 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4235782.100 ops/s (100 runs over 1000 unique samples each)
```

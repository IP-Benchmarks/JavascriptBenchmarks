...
```typescript
Custom stringify for primitives: 8994460.676 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4509445.598 ops/s (100 runs over 1000 unique samples each)
```

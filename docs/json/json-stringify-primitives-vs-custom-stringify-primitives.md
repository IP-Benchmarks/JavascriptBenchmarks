...
```typescript
Custom stringify for primitives: 5613981.509 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4526000.970 ops/s (100 runs over 1000 unique samples each)
```

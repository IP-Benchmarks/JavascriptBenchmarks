...
```typescript
Custom stringify for primitives: 9205581.344 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6715166.284 ops/s (100 runs over 1000 unique samples each)
```

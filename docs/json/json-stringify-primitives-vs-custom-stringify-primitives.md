...
```typescript
Custom stringify for primitives: 10173980.148 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6808073.531 ops/s (100 runs over 1000 unique samples each)
```

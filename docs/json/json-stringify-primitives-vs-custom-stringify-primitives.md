...
```typescript
Custom stringify for primitives: 5922715.901 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4179182.796 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/2/2022 1:3:28`

...
```typescript
Custom stringify for primitives: 5701864.773 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4324429.234 ops/s (100 runs over 1000 unique samples each)
```

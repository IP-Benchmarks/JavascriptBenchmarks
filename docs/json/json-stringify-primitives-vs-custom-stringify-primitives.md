...
```typescript
Custom stringify for primitives: 7584131.145 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5961505.958 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8377287.563 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4545221.292 ops/s (100 runs over 1000 unique samples each)
```

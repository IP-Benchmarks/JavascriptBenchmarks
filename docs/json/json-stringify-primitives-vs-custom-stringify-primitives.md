...
```typescript
Custom stringify for primitives: 11567596.755 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6418589.467 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5303125.879 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4462360.723 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4364744.787 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3356125.002 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4956199.094 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3649354.276 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7947831.704 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5778260.969 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9029780.756 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5949643.054 ops/s (100 runs over 1000 unique samples each)
```

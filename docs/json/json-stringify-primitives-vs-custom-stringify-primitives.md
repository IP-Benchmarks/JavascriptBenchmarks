...
```typescript
Custom stringify for primitives: 4443172.710 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3119588.392 ops/s (100 runs over 1000 unique samples each)
```

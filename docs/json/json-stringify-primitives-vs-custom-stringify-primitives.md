...
```typescript
Custom stringify for primitives: 8370030.328 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5973814.859 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/14/2023 0:54:47`

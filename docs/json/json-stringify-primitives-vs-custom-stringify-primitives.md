...
```typescript
Custom stringify for primitives: 10252975.772 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6776755.052 ops/s (100 runs over 1000 unique samples each)
```

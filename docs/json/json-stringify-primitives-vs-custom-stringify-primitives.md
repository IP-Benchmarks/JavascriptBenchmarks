...
```typescript
Custom stringify for primitives: 5959309.708 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4047593.221 ops/s (100 runs over 1000 unique samples each)
```

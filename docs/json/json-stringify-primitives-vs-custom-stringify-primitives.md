...
```typescript
Custom stringify for primitives: 6354173.498 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4879811.225 ops/s (100 runs over 1000 unique samples each)
```

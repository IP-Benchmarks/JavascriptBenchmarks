...
```typescript
Custom stringify for primitives: 8781827.097 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6197832.458 ops/s (100 runs over 1000 unique samples each)
```

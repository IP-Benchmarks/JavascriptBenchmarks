...
```typescript
Custom stringify for primitives: 4473433.285 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3640388.185 ops/s (100 runs over 1000 unique samples each)
```

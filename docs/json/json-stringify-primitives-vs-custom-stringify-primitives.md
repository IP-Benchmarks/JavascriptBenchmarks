...
```typescript
Custom stringify for primitives: 9923291.961 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6909597.521 ops/s (100 runs over 1000 unique samples each)
```

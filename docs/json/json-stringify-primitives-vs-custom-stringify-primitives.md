...
```typescript
Custom stringify for primitives: 9810210.683 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6219001.774 ops/s (100 runs over 1000 unique samples each)
```

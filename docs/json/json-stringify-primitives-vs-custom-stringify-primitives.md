...
```typescript
Custom stringify for primitives: 8215446.472 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5912990.232 ops/s (100 runs over 1000 unique samples each)
```

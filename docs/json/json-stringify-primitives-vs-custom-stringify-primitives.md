...
```typescript
Custom stringify for primitives: 8702687.729 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4755608.112 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/21/2024 1:5:2`

...
```typescript
Custom stringify for primitives: 10518412.586 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6655246.707 ops/s (100 runs over 1000 unique samples each)
```

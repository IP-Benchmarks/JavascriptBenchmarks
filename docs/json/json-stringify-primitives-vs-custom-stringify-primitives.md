...
```typescript
Custom stringify for primitives: 5751649.083 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4372774.286 ops/s (100 runs over 1000 unique samples each)
```

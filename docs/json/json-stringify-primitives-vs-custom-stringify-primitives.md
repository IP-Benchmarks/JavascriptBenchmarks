...
```typescript
Custom stringify for primitives: 9948962.816 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6900044.574 ops/s (100 runs over 1000 unique samples each)
```

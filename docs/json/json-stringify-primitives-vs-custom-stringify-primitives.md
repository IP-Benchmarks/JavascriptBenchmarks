...
```typescript
Custom stringify for primitives: 10164610.789 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5236858.118 ops/s (100 runs over 1000 unique samples each)
```

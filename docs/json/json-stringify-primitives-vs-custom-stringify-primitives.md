...
```typescript
Custom stringify for primitives: 9128728.584 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5847425.238 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10310203.080 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6602641.294 ops/s (100 runs over 1000 unique samples each)
```

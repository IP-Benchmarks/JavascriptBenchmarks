...
```typescript
Custom stringify for primitives: 8912926.062 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4928253.013 ops/s (100 runs over 1000 unique samples each)
```

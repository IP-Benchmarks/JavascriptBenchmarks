...
```typescript
Custom stringify for primitives: 5603457.961 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4281134.757 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10606517.811 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6609128.039 ops/s (100 runs over 1000 unique samples each)
```

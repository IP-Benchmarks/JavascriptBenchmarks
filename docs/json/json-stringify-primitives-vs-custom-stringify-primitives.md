...
```typescript
Custom stringify for primitives: 5193321.658 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4167097.440 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9514528.781 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5358587.858 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4031530.926 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3119458.088 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4651692.002 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3609057.377 ops/s (100 runs over 1000 unique samples each)
```

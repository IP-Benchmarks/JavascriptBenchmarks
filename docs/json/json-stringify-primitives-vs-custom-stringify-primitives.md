...
```typescript
Custom stringify for primitives: 4798751.403 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3574275.610 ops/s (100 runs over 1000 unique samples each)
```

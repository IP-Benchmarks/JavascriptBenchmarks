...
```typescript
Custom stringify for primitives: 8444213.600 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5830615.490 ops/s (100 runs over 1000 unique samples each)
```

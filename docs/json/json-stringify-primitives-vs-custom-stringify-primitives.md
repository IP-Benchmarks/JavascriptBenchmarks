...
```typescript
Custom stringify for primitives: 7166067.009 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5549968.280 ops/s (100 runs over 1000 unique samples each)
```

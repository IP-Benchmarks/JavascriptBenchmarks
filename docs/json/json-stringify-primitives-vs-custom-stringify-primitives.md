...
```typescript
Custom stringify for primitives: 6242042.565 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4463914.652 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/30/2022 1:13:0`

...
```typescript
Custom stringify for primitives: 8750504.904 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6100498.513 ops/s (100 runs over 1000 unique samples each)
```

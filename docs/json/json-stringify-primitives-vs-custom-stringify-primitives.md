...
```typescript
Custom stringify for primitives: 5707040.707 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4277984.274 ops/s (100 runs over 1000 unique samples each)
```

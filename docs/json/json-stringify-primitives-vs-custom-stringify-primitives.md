...
```typescript
Custom stringify for primitives: 6006483.639 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4220868.421 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9783500.908 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5815811.505 ops/s (100 runs over 1000 unique samples each)
```

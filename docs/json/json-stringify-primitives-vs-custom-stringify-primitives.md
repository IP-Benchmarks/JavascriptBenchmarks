...
```typescript
Custom stringify for primitives: 9569382.569 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5453582.352 ops/s (100 runs over 1000 unique samples each)
```

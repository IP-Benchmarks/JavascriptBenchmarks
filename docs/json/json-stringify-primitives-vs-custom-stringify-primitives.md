...
```typescript
Custom stringify for primitives: 10322863.025 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6832093.980 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/19/2025 1:24:10`

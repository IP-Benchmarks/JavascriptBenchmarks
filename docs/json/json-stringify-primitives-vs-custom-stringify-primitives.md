...
```typescript
Custom stringify for primitives: 5293176.895 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4086922.132 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6186109.858 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4205460.993 ops/s (100 runs over 1000 unique samples each)
```

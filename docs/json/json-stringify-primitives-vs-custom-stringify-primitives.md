...
```typescript
Custom stringify for primitives: 5264752.560 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3563988.491 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8395726.167 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5659852.166 ops/s (100 runs over 1000 unique samples each)
```

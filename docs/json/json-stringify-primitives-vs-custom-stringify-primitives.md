...
```typescript
Custom stringify for primitives: 5590376.771 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4677857.036 ops/s (100 runs over 1000 unique samples each)
```

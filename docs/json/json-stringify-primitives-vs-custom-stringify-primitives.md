...
```typescript
Custom stringify for primitives: 5416889.504 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4348542.273 ops/s (100 runs over 1000 unique samples each)
```

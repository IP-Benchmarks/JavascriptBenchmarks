...
#### **Custom stringify for primitives** is **_`1.25x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5585603.621 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4481160.685 ops/s (100 runs over 1000 unique samples each)
```

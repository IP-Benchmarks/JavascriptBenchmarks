...
```typescript
Custom stringify for primitives: 8428273.623 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6150309.253 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9883789.370 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4999408.320 ops/s (100 runs over 1000 unique samples each)
```

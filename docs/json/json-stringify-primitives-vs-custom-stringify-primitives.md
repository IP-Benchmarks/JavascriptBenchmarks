...
```typescript
Custom stringify for primitives: 7192983.506 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4273813.120 ops/s (100 runs over 1000 unique samples each)
```

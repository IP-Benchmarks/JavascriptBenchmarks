...
```typescript
Custom stringify for primitives: 10313718.566 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5840088.223 ops/s (100 runs over 1000 unique samples each)
```

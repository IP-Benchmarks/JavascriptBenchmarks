...
```typescript
Custom stringify for primitives: 10642028.243 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6597406.217 ops/s (100 runs over 1000 unique samples each)
```

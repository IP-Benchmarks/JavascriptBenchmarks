...
```typescript
Custom stringify for primitives: 6311167.440 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4760268.815 ops/s (100 runs over 1000 unique samples each)
```

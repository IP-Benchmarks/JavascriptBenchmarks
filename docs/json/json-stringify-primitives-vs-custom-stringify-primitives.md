...
```typescript
Custom stringify for primitives: 10235392.534 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6949806.896 ops/s (100 runs over 1000 unique samples each)
```

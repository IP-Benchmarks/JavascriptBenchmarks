...
```typescript
Custom stringify for primitives: 9677798.974 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6680394.878 ops/s (100 runs over 1000 unique samples each)
```

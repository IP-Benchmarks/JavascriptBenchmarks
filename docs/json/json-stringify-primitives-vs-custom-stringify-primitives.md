...
```typescript
Custom stringify for primitives: 5281550.199 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3256982.074 ops/s (100 runs over 1000 unique samples each)
```

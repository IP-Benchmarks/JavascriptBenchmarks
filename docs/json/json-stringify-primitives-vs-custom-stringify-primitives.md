...
```typescript
Custom stringify for primitives: 7671925.747 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4403250.762 ops/s (100 runs over 1000 unique samples each)
```

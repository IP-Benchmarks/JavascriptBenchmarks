...
```typescript
Custom stringify for primitives: 10084339.364 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5084580.988 ops/s (100 runs over 1000 unique samples each)
```

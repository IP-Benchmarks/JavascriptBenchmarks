...
```typescript
Custom stringify for primitives: 8786472.980 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4331189.237 ops/s (100 runs over 1000 unique samples each)
```

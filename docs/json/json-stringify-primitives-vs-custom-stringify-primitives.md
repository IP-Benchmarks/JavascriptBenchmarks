...
```typescript
Custom stringify for primitives: 5895655.621 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4367058.422 ops/s (100 runs over 1000 unique samples each)
```

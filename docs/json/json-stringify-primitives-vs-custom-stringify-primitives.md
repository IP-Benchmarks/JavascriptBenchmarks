...
```typescript
Custom stringify for primitives: 9427779.953 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4945556.104 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8289332.864 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5815365.067 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8421471.050 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4425966.525 ops/s (100 runs over 1000 unique samples each)
```

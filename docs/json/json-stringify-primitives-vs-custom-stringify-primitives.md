...
```typescript
Custom stringify for primitives: 8232114.007 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4827306.957 ops/s (100 runs over 1000 unique samples each)
```

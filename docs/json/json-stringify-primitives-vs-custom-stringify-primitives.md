...
```typescript
Custom stringify for primitives: 10319459.508 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6031038.256 ops/s (100 runs over 1000 unique samples each)
```

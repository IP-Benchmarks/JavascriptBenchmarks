...
```typescript
Custom stringify for primitives: 10594503.127 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5002244.507 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10289398.596 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6455315.339 ops/s (100 runs over 1000 unique samples each)
```

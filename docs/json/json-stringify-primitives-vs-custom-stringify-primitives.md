...
```typescript
Custom stringify for primitives: 5529199.093 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4360470.124 ops/s (100 runs over 1000 unique samples each)
```

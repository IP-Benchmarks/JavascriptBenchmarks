...
```typescript
Custom stringify for primitives: 8245749.050 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6275337.459 ops/s (100 runs over 1000 unique samples each)
```

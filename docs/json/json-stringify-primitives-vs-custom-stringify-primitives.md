...
```typescript
Custom stringify for primitives: 5859385.528 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4136327.908 ops/s (100 runs over 1000 unique samples each)
```

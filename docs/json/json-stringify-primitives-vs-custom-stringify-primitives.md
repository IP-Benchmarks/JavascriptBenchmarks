...
```typescript
Custom stringify for primitives: 5913573.479 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3545553.376 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/10/2023 1:5:30`

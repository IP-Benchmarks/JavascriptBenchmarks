...
```typescript
Custom stringify for primitives: 4519906.391 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3473521.415 ops/s (100 runs over 1000 unique samples each)
```

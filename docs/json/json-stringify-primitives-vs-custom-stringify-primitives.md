...
```typescript
Custom stringify for primitives: 4357806.031 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3459231.846 ops/s (100 runs over 1000 unique samples each)
```

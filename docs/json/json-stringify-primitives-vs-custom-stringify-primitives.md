...
```typescript
Custom stringify for primitives: 10247461.857 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5651971.597 ops/s (100 runs over 1000 unique samples each)
```

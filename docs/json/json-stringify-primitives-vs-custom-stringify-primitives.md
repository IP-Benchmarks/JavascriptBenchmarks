...
```typescript
Custom stringify for primitives: 4947401.944 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3521577.373 ops/s (100 runs over 1000 unique samples each)
```

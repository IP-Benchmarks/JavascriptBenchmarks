...
```typescript
Custom stringify for primitives: 10070779.452 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5529488.930 ops/s (100 runs over 1000 unique samples each)
```

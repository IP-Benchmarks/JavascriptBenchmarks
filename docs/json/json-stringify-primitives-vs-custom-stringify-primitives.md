...
```typescript
Custom stringify for primitives: 5313966.124 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4127208.660 ops/s (100 runs over 1000 unique samples each)
```

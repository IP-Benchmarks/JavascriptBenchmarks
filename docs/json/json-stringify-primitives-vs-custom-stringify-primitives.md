...
```typescript
Custom stringify for primitives: 8633694.530 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4596312.323 ops/s (100 runs over 1000 unique samples each)
```

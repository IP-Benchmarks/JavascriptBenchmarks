...
```typescript
Custom stringify for primitives: 8622135.349 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6287089.901 ops/s (100 runs over 1000 unique samples each)
```

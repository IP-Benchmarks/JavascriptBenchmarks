...
```typescript
Custom stringify for primitives: 10450910.818 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6520663.363 ops/s (100 runs over 1000 unique samples each)
```

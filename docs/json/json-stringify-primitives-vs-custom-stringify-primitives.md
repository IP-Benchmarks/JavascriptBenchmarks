...
```typescript
Custom stringify for primitives: 9366439.952 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6577252.860 ops/s (100 runs over 1000 unique samples each)
```

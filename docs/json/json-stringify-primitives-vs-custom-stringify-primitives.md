...
#### **Custom stringify for primitives** is **_`1.43x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10157905.659 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7102704.035 ops/s (100 runs over 1000 unique samples each)
```

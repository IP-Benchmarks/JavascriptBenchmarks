...
```typescript
Custom stringify for primitives: 8676313.055 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6125663.581 ops/s (100 runs over 1000 unique samples each)
```

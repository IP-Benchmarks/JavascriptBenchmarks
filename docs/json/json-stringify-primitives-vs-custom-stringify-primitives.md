...
```typescript
Custom stringify for primitives: 5519783.371 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4131259.193 ops/s (100 runs over 1000 unique samples each)
```

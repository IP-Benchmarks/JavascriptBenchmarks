...
```typescript
Custom stringify for primitives: 8122230.468 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6218818.453 ops/s (100 runs over 1000 unique samples each)
```

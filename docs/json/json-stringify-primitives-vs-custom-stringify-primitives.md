...
```typescript
Custom stringify for primitives: 7809779.380 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4723402.065 ops/s (100 runs over 1000 unique samples each)
```

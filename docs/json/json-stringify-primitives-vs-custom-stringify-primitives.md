...
```typescript
Custom stringify for primitives: 6281368.767 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4582976.835 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8084156.718 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4922349.931 ops/s (100 runs over 1000 unique samples each)
```

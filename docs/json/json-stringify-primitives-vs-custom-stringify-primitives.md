...
#### **Custom stringify for primitives** is **_`1.22x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 4502590.902 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3695700.049 ops/s (100 runs over 1000 unique samples each)
```

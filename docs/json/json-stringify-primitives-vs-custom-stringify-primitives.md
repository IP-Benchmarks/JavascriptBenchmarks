...
```typescript
Custom stringify for primitives: 5571727.495 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3758166.213 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/18/2022 1:13:34`

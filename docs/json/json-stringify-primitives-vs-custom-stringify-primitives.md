...
```typescript
Custom stringify for primitives: 10147737.871 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6749124.774 ops/s (100 runs over 1000 unique samples each)
```

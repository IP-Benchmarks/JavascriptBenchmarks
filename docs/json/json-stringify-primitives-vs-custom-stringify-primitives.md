...
```typescript
Custom stringify for primitives: 9929759.858 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6751322.398 ops/s (100 runs over 1000 unique samples each)
```

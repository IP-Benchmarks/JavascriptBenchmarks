...
```typescript
Custom stringify for primitives: 10285583.336 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6514246.331 ops/s (100 runs over 1000 unique samples each)
```

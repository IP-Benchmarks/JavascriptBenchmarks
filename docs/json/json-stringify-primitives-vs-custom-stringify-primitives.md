...
```typescript
Custom stringify for primitives: 5266410.320 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4265964.820 ops/s (100 runs over 1000 unique samples each)
```

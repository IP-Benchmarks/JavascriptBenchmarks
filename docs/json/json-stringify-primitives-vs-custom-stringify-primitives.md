...
```typescript
Custom stringify for primitives: 5973171.500 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4344760.953 ops/s (100 runs over 1000 unique samples each)
```

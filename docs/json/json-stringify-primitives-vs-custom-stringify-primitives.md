...
```typescript
Custom stringify for primitives: 10048982.762 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6426944.631 ops/s (100 runs over 1000 unique samples each)
```

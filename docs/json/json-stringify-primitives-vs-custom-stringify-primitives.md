...
```typescript
Custom stringify for primitives: 6613492.427 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4603132.634 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9824854.287 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5488773.044 ops/s (100 runs over 1000 unique samples each)
```

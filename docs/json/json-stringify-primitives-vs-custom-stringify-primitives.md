...
```typescript
Custom stringify for primitives: 10104959.201 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5894313.544 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8475456.856 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4619523.994 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/17/2023 0:55:0`

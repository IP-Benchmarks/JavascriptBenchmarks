...
```typescript
Custom stringify for primitives: 9635911.887 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5590656.180 ops/s (100 runs over 1000 unique samples each)
```

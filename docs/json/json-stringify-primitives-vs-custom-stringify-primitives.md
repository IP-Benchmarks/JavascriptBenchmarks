...
```typescript
Custom stringify for primitives: 6035007.023 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4060322.752 ops/s (100 runs over 1000 unique samples each)
```

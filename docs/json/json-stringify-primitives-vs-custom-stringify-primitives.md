...
```typescript
Custom stringify for primitives: 6376584.367 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4439169.724 ops/s (100 runs over 1000 unique samples each)
```

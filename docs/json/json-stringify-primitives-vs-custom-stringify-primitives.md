...
```typescript
Custom stringify for primitives: 8546649.148 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6011218.256 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/8/2024 0:51:28`

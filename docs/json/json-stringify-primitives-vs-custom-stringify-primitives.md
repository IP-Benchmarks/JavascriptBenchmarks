...
```typescript
Custom stringify for primitives: 10633352.232 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5365911.427 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10629344.346 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5724688.618 ops/s (100 runs over 1000 unique samples each)
```

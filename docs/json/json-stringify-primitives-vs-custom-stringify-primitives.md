...
```typescript
Custom stringify for primitives: 8739686.517 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6344621.707 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8061926.566 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5608096.880 ops/s (100 runs over 1000 unique samples each)
```

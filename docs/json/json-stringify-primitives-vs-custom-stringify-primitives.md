...
```typescript
Custom stringify for primitives: 5634238.955 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3260861.236 ops/s (100 runs over 1000 unique samples each)
```

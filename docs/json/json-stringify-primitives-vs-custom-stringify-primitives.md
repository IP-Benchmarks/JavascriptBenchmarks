...
```typescript
Custom stringify for primitives: 5485694.324 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4446719.584 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6129245.064 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4361776.946 ops/s (100 runs over 1000 unique samples each)
```

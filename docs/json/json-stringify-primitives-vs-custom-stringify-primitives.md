...
```typescript
Custom stringify for primitives: 4162311.675 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3209458.505 ops/s (100 runs over 1000 unique samples each)
```

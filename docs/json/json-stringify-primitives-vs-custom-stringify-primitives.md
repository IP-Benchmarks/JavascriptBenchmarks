...
```typescript
Custom stringify for primitives: 5616627.961 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4387181.778 ops/s (100 runs over 1000 unique samples each)
```

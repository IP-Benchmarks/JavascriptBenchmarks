...
```typescript
Custom stringify for primitives: 4877000.583 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2541099.295 ops/s (100 runs over 1000 unique samples each)
```

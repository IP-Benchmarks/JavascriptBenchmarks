...
```typescript
Custom stringify for primitives: 5832887.652 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4332278.293 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9383637.638 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5214122.911 ops/s (100 runs over 1000 unique samples each)
```

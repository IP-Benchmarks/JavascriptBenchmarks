...
```typescript
Custom stringify for primitives: 9982627.234 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5760145.027 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 13488375.920 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7935835.910 ops/s (100 runs over 1000 unique samples each)
```

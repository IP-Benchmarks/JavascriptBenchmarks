...
```typescript
Custom stringify for primitives: 4427935.330 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3339858.527 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5732304.148 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4334078.390 ops/s (100 runs over 1000 unique samples each)
```

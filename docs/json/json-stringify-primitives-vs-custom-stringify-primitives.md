...
```typescript
Custom stringify for primitives: 4358738.853 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3345352.069 ops/s (100 runs over 1000 unique samples each)
```

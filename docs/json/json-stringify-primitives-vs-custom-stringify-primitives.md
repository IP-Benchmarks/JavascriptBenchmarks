...
```typescript
Custom stringify for primitives: 8491979.793 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6015768.896 ops/s (100 runs over 1000 unique samples each)
```

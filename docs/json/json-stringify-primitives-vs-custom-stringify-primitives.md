...
```typescript
Custom stringify for primitives: 5929606.674 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4562954.097 ops/s (100 runs over 1000 unique samples each)
```

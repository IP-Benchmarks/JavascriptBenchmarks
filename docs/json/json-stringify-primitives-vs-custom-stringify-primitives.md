...
```typescript
Custom stringify for primitives: 9935834.382 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5324008.793 ops/s (100 runs over 1000 unique samples each)
```

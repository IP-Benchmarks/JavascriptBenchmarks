...
```typescript
Custom stringify for primitives: 8721851.858 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5836328.342 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/28/2024 1:14:20`

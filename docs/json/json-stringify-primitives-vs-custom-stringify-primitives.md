...
```typescript
Custom stringify for primitives: 3667878.717 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3278202.169 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/23/2023 1:0:50`

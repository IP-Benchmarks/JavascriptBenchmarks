...
```typescript
Custom stringify for primitives: 4427886.315 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3068757.350 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7365276.390 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5815784.107 ops/s (100 runs over 1000 unique samples each)
```

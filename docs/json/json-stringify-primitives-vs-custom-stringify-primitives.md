...
```typescript
Custom stringify for primitives: 9910253.733 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5627900.338 ops/s (100 runs over 1000 unique samples each)
```

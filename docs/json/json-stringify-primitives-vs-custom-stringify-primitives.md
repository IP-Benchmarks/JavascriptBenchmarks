...
```typescript
Custom stringify for primitives: 4617799.512 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3561677.335 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10001328.176 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6895240.202 ops/s (100 runs over 1000 unique samples each)
```

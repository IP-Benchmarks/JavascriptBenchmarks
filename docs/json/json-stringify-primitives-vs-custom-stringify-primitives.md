...
```typescript
Custom stringify for primitives: 4484657.471 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3739454.971 ops/s (100 runs over 1000 unique samples each)
```

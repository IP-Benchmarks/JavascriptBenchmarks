...
```typescript
Custom stringify for primitives: 5045290.819 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4498226.439 ops/s (100 runs over 1000 unique samples each)
```

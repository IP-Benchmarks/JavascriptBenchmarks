...
```typescript
Custom stringify for primitives: 9877814.399 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6088025.050 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8498396.988 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6138163.429 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/21/2024 0:53:41`

...
```typescript
Custom stringify for primitives: 10395652.289 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6917394.550 ops/s (100 runs over 1000 unique samples each)
```

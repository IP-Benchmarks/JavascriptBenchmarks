...
```typescript
Custom stringify for primitives: 5866575.649 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4360853.663 ops/s (100 runs over 1000 unique samples each)
```

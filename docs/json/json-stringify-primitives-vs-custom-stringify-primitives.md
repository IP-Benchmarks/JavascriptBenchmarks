...
```typescript
Custom stringify for primitives: 5042066.719 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4305492.241 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10549737.317 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5257689.344 ops/s (100 runs over 1000 unique samples each)
```

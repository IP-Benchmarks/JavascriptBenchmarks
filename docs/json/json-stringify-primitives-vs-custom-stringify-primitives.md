...
```typescript
Custom stringify for primitives: 10466325.018 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5249393.433 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/21/2025 1:20:1`

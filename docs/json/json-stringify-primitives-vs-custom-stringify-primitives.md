...
```typescript
Custom stringify for primitives: 9882276.394 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5210552.160 ops/s (100 runs over 1000 unique samples each)
```

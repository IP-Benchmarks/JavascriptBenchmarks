...
```typescript
Custom stringify for primitives: 8392229.299 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5727620.925 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8958919.769 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5841410.494 ops/s (100 runs over 1000 unique samples each)
```

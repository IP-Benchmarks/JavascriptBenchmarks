...
```typescript
Custom stringify for primitives: 8643220.894 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5943586.920 ops/s (100 runs over 1000 unique samples each)
```

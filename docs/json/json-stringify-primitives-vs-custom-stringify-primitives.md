...
```typescript
Custom stringify for primitives: 7813100.025 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4465515.126 ops/s (100 runs over 1000 unique samples each)
```

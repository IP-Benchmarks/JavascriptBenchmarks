...
```typescript
Custom stringify for primitives: 5710223.625 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4114976.390 ops/s (100 runs over 1000 unique samples each)
```

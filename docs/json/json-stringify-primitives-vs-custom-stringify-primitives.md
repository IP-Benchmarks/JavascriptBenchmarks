...
```typescript
Custom stringify for primitives: 8607805.402 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4601664.505 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/24/2024 1:1:25`

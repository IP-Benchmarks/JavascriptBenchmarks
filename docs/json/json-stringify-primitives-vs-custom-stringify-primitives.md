...
```typescript
Custom stringify for primitives: 10043890.798 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6902464.042 ops/s (100 runs over 1000 unique samples each)
```

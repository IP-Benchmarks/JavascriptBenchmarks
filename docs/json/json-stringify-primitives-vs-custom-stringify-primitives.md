...
```typescript
Custom stringify for primitives: 9839697.551 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5253017.911 ops/s (100 runs over 1000 unique samples each)
```

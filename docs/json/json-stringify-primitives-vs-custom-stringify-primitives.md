...
```typescript
Custom stringify for primitives: 4222730.630 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3649011.108 ops/s (100 runs over 1000 unique samples each)
```

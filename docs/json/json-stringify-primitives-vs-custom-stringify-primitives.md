...
```typescript
Custom stringify for primitives: 8401360.550 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4903241.155 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/29/2024 0:59:58`

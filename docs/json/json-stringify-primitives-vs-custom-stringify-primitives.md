...
```typescript
Custom stringify for primitives: 8740098.999 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4779127.828 ops/s (100 runs over 1000 unique samples each)
```

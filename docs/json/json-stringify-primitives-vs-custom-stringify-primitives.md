...
```typescript
Custom stringify for primitives: 7481926.845 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6268124.282 ops/s (100 runs over 1000 unique samples each)
```

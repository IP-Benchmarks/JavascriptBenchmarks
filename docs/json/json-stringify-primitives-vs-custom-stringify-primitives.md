...
```typescript
Custom stringify for primitives: 8420074.130 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5979010.324 ops/s (100 runs over 1000 unique samples each)
```

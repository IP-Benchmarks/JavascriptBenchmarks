...
```typescript
Custom stringify for primitives: 8490427.466 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5122508.111 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/10/2024 0:56:12`

...
```typescript
Custom stringify for primitives: 8391515.201 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5451313.718 ops/s (100 runs over 1000 unique samples each)
```

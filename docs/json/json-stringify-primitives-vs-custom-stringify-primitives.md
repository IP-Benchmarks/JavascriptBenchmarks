...
```typescript
Custom stringify for primitives: 4217217.752 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3569631.899 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/26/2023 0:59:38`

...
```typescript
Custom stringify for primitives: 8476687.541 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6267337.021 ops/s (100 runs over 1000 unique samples each)
```

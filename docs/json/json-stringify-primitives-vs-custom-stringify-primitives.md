...
```typescript
Custom stringify for primitives: 8334539.051 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4515410.035 ops/s (100 runs over 1000 unique samples each)
```

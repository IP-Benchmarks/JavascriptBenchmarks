...
```typescript
Custom stringify for primitives: 4606497.547 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3746672.205 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/5/2023 1:16:36`

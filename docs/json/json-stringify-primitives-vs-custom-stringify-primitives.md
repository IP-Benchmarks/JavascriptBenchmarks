...
```typescript
Custom stringify for primitives: 8040706.562 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5010753.076 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8927549.549 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4439218.006 ops/s (100 runs over 1000 unique samples each)
```

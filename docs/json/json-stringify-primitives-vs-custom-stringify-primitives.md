...
```typescript
Custom stringify for primitives: 10423742.868 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5599768.528 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/13/2026 1:43:49`

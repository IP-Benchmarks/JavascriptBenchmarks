...
```typescript
Custom stringify for primitives: 5704047.763 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4194677.147 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/31/2022 0:43:43`

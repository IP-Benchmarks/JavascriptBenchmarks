...
```typescript
Custom stringify for primitives: 10179842.182 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7008090.069 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 11850406.629 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 8969263.858 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5729117.909 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4215976.019 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/14/2022 0:49:33`

...
```typescript
Custom stringify for primitives: 10189905.187 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6682861.914 ops/s (100 runs over 1000 unique samples each)
```

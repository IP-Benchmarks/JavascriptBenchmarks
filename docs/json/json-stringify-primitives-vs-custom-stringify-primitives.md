...
```typescript
Custom stringify for primitives: 5261653.063 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4215498.831 ops/s (100 runs over 1000 unique samples each)
```

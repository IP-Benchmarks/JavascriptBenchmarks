...
```typescript
Custom stringify for primitives: 9591836.656 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6980133.771 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7933660.006 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6292811.174 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5222184.906 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4206272.402 ops/s (100 runs over 1000 unique samples each)
```

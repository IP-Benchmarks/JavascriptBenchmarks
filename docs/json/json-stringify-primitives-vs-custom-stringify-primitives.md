...
#### **Custom stringify for primitives** is **_`1.53x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5449284.220 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3567582.590 ops/s (100 runs over 1000 unique samples each)
```

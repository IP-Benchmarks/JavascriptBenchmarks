...
```typescript
Custom stringify for primitives: 5949356.342 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4171668.671 ops/s (100 runs over 1000 unique samples each)
```

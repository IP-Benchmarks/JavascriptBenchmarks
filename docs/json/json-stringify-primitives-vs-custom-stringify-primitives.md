...
```typescript
Custom stringify for primitives: 4751907.879 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3788960.364 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/24/2023 0:52:1`

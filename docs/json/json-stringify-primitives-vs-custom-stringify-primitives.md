...
```typescript
Custom stringify for primitives: 6156798.386 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4159258.161 ops/s (100 runs over 1000 unique samples each)
```

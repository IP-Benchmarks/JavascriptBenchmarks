...
#### **Custom stringify for primitives** is **_`1.81x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10586243.959 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5839385.711 ops/s (100 runs over 1000 unique samples each)
```

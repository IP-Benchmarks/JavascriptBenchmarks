...
```typescript
Custom stringify for primitives: 5328455.594 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4447946.857 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6246095.410 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4774410.078 ops/s (100 runs over 1000 unique samples each)
```

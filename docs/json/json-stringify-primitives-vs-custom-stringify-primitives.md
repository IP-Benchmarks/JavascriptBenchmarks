...
```typescript
Custom stringify for primitives: 10449842.740 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6693808.274 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/11/2025 1:15:42`

...
```typescript
Custom stringify for primitives: 5423532.610 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4180639.584 ops/s (100 runs over 1000 unique samples each)
```

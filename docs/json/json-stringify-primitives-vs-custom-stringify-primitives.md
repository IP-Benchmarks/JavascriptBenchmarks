...
```typescript
Custom stringify for primitives: 9544624.076 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5248910.694 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5333075.639 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4321080.477 ops/s (100 runs over 1000 unique samples each)
```

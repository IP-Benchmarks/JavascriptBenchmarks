...
```typescript
Custom stringify for primitives: 5447833.722 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4230076.930 ops/s (100 runs over 1000 unique samples each)
```

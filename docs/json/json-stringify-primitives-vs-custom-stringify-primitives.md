...
```typescript
Custom stringify for primitives: 10467126.941 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5606170.241 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4637135.779 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3461490.400 ops/s (100 runs over 1000 unique samples each)
```

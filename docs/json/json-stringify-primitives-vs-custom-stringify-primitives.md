...
```typescript
Custom stringify for primitives: 6343359.584 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4433966.096 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.20x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 3628437.151 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3031516.740 ops/s (100 runs over 1000 unique samples each)
```

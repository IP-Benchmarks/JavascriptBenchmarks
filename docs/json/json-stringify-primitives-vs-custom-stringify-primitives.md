...
```typescript
Custom stringify for primitives: 8532422.485 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5950456.264 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/7/2024 1:8:7`

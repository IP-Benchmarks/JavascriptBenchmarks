...
```typescript
Custom stringify for primitives: 9572529.139 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4570258.585 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9130535.615 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5238459.660 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9619918.927 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5186951.208 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/10/2025 1:1:44`

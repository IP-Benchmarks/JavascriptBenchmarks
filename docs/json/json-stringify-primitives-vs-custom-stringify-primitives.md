...
```typescript
Custom stringify for primitives: 5782832.436 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4398747.132 ops/s (100 runs over 1000 unique samples each)
```

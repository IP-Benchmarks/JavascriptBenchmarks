...
```typescript
Custom stringify for primitives: 9565575.560 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6660018.192 ops/s (100 runs over 1000 unique samples each)
```

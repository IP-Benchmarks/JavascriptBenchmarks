...
```typescript
Custom stringify for primitives: 9935899.538 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7291260.331 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9633644.076 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5174793.931 ops/s (100 runs over 1000 unique samples each)
```

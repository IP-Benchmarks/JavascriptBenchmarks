...
```typescript
Custom stringify for primitives: 8927037.891 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6279825.245 ops/s (100 runs over 1000 unique samples each)
```

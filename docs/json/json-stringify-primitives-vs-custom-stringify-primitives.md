...
```typescript
Custom stringify for primitives: 8474195.651 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6274138.572 ops/s (100 runs over 1000 unique samples each)
```

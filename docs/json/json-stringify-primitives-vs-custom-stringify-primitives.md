...
```typescript
Custom stringify for primitives: 10014821.936 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6598299.922 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8799325.055 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4997692.066 ops/s (100 runs over 1000 unique samples each)
```

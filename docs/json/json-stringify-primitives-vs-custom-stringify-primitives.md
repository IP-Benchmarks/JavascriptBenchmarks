...
```typescript
Custom stringify for primitives: 5647777.489 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4517094.175 ops/s (100 runs over 1000 unique samples each)
```

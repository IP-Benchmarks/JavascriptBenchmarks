...
```typescript
Custom stringify for primitives: 5376218.930 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3572143.128 ops/s (100 runs over 1000 unique samples each)
```

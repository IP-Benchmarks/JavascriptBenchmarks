...
```typescript
Custom stringify for primitives: 9071687.839 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6434515.358 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/7/2024 1:0:8`

...
```typescript
Custom stringify for primitives: 8323510.895 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4591746.025 ops/s (100 runs over 1000 unique samples each)
```

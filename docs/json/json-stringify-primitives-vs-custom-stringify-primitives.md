...
```typescript
Custom stringify for primitives: 10270696.532 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6042183.261 ops/s (100 runs over 1000 unique samples each)
```

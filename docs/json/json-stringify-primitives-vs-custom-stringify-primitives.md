...
#### **Custom stringify for primitives** is **_`1.78x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10256901.536 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5765814.967 ops/s (100 runs over 1000 unique samples each)
```

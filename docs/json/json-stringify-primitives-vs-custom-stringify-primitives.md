...
```typescript
Custom stringify for primitives: 6610346.953 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4408674.031 ops/s (100 runs over 1000 unique samples each)
```

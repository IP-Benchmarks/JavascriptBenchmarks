...
```typescript
Custom stringify for primitives: 5944858.936 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4320218.575 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/23/2023 0:49:27`

...
```typescript
Custom stringify for primitives: 8727753.610 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5488700.139 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/19/2024 1:8:18`

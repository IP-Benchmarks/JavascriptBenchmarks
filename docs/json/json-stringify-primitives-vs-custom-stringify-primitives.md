...
```typescript
Custom stringify for primitives: 8707660.418 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6121641.795 ops/s (100 runs over 1000 unique samples each)
```

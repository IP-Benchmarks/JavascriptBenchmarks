...
```typescript
Custom stringify for primitives: 7622351.510 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5880100.172 ops/s (100 runs over 1000 unique samples each)
```

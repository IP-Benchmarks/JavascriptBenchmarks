...
```typescript
Custom stringify for primitives: 9822078.933 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6110131.080 ops/s (100 runs over 1000 unique samples each)
```

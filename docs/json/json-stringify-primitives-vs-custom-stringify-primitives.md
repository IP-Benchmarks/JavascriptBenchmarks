...
```typescript
Custom stringify for primitives: 4488380.704 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3209184.532 ops/s (100 runs over 1000 unique samples each)
```

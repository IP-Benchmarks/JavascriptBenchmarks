...
```typescript
Custom stringify for primitives: 9283597.758 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7324141.682 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4920375.772 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3602971.818 ops/s (100 runs over 1000 unique samples each)
```

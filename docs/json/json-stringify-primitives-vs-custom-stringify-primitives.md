...
```typescript
Custom stringify for primitives: 9628236.459 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5710544.492 ops/s (100 runs over 1000 unique samples each)
```

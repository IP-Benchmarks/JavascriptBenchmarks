...
```typescript
Custom stringify for primitives: 5992498.591 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4278454.849 ops/s (100 runs over 1000 unique samples each)
```

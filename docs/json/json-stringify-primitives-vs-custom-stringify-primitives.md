...
```typescript
Custom stringify for primitives: 5339718.211 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3542539.290 ops/s (100 runs over 1000 unique samples each)
```

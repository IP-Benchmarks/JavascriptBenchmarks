...
```typescript
Custom stringify for primitives: 5420082.697 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4298680.581 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10291553.537 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6904466.624 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5011865.089 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4401046.216 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/13/2023 0:52:18`

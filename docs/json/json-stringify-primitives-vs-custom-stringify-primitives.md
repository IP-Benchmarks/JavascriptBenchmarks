...
```typescript
Custom stringify for primitives: 8828889.325 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5826934.678 ops/s (100 runs over 1000 unique samples each)
```

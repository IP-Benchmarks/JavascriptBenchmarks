...
```typescript
Custom stringify for primitives: 4419470.508 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3183612.292 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8138338.075 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4371514.947 ops/s (100 runs over 1000 unique samples each)
```

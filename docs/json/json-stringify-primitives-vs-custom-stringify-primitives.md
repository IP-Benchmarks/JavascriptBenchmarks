...
```typescript
Custom stringify for primitives: 10064526.700 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6617761.848 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5677640.278 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4363485.879 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9850536.820 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6064309.332 ops/s (100 runs over 1000 unique samples each)
```

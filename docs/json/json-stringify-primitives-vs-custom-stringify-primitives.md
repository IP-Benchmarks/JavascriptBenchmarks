...
```typescript
Custom stringify for primitives: 4132555.009 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2991103.979 ops/s (100 runs over 1000 unique samples each)
```

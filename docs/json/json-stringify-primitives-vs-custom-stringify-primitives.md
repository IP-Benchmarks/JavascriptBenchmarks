...
```typescript
Custom stringify for primitives: 5891200.484 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4228811.340 ops/s (100 runs over 1000 unique samples each)
```

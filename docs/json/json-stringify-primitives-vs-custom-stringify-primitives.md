...
#### **Custom stringify for primitives** is **_`2.09x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10360397.835 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4960184.352 ops/s (100 runs over 1000 unique samples each)
```

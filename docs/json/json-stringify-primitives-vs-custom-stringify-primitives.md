...
```typescript
Custom stringify for primitives: 8023489.569 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4723494.654 ops/s (100 runs over 1000 unique samples each)
```

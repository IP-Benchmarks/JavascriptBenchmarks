...
```typescript
Custom stringify for primitives: 6337850.933 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4416602.965 ops/s (100 runs over 1000 unique samples each)
```

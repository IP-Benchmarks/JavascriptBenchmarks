...
```typescript
Custom stringify for primitives: 5448724.236 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3907486.659 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/26/2023 1:16:28`

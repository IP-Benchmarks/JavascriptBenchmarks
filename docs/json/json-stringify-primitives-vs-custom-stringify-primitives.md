...
```typescript
Custom stringify for primitives: 8959032.137 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6100291.973 ops/s (100 runs over 1000 unique samples each)
```

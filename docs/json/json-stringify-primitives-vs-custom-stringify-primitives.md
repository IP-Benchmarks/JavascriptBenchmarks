...
```typescript
Custom stringify for primitives: 5085756.794 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4181777.170 ops/s (100 runs over 1000 unique samples each)
```

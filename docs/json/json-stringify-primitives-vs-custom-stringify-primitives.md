...
```typescript
Custom stringify for primitives: 9789974.694 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6918961.525 ops/s (100 runs over 1000 unique samples each)
```

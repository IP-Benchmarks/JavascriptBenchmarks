...
```typescript
Custom stringify for primitives: 8082394.516 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6248310.613 ops/s (100 runs over 1000 unique samples each)
```

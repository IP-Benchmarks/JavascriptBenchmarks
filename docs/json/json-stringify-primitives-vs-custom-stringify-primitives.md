...
```typescript
Custom stringify for primitives: 5377143.430 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4188352.911 ops/s (100 runs over 1000 unique samples each)
```

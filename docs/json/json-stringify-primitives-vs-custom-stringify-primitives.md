...
```typescript
Custom stringify for primitives: 5668350.372 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4111183.335 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9024082.471 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5970177.054 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/11/2024 0:56:12`

...
```typescript
Custom stringify for primitives: 5609083.350 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4431123.502 ops/s (100 runs over 1000 unique samples each)
```

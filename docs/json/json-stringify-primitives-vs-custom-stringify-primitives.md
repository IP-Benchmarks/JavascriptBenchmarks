...
```typescript
Custom stringify for primitives: 8916357.611 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6254130.072 ops/s (100 runs over 1000 unique samples each)
```

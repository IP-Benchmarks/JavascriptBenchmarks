...
```typescript
Custom stringify for primitives: 4495195.402 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3478735.067 ops/s (100 runs over 1000 unique samples each)
```

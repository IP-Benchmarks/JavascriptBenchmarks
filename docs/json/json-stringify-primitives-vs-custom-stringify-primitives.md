...
```typescript
Custom stringify for primitives: 10622995.109 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5597919.679 ops/s (100 runs over 1000 unique samples each)
```

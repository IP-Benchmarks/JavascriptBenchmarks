...
```typescript
Custom stringify for primitives: 10573808.887 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6273565.472 ops/s (100 runs over 1000 unique samples each)
```

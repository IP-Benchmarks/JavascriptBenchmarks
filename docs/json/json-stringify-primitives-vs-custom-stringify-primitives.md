...
```typescript
Custom stringify for primitives: 4528284.936 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3681183.992 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10147085.042 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5633579.378 ops/s (100 runs over 1000 unique samples each)
```

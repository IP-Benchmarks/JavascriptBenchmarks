...
```typescript
Custom stringify for primitives: 7936153.957 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5915869.825 ops/s (100 runs over 1000 unique samples each)
```

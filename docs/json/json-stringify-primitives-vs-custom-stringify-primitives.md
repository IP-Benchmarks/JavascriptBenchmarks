...
```typescript
Custom stringify for primitives: 8536090.377 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4463912.857 ops/s (100 runs over 1000 unique samples each)
```

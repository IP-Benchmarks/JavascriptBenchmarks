...
```typescript
Custom stringify for primitives: 5333093.274 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4229936.470 ops/s (100 runs over 1000 unique samples each)
```

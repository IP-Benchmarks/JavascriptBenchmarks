...
```typescript
Custom stringify for primitives: 6187176.569 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4596785.174 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/3/2023 2:57:12`

...
```typescript
Custom stringify for primitives: 10287029.732 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6075235.227 ops/s (100 runs over 1000 unique samples each)
```

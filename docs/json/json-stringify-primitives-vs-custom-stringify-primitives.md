...
```typescript
Custom stringify for primitives: 10153693.411 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6389000.288 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9859308.652 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6425218.933 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/17/2025 1:12:1`

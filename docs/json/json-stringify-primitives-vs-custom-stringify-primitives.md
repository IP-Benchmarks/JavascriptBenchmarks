...
```typescript
Custom stringify for primitives: 10846609.312 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6003799.204 ops/s (100 runs over 1000 unique samples each)
```

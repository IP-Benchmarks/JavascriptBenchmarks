...
```typescript
Custom stringify for primitives: 9047820.898 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6293173.530 ops/s (100 runs over 1000 unique samples each)
```

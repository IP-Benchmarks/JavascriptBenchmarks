...
```typescript
Custom stringify for primitives: 10805579.742 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6035134.137 ops/s (100 runs over 1000 unique samples each)
```

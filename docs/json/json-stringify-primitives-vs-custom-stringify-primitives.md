...
```typescript
Custom stringify for primitives: 5085321.264 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4230525.032 ops/s (100 runs over 1000 unique samples each)
```

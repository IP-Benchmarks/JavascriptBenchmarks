...
```typescript
Custom stringify for primitives: 6503170.033 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4332349.052 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/8/2022 1:7:56`

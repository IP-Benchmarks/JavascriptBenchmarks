...
```typescript
Custom stringify for primitives: 10140576.788 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5220065.430 ops/s (100 runs over 1000 unique samples each)
```

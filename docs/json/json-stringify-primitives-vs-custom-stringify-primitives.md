...
```typescript
Custom stringify for primitives: 9777104.505 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6871139.407 ops/s (100 runs over 1000 unique samples each)
```

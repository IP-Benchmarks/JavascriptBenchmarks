...
```typescript
Custom stringify for primitives: 5997091.411 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4392914.966 ops/s (100 runs over 1000 unique samples each)
```

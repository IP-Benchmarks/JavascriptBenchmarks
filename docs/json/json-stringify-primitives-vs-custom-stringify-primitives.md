...
```typescript
Custom stringify for primitives: 5739966.323 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3730064.763 ops/s (100 runs over 1000 unique samples each)
```

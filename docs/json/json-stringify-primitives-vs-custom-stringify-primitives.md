...
```typescript
Custom stringify for primitives: 7842127.930 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6047957.765 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9762882.050 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5236127.078 ops/s (100 runs over 1000 unique samples each)
```

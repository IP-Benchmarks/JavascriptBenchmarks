...
```typescript
Custom stringify for primitives: 7955527.331 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5836646.165 ops/s (100 runs over 1000 unique samples each)
```

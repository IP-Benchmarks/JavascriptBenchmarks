...
```typescript
Custom stringify for primitives: 8104809.451 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5615467.288 ops/s (100 runs over 1000 unique samples each)
```

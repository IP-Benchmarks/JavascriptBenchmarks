...
```typescript
Custom stringify for primitives: 5263208.866 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4411917.826 ops/s (100 runs over 1000 unique samples each)
```

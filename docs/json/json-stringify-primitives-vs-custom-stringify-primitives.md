...
```typescript
Custom stringify for primitives: 4971994.001 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3433317.136 ops/s (100 runs over 1000 unique samples each)
```

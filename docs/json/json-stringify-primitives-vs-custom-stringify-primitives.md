...
```typescript
Custom stringify for primitives: 10602837.022 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5108165.402 ops/s (100 runs over 1000 unique samples each)
```

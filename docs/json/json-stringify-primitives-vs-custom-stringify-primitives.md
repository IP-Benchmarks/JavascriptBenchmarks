...
```typescript
Custom stringify for primitives: 8481449.843 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5375001.204 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/11/2024 0:56:5`

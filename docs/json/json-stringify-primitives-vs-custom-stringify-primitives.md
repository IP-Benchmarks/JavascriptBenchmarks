...
```typescript
Custom stringify for primitives: 9600046.695 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4912798.321 ops/s (100 runs over 1000 unique samples each)
```

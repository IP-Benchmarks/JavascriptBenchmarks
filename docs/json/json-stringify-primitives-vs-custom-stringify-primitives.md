...
```typescript
Custom stringify for primitives: 9839964.781 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6776302.268 ops/s (100 runs over 1000 unique samples each)
```

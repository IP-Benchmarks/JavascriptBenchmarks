...
```typescript
Custom stringify for primitives: 9877144.130 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6550152.982 ops/s (100 runs over 1000 unique samples each)
```

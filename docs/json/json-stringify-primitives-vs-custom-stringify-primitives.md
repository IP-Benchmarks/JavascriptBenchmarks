...
```typescript
Custom stringify for primitives: 9417085.248 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6819304.524 ops/s (100 runs over 1000 unique samples each)
```

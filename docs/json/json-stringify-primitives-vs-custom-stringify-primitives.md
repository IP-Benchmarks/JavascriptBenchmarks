...
```typescript
Custom stringify for primitives: 8745027.352 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5810433.448 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/18/2024 1:5:33`

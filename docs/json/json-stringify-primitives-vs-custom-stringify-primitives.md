...
#### **Custom stringify for primitives** is **_`1.71x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10404161.082 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6094809.021 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/24/2025 1:13:47`

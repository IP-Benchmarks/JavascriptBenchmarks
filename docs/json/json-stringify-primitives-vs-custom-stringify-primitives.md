...
```typescript
Custom stringify for primitives: 9337655.797 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5794137.538 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10464630.647 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6238097.320 ops/s (100 runs over 1000 unique samples each)
```

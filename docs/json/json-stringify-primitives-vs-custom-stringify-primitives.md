...
```typescript
Custom stringify for primitives: 4444252.650 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3430724.395 ops/s (100 runs over 1000 unique samples each)
```

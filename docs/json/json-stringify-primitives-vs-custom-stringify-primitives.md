...
```typescript
Custom stringify for primitives: 9125593.819 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4583992.588 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9450055.888 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5839291.260 ops/s (100 runs over 1000 unique samples each)
```

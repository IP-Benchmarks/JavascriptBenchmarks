...
```typescript
Custom stringify for primitives: 4803509.559 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3937285.344 ops/s (100 runs over 1000 unique samples each)
```

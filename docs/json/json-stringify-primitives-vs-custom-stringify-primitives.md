...
```typescript
Custom stringify for primitives: 10503281.540 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6176683.920 ops/s (100 runs over 1000 unique samples each)
```

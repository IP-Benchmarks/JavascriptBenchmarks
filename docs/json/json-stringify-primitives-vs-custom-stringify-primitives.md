...
```typescript
Custom stringify for primitives: 9016794.320 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5088879.572 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7253489.959 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3544437.805 ops/s (100 runs over 1000 unique samples each)
```

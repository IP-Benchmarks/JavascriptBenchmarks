...
```typescript
Custom stringify for primitives: 5381961.581 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4258911.858 ops/s (100 runs over 1000 unique samples each)
```

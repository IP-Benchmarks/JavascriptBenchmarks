...
```typescript
Custom stringify for primitives: 6418594.410 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4920925.404 ops/s (100 runs over 1000 unique samples each)
```

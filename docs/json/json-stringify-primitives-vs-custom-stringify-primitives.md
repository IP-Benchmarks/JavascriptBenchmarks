...
```typescript
Custom stringify for primitives: 4493258.607 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3380835.995 ops/s (100 runs over 1000 unique samples each)
```

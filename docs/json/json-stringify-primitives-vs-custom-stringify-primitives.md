...
#### **Custom stringify for primitives** is **_`1.37x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 4567996.779 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3332514.645 ops/s (100 runs over 1000 unique samples each)
```

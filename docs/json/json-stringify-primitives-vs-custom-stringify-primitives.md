...
#### **Custom stringify for primitives** is **_`1.72x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10216915.329 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5941466.337 ops/s (100 runs over 1000 unique samples each)
```

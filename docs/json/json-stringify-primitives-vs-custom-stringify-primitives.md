...
```typescript
Custom stringify for primitives: 8868633.705 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6280807.371 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10558872.684 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5711897.488 ops/s (100 runs over 1000 unique samples each)
```

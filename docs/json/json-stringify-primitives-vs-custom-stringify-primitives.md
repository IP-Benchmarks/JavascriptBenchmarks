...
```typescript
Custom stringify for primitives: 10544420.004 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7102106.272 ops/s (100 runs over 1000 unique samples each)
```

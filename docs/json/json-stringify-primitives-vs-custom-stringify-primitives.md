...
```typescript
Custom stringify for primitives: 5728223.628 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4269197.856 ops/s (100 runs over 1000 unique samples each)
```

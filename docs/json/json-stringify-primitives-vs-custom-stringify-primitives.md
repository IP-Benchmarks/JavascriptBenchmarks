...
```typescript
Custom stringify for primitives: 7501722.398 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4995141.476 ops/s (100 runs over 1000 unique samples each)
```

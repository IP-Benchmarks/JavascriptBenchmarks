...
```typescript
Custom stringify for primitives: 8859341.215 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4537119.032 ops/s (100 runs over 1000 unique samples each)
```

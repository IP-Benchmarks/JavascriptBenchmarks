...
```typescript
Custom stringify for primitives: 4946771.992 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4282452.953 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/31/2023 0:52:40`

...
```typescript
Custom stringify for primitives: 8377091.073 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4460217.359 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/3/2024 1:15:50`

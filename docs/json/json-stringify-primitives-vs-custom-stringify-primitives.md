...
```typescript
Custom stringify for primitives: 8688326.026 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5926481.874 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/29/2024 1:14:9`

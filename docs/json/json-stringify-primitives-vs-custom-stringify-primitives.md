...
```typescript
Custom stringify for primitives: 5186139.896 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3828137.013 ops/s (100 runs over 1000 unique samples each)
```

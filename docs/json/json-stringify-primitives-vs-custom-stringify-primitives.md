...
#### **Custom stringify for primitives** is **_`1.32x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 6046519.502 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4581918.074 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.86x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10538768.176 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5657904.214 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10506243.335 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5740420.372 ops/s (100 runs over 1000 unique samples each)
```

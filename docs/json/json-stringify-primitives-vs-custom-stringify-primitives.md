...
```typescript
Custom stringify for primitives: 8653249.744 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6008257.388 ops/s (100 runs over 1000 unique samples each)
```

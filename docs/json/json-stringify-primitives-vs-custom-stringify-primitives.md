...
```typescript
Custom stringify for primitives: 8384931.405 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5984444.037 ops/s (100 runs over 1000 unique samples each)
```

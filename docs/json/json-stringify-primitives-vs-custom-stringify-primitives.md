...
```typescript
Custom stringify for primitives: 9840344.349 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6329815.011 ops/s (100 runs over 1000 unique samples each)
```

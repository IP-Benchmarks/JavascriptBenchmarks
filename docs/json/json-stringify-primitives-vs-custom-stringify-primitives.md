...
```typescript
Custom stringify for primitives: 9015629.405 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6672419.627 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8775663.330 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6277843.413 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9753551.170 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6567939.157 ops/s (100 runs over 1000 unique samples each)
```

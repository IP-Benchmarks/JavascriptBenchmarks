...
```typescript
Custom stringify for primitives: 9013601.073 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4969672.325 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6147109.301 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4516198.407 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5590385.835 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4299719.702 ops/s (100 runs over 1000 unique samples each)
```

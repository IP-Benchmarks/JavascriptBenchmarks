...
```typescript
Custom stringify for primitives: 8030963.545 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6029406.985 ops/s (100 runs over 1000 unique samples each)
```

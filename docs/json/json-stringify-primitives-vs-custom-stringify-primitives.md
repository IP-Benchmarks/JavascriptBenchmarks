...
```typescript
Custom stringify for primitives: 9857906.169 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6372234.594 ops/s (100 runs over 1000 unique samples each)
```

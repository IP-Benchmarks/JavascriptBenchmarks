...
```typescript
Custom stringify for primitives: 5488288.650 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4152371.781 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/11/2023 1:8:51`

...
```typescript
Custom stringify for primitives: 8581766.164 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6130740.996 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/1/2024 0:54:38`

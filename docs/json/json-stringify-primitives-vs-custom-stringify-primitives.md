...
```typescript
Custom stringify for primitives: 8605983.808 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5789152.020 ops/s (100 runs over 1000 unique samples each)
```

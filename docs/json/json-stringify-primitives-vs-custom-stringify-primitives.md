...
```typescript
Custom stringify for primitives: 8635168.459 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5753630.681 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5936644.957 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4443594.631 ops/s (100 runs over 1000 unique samples each)
```

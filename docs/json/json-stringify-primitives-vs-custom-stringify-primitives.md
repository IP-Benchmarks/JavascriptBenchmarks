...
```typescript
Custom stringify for primitives: 4718451.641 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3864814.508 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5029046.010 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4170528.750 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9802918.211 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6596358.283 ops/s (100 runs over 1000 unique samples each)
```

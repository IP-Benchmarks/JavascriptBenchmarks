...
```typescript
Custom stringify for primitives: 4975149.129 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4084238.897 ops/s (100 runs over 1000 unique samples each)
```

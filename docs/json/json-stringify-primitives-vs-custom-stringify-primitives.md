...
```typescript
Custom stringify for primitives: 9340233.026 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5228483.145 ops/s (100 runs over 1000 unique samples each)
```

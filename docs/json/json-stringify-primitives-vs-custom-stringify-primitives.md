...
```typescript
Custom stringify for primitives: 4550582.638 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3663386.910 ops/s (100 runs over 1000 unique samples each)
```

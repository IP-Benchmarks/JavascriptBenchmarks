...
```typescript
Custom stringify for primitives: 12148992.818 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 8093505.237 ops/s (100 runs over 1000 unique samples each)
```

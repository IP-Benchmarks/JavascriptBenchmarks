...
```typescript
Custom stringify for primitives: 5627555.438 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4675271.754 ops/s (100 runs over 1000 unique samples each)
```

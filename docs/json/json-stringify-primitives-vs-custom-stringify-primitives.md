...
```typescript
Custom stringify for primitives: 8168406.407 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4589121.495 ops/s (100 runs over 1000 unique samples each)
```

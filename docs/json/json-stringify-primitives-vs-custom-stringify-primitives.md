...
```typescript
Custom stringify for primitives: 6097755.806 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3847343.563 ops/s (100 runs over 1000 unique samples each)
```

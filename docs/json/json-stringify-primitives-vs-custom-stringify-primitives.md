...
```typescript
Custom stringify for primitives: 6384788.882 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4580025.620 ops/s (100 runs over 1000 unique samples each)
```

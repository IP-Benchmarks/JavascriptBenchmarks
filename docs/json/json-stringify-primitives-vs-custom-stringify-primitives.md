...
```typescript
Custom stringify for primitives: 8420744.875 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6606084.904 ops/s (100 runs over 1000 unique samples each)
```

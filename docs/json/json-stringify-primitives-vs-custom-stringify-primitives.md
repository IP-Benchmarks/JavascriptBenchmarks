...
#### **Custom stringify for primitives** is **_`2.06x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10141297.686 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4926228.739 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/8/2026 1:27:19`

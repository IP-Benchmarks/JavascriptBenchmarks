...
```typescript
Custom stringify for primitives: 10505404.505 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5388320.352 ops/s (100 runs over 1000 unique samples each)
```

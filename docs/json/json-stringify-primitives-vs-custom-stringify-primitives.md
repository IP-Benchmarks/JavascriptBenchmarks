...
```typescript
Custom stringify for primitives: 9627794.287 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4836690.827 ops/s (100 runs over 1000 unique samples each)
```

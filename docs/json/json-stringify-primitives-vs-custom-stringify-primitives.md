...
```typescript
Custom stringify for primitives: 10263012.268 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6927977.988 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/1/2025 1:16:15`

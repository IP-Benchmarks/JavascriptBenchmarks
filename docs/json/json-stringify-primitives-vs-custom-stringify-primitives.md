...
```typescript
Custom stringify for primitives: 4423568.152 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3666212.472 ops/s (100 runs over 1000 unique samples each)
```

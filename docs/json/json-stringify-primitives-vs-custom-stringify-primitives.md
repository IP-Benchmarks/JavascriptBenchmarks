...
```typescript
Custom stringify for primitives: 9707789.705 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5733567.209 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9596333.126 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5932618.623 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/5/2025 1:13:56`

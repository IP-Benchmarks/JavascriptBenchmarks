...
```typescript
Custom stringify for primitives: 10473461.192 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6224868.262 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8294667.053 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5991683.542 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/25/2024 0:54:12`

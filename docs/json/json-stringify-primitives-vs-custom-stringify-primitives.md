...
```typescript
Custom stringify for primitives: 11329240.532 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6455540.787 ops/s (100 runs over 1000 unique samples each)
```

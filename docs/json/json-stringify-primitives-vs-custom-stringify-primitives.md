...
#### **Custom stringify for primitives** is **_`1.68x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10462389.488 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6212204.945 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/11/2025 1:20:48`

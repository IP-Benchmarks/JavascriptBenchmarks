...
```typescript
Custom stringify for primitives: 8292161.367 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6300824.418 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/25/2024 0:58:40`

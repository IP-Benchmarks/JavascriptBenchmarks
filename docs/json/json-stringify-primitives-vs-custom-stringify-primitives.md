...
```typescript
Custom stringify for primitives: 10242005.270 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5439852.610 ops/s (100 runs over 1000 unique samples each)
```

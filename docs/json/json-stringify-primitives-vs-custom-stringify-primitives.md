...
```typescript
Custom stringify for primitives: 6437098.284 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4236346.266 ops/s (100 runs over 1000 unique samples each)
```

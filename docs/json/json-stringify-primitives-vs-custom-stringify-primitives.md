...
```typescript
Custom stringify for primitives: 7058708.764 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5773411.718 ops/s (100 runs over 1000 unique samples each)
```

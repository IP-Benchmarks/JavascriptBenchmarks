...
```typescript
Custom stringify for primitives: 6446204.329 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4408641.961 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6030545.072 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4246228.245 ops/s (100 runs over 1000 unique samples each)
```

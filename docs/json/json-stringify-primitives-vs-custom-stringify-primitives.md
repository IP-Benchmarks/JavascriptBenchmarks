...
```typescript
Custom stringify for primitives: 8677784.237 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4449842.203 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10100879.504 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6928432.068 ops/s (100 runs over 1000 unique samples each)
```

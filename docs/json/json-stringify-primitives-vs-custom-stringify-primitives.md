...
```typescript
Custom stringify for primitives: 8152700.069 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6433544.190 ops/s (100 runs over 1000 unique samples each)
```

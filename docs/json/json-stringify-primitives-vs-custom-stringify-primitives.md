...
```typescript
Custom stringify for primitives: 9529192.156 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5591210.706 ops/s (100 runs over 1000 unique samples each)
```

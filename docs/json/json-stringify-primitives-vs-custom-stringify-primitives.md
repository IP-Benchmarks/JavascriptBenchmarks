...
```typescript
Custom stringify for primitives: 10710226.156 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6920181.998 ops/s (100 runs over 1000 unique samples each)
```

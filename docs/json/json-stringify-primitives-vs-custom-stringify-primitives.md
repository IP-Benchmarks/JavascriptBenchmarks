...
```typescript
Custom stringify for primitives: 4829529.676 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3858810.746 ops/s (100 runs over 1000 unique samples each)
```

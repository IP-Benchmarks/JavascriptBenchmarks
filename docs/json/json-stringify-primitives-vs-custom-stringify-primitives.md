...
```typescript
Custom stringify for primitives: 8840276.014 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6136200.330 ops/s (100 runs over 1000 unique samples each)
```

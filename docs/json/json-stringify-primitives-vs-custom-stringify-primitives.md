...
```typescript
Custom stringify for primitives: 5598218.648 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3957791.108 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5266604.194 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3895969.206 ops/s (100 runs over 1000 unique samples each)
```

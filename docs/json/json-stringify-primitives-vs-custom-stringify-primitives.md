...
```typescript
Custom stringify for primitives: 5746520.409 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4408760.135 ops/s (100 runs over 1000 unique samples each)
```

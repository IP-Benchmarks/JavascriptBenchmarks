...
```typescript
Custom stringify for primitives: 10573205.172 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6770577.885 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5080572.545 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3357799.267 ops/s (100 runs over 1000 unique samples each)
```

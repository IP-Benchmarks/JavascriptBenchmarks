...
```typescript
Custom stringify for primitives: 9761364.889 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6074463.569 ops/s (100 runs over 1000 unique samples each)
```

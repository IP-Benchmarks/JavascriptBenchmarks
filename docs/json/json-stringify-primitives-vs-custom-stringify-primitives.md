...
```typescript
Custom stringify for primitives: 9010546.484 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7216849.438 ops/s (100 runs over 1000 unique samples each)
```

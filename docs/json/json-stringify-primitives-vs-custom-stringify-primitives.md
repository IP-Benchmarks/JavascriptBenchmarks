...
```typescript
Custom stringify for primitives: 12917142.987 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6987293.537 ops/s (100 runs over 1000 unique samples each)
```

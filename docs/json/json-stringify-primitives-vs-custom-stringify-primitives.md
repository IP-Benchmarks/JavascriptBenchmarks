...
```typescript
Custom stringify for primitives: 9052309.221 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6801923.366 ops/s (100 runs over 1000 unique samples each)
```

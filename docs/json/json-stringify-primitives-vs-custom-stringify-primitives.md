...
```typescript
Custom stringify for primitives: 9556755.757 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6311307.648 ops/s (100 runs over 1000 unique samples each)
```

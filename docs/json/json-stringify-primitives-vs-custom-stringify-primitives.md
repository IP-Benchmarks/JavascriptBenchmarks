...
```typescript
Custom stringify for primitives: 6110139.292 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4126072.645 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5400666.830 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4558074.820 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10473657.547 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6473889.348 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/1/2026 2:6:27`

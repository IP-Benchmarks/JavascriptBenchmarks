...
```typescript
Custom stringify for primitives: 8812453.975 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6099235.664 ops/s (100 runs over 1000 unique samples each)
```

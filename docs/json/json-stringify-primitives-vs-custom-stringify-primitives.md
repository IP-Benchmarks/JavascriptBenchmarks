...
```typescript
Custom stringify for primitives: 10189359.049 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6473737.213 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7728627.485 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5144256.528 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8734806.891 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5453295.662 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/11/2024 0:53:39`

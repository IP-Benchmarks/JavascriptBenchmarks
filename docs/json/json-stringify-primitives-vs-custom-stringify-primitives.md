...
```typescript
Custom stringify for primitives: 6380506.888 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4111682.676 ops/s (100 runs over 1000 unique samples each)
```

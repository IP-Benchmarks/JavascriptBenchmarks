...
```typescript
Custom stringify for primitives: 9625886.087 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5093003.334 ops/s (100 runs over 1000 unique samples each)
```

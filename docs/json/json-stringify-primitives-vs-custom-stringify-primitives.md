...
```typescript
Custom stringify for primitives: 5988788.506 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4165553.248 ops/s (100 runs over 1000 unique samples each)
```

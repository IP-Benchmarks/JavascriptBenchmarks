...
```typescript
Custom stringify for primitives: 10486660.758 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6480755.817 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5318217.117 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4037148.223 ops/s (100 runs over 1000 unique samples each)
```

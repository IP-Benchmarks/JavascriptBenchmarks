...
```typescript
Custom stringify for primitives: 8928061.253 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6102879.781 ops/s (100 runs over 1000 unique samples each)
```

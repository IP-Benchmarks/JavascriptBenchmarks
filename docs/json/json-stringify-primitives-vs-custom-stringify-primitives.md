...
```typescript
Custom stringify for primitives: 4379894.724 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3613522.887 ops/s (100 runs over 1000 unique samples each)
```

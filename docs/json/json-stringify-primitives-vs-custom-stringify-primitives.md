...
```typescript
Custom stringify for primitives: 8896180.598 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5867084.028 ops/s (100 runs over 1000 unique samples each)
```

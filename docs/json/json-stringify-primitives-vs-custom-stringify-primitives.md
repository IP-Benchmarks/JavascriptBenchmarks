...
```typescript
Custom stringify for primitives: 4767982.350 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3590161.263 ops/s (100 runs over 1000 unique samples each)
```

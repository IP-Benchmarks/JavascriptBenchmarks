...
```typescript
Custom stringify for primitives: 5909320.648 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4584269.975 ops/s (100 runs over 1000 unique samples each)
```

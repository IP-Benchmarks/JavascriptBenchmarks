...
```typescript
Custom stringify for primitives: 5756667.947 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4406217.083 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8558701.782 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5491179.107 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 3907126.355 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3131994.723 ops/s (100 runs over 1000 unique samples each)
```

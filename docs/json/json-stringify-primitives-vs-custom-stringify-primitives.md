...
```typescript
Custom stringify for primitives: 10754141.716 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5724913.771 ops/s (100 runs over 1000 unique samples each)
```

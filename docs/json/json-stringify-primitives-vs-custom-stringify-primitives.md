...
```typescript
Custom stringify for primitives: 10432517.573 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5126897.375 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4547785.079 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3386642.015 ops/s (100 runs over 1000 unique samples each)
```

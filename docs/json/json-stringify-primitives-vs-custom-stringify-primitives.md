...
```typescript
Custom stringify for primitives: 5896699.263 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4289436.597 ops/s (100 runs over 1000 unique samples each)
```

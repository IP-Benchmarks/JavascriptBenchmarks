...
```typescript
Custom stringify for primitives: 8332990.292 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4514644.559 ops/s (100 runs over 1000 unique samples each)
```

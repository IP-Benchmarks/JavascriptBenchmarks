...
```typescript
Custom stringify for primitives: 10247808.404 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6850838.207 ops/s (100 runs over 1000 unique samples each)
```

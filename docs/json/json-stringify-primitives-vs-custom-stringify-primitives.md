...
```typescript
Custom stringify for primitives: 8274092.897 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5859010.643 ops/s (100 runs over 1000 unique samples each)
```

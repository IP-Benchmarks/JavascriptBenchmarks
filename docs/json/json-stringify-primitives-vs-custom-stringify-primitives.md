...
```typescript
Custom stringify for primitives: 7898025.121 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4431308.079 ops/s (100 runs over 1000 unique samples each)
```

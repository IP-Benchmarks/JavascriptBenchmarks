...
```typescript
Custom stringify for primitives: 9449267.403 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5882189.624 ops/s (100 runs over 1000 unique samples each)
```

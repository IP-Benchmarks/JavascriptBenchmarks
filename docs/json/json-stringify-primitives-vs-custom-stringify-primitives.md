...
```typescript
Custom stringify for primitives: 5553400.836 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4653403.349 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9639922.854 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6879718.240 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/24/2025 1:22:49`

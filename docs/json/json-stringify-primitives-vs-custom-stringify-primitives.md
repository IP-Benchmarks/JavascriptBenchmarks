...
```typescript
Custom stringify for primitives: 10262105.462 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6704149.117 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/3/2025 1:12:43`

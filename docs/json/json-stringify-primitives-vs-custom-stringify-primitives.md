...
```typescript
Custom stringify for primitives: 6114192.323 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4254307.348 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9976033.577 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5397602.514 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10772125.488 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5891414.630 ops/s (100 runs over 1000 unique samples each)
```

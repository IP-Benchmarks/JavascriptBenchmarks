...
```typescript
Custom stringify for primitives: 5829094.221 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4405714.105 ops/s (100 runs over 1000 unique samples each)
```

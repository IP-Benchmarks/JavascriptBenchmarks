...
```typescript
Custom stringify for primitives: 9881749.062 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6730591.129 ops/s (100 runs over 1000 unique samples each)
```

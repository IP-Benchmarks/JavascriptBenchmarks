...
```typescript
Custom stringify for primitives: 10475540.294 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7005097.399 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10640341.044 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5732402.070 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10801516.835 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5607399.704 ops/s (100 runs over 1000 unique samples each)
```

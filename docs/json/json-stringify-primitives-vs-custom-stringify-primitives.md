...
```typescript
Custom stringify for primitives: 8309059.798 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4595773.460 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/26/2024 1:8:17`

...
```typescript
Custom stringify for primitives: 5501181.571 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4469237.191 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10012798.359 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5265537.086 ops/s (100 runs over 1000 unique samples each)
```

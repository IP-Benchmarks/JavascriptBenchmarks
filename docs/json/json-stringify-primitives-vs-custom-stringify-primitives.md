...
```typescript
Custom stringify for primitives: 8187257.644 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6032406.933 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/30/2024 0:52:9`

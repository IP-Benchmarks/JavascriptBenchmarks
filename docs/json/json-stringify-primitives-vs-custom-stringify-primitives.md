...
```typescript
Custom stringify for primitives: 6092418.826 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4438733.274 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/27/2023 1:2:7`

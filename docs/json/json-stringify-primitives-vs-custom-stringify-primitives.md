...
```typescript
Custom stringify for primitives: 10154636.841 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6706680.961 ops/s (100 runs over 1000 unique samples each)
```

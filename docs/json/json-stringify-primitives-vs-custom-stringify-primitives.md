...
```typescript
Custom stringify for primitives: 10312796.396 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5816491.102 ops/s (100 runs over 1000 unique samples each)
```

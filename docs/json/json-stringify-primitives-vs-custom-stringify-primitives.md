...
```typescript
Custom stringify for primitives: 5773122.409 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3902256.893 ops/s (100 runs over 1000 unique samples each)
```

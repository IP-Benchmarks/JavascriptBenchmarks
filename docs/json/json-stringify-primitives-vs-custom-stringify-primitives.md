...
```typescript
Custom stringify for primitives: 4294916.820 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3161136.233 ops/s (100 runs over 1000 unique samples each)
```

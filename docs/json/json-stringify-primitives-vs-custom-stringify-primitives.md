...
#### **Custom stringify for primitives** is **_`1.28x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5714354.286 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4466502.414 ops/s (100 runs over 1000 unique samples each)
```

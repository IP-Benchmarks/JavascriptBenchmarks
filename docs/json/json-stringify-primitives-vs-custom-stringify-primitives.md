...
#### **Custom stringify for primitives** is **_`1.15x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5016644.725 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4360988.689 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4556963.364 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3665841.938 ops/s (100 runs over 1000 unique samples each)
```

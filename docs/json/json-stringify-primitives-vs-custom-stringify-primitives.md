...
```typescript
Custom stringify for primitives: 9931429.439 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6065427.156 ops/s (100 runs over 1000 unique samples each)
```

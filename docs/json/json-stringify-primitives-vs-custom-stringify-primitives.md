...
```typescript
Custom stringify for primitives: 6418355.470 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4871527.587 ops/s (100 runs over 1000 unique samples each)
```

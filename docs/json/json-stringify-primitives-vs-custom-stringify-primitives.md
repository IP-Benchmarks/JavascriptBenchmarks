...
```typescript
Custom stringify for primitives: 9201738.172 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6386124.229 ops/s (100 runs over 1000 unique samples each)
```

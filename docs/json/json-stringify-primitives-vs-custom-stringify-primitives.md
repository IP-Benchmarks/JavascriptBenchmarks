...
#### **Custom stringify for primitives** is **_`1.88x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 8779709.877 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4676764.488 ops/s (100 runs over 1000 unique samples each)
```

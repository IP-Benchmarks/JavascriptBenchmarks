...
```typescript
Custom stringify for primitives: 9749626.662 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6779251.504 ops/s (100 runs over 1000 unique samples each)
```

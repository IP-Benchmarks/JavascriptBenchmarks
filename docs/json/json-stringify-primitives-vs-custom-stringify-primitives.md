...
```typescript
Custom stringify for primitives: 4513189.752 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3002101.020 ops/s (100 runs over 1000 unique samples each)
```

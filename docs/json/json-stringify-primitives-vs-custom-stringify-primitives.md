...
```typescript
Custom stringify for primitives: 8797795.340 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6059672.873 ops/s (100 runs over 1000 unique samples each)
```

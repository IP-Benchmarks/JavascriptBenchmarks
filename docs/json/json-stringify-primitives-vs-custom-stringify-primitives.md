...
```typescript
Custom stringify for primitives: 8155091.571 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4996786.816 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4578011.700 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2905127.934 ops/s (100 runs over 1000 unique samples each)
```

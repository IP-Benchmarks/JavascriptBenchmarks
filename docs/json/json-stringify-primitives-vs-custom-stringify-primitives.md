...
```typescript
Custom stringify for primitives: 10160449.758 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6289594.570 ops/s (100 runs over 1000 unique samples each)
```

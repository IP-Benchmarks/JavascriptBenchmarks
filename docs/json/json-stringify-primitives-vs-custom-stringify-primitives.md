...
```typescript
Custom stringify for primitives: 5739354.230 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4469674.066 ops/s (100 runs over 1000 unique samples each)
```

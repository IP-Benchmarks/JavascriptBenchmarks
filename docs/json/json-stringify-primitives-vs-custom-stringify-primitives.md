...
```typescript
Custom stringify for primitives: 10263425.176 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6775995.089 ops/s (100 runs over 1000 unique samples each)
```

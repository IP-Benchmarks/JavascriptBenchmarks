...
```typescript
Custom stringify for primitives: 8638615.529 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4780599.410 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/8/2024 0:57:39`

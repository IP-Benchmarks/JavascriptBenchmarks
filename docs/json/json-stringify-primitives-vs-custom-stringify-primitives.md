...
```typescript
Custom stringify for primitives: 8049684.586 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5773840.738 ops/s (100 runs over 1000 unique samples each)
```

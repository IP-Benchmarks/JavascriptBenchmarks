...
```typescript
Custom stringify for primitives: 8916730.487 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5694067.544 ops/s (100 runs over 1000 unique samples each)
```

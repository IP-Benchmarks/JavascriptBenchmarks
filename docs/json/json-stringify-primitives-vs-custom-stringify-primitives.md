...
#### **Custom stringify for primitives** is **_`2.11x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10595615.577 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5021654.126 ops/s (100 runs over 1000 unique samples each)
```

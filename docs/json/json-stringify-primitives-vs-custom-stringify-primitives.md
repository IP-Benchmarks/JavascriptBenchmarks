...
```typescript
Custom stringify for primitives: 4830321.669 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3894660.343 ops/s (100 runs over 1000 unique samples each)
```

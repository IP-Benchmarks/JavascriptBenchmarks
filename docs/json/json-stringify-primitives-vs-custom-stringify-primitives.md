...
```typescript
Custom stringify for primitives: 9113743.991 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5575615.070 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8052722.789 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5601782.401 ops/s (100 runs over 1000 unique samples each)
```

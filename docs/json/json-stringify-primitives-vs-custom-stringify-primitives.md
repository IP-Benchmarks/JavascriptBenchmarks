...
```typescript
Custom stringify for primitives: 8422168.966 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5790219.645 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5514744.001 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4429984.582 ops/s (100 runs over 1000 unique samples each)
```

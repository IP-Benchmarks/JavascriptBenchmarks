...
```typescript
Custom stringify for primitives: 6461522.377 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4266931.740 ops/s (100 runs over 1000 unique samples each)
```

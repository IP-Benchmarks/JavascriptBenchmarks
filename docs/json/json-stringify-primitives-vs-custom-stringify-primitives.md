...
```typescript
Custom stringify for primitives: 10585764.328 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6748662.921 ops/s (100 runs over 1000 unique samples each)
```

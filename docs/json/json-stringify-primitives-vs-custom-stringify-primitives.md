...
```typescript
Custom stringify for primitives: 9866756.362 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6320926.724 ops/s (100 runs over 1000 unique samples each)
```

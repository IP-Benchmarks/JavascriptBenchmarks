...
```typescript
Custom stringify for primitives: 10260221.797 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6916450.113 ops/s (100 runs over 1000 unique samples each)
```

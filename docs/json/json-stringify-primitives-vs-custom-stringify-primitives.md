...
```typescript
Custom stringify for primitives: 10641449.553 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5295595.928 ops/s (100 runs over 1000 unique samples each)
```

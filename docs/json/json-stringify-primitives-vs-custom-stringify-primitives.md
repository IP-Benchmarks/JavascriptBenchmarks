...
```typescript
Custom stringify for primitives: 8335706.927 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4674867.414 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/15/2024 1:12:50`

...
```typescript
Custom stringify for primitives: 8460958.432 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6007198.064 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/17/2024 0:55:43`

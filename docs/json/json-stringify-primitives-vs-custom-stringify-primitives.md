...
```typescript
Custom stringify for primitives: 4591909.011 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3519576.659 ops/s (100 runs over 1000 unique samples each)
```

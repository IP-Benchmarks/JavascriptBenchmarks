...
```typescript
Custom stringify for primitives: 8548833.759 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6163563.724 ops/s (100 runs over 1000 unique samples each)
```

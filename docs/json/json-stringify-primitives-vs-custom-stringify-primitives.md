...
```typescript
Custom stringify for primitives: 5570320.929 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4417615.968 ops/s (100 runs over 1000 unique samples each)
```

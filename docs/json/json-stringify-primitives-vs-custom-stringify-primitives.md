...
```typescript
Custom stringify for primitives: 10208522.340 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6165302.994 ops/s (100 runs over 1000 unique samples each)
```

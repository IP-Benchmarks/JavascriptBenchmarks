...
```typescript
Custom stringify for primitives: 9291897.048 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5664531.063 ops/s (100 runs over 1000 unique samples each)
```

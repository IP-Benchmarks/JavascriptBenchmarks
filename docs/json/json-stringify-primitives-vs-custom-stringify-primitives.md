...
```typescript
Custom stringify for primitives: 6278373.933 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4351554.423 ops/s (100 runs over 1000 unique samples each)
```

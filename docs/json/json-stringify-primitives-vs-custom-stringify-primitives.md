...
```typescript
Custom stringify for primitives: 9351027.472 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5229178.418 ops/s (100 runs over 1000 unique samples each)
```

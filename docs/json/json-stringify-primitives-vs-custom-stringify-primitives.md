...
```typescript
Custom stringify for primitives: 10651403.631 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6263895.670 ops/s (100 runs over 1000 unique samples each)
```

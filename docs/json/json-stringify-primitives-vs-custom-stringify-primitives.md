...
```typescript
Custom stringify for primitives: 5388553.506 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3884543.294 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9302072.046 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6857740.225 ops/s (100 runs over 1000 unique samples each)
```

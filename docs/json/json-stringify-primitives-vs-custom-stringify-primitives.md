...
```typescript
Custom stringify for primitives: 9215557.889 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6879775.983 ops/s (100 runs over 1000 unique samples each)
```

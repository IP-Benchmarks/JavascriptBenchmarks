...
```typescript
Custom stringify for primitives: 9876273.990 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7017331.616 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/2/2025 1:21:39`

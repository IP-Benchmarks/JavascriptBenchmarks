...
```typescript
Custom stringify for primitives: 5495460.858 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4329413.468 ops/s (100 runs over 1000 unique samples each)
```

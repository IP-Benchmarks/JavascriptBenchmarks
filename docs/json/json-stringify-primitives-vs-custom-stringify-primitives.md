...
```typescript
Custom stringify for primitives: 8903141.037 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6473585.924 ops/s (100 runs over 1000 unique samples each)
```

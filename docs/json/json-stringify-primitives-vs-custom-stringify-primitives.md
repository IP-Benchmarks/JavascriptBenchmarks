...
```typescript
Custom stringify for primitives: 10498146.500 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6895306.289 ops/s (100 runs over 1000 unique samples each)
```

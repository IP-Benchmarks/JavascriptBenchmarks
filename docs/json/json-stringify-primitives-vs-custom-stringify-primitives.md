...
```typescript
Custom stringify for primitives: 4783579.388 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3951338.163 ops/s (100 runs over 1000 unique samples each)
```

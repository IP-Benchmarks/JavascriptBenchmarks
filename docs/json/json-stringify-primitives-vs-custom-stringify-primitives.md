...
```typescript
Custom stringify for primitives: 8370476.627 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5579995.314 ops/s (100 runs over 1000 unique samples each)
```

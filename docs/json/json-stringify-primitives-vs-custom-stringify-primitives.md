...
```typescript
Custom stringify for primitives: 9210890.994 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6365271.891 ops/s (100 runs over 1000 unique samples each)
```

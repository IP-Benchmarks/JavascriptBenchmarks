...
```typescript
Custom stringify for primitives: 10314268.543 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6639839.061 ops/s (100 runs over 1000 unique samples each)
```

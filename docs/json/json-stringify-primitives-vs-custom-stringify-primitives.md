...
```typescript
Custom stringify for primitives: 5366110.106 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4258008.036 ops/s (100 runs over 1000 unique samples each)
```

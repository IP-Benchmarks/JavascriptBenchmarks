...
#### **Custom stringify for primitives** is **_`1.49x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10245572.017 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6870201.422 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10218105.461 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6778950.951 ops/s (100 runs over 1000 unique samples each)
```

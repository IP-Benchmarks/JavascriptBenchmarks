...
#### **Custom stringify for primitives** is **_`1.16x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 4670452.412 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4036261.125 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10023800.512 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6499041.229 ops/s (100 runs over 1000 unique samples each)
```

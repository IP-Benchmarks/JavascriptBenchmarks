...
#### **Custom stringify for primitives** is **_`1.92x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 8876148.261 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4625357.170 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/6/2023 0:55:50`

...
```typescript
Custom stringify for primitives: 11159006.808 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6791302.922 ops/s (100 runs over 1000 unique samples each)
```

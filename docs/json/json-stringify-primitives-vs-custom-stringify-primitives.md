...
```typescript
Custom stringify for primitives: 5534958.133 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4125279.797 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9288155.744 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6693197.610 ops/s (100 runs over 1000 unique samples each)
```

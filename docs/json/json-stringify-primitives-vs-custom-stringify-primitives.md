...
```typescript
Custom stringify for primitives: 5531601.264 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3342662.929 ops/s (100 runs over 1000 unique samples each)
```

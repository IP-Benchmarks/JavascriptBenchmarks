...
```typescript
Custom stringify for primitives: 6372483.918 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4292915.221 ops/s (100 runs over 1000 unique samples each)
```

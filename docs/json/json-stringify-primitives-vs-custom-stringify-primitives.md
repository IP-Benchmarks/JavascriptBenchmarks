...
```typescript
Custom stringify for primitives: 10561087.336 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6892057.152 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/31/2025 1:20:34`

...
```typescript
Custom stringify for primitives: 4022360.624 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3301726.783 ops/s (100 runs over 1000 unique samples each)
```

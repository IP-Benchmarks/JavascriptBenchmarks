...
```typescript
Custom stringify for primitives: 9611218.522 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5544277.878 ops/s (100 runs over 1000 unique samples each)
```

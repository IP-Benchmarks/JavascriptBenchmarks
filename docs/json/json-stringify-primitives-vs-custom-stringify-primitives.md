...
```typescript
Custom stringify for primitives: 7584979.644 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5755576.880 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/24/2024 0:49:53`

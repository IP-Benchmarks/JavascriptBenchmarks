...
```typescript
Custom stringify for primitives: 10452623.692 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5376248.412 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/7/2025 1:19:6`

...
```typescript
Custom stringify for primitives: 9229518.844 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4968686.839 ops/s (100 runs over 1000 unique samples each)
```

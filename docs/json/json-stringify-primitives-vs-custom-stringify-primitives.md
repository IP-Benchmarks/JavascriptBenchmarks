...
```typescript
Custom stringify for primitives: 4640537.685 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3509875.755 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10220050.984 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6247370.248 ops/s (100 runs over 1000 unique samples each)
```

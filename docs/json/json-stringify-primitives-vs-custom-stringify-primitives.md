...
```typescript
Custom stringify for primitives: 10120749.652 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6168626.563 ops/s (100 runs over 1000 unique samples each)
```

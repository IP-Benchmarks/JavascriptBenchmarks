...
```typescript
Custom stringify for primitives: 4416780.090 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2886216.541 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4360558.729 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3364830.049 ops/s (100 runs over 1000 unique samples each)
```

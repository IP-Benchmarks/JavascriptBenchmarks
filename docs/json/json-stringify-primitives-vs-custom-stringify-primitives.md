...
```typescript
Custom stringify for primitives: 8536721.430 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5945261.855 ops/s (100 runs over 1000 unique samples each)
```

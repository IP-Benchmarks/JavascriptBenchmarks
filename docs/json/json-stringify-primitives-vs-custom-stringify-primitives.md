...
```typescript
Custom stringify for primitives: 5436103.227 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4347666.547 ops/s (100 runs over 1000 unique samples each)
```

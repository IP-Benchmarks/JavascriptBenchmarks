...
```typescript
Custom stringify for primitives: 5821515.027 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4360191.400 ops/s (100 runs over 1000 unique samples each)
```

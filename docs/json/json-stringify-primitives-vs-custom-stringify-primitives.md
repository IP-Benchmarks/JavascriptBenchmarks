...
```typescript
Custom stringify for primitives: 4671503.822 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3655607.418 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8749583.847 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5112933.973 ops/s (100 runs over 1000 unique samples each)
```

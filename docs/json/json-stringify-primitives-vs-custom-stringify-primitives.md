...
```typescript
Custom stringify for primitives: 3921815.471 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3363083.167 ops/s (100 runs over 1000 unique samples each)
```

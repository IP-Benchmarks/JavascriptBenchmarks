...
```typescript
Custom stringify for primitives: 8645058.285 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6040719.279 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4065714.965 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3401212.117 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.56x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10442338.503 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6708220.965 ops/s (100 runs over 1000 unique samples each)
```

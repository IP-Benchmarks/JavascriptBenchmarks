...
```typescript
Custom stringify for primitives: 8719628.118 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5962963.793 ops/s (100 runs over 1000 unique samples each)
```

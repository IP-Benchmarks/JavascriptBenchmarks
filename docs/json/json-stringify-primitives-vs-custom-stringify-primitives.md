...
```typescript
Custom stringify for primitives: 8465786.922 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4628845.084 ops/s (100 runs over 1000 unique samples each)
```

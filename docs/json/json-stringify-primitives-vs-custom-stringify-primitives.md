...
```typescript
Custom stringify for primitives: 5816010.733 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4474440.697 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10085412.349 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6645668.128 ops/s (100 runs over 1000 unique samples each)
```

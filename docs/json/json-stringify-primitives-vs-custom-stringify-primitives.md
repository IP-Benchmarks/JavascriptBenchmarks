...
```typescript
Custom stringify for primitives: 9691037.138 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6778572.309 ops/s (100 runs over 1000 unique samples each)
```

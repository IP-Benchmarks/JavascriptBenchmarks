...
```typescript
Custom stringify for primitives: 7277139.601 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4558534.638 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/2/2024 1:0:59`

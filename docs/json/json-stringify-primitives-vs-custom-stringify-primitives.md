...
```typescript
Custom stringify for primitives: 4412866.365 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3751738.603 ops/s (100 runs over 1000 unique samples each)
```

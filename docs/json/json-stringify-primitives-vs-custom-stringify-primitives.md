...
```typescript
Custom stringify for primitives: 8695727.793 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6008976.208 ops/s (100 runs over 1000 unique samples each)
```

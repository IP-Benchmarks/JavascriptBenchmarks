...
```typescript
Custom stringify for primitives: 5087346.433 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4095613.908 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/5/2024 0:53:20`

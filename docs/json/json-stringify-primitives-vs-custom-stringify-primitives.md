...
```typescript
Custom stringify for primitives: 5100490.891 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3744909.918 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/8/2022 0:47:51`

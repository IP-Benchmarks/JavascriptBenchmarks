...
```typescript
Custom stringify for primitives: 8992572.046 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6780751.454 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6002456.445 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4365163.188 ops/s (100 runs over 1000 unique samples each)
```

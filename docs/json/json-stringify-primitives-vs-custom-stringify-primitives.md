...
```typescript
Custom stringify for primitives: 8023439.356 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6002458.608 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5055472.436 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3739541.811 ops/s (100 runs over 1000 unique samples each)
```

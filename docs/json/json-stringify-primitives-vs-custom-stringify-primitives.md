...
```typescript
Custom stringify for primitives: 8499119.280 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6008801.816 ops/s (100 runs over 1000 unique samples each)
```

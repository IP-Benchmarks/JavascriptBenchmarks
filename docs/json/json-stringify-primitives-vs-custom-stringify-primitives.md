...
```typescript
Custom stringify for primitives: 7931304.120 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5569026.102 ops/s (100 runs over 1000 unique samples each)
```

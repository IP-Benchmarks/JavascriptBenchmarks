...
```typescript
Custom stringify for primitives: 9921211.690 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6477861.197 ops/s (100 runs over 1000 unique samples each)
```

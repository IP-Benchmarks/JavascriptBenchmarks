...
```typescript
Custom stringify for primitives: 8617668.264 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4785468.640 ops/s (100 runs over 1000 unique samples each)
```

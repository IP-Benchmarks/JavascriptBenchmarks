...
#### **Custom stringify for primitives** is **_`1.66x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10387790.772 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6274152.743 ops/s (100 runs over 1000 unique samples each)
```

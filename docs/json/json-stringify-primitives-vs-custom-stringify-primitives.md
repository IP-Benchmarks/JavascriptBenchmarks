...
```typescript
Custom stringify for primitives: 8853310.384 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4931075.399 ops/s (100 runs over 1000 unique samples each)
```

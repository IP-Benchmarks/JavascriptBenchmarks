...
```typescript
Custom stringify for primitives: 6432443.393 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4459710.330 ops/s (100 runs over 1000 unique samples each)
```

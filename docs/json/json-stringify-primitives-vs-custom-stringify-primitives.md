...
```typescript
Custom stringify for primitives: 9639453.589 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6929677.494 ops/s (100 runs over 1000 unique samples each)
```

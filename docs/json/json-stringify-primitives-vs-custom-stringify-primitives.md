...
```typescript
Custom stringify for primitives: 8190078.622 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4823856.402 ops/s (100 runs over 1000 unique samples each)
```

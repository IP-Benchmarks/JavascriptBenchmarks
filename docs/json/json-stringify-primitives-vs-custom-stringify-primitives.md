...
```typescript
Custom stringify for primitives: 10059629.460 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6724115.718 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9965742.759 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5890224.360 ops/s (100 runs over 1000 unique samples each)
```

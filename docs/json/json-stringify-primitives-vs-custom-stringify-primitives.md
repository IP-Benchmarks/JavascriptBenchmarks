...
```typescript
Custom stringify for primitives: 10371911.867 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5427984.059 ops/s (100 runs over 1000 unique samples each)
```

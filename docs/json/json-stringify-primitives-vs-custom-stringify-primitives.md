...
```typescript
Custom stringify for primitives: 8929107.176 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5697216.853 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/9/2024 1:2:30`

...
```typescript
Custom stringify for primitives: 8901842.853 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5974879.934 ops/s (100 runs over 1000 unique samples each)
```

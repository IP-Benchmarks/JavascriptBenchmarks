...
```typescript
Custom stringify for primitives: 9924639.237 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6820691.523 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5524133.365 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4284884.119 ops/s (100 runs over 1000 unique samples each)
```

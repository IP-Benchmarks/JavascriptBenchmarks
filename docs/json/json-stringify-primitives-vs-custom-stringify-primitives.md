...
```typescript
Custom stringify for primitives: 5399498.936 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4075132.401 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8623687.881 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4581520.903 ops/s (100 runs over 1000 unique samples each)
```

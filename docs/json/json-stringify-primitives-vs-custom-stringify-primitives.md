...
```typescript
Custom stringify for primitives: 8957323.638 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5630852.250 ops/s (100 runs over 1000 unique samples each)
```

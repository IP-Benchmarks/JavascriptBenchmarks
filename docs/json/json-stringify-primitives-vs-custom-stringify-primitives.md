...
```typescript
Custom stringify for primitives: 8528415.149 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5882693.791 ops/s (100 runs over 1000 unique samples each)
```

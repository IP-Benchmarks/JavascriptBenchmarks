...
```typescript
Custom stringify for primitives: 9554433.759 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5843826.655 ops/s (100 runs over 1000 unique samples each)
```

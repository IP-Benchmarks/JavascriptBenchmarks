...
```typescript
Custom stringify for primitives: 10222806.058 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5034311.602 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/15/2025 1:8:9`

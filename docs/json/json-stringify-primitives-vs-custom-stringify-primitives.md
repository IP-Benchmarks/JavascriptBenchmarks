...
#### **Custom stringify for primitives** is **_`1.64x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10431925.531 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6377596.575 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/19/2024 1:13:20`

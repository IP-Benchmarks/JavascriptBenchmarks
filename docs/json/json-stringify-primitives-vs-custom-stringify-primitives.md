...
```typescript
Custom stringify for primitives: 3958968.459 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3063143.455 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4723698.587 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2917899.868 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10500199.031 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6612722.283 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10176488.810 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6903196.408 ops/s (100 runs over 1000 unique samples each)
```

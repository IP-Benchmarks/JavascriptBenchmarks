...
```typescript
Custom stringify for primitives: 9760738.911 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6863364.281 ops/s (100 runs over 1000 unique samples each)
```

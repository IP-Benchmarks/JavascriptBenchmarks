...
```typescript
Custom stringify for primitives: 6180677.139 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4450661.920 ops/s (100 runs over 1000 unique samples each)
```

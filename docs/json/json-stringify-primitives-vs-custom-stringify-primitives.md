...
```typescript
Custom stringify for primitives: 5705174.712 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4409291.612 ops/s (100 runs over 1000 unique samples each)
```

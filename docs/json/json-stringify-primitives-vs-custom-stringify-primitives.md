...
```typescript
Custom stringify for primitives: 9859118.131 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6610539.659 ops/s (100 runs over 1000 unique samples each)
```

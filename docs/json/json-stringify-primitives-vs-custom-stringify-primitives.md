...
```typescript
Custom stringify for primitives: 4855726.414 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3802892.435 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10615683.079 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6854611.899 ops/s (100 runs over 1000 unique samples each)
```

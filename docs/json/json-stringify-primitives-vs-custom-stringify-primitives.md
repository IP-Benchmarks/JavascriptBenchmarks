...
```typescript
Custom stringify for primitives: 10112027.103 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6138892.190 ops/s (100 runs over 1000 unique samples each)
```

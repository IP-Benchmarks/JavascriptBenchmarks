...
```typescript
Custom stringify for primitives: 9683224.917 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6669858.416 ops/s (100 runs over 1000 unique samples each)
```

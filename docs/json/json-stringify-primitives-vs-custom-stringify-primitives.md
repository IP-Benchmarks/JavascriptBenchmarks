...
```typescript
Custom stringify for primitives: 4315437.416 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3444081.920 ops/s (100 runs over 1000 unique samples each)
```

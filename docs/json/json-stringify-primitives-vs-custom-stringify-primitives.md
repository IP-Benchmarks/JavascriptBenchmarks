...
```typescript
Custom stringify for primitives: 8338140.966 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4795551.951 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/18/2024 0:53:17`

...
#### **Custom stringify for primitives** is **_`2.18x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 11373116.114 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5217548.012 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/15/2026 1:3:12`

...
```typescript
Custom stringify for primitives: 8208881.223 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5741474.384 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5116075.307 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3667944.910 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8228612.579 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4690656.810 ops/s (100 runs over 1000 unique samples each)
```

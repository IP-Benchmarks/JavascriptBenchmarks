...
```typescript
Custom stringify for primitives: 8637995.429 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6054589.267 ops/s (100 runs over 1000 unique samples each)
```

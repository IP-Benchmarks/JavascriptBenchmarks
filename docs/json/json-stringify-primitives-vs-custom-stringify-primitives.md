...
```typescript
Custom stringify for primitives: 5792381.246 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4269132.245 ops/s (100 runs over 1000 unique samples each)
```

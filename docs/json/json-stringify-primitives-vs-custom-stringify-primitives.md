...
```typescript
Custom stringify for primitives: 7870122.208 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4379764.855 ops/s (100 runs over 1000 unique samples each)
```

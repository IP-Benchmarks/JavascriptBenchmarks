...
```typescript
Custom stringify for primitives: 4719481.567 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3437098.181 ops/s (100 runs over 1000 unique samples each)
```

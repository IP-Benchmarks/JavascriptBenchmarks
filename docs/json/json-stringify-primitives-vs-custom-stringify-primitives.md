...
```typescript
Custom stringify for primitives: 4846706.665 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3687243.711 ops/s (100 runs over 1000 unique samples each)
```

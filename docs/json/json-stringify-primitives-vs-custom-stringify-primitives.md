...
```typescript
Custom stringify for primitives: 5460530.791 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4387114.606 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/30/2022 0:45:12`

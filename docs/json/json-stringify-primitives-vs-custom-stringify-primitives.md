...
```typescript
Custom stringify for primitives: 9993711.956 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6673391.666 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9036595.047 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6938278.531 ops/s (100 runs over 1000 unique samples each)
```

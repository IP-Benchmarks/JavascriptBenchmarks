...
```typescript
Custom stringify for primitives: 4683250.244 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3594156.607 ops/s (100 runs over 1000 unique samples each)
```

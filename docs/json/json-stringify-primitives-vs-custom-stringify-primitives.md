...
```typescript
Custom stringify for primitives: 5654225.881 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4378051.968 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9368033.403 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6639522.528 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6424328.572 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4212373.021 ops/s (100 runs over 1000 unique samples each)
```

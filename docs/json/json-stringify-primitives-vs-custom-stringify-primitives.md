...
```typescript
Custom stringify for primitives: 5011556.398 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3667958.228 ops/s (100 runs over 1000 unique samples each)
```

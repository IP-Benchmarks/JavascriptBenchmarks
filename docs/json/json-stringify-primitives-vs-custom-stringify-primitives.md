...
```typescript
Custom stringify for primitives: 8395553.483 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4645219.717 ops/s (100 runs over 1000 unique samples each)
```

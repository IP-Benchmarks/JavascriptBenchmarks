...
```typescript
Custom stringify for primitives: 8483515.594 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5123777.921 ops/s (100 runs over 1000 unique samples each)
```

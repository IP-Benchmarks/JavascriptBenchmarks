...
```typescript
Custom stringify for primitives: 3598931.089 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2971373.314 ops/s (100 runs over 1000 unique samples each)
```

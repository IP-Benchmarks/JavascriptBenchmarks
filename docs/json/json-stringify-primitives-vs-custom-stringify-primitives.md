...
```typescript
Custom stringify for primitives: 10276041.184 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7110234.877 ops/s (100 runs over 1000 unique samples each)
```

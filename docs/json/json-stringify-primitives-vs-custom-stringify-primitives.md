...
```typescript
Custom stringify for primitives: 5508583.557 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4340769.881 ops/s (100 runs over 1000 unique samples each)
```

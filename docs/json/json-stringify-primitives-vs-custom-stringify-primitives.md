...
```typescript
Custom stringify for primitives: 10140423.571 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6549374.358 ops/s (100 runs over 1000 unique samples each)
```

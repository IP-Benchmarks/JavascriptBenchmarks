...
```typescript
Custom stringify for primitives: 8405198.480 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6184659.840 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/28/2024 0:58:50`

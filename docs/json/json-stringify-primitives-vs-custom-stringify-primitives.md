...
```typescript
Custom stringify for primitives: 9917939.957 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6990828.103 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/18/2026 3:27:21`

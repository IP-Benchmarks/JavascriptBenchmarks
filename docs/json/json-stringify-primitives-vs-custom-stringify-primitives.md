...
```typescript
Custom stringify for primitives: 8479178.736 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5864905.192 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8587758.566 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4909417.565 ops/s (100 runs over 1000 unique samples each)
```

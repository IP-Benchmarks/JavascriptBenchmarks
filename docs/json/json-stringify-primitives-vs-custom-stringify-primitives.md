...
```typescript
Custom stringify for primitives: 5590814.025 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3953672.760 ops/s (100 runs over 1000 unique samples each)
```

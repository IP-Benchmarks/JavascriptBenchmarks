...
```typescript
Custom stringify for primitives: 5786065.661 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4362590.992 ops/s (100 runs over 1000 unique samples each)
```

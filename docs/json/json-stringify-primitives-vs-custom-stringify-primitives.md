...
```typescript
Custom stringify for primitives: 4167286.029 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3494600.894 ops/s (100 runs over 1000 unique samples each)
```

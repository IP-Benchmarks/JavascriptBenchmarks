...
```typescript
Custom stringify for primitives: 10637428.772 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5458017.746 ops/s (100 runs over 1000 unique samples each)
```

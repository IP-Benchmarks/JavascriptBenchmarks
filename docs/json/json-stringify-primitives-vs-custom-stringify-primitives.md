...
```typescript
Custom stringify for primitives: 5594542.681 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4416157.484 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4863980.726 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3832839.152 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9947819.707 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5636387.617 ops/s (100 runs over 1000 unique samples each)
```

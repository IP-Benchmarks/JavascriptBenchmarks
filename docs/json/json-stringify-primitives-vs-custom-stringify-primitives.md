...
```typescript
Custom stringify for primitives: 9195066.626 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6875534.401 ops/s (100 runs over 1000 unique samples each)
```

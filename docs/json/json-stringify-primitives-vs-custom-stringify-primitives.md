...
```typescript
Custom stringify for primitives: 9971768.925 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5860508.070 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5255969.941 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3575184.558 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/17/2022 1:58:25`

...
```typescript
Custom stringify for primitives: 4508529.890 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3129884.282 ops/s (100 runs over 1000 unique samples each)
```

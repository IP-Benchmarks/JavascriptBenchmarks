...
```typescript
Custom stringify for primitives: 4730795.948 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3508805.048 ops/s (100 runs over 1000 unique samples each)
```

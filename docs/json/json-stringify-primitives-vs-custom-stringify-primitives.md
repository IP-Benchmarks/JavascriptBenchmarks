...
```typescript
Custom stringify for primitives: 10215851.753 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5590376.145 ops/s (100 runs over 1000 unique samples each)
```

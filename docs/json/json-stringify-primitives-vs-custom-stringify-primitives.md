...
```typescript
Custom stringify for primitives: 10397815.211 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6783308.827 ops/s (100 runs over 1000 unique samples each)
```

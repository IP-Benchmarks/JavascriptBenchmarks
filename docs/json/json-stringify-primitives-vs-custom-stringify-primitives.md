...
```typescript
Custom stringify for primitives: 8880990.730 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5972413.779 ops/s (100 runs over 1000 unique samples each)
```

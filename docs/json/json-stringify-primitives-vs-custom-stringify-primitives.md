...
```typescript
Custom stringify for primitives: 10632362.978 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6491151.976 ops/s (100 runs over 1000 unique samples each)
```

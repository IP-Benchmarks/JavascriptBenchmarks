...
```typescript
Custom stringify for primitives: 10322788.433 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7000490.174 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10330660.688 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5612282.953 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/7/2025 1:20:6`

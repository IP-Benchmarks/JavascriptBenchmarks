...
```typescript
Custom stringify for primitives: 8547413.269 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4735053.177 ops/s (100 runs over 1000 unique samples each)
```

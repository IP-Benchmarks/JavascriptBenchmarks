...
```typescript
Custom stringify for primitives: 10135892.930 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6823155.278 ops/s (100 runs over 1000 unique samples each)
```

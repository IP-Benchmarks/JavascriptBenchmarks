...
```typescript
Custom stringify for primitives: 5881300.879 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4590637.477 ops/s (100 runs over 1000 unique samples each)
```

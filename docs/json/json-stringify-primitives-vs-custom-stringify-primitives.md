...
```typescript
Custom stringify for primitives: 5050756.313 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4154076.527 ops/s (100 runs over 1000 unique samples each)
```

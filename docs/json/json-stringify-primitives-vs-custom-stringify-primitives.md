...
```typescript
Custom stringify for primitives: 8567967.114 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6406351.823 ops/s (100 runs over 1000 unique samples each)
```

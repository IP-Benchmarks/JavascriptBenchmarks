...
```typescript
Custom stringify for primitives: 10316071.005 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6744184.776 ops/s (100 runs over 1000 unique samples each)
```

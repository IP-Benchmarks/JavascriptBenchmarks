...
```typescript
Custom stringify for primitives: 10308042.448 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5957922.530 ops/s (100 runs over 1000 unique samples each)
```

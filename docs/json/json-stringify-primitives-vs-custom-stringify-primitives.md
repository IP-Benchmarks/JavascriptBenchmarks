...
```typescript
Custom stringify for primitives: 8711057.110 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6116312.695 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6565722.186 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4280845.925 ops/s (100 runs over 1000 unique samples each)
```

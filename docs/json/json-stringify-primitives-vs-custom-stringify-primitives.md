...
```typescript
Custom stringify for primitives: 7781358.153 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4599565.084 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8842302.139 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6131879.685 ops/s (100 runs over 1000 unique samples each)
```

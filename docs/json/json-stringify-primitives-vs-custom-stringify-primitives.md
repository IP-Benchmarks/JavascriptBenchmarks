...
```typescript
Custom stringify for primitives: 8486066.981 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4774589.481 ops/s (100 runs over 1000 unique samples each)
```

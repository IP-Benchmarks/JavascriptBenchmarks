...
```typescript
Custom stringify for primitives: 10421773.336 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6858835.226 ops/s (100 runs over 1000 unique samples each)
```

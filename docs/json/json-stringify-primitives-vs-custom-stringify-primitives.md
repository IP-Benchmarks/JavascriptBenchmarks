...
```typescript
Custom stringify for primitives: 3699440.852 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3274191.182 ops/s (100 runs over 1000 unique samples each)
```

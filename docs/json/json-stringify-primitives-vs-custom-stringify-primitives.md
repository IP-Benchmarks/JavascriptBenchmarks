...
```typescript
Custom stringify for primitives: 9982261.521 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6831966.086 ops/s (100 runs over 1000 unique samples each)
```

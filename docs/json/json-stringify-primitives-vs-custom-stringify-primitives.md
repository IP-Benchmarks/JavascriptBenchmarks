...
```typescript
Custom stringify for primitives: 10090750.152 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6777363.146 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6083021.071 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4396676.412 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/17/2023 1:2:56`

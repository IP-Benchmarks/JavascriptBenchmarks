...
```typescript
Custom stringify for primitives: 8976433.451 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5910734.551 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 12969322.494 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 8859425.982 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7778507.315 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6024424.825 ops/s (100 runs over 1000 unique samples each)
```

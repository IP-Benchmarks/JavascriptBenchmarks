...
```typescript
Custom stringify for primitives: 10773327.783 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5552989.149 ops/s (100 runs over 1000 unique samples each)
```

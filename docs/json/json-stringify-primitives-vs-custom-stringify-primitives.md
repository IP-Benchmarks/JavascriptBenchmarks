...
```typescript
Custom stringify for primitives: 4642034.393 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3441802.071 ops/s (100 runs over 1000 unique samples each)
```

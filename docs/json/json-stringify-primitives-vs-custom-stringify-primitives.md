...
```typescript
Custom stringify for primitives: 10016438.980 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5800896.413 ops/s (100 runs over 1000 unique samples each)
```

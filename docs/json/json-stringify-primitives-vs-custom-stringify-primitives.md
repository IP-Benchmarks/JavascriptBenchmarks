...
```typescript
Custom stringify for primitives: 5154446.814 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4202964.165 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/16/2023 0:49:52`

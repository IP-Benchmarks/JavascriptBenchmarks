...
```typescript
Custom stringify for primitives: 8183543.126 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4695230.918 ops/s (100 runs over 1000 unique samples each)
```

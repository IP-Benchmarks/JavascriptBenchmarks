...
```typescript
Custom stringify for primitives: 5590031.454 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4321044.442 ops/s (100 runs over 1000 unique samples each)
```

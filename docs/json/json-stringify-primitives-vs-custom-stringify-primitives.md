...
```typescript
Custom stringify for primitives: 8404421.428 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5902695.367 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/10/2024 0:55:16`

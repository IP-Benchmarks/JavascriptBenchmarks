...
```typescript
Custom stringify for primitives: 5869497.707 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4299847.823 ops/s (100 runs over 1000 unique samples each)
```

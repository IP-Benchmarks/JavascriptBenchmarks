...
```typescript
Custom stringify for primitives: 8762485.556 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5814411.203 ops/s (100 runs over 1000 unique samples each)
```

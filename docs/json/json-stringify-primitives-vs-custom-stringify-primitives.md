...
```typescript
Custom stringify for primitives: 8917872.365 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5673784.296 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/5/2024 0:58:12`

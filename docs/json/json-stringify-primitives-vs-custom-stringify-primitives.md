...
```typescript
Custom stringify for primitives: 4548751.357 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3515354.277 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9221217.468 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5320501.419 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5286462.290 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4514989.653 ops/s (100 runs over 1000 unique samples each)
```

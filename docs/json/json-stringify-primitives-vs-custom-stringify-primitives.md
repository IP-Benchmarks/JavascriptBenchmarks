...
```typescript
Custom stringify for primitives: 5156292.910 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4298237.876 ops/s (100 runs over 1000 unique samples each)
```

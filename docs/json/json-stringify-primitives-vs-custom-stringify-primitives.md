...
#### **Custom stringify for primitives** is **_`1.33x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5621722.604 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4216299.362 ops/s (100 runs over 1000 unique samples each)
```

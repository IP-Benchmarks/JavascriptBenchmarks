...
```typescript
Custom stringify for primitives: 10757695.706 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6831105.494 ops/s (100 runs over 1000 unique samples each)
```

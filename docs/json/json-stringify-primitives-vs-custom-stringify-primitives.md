...
```typescript
Custom stringify for primitives: 5092180.951 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3586091.588 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10578802.238 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5785922.042 ops/s (100 runs over 1000 unique samples each)
```

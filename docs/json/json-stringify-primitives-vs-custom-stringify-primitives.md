...
```typescript
Custom stringify for primitives: 8539557.967 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4664974.370 ops/s (100 runs over 1000 unique samples each)
```

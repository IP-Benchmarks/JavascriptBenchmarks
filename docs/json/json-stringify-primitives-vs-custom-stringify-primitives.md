...
```typescript
Custom stringify for primitives: 10108280.916 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6602706.687 ops/s (100 runs over 1000 unique samples each)
```

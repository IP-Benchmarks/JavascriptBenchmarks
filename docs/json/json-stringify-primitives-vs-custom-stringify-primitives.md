...
```typescript
Custom stringify for primitives: 8906985.512 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6109135.554 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5419522.236 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3948922.270 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/16/2023 1:2:22`

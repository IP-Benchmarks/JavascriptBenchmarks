...
```typescript
Custom stringify for primitives: 8572872.981 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6260007.011 ops/s (100 runs over 1000 unique samples each)
```

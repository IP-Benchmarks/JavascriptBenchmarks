...
```typescript
Custom stringify for primitives: 5344347.535 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2686256.425 ops/s (100 runs over 1000 unique samples each)
```

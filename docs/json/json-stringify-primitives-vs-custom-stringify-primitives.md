...
```typescript
Custom stringify for primitives: 9964157.928 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6824781.848 ops/s (100 runs over 1000 unique samples each)
```

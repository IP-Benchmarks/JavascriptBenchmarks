...
```typescript
Custom stringify for primitives: 7474483.429 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6343142.307 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/7/2024 0:50:36`

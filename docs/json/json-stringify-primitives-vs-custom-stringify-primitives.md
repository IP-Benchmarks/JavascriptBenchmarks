...
#### **Custom stringify for primitives** is **_`1.89x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10434104.664 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5524528.881 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4045351.628 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3310377.520 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/1/2023 1:1:0`

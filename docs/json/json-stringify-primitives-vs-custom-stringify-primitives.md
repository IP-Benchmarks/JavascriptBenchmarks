...
```typescript
Custom stringify for primitives: 6139249.850 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3726340.255 ops/s (100 runs over 1000 unique samples each)
```

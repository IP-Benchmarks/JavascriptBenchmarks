...
```typescript
Custom stringify for primitives: 8473858.866 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4659658.540 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/4/2023 0:51:50`

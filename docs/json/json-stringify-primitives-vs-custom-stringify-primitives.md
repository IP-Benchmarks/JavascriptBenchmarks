...
```typescript
Custom stringify for primitives: 6363851.288 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4689981.660 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9210817.184 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5734284.934 ops/s (100 runs over 1000 unique samples each)
```

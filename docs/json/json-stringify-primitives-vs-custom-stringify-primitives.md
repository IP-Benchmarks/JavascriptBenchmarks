...
```typescript
Custom stringify for primitives: 5381402.606 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4385414.427 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5179908.853 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3771346.719 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4457659.523 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3777701.032 ops/s (100 runs over 1000 unique samples each)
```

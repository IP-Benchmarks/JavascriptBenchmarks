...
```typescript
Custom stringify for primitives: 8255435.046 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5779540.358 ops/s (100 runs over 1000 unique samples each)
```

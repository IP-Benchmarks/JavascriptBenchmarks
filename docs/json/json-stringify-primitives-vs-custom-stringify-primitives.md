...
```typescript
Custom stringify for primitives: 8872520.076 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6009147.724 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5255839.277 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3766434.649 ops/s (100 runs over 1000 unique samples each)
```

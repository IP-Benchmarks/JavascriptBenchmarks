...
```typescript
Custom stringify for primitives: 8393540.898 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4622703.492 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8887257.581 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4883467.285 ops/s (100 runs over 1000 unique samples each)
```

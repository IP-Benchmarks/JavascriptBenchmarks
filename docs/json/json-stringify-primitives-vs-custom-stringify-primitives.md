...
```typescript
Custom stringify for primitives: 7789329.184 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6256164.667 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5967276.055 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4326461.643 ops/s (100 runs over 1000 unique samples each)
```

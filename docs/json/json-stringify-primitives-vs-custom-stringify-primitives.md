...
```typescript
Custom stringify for primitives: 5104010.548 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3184528.085 ops/s (100 runs over 1000 unique samples each)
```

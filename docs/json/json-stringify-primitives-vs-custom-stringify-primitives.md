...
```typescript
Custom stringify for primitives: 10245364.178 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6829347.646 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8707608.097 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5810998.666 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6070231.978 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4296666.243 ops/s (100 runs over 1000 unique samples each)
```

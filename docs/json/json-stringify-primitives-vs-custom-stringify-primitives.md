...
```typescript
Custom stringify for primitives: 5150725.686 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4324964.326 ops/s (100 runs over 1000 unique samples each)
```

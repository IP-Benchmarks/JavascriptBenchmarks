...
```typescript
Custom stringify for primitives: 5246084.926 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3889583.742 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5220035.729 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4186918.617 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10206512.449 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5218022.004 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/31/2025 1:18:28`

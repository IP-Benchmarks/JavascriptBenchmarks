...
```typescript
Custom stringify for primitives: 7232343.969 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5111316.029 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8645713.783 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6240147.976 ops/s (100 runs over 1000 unique samples each)
```

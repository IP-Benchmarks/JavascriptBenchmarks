...
```typescript
Custom stringify for primitives: 5774851.364 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4419006.287 ops/s (100 runs over 1000 unique samples each)
```

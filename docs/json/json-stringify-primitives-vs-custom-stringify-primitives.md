...
```typescript
Custom stringify for primitives: 4399820.682 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3160796.414 ops/s (100 runs over 1000 unique samples each)
```

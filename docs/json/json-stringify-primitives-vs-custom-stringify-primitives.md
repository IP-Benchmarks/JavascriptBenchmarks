...
```typescript
Custom stringify for primitives: 11589352.167 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 8403892.414 ops/s (100 runs over 1000 unique samples each)
```

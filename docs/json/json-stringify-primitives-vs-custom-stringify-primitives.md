...
```typescript
Custom stringify for primitives: 9672644.813 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5474715.001 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8874352.306 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5931600.579 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/23/2023 0:52:13`

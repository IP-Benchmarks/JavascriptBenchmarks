...
```typescript
Custom stringify for primitives: 5066893.122 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3826099.932 ops/s (100 runs over 1000 unique samples each)
```

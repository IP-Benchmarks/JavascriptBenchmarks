...
```typescript
Custom stringify for primitives: 9718810.515 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6806562.397 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9719605.893 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6541268.799 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/10/2026 2:10:24`

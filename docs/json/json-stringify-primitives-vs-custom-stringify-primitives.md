...
```typescript
Custom stringify for primitives: 5713380.061 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3760774.289 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6358583.948 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4297665.787 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/29/2022 1:13:54`

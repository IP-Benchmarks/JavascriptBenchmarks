...
```typescript
Custom stringify for primitives: 6008459.190 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3456278.697 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4551377.129 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3771158.698 ops/s (100 runs over 1000 unique samples each)
```

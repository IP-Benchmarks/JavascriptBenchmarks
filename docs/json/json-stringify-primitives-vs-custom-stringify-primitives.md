...
```typescript
Custom stringify for primitives: 10457653.041 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6346510.190 ops/s (100 runs over 1000 unique samples each)
```

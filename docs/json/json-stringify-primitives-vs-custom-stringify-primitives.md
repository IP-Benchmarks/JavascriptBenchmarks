...
```typescript
Custom stringify for primitives: 5668572.080 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4332004.477 ops/s (100 runs over 1000 unique samples each)
```

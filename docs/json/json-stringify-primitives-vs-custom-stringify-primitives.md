...
```typescript
Custom stringify for primitives: 3674827.319 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3004544.615 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10397623.852 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6928832.438 ops/s (100 runs over 1000 unique samples each)
```

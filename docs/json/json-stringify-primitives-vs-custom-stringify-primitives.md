...
```typescript
Custom stringify for primitives: 9450370.247 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6361578.104 ops/s (100 runs over 1000 unique samples each)
```

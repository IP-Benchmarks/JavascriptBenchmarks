...
```typescript
Custom stringify for primitives: 5584183.493 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4368198.033 ops/s (100 runs over 1000 unique samples each)
```

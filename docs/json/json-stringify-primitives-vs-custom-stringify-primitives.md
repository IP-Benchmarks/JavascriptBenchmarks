...
```typescript
Custom stringify for primitives: 4975687.299 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3673556.998 ops/s (100 runs over 1000 unique samples each)
```

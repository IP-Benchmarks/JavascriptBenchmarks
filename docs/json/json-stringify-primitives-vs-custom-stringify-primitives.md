...
```typescript
Custom stringify for primitives: 8916476.075 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6148201.159 ops/s (100 runs over 1000 unique samples each)
```

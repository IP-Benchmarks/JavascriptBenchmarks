...
```typescript
Custom stringify for primitives: 4737390.571 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3641154.867 ops/s (100 runs over 1000 unique samples each)
```

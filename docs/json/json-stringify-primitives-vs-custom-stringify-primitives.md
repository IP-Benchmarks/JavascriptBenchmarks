...
```typescript
Custom stringify for primitives: 8573767.496 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5996198.888 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7860546.982 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4484339.316 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9230229.333 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5622034.552 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5535476.229 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4331792.991 ops/s (100 runs over 1000 unique samples each)
```

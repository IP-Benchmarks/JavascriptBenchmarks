...
```typescript
Custom stringify for primitives: 8285522.422 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4367813.582 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8521192.977 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6143428.410 ops/s (100 runs over 1000 unique samples each)
```

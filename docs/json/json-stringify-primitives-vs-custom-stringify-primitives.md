...
```typescript
Custom stringify for primitives: 5877454.258 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4308710.303 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8294298.294 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4758376.765 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/8/2024 0:45:6`

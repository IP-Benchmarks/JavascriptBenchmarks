...
```typescript
Custom stringify for primitives: 7853209.071 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4638189.451 ops/s (100 runs over 1000 unique samples each)
```

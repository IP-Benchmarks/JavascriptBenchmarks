...
```typescript
Custom stringify for primitives: 10320418.018 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6353037.130 ops/s (100 runs over 1000 unique samples each)
```

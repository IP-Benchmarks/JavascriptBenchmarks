...
```typescript
Custom stringify for primitives: 10141204.098 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6898283.907 ops/s (100 runs over 1000 unique samples each)
```

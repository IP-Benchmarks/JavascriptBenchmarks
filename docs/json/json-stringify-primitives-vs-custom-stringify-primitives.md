...
```typescript
Custom stringify for primitives: 4462068.624 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3082828.163 ops/s (100 runs over 1000 unique samples each)
```

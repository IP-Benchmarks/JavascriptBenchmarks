...
```typescript
Custom stringify for primitives: 8851488.401 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5822927.569 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8877138.717 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4524348.051 ops/s (100 runs over 1000 unique samples each)
```

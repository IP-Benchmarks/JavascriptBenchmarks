...
```typescript
Custom stringify for primitives: 5939285.886 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4713396.950 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5117696.267 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4121026.131 ops/s (100 runs over 1000 unique samples each)
```

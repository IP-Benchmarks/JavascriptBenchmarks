...
```typescript
Custom stringify for primitives: 10413875.531 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4966826.319 ops/s (100 runs over 1000 unique samples each)
```

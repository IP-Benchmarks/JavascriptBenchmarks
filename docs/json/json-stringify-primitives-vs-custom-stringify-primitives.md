...
```typescript
Custom stringify for primitives: 7478844.779 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5465965.344 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5518736.083 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4359759.696 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.36x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5057407.133 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3718606.086 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8500859.058 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4536318.604 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/10/2024 1:16:47`

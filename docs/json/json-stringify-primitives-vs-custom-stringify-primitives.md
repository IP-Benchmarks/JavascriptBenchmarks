...
```typescript
Custom stringify for primitives: 6070900.100 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4210384.138 ops/s (100 runs over 1000 unique samples each)
```

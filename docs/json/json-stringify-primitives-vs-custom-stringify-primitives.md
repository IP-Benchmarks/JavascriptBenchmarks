...
#### **Custom stringify for primitives** is **_`1.90x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10125048.398 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5338467.658 ops/s (100 runs over 1000 unique samples each)
```

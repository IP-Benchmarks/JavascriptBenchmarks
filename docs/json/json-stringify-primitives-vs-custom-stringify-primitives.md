...
```typescript
Custom stringify for primitives: 8636824.148 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5991426.866 ops/s (100 runs over 1000 unique samples each)
```

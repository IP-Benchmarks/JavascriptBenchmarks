...
```typescript
Custom stringify for primitives: 9750966.175 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6734535.066 ops/s (100 runs over 1000 unique samples each)
```

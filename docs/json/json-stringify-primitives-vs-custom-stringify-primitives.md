...
```typescript
Custom stringify for primitives: 6526677.272 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4823996.488 ops/s (100 runs over 1000 unique samples each)
```

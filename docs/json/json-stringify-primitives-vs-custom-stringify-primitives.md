...
```typescript
Custom stringify for primitives: 8839007.813 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4464909.407 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/2/2024 1:16:42`

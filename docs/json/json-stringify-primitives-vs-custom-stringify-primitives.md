...
```typescript
Custom stringify for primitives: 6195447.535 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4274557.568 ops/s (100 runs over 1000 unique samples each)
```

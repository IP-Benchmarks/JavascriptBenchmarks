...
```typescript
Custom stringify for primitives: 6286186.434 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4499094.851 ops/s (100 runs over 1000 unique samples each)
```

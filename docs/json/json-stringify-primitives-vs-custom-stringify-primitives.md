...
```typescript
Custom stringify for primitives: 9699469.691 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6166934.856 ops/s (100 runs over 1000 unique samples each)
```

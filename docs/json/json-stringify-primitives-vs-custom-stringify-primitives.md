...
```typescript
Custom stringify for primitives: 6559185.664 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4536759.434 ops/s (100 runs over 1000 unique samples each)
```

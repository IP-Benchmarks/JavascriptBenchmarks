...
```typescript
Custom stringify for primitives: 5679554.750 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3966322.116 ops/s (100 runs over 1000 unique samples each)
```

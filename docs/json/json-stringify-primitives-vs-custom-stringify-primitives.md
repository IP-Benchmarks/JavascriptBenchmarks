...
```typescript
Custom stringify for primitives: 5503524.924 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4217933.718 ops/s (100 runs over 1000 unique samples each)
```

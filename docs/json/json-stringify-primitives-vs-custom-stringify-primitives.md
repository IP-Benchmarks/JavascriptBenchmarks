...
#### **Custom stringify for primitives** is **_`1.48x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10404037.682 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7020505.774 ops/s (100 runs over 1000 unique samples each)
```

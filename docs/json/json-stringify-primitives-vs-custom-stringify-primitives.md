...
```typescript
Custom stringify for primitives: 5541513.975 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4440860.966 ops/s (100 runs over 1000 unique samples each)
```

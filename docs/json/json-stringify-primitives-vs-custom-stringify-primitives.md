...
```typescript
Custom stringify for primitives: 9807474.374 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5856139.826 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9079727.819 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6735903.220 ops/s (100 runs over 1000 unique samples each)
```

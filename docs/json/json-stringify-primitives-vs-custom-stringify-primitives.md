...
```typescript
Custom stringify for primitives: 8185225.096 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5601792.439 ops/s (100 runs over 1000 unique samples each)
```

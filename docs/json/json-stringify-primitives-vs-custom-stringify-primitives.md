...
```typescript
Custom stringify for primitives: 8973978.159 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6045034.782 ops/s (100 runs over 1000 unique samples each)
```

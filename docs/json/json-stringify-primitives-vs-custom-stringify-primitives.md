...
```typescript
Custom stringify for primitives: 6207395.153 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4106308.044 ops/s (100 runs over 1000 unique samples each)
```

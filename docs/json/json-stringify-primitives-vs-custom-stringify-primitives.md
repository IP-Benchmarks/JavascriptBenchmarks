...
```typescript
Custom stringify for primitives: 10847831.822 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5765440.325 ops/s (100 runs over 1000 unique samples each)
```

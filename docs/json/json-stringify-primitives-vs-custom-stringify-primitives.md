...
```typescript
Custom stringify for primitives: 9135977.705 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6129934.131 ops/s (100 runs over 1000 unique samples each)
```

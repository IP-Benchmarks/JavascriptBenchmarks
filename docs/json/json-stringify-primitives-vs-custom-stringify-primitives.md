...
```typescript
Custom stringify for primitives: 10074380.156 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6556354.258 ops/s (100 runs over 1000 unique samples each)
```

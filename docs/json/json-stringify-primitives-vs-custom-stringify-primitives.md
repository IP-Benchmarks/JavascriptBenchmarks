...
```typescript
Custom stringify for primitives: 4917284.150 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4401510.158 ops/s (100 runs over 1000 unique samples each)
```

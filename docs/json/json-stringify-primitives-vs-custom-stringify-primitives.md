...
```typescript
Custom stringify for primitives: 8604308.084 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5592375.758 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5768779.251 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4300221.143 ops/s (100 runs over 1000 unique samples each)
```

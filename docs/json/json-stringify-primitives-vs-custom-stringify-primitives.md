...
```typescript
Custom stringify for primitives: 5720172.262 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4325928.426 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10532152.820 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5264623.400 ops/s (100 runs over 1000 unique samples each)
```

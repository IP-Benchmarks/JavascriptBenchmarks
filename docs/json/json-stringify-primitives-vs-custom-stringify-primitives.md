...
```typescript
Custom stringify for primitives: 9348406.704 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6801814.180 ops/s (100 runs over 1000 unique samples each)
```

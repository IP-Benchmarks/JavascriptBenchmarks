...
```typescript
Custom stringify for primitives: 10317227.934 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6951771.322 ops/s (100 runs over 1000 unique samples each)
```

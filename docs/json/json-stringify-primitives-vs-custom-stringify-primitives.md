...
```typescript
Custom stringify for primitives: 10902499.060 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6833248.510 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/23/2025 1:18:36`

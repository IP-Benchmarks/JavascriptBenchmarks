...
```typescript
Custom stringify for primitives: 6490028.007 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4675219.076 ops/s (100 runs over 1000 unique samples each)
```

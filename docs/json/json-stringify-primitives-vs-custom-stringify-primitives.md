...
```typescript
Custom stringify for primitives: 5445140.805 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4116868.002 ops/s (100 runs over 1000 unique samples each)
```

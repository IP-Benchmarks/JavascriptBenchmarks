...
```typescript
Custom stringify for primitives: 10055353.717 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6911749.470 ops/s (100 runs over 1000 unique samples each)
```

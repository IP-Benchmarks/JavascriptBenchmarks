...
```typescript
Custom stringify for primitives: 8199899.109 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4827638.345 ops/s (100 runs over 1000 unique samples each)
```

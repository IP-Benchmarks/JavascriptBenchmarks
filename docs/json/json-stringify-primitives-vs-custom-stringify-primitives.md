...
```typescript
Custom stringify for primitives: 8670967.813 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6195819.495 ops/s (100 runs over 1000 unique samples each)
```

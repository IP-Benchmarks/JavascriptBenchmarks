...
```typescript
Custom stringify for primitives: 3320508.974 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2917944.739 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8272791.667 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5812797.013 ops/s (100 runs over 1000 unique samples each)
```

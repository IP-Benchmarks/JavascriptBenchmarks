...
```typescript
Custom stringify for primitives: 4930318.575 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3651111.205 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9136976.064 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6431941.537 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/4/2024 0:55:55`

...
```typescript
Custom stringify for primitives: 9292419.430 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4781396.695 ops/s (100 runs over 1000 unique samples each)
```

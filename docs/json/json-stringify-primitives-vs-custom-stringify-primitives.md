...
```typescript
Custom stringify for primitives: 6717143.312 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4430979.781 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4309065.109 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3135394.420 ops/s (100 runs over 1000 unique samples each)
```

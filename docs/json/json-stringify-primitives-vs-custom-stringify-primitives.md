...
```typescript
Custom stringify for primitives: 10052155.609 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5734834.445 ops/s (100 runs over 1000 unique samples each)
```

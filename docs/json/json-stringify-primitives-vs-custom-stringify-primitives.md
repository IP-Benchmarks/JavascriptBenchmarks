...
```typescript
Custom stringify for primitives: 9594381.223 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5117844.773 ops/s (100 runs over 1000 unique samples each)
```

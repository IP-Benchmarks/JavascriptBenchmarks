...
```typescript
Custom stringify for primitives: 8958471.928 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6708688.550 ops/s (100 runs over 1000 unique samples each)
```

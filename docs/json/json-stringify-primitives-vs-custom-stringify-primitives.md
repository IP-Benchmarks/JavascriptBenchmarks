...
```typescript
Custom stringify for primitives: 4312380.383 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3171668.224 ops/s (100 runs over 1000 unique samples each)
```

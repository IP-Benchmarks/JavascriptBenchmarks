...
```typescript
Custom stringify for primitives: 5733600.742 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4189397.815 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8753540.479 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6885614.519 ops/s (100 runs over 1000 unique samples each)
```

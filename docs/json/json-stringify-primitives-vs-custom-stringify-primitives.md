...
```typescript
Custom stringify for primitives: 5721312.139 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4284222.887 ops/s (100 runs over 1000 unique samples each)
```

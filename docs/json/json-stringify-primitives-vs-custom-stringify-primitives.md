...
```typescript
Custom stringify for primitives: 4837998.180 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3602429.406 ops/s (100 runs over 1000 unique samples each)
```

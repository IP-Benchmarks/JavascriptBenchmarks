...
```typescript
Custom stringify for primitives: 7519070.620 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4210205.454 ops/s (100 runs over 1000 unique samples each)
```

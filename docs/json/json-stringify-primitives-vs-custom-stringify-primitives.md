...
```typescript
Custom stringify for primitives: 4676079.115 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3688520.116 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5721010.681 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4243332.187 ops/s (100 runs over 1000 unique samples each)
```

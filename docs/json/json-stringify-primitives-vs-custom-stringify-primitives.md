...
```typescript
Custom stringify for primitives: 6946898.053 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5923485.979 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/16/2024 1:11:25`

...
```typescript
Custom stringify for primitives: 5046197.178 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3701071.556 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8676306.274 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5257417.901 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8864072.637 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5682316.353 ops/s (100 runs over 1000 unique samples each)
```

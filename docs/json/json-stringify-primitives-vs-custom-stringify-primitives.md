...
```typescript
Custom stringify for primitives: 9679275.278 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4848169.864 ops/s (100 runs over 1000 unique samples each)
```

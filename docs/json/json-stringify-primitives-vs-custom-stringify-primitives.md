...
#### **Custom stringify for primitives** is **_`2.16x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10350389.671 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4794980.078 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/15/2025 1:17:54`

...
#### **Custom stringify for primitives** is **_`1.63x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10722664.711 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6582741.973 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9784481.148 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5383682.392 ops/s (100 runs over 1000 unique samples each)
```

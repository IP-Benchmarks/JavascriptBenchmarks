...
```typescript
Custom stringify for primitives: 10507330.702 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6538941.949 ops/s (100 runs over 1000 unique samples each)
```

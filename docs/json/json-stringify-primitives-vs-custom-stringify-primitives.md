...
```typescript
Custom stringify for primitives: 8375017.193 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6156078.255 ops/s (100 runs over 1000 unique samples each)
```

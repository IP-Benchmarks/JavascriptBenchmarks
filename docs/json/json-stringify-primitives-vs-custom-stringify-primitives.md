...
```typescript
Custom stringify for primitives: 6303927.738 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3616275.816 ops/s (100 runs over 1000 unique samples each)
```

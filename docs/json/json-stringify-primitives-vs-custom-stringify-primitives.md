...
```typescript
Custom stringify for primitives: 9826150.827 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6661154.339 ops/s (100 runs over 1000 unique samples each)
```

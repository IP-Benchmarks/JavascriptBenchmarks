...
```typescript
Custom stringify for primitives: 9625049.461 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6795191.369 ops/s (100 runs over 1000 unique samples each)
```

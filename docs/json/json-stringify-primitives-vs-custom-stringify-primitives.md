...
```typescript
Custom stringify for primitives: 9404476.564 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5972502.956 ops/s (100 runs over 1000 unique samples each)
```

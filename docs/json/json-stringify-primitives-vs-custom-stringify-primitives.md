...
```typescript
Custom stringify for primitives: 10210023.241 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5298517.130 ops/s (100 runs over 1000 unique samples each)
```

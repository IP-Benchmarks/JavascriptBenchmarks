...
```typescript
Custom stringify for primitives: 4708374.357 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3463139.657 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8858465.374 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5909758.927 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/15/2024 1:13:8`

...
```typescript
Custom stringify for primitives: 9483473.151 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6584889.365 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10790213.751 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6808474.481 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4198215.910 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3270398.546 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10498197.197 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5886053.191 ops/s (100 runs over 1000 unique samples each)
```

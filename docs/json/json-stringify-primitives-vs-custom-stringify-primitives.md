...
```typescript
Custom stringify for primitives: 10499953.170 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5923434.749 ops/s (100 runs over 1000 unique samples each)
```

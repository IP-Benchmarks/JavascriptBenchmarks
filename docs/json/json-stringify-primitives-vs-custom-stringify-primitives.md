...
```typescript
Custom stringify for primitives: 7932970.206 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6336175.149 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/16/2023 0:55:5`

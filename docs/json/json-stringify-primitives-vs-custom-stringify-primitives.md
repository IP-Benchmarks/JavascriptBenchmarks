...
```typescript
Custom stringify for primitives: 5717126.963 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4432583.639 ops/s (100 runs over 1000 unique samples each)
```

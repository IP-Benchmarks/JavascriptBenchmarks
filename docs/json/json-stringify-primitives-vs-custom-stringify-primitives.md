...
```typescript
Custom stringify for primitives: 10399160.330 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4898445.909 ops/s (100 runs over 1000 unique samples each)
```

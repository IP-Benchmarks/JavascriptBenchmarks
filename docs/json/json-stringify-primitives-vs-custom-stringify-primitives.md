...
```typescript
Custom stringify for primitives: 8758187.915 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6084583.004 ops/s (100 runs over 1000 unique samples each)
```

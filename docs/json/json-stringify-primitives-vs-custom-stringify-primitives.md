...
```typescript
Custom stringify for primitives: 5782395.059 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4765879.959 ops/s (100 runs over 1000 unique samples each)
```

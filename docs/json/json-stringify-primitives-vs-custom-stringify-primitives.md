...
```typescript
Custom stringify for primitives: 7933129.432 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6265395.644 ops/s (100 runs over 1000 unique samples each)
```

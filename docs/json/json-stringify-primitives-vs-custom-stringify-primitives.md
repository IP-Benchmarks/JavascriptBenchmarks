...
```typescript
Custom stringify for primitives: 6072608.480 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4520099.255 ops/s (100 runs over 1000 unique samples each)
```

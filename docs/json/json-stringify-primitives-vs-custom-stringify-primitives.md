...
```typescript
Custom stringify for primitives: 8967463.800 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4720294.912 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/31/2024 0:53:8`

...
```typescript
Custom stringify for primitives: 5542207.149 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4738491.424 ops/s (100 runs over 1000 unique samples each)
```

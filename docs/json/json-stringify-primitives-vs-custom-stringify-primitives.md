...
```typescript
Custom stringify for primitives: 5070570.167 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3897528.823 ops/s (100 runs over 1000 unique samples each)
```

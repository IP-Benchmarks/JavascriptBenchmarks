...
```typescript
Custom stringify for primitives: 8840082.204 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5858571.618 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4288364.741 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3715885.202 ops/s (100 runs over 1000 unique samples each)
```

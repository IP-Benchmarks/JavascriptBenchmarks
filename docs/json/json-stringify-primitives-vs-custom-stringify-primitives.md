...
```typescript
Custom stringify for primitives: 4532017.322 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3569335.665 ops/s (100 runs over 1000 unique samples each)
```

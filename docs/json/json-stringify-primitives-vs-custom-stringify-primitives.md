...
```typescript
Custom stringify for primitives: 5011819.122 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3351386.582 ops/s (100 runs over 1000 unique samples each)
```

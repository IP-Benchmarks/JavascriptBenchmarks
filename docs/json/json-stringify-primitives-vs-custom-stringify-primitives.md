...
```typescript
Custom stringify for primitives: 6394747.508 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3929081.339 ops/s (100 runs over 1000 unique samples each)
```

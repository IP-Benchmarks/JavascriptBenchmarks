...
```typescript
Custom stringify for primitives: 10282636.781 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6756023.180 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8417531.094 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5647200.521 ops/s (100 runs over 1000 unique samples each)
```

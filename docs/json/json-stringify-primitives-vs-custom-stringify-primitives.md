...
```typescript
Custom stringify for primitives: 5360256.975 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4016789.861 ops/s (100 runs over 1000 unique samples each)
```

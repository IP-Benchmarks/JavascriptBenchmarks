...
```typescript
Custom stringify for primitives: 10338004.147 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5720996.607 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8991229.060 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5014035.288 ops/s (100 runs over 1000 unique samples each)
```

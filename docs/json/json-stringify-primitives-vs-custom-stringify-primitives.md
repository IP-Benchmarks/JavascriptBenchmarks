...
```typescript
Custom stringify for primitives: 6043520.116 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4247209.508 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8542304.440 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5861794.936 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/3/2024 0:57:13`

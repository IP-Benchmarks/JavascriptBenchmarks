...
```typescript
Custom stringify for primitives: 10596502.561 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6774055.314 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.38x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 8611580.675 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6261066.829 ops/s (100 runs over 1000 unique samples each)
```

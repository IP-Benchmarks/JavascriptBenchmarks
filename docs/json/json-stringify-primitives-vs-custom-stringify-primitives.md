...
```typescript
Custom stringify for primitives: 10185378.990 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6743870.496 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/4/2025 1:10:21`

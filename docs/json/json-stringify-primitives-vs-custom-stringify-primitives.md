...
```typescript
Custom stringify for primitives: 6277710.205 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4398907.734 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/10/2023 1:8:22`

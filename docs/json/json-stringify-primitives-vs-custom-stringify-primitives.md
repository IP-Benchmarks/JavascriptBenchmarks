...
```typescript
Custom stringify for primitives: 5827918.468 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4133764.314 ops/s (100 runs over 1000 unique samples each)
```

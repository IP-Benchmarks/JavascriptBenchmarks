...
```typescript
Custom stringify for primitives: 10365553.689 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5252016.985 ops/s (100 runs over 1000 unique samples each)
```

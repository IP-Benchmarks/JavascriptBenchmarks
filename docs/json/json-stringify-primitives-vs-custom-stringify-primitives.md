...
```typescript
Custom stringify for primitives: 9900346.086 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5469549.323 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8264828.921 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4690264.545 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/28/2024 1:4:4`

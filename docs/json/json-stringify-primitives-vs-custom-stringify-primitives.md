...
```typescript
Custom stringify for primitives: 8522083.274 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5815292.358 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10087686.203 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6332223.126 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/11/2025 1:14:40`

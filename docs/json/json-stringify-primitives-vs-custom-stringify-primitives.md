...
```typescript
Custom stringify for primitives: 5449901.643 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4458117.590 ops/s (100 runs over 1000 unique samples each)
```

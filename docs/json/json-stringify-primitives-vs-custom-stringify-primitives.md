...
```typescript
Custom stringify for primitives: 6484420.305 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4479178.583 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4578037.060 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3546622.480 ops/s (100 runs over 1000 unique samples each)
```

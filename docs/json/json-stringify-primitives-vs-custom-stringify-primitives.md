...
```typescript
Custom stringify for primitives: 6180505.240 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4125421.901 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/11/2022 1:1:35`

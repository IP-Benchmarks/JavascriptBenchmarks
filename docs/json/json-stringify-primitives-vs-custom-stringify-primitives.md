...
```typescript
Custom stringify for primitives: 5666105.044 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4587855.296 ops/s (100 runs over 1000 unique samples each)
```

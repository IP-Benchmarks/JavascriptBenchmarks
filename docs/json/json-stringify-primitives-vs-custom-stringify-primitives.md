...
```typescript
Custom stringify for primitives: 10703791.411 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5623012.335 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5889350.182 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4276574.635 ops/s (100 runs over 1000 unique samples each)
```

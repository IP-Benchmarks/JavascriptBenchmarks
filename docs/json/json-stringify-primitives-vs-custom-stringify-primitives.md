...
```typescript
Custom stringify for primitives: 9778920.130 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5511681.651 ops/s (100 runs over 1000 unique samples each)
```

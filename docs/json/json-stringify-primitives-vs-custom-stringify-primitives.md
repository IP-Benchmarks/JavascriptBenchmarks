...
```typescript
Custom stringify for primitives: 5720101.259 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4120774.630 ops/s (100 runs over 1000 unique samples each)
```

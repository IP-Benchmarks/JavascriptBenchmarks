...
```typescript
Custom stringify for primitives: 8783276.436 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6009184.556 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8988284.131 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5582574.285 ops/s (100 runs over 1000 unique samples each)
```

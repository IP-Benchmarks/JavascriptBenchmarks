...
```typescript
Custom stringify for primitives: 5093424.094 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3613257.316 ops/s (100 runs over 1000 unique samples each)
```

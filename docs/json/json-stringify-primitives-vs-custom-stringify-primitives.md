...
```typescript
Custom stringify for primitives: 5969743.668 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4738592.466 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9572097.565 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5818764.795 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.35x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5267319.909 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3914461.194 ops/s (100 runs over 1000 unique samples each)
```

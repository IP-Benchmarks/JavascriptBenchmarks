...
```typescript
Custom stringify for primitives: 10541345.529 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5505341.943 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/30/2025 1:17:48`

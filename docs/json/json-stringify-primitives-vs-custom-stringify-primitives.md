...
```typescript
Custom stringify for primitives: 4623949.450 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3418784.718 ops/s (100 runs over 1000 unique samples each)
```

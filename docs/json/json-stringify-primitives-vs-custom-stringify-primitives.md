...
```typescript
Custom stringify for primitives: 9031225.009 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7020334.258 ops/s (100 runs over 1000 unique samples each)
```

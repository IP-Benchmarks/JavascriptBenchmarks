...
```typescript
Custom stringify for primitives: 8493713.760 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6363898.267 ops/s (100 runs over 1000 unique samples each)
```

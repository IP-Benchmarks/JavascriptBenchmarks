...
```typescript
Custom stringify for primitives: 9786772.648 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6590902.919 ops/s (100 runs over 1000 unique samples each)
```

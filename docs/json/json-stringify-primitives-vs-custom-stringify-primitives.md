...
```typescript
Custom stringify for primitives: 9975647.449 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5823909.665 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/27/2026 7:12:42`

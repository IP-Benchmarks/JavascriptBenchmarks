...
```typescript
Custom stringify for primitives: 10499505.578 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6573682.368 ops/s (100 runs over 1000 unique samples each)
```

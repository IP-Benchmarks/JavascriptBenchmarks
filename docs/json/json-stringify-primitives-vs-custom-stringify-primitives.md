...
```typescript
Custom stringify for primitives: 10594774.763 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6465785.488 ops/s (100 runs over 1000 unique samples each)
```

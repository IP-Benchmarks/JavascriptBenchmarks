...
```typescript
Custom stringify for primitives: 5509175.036 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4431064.206 ops/s (100 runs over 1000 unique samples each)
```

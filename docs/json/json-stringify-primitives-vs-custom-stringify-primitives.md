...
```typescript
Custom stringify for primitives: 5635027.281 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4507620.447 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/14/2022 0:45:19`

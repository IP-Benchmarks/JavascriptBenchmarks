...
```typescript
Custom stringify for primitives: 8669475.638 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4842028.576 ops/s (100 runs over 1000 unique samples each)
```

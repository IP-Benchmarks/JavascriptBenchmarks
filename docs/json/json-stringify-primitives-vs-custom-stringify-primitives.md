...
```typescript
Custom stringify for primitives: 10332779.565 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6393583.911 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5772254.321 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4251749.850 ops/s (100 runs over 1000 unique samples each)
```

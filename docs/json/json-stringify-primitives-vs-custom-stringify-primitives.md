...
```typescript
Custom stringify for primitives: 9795880.303 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6242717.090 ops/s (100 runs over 1000 unique samples each)
```

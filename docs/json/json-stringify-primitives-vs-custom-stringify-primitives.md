...
#### **Custom stringify for primitives** is **_`1.10x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 3801590.433 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3467419.124 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9672192.003 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6167049.332 ops/s (100 runs over 1000 unique samples each)
```

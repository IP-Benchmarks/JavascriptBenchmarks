...
```typescript
Custom stringify for primitives: 5479256.903 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4404783.966 ops/s (100 runs over 1000 unique samples each)
```

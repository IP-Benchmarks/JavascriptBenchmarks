...
```typescript
Custom stringify for primitives: 8882502.959 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6349688.522 ops/s (100 runs over 1000 unique samples each)
```

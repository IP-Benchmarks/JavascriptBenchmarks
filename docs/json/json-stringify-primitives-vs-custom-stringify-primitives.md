...
```typescript
Custom stringify for primitives: 10700706.899 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6960525.676 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/12/2025 1:14:4`

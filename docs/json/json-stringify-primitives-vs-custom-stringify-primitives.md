...
```typescript
Custom stringify for primitives: 10513835.314 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5076256.026 ops/s (100 runs over 1000 unique samples each)
```

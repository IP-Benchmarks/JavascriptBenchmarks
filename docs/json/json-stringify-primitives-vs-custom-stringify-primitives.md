...
```typescript
Custom stringify for primitives: 5548311.927 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4077259.833 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6097712.305 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4284862.639 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10465444.359 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6555173.221 ops/s (100 runs over 1000 unique samples each)
```

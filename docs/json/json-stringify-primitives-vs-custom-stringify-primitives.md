...
```typescript
Custom stringify for primitives: 5681646.764 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4327710.513 ops/s (100 runs over 1000 unique samples each)
```

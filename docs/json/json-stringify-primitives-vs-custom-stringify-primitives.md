...
```typescript
Custom stringify for primitives: 6038517.167 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4657501.759 ops/s (100 runs over 1000 unique samples each)
```

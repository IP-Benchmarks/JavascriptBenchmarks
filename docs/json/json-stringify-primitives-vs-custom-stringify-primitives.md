...
```typescript
Custom stringify for primitives: 5535506.565 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4106008.602 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8271570.206 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5474170.455 ops/s (100 runs over 1000 unique samples each)
```

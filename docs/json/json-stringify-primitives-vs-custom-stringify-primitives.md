...
```typescript
Custom stringify for primitives: 10153519.179 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5826594.488 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/19/2025 1:12:40`

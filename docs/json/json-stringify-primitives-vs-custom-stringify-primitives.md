...
```typescript
Custom stringify for primitives: 8884974.764 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5876558.311 ops/s (100 runs over 1000 unique samples each)
```

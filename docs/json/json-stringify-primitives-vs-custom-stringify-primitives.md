...
```typescript
Custom stringify for primitives: 9924320.112 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5330398.629 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8740432.065 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5777383.657 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4847050.825 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3759114.302 ops/s (100 runs over 1000 unique samples each)
```

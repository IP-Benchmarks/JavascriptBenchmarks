...
```typescript
Custom stringify for primitives: 8777612.177 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6306543.685 ops/s (100 runs over 1000 unique samples each)
```

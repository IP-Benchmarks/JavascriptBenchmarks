...
```typescript
Custom stringify for primitives: 11814437.715 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 8230837.458 ops/s (100 runs over 1000 unique samples each)
```

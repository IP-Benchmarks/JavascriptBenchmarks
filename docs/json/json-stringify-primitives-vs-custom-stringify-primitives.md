...
```typescript
Custom stringify for primitives: 9696520.249 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6784831.749 ops/s (100 runs over 1000 unique samples each)
```

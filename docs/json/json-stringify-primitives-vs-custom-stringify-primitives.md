...
```typescript
Custom stringify for primitives: 8802479.836 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5942481.769 ops/s (100 runs over 1000 unique samples each)
```

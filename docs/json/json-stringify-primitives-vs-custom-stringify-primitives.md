...
```typescript
Custom stringify for primitives: 6511839.011 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4825045.072 ops/s (100 runs over 1000 unique samples each)
```

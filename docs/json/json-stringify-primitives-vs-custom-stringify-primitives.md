...
```typescript
Custom stringify for primitives: 7936358.657 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4760458.944 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/14/2024 1:0:16`

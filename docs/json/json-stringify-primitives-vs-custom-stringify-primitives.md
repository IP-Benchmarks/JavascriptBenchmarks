...
```typescript
Custom stringify for primitives: 5828748.342 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3828948.320 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5921032.961 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3974480.971 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8354672.558 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6213175.672 ops/s (100 runs over 1000 unique samples each)
```

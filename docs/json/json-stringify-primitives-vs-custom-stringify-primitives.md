...
```typescript
Custom stringify for primitives: 8780304.232 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6572219.923 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.47x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 8667893.053 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5895900.682 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/27/2023 0:55:17`

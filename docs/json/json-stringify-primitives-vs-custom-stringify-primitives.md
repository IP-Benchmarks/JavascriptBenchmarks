...
```typescript
Custom stringify for primitives: 9948817.315 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6628043.730 ops/s (100 runs over 1000 unique samples each)
```

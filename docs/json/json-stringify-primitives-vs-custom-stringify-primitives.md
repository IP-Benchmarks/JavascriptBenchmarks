...
```typescript
Custom stringify for primitives: 5208032.787 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4042847.391 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/16/2023 1:5:56`

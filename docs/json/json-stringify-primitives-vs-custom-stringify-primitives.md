...
```typescript
Custom stringify for primitives: 10160269.101 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6298865.814 ops/s (100 runs over 1000 unique samples each)
```

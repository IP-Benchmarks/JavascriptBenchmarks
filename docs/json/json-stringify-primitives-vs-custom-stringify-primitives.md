...
```typescript
Custom stringify for primitives: 5062957.625 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3875160.165 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8493122.952 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5833843.844 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5037853.169 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3654907.975 ops/s (100 runs over 1000 unique samples each)
```

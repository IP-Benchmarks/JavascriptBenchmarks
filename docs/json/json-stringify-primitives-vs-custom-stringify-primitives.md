...
```typescript
Custom stringify for primitives: 4402690.696 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3819272.192 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6106683.765 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4219237.131 ops/s (100 runs over 1000 unique samples each)
```

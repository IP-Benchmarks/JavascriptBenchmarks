...
```typescript
Custom stringify for primitives: 10194078.953 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6795975.505 ops/s (100 runs over 1000 unique samples each)
```

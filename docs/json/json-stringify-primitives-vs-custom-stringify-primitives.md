...
```typescript
Custom stringify for primitives: 7576067.505 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5962014.574 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9457320.060 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6860877.527 ops/s (100 runs over 1000 unique samples each)
```

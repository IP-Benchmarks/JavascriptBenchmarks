...
```typescript
Custom stringify for primitives: 5340594.548 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3788684.459 ops/s (100 runs over 1000 unique samples each)
```

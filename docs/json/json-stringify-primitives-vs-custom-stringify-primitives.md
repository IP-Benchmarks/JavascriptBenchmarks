...
```typescript
Custom stringify for primitives: 8682396.043 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5947704.567 ops/s (100 runs over 1000 unique samples each)
```

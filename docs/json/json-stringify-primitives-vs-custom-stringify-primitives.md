...
```typescript
Custom stringify for primitives: 8932921.448 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6214588.496 ops/s (100 runs over 1000 unique samples each)
```

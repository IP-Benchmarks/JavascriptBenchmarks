...
```typescript
Custom stringify for primitives: 9140279.062 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5390393.306 ops/s (100 runs over 1000 unique samples each)
```

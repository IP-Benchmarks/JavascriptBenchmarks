...
```typescript
Custom stringify for primitives: 9981425.565 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6327450.365 ops/s (100 runs over 1000 unique samples each)
```

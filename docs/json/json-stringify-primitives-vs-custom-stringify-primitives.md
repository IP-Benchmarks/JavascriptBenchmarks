...
```typescript
Custom stringify for primitives: 10193981.270 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6813663.275 ops/s (100 runs over 1000 unique samples each)
```

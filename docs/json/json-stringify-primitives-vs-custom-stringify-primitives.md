...
```typescript
Custom stringify for primitives: 8417538.181 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5916700.435 ops/s (100 runs over 1000 unique samples each)
```

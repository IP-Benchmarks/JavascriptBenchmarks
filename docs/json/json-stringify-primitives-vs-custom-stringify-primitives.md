...
```typescript
Custom stringify for primitives: 7979401.016 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5953618.101 ops/s (100 runs over 1000 unique samples each)
```

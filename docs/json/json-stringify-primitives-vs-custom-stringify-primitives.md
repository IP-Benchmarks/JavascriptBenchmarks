...
```typescript
Custom stringify for primitives: 5967006.512 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4218421.069 ops/s (100 runs over 1000 unique samples each)
```

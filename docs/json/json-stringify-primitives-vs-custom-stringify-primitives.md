...
```typescript
Custom stringify for primitives: 5332931.728 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4362222.370 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8128239.561 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5875688.183 ops/s (100 runs over 1000 unique samples each)
```

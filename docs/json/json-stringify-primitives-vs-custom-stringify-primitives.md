...
```typescript
Custom stringify for primitives: 4396028.926 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3411266.212 ops/s (100 runs over 1000 unique samples each)
```

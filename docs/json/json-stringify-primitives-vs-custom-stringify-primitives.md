...
```typescript
Custom stringify for primitives: 7893454.778 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5815632.248 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/24/2024 0:56:34`

...
```typescript
Custom stringify for primitives: 5194661.634 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3592555.364 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6131914.654 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4664858.381 ops/s (100 runs over 1000 unique samples each)
```

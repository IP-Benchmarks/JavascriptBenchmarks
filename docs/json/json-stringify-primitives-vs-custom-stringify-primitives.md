...
```typescript
Custom stringify for primitives: 5641162.071 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4594255.776 ops/s (100 runs over 1000 unique samples each)
```

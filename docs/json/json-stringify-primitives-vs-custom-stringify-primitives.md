...
```typescript
Custom stringify for primitives: 9420219.408 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6282571.994 ops/s (100 runs over 1000 unique samples each)
```

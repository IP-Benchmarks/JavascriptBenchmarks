...
```typescript
Custom stringify for primitives: 5433904.620 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3630486.868 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8809323.082 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6186694.645 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/18/2024 0:55:16`

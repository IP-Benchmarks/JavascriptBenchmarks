...
```typescript
Custom stringify for primitives: 10335548.758 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6401531.041 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5894450.086 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4259976.481 ops/s (100 runs over 1000 unique samples each)
```

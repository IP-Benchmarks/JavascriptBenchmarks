...
```typescript
Custom stringify for primitives: 9847298.920 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6859996.459 ops/s (100 runs over 1000 unique samples each)
```

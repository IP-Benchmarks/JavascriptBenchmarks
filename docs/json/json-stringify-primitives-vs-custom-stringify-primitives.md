...
```typescript
Custom stringify for primitives: 9880279.663 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6781139.995 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9187481.212 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6233263.299 ops/s (100 runs over 1000 unique samples each)
```

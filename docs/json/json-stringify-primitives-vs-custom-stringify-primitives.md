...
```typescript
Custom stringify for primitives: 8758797.008 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5756383.958 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5789216.034 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4309369.275 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4218467.159 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3442747.047 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8807924.877 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5618812.774 ops/s (100 runs over 1000 unique samples each)
```

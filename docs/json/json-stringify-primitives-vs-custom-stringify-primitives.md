...
```typescript
Custom stringify for primitives: 8493104.194 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5344289.840 ops/s (100 runs over 1000 unique samples each)
```

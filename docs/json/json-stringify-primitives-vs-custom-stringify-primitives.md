...
```typescript
Custom stringify for primitives: 4556519.431 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3585880.824 ops/s (100 runs over 1000 unique samples each)
```

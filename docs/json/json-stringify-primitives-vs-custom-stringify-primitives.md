...
```typescript
Custom stringify for primitives: 9486758.762 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6054786.493 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/14/2026 2:23:14`

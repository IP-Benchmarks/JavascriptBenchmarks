...
```typescript
Custom stringify for primitives: 4425035.453 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3309334.590 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10171015.454 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6628859.189 ops/s (100 runs over 1000 unique samples each)
```

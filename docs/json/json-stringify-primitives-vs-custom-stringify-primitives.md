...
```typescript
Custom stringify for primitives: 5315676.498 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3857617.647 ops/s (100 runs over 1000 unique samples each)
```

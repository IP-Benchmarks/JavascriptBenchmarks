...
```typescript
Custom stringify for primitives: 8629487.269 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5776521.294 ops/s (100 runs over 1000 unique samples each)
```

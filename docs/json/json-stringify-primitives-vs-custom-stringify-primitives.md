...
```typescript
Custom stringify for primitives: 7749419.720 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5913439.548 ops/s (100 runs over 1000 unique samples each)
```

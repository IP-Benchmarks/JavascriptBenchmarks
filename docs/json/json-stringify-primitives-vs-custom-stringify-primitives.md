...
```typescript
Custom stringify for primitives: 8857368.466 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6132744.606 ops/s (100 runs over 1000 unique samples each)
```

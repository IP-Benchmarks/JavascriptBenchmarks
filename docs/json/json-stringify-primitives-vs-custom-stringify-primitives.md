...
```typescript
Custom stringify for primitives: 7833609.131 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5673480.100 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4506921.392 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3498463.247 ops/s (100 runs over 1000 unique samples each)
```

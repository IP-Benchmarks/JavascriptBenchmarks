...
```typescript
Custom stringify for primitives: 5664841.040 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4528031.299 ops/s (100 runs over 1000 unique samples each)
```

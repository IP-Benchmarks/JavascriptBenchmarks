...
```typescript
Custom stringify for primitives: 10536215.396 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6723748.151 ops/s (100 runs over 1000 unique samples each)
```

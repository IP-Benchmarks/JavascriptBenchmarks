...
```typescript
Custom stringify for primitives: 9753438.916 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5661972.967 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8740309.837 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7019565.987 ops/s (100 runs over 1000 unique samples each)
```

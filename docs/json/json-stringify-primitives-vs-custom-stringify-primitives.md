...
```typescript
Custom stringify for primitives: 4897707.703 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4367817.588 ops/s (100 runs over 1000 unique samples each)
```

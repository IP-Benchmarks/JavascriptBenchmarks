...
```typescript
Custom stringify for primitives: 8351303.248 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5735034.742 ops/s (100 runs over 1000 unique samples each)
```

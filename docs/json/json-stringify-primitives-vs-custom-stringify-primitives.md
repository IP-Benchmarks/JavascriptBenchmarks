...
```typescript
Custom stringify for primitives: 4012232.978 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3303842.029 ops/s (100 runs over 1000 unique samples each)
```

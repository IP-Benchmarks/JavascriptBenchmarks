...
```typescript
Custom stringify for primitives: 4790305.572 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3691463.222 ops/s (100 runs over 1000 unique samples each)
```

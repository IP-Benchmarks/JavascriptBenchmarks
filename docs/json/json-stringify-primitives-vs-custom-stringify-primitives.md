...
```typescript
Custom stringify for primitives: 8692875.744 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5904527.918 ops/s (100 runs over 1000 unique samples each)
```

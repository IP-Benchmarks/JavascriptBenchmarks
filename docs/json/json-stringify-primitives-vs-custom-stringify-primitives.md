...
```typescript
Custom stringify for primitives: 6373904.318 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4505021.364 ops/s (100 runs over 1000 unique samples each)
```

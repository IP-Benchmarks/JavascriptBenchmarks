...
```typescript
Custom stringify for primitives: 8298223.551 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5924292.051 ops/s (100 runs over 1000 unique samples each)
```

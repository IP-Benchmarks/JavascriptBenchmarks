...
```typescript
Custom stringify for primitives: 8203553.799 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4609729.045 ops/s (100 runs over 1000 unique samples each)
```

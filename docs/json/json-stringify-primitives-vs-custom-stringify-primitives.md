...
```typescript
Custom stringify for primitives: 9153003.057 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4905181.853 ops/s (100 runs over 1000 unique samples each)
```

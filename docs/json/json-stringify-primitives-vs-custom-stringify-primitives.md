...
```typescript
Custom stringify for primitives: 5255605.037 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4487836.638 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5030285.588 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4348064.663 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/28/2023 0:51:9`

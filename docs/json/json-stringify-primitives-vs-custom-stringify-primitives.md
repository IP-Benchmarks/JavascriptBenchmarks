...
```typescript
Custom stringify for primitives: 8833850.467 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6218495.934 ops/s (100 runs over 1000 unique samples each)
```

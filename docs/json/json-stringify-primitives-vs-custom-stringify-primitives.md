...
```typescript
Custom stringify for primitives: 8409471.994 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5701062.183 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10265686.225 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5507760.434 ops/s (100 runs over 1000 unique samples each)
```

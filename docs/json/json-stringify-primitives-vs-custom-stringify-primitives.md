...
```typescript
Custom stringify for primitives: 10418667.919 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6884515.218 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/6/2025 1:20:34`

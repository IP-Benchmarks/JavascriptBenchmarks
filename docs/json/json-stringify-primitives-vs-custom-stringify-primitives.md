...
```typescript
Custom stringify for primitives: 7731045.583 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5577958.499 ops/s (100 runs over 1000 unique samples each)
```

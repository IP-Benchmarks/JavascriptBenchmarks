...
```typescript
Custom stringify for primitives: 10501954.571 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6480662.158 ops/s (100 runs over 1000 unique samples each)
```

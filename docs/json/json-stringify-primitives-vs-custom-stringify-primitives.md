...
```typescript
Custom stringify for primitives: 8341455.827 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5679298.640 ops/s (100 runs over 1000 unique samples each)
```

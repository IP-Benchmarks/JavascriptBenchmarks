...
```typescript
Custom stringify for primitives: 5841492.049 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4139091.863 ops/s (100 runs over 1000 unique samples each)
```

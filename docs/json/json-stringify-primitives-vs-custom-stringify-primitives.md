...
```typescript
Custom stringify for primitives: 10705870.136 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6767368.722 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5635078.090 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3959013.129 ops/s (100 runs over 1000 unique samples each)
```

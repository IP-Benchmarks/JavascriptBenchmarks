...
```typescript
Custom stringify for primitives: 8201269.653 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4663898.923 ops/s (100 runs over 1000 unique samples each)
```

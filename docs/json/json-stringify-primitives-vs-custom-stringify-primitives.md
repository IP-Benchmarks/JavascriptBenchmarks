...
```typescript
Custom stringify for primitives: 7296734.857 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6936792.777 ops/s (100 runs over 1000 unique samples each)
```

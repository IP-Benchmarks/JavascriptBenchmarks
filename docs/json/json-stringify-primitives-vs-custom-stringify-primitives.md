...
```typescript
Custom stringify for primitives: 8540408.341 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5625532.494 ops/s (100 runs over 1000 unique samples each)
```

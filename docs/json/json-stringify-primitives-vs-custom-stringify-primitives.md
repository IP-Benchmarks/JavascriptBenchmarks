...
```typescript
Custom stringify for primitives: 10176060.086 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5855540.764 ops/s (100 runs over 1000 unique samples each)
```

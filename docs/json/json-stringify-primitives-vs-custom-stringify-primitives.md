...
```typescript
Custom stringify for primitives: 10305415.413 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6979748.400 ops/s (100 runs over 1000 unique samples each)
```

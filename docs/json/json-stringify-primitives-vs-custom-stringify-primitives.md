...
```typescript
Custom stringify for primitives: 10652582.532 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6678308.740 ops/s (100 runs over 1000 unique samples each)
```

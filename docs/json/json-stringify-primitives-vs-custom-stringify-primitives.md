...
```typescript
Custom stringify for primitives: 8487121.382 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5231722.402 ops/s (100 runs over 1000 unique samples each)
```

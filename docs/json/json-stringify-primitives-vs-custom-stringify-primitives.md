...
```typescript
Custom stringify for primitives: 9243302.580 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4865412.474 ops/s (100 runs over 1000 unique samples each)
```

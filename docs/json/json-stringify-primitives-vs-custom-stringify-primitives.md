...
```typescript
Custom stringify for primitives: 5945493.735 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4163552.502 ops/s (100 runs over 1000 unique samples each)
```

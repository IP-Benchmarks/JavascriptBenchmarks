...
```typescript
Custom stringify for primitives: 4747541.189 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4328914.565 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/28/2022 1:0:3`

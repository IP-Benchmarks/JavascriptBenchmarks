...
```typescript
Custom stringify for primitives: 8691927.494 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4677932.751 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10469307.654 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6041687.523 ops/s (100 runs over 1000 unique samples each)
```

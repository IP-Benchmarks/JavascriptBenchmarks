...
```typescript
Custom stringify for primitives: 4657232.790 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3461950.807 ops/s (100 runs over 1000 unique samples each)
```

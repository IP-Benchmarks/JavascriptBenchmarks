...
```typescript
Custom stringify for primitives: 10163632.450 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5900016.201 ops/s (100 runs over 1000 unique samples each)
```

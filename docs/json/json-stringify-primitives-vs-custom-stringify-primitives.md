...
```typescript
Custom stringify for primitives: 5574432.131 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3890826.218 ops/s (100 runs over 1000 unique samples each)
```

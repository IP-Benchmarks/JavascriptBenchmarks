...
```typescript
Custom stringify for primitives: 4068202.271 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3337103.816 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/4/2023 1:18:54`

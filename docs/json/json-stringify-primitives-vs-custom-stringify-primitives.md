...
```typescript
Custom stringify for primitives: 8629052.397 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6767933.908 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9155222.867 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5391880.238 ops/s (100 runs over 1000 unique samples each)
```

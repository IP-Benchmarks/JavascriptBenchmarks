...
```typescript
Custom stringify for primitives: 7787862.367 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5605499.623 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10145777.576 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6674960.528 ops/s (100 runs over 1000 unique samples each)
```

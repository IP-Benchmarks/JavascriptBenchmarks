...
```typescript
Custom stringify for primitives: 9456159.260 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6729640.851 ops/s (100 runs over 1000 unique samples each)
```

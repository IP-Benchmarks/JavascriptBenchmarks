...
```typescript
Custom stringify for primitives: 10499752.521 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5284005.242 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/21/2026 1:39:55`

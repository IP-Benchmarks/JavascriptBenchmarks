...
```typescript
Custom stringify for primitives: 9317161.102 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5948781.939 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10319492.520 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6796627.242 ops/s (100 runs over 1000 unique samples each)
```

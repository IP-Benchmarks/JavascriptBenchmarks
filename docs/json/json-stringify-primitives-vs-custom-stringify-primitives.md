...
```typescript
Custom stringify for primitives: 8378277.904 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6155201.814 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/29/2024 0:52:59`

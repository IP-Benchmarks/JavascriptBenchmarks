...
```typescript
Custom stringify for primitives: 4164265.793 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3427476.282 ops/s (100 runs over 1000 unique samples each)
```

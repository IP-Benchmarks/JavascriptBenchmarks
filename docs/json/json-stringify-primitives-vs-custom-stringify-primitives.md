...
```typescript
Custom stringify for primitives: 9720872.911 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5517890.435 ops/s (100 runs over 1000 unique samples each)
```

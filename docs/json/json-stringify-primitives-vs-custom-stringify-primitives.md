...
```typescript
Custom stringify for primitives: 5309100.053 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4170544.578 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6639150.043 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4895092.297 ops/s (100 runs over 1000 unique samples each)
```

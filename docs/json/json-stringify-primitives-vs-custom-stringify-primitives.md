...
```typescript
Custom stringify for primitives: 6407235.973 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3696846.054 ops/s (100 runs over 1000 unique samples each)
```

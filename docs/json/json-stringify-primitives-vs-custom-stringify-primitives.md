...
```typescript
Custom stringify for primitives: 5616575.908 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4640705.231 ops/s (100 runs over 1000 unique samples each)
```

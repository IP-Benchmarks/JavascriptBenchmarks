...
```typescript
Custom stringify for primitives: 4317768.412 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3722627.889 ops/s (100 runs over 1000 unique samples each)
```

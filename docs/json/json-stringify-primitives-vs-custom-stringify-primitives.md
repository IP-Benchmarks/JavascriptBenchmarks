...
```typescript
Custom stringify for primitives: 7553960.966 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4485052.309 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/15/2024 0:59:14`

...
```typescript
Custom stringify for primitives: 5785121.050 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4322440.395 ops/s (100 runs over 1000 unique samples each)
```

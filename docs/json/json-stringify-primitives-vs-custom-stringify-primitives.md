...
```typescript
Custom stringify for primitives: 6367864.799 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4283454.152 ops/s (100 runs over 1000 unique samples each)
```

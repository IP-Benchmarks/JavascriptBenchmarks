...
```typescript
Custom stringify for primitives: 5198673.008 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4539323.158 ops/s (100 runs over 1000 unique samples each)
```

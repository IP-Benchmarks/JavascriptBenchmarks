...
```typescript
Custom stringify for primitives: 7318109.666 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5698183.300 ops/s (100 runs over 1000 unique samples each)
```

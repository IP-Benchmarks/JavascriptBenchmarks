...
```typescript
Custom stringify for primitives: 5916521.548 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4447765.442 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10652570.050 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5730139.209 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8241222.554 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5635449.640 ops/s (100 runs over 1000 unique samples each)
```

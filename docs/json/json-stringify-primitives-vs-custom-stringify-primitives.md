...
```typescript
Custom stringify for primitives: 5500891.970 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4449838.242 ops/s (100 runs over 1000 unique samples each)
```

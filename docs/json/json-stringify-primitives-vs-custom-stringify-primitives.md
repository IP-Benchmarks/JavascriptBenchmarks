...
```typescript
Custom stringify for primitives: 5836267.371 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3757510.700 ops/s (100 runs over 1000 unique samples each)
```

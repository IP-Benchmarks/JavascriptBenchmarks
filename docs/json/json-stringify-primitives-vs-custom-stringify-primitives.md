...
```typescript
Custom stringify for primitives: 11182896.610 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6447071.669 ops/s (100 runs over 1000 unique samples each)
```

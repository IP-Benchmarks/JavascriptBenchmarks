...
```typescript
Custom stringify for primitives: 4909948.114 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3449856.133 ops/s (100 runs over 1000 unique samples each)
```

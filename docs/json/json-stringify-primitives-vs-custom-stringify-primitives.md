...
```typescript
Custom stringify for primitives: 5909780.927 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4077255.677 ops/s (100 runs over 1000 unique samples each)
```

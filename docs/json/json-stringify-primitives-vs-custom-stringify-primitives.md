...
```typescript
Custom stringify for primitives: 4596010.242 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3654482.560 ops/s (100 runs over 1000 unique samples each)
```

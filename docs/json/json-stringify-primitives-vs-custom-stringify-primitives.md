...
```typescript
Custom stringify for primitives: 8714336.465 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6146613.197 ops/s (100 runs over 1000 unique samples each)
```

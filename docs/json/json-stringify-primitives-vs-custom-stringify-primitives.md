...
```typescript
Custom stringify for primitives: 5805917.020 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4525867.209 ops/s (100 runs over 1000 unique samples each)
```

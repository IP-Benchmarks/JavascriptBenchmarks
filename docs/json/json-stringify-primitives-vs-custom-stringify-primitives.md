...
```typescript
Custom stringify for primitives: 10390552.826 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7076265.942 ops/s (100 runs over 1000 unique samples each)
```

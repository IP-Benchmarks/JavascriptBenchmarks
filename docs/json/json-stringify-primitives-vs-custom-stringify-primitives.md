...
```typescript
Custom stringify for primitives: 10685368.055 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5242549.708 ops/s (100 runs over 1000 unique samples each)
```

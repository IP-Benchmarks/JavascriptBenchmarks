...
```typescript
Custom stringify for primitives: 11032806.381 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7896734.716 ops/s (100 runs over 1000 unique samples each)
```

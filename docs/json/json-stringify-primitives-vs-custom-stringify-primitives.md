...
```typescript
Custom stringify for primitives: 8631391.837 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6486610.048 ops/s (100 runs over 1000 unique samples each)
```

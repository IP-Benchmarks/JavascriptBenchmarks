...
```typescript
Custom stringify for primitives: 6206931.269 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3405501.240 ops/s (100 runs over 1000 unique samples each)
```

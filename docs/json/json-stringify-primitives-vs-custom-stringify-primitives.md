...
```typescript
Custom stringify for primitives: 9536430.308 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5968361.952 ops/s (100 runs over 1000 unique samples each)
```

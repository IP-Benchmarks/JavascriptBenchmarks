...
```typescript
Custom stringify for primitives: 5543719.099 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3627742.933 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4316017.042 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3588156.042 ops/s (100 runs over 1000 unique samples each)
```

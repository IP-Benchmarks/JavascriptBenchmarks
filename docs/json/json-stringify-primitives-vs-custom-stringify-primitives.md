...
```typescript
Custom stringify for primitives: 9094904.234 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5866914.329 ops/s (100 runs over 1000 unique samples each)
```

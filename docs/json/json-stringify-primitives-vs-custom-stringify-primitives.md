...
```typescript
Custom stringify for primitives: 8779955.778 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5492663.341 ops/s (100 runs over 1000 unique samples each)
```

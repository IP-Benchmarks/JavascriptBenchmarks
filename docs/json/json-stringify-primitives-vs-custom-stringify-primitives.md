...
```typescript
Custom stringify for primitives: 5095152.224 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4251045.130 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8751581.626 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4588459.253 ops/s (100 runs over 1000 unique samples each)
```

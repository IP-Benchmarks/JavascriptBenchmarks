...
```typescript
Custom stringify for primitives: 9635386.380 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5069170.607 ops/s (100 runs over 1000 unique samples each)
```

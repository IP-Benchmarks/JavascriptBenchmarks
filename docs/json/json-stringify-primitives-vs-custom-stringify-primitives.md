...
```typescript
Custom stringify for primitives: 8903426.403 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4929682.759 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4593963.458 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3184732.749 ops/s (100 runs over 1000 unique samples each)
```

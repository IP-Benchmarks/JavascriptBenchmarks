...
```typescript
Custom stringify for primitives: 5218459.047 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3665426.469 ops/s (100 runs over 1000 unique samples each)
```

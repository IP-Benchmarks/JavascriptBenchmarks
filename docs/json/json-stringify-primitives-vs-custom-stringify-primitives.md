...
```typescript
Custom stringify for primitives: 9345694.822 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4882861.853 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5338109.162 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3900546.973 ops/s (100 runs over 1000 unique samples each)
```

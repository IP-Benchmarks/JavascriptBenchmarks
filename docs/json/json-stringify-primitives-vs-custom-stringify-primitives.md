...
```typescript
Custom stringify for primitives: 4253765.349 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3675665.320 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9252112.003 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5757205.517 ops/s (100 runs over 1000 unique samples each)
```

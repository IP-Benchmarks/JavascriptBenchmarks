...
```typescript
Custom stringify for primitives: 10691291.419 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5928276.158 ops/s (100 runs over 1000 unique samples each)
```

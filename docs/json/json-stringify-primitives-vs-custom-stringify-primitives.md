...
```typescript
Custom stringify for primitives: 5316218.229 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3951251.046 ops/s (100 runs over 1000 unique samples each)
```

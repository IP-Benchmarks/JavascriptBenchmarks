...
```typescript
Custom stringify for primitives: 5094188.229 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4276454.479 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8564336.327 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4936453.041 ops/s (100 runs over 1000 unique samples each)
```

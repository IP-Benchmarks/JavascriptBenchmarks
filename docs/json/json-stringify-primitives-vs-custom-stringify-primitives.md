...
```typescript
Custom stringify for primitives: 5701167.165 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4675825.924 ops/s (100 runs over 1000 unique samples each)
```

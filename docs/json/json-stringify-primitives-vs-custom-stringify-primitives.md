...
```typescript
Custom stringify for primitives: 10332904.483 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5666333.316 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 15399811.445 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 11735407.402 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10434016.480 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6587182.647 ops/s (100 runs over 1000 unique samples each)
```

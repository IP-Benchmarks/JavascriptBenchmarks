...
```typescript
Custom stringify for primitives: 10255972.668 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6182801.832 ops/s (100 runs over 1000 unique samples each)
```

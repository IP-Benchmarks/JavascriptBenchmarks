...
```typescript
Custom stringify for primitives: 7456369.798 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5405530.171 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9880399.737 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6675928.405 ops/s (100 runs over 1000 unique samples each)
```

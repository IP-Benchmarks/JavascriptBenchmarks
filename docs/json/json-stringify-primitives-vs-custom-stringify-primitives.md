...
```typescript
Custom stringify for primitives: 5098563.387 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4459804.807 ops/s (100 runs over 1000 unique samples each)
```

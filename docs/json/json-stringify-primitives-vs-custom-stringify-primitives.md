...
```typescript
Custom stringify for primitives: 10637563.428 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6714085.567 ops/s (100 runs over 1000 unique samples each)
```

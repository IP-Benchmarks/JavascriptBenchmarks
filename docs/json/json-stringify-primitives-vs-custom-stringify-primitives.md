...
```typescript
Custom stringify for primitives: 8561533.886 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6129882.649 ops/s (100 runs over 1000 unique samples each)
```

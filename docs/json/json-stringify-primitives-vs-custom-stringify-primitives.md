...
```typescript
Custom stringify for primitives: 10918108.075 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5990378.494 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 7956205.227 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4647641.392 ops/s (100 runs over 1000 unique samples each)
```

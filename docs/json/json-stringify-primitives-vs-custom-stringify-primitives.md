...
```typescript
Custom stringify for primitives: 5369096.094 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4053512.363 ops/s (100 runs over 1000 unique samples each)
```

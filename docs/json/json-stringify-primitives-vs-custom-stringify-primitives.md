...
```typescript
Custom stringify for primitives: 4693431.618 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3765547.664 ops/s (100 runs over 1000 unique samples each)
```

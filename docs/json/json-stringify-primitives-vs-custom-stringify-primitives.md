...
```typescript
Custom stringify for primitives: 4392675.494 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3628622.663 ops/s (100 runs over 1000 unique samples each)
```

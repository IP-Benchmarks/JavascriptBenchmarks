...
```typescript
Custom stringify for primitives: 10050420.952 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7251916.119 ops/s (100 runs over 1000 unique samples each)
```

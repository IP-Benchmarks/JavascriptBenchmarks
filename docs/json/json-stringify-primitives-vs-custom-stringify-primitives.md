...
```typescript
Custom stringify for primitives: 9542336.197 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5730019.037 ops/s (100 runs over 1000 unique samples each)
```

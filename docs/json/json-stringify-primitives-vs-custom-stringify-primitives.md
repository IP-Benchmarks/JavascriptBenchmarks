...
```typescript
Custom stringify for primitives: 7799212.702 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4424820.269 ops/s (100 runs over 1000 unique samples each)
```

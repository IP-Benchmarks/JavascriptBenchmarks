...
```typescript
Custom stringify for primitives: 6074548.068 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4379116.013 ops/s (100 runs over 1000 unique samples each)
```

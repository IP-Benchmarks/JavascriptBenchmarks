...
```typescript
Custom stringify for primitives: 7916605.844 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5533352.671 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10028116.834 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6334979.795 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9862395.907 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6548673.111 ops/s (100 runs over 1000 unique samples each)
```

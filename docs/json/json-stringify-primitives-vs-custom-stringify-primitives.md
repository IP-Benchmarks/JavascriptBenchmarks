...
```typescript
Custom stringify for primitives: 4503161.062 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3564012.498 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5924303.982 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4289091.271 ops/s (100 runs over 1000 unique samples each)
```

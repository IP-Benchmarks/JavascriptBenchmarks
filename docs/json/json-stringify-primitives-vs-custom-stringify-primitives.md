...
```typescript
Custom stringify for primitives: 5558809.930 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4351680.919 ops/s (100 runs over 1000 unique samples each)
```

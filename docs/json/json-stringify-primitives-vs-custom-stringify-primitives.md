...
```typescript
Custom stringify for primitives: 10390342.302 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6753123.303 ops/s (100 runs over 1000 unique samples each)
```

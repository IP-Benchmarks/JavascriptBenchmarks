...
```typescript
Custom stringify for primitives: 8531342.960 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4911295.376 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 5/25/2024 0:55:13`

...
```typescript
Custom stringify for primitives: 10666936.327 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6883729.472 ops/s (100 runs over 1000 unique samples each)
```

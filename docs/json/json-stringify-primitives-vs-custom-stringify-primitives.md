...
```typescript
Custom stringify for primitives: 6369966.373 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4456364.129 ops/s (100 runs over 1000 unique samples each)
```

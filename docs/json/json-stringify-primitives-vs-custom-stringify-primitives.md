...
```typescript
Custom stringify for primitives: 10377000.582 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6765536.412 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/26/2025 1:14:17`

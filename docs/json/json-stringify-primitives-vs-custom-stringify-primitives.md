...
```typescript
Custom stringify for primitives: 8125183.071 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4572586.194 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5802069.366 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4203797.584 ops/s (100 runs over 1000 unique samples each)
```

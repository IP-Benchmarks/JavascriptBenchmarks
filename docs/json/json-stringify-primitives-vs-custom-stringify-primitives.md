...
```typescript
Custom stringify for primitives: 10382227.951 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6663284.828 ops/s (100 runs over 1000 unique samples each)
```

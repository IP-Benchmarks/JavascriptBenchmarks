...
```typescript
Custom stringify for primitives: 6247890.166 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4414892.138 ops/s (100 runs over 1000 unique samples each)
```

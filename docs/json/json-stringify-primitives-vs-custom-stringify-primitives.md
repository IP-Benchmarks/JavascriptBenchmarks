...
```typescript
Custom stringify for primitives: 5023191.321 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3518784.168 ops/s (100 runs over 1000 unique samples each)
```

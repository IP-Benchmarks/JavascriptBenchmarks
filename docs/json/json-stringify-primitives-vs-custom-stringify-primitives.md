...
```typescript
Custom stringify for primitives: 5988122.918 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4531933.521 ops/s (100 runs over 1000 unique samples each)
```

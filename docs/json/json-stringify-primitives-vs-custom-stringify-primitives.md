...
```typescript
Custom stringify for primitives: 8984981.067 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5589741.172 ops/s (100 runs over 1000 unique samples each)
```

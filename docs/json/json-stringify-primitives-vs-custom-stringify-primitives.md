...
```typescript
Custom stringify for primitives: 8919312.067 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5281238.632 ops/s (100 runs over 1000 unique samples each)
```

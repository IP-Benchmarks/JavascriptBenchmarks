...
#### **Custom stringify for primitives** is **_`1.85x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10318729.030 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5574794.481 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/20/2025 1:18:14`

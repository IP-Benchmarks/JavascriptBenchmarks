...
```typescript
Custom stringify for primitives: 10175601.370 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6845811.513 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10636964.857 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6164958.634 ops/s (100 runs over 1000 unique samples each)
```

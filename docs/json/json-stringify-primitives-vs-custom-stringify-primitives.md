...
```typescript
Custom stringify for primitives: 5213694.478 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4335542.553 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10371830.109 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6865448.873 ops/s (100 runs over 1000 unique samples each)
```

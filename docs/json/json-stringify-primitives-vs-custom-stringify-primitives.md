...
```typescript
Custom stringify for primitives: 10099717.541 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6904635.862 ops/s (100 runs over 1000 unique samples each)
```

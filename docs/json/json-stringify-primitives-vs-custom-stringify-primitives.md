...
```typescript
Custom stringify for primitives: 5552653.676 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4151324.410 ops/s (100 runs over 1000 unique samples each)
```

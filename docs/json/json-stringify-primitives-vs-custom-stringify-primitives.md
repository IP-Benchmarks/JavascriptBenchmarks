...
```typescript
Custom stringify for primitives: 5462606.275 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4278380.347 ops/s (100 runs over 1000 unique samples each)
```

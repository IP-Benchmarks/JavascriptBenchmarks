...
```typescript
Custom stringify for primitives: 9345762.075 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6182855.732 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8767216.293 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5084026.243 ops/s (100 runs over 1000 unique samples each)
```

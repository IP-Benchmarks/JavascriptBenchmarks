...
```typescript
Custom stringify for primitives: 10096304.611 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7009111.284 ops/s (100 runs over 1000 unique samples each)
```

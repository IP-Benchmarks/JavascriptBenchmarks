...
```typescript
Custom stringify for primitives: 8984246.483 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6229797.545 ops/s (100 runs over 1000 unique samples each)
```

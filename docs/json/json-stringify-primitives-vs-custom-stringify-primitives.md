...
```typescript
Custom stringify for primitives: 5596843.157 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4320611.308 ops/s (100 runs over 1000 unique samples each)
```

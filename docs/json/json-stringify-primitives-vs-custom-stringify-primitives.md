...
```typescript
Custom stringify for primitives: 8480024.333 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5741978.785 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10326638.814 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6915980.382 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/24/2025 1:24:50`

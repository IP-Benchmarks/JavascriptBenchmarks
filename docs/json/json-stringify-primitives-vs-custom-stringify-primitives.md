...
```typescript
Custom stringify for primitives: 8858786.336 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5911203.789 ops/s (100 runs over 1000 unique samples each)
```

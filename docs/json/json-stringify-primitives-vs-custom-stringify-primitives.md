...
```typescript
Custom stringify for primitives: 5011061.668 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4431487.956 ops/s (100 runs over 1000 unique samples each)
```

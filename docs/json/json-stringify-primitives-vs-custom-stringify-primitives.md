...
```typescript
Custom stringify for primitives: 9033114.404 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6062188.476 ops/s (100 runs over 1000 unique samples each)
```

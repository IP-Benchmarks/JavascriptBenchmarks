...
```typescript
Custom stringify for primitives: 5943631.432 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3982025.138 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4392460.166 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3557736.369 ops/s (100 runs over 1000 unique samples each)
```

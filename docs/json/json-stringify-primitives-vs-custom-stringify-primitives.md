...
```typescript
Custom stringify for primitives: 5696176.430 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4296882.066 ops/s (100 runs over 1000 unique samples each)
```

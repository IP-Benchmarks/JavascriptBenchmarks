...
```typescript
Custom stringify for primitives: 5874489.418 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4856537.401 ops/s (100 runs over 1000 unique samples each)
```

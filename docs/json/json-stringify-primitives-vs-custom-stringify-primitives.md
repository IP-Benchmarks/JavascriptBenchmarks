...
```typescript
Custom stringify for primitives: 5842612.178 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4258378.658 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4470437.356 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3458760.558 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10165134.645 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5908610.109 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/27/2026 2:51:15`

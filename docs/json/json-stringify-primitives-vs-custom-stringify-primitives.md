...
```typescript
Custom stringify for primitives: 10945969.273 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5609884.796 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8881260.475 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5623624.533 ops/s (100 runs over 1000 unique samples each)
```

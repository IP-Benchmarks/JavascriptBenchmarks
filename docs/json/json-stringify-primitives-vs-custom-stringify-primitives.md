...
```typescript
Custom stringify for primitives: 9862808.336 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6977133.770 ops/s (100 runs over 1000 unique samples each)
```

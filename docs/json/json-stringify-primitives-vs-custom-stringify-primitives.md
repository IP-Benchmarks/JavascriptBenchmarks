...
```typescript
Custom stringify for primitives: 10498006.534 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6374794.166 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5811965.594 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3804063.493 ops/s (100 runs over 1000 unique samples each)
```

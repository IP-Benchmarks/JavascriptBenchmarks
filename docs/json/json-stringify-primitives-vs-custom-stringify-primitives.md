...
```typescript
Custom stringify for primitives: 6727888.209 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5298804.064 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9686283.554 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6773267.970 ops/s (100 runs over 1000 unique samples each)
```

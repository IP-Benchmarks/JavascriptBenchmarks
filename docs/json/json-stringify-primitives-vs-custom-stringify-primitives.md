...
```typescript
Custom stringify for primitives: 13571054.786 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 9570803.078 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5094843.310 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4144099.970 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5777605.631 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3920894.695 ops/s (100 runs over 1000 unique samples each)
```

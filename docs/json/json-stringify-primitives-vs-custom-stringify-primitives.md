...
```typescript
Custom stringify for primitives: 10336564.750 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6807237.945 ops/s (100 runs over 1000 unique samples each)
```

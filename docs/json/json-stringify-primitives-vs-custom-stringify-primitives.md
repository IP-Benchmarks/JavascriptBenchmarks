...
```typescript
Custom stringify for primitives: 5320783.378 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4267183.917 ops/s (100 runs over 1000 unique samples each)
```

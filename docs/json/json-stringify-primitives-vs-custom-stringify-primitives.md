...
```typescript
Custom stringify for primitives: 10354747.434 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6944919.014 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10414889.626 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6994246.393 ops/s (100 runs over 1000 unique samples each)
```

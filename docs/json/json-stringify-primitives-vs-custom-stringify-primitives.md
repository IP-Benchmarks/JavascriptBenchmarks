...
```typescript
Custom stringify for primitives: 8087135.324 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4360001.867 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/20/2024 1:12:20`

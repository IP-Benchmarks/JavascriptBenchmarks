...
```typescript
Custom stringify for primitives: 8812224.879 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6170353.464 ops/s (100 runs over 1000 unique samples each)
```

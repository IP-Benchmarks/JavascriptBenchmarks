...
```typescript
Custom stringify for primitives: 8666640.784 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6190952.246 ops/s (100 runs over 1000 unique samples each)
```

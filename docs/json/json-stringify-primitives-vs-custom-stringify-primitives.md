...
#### **Custom stringify for primitives** is **_`1.77x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10409816.790 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5875222.495 ops/s (100 runs over 1000 unique samples each)
```

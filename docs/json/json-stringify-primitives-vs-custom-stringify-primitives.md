...
```typescript
Custom stringify for primitives: 8933545.499 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5721576.310 ops/s (100 runs over 1000 unique samples each)
```

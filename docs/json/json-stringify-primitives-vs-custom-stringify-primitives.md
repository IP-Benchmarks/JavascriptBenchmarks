...
#### **Custom stringify for primitives** is **_`1.50x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10455926.492 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6993001.614 ops/s (100 runs over 1000 unique samples each)
```

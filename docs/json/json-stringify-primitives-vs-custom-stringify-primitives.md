...
```typescript
Custom stringify for primitives: 10313070.796 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6801007.882 ops/s (100 runs over 1000 unique samples each)
```

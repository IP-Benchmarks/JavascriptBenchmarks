...
```typescript
Custom stringify for primitives: 4920402.163 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3677647.706 ops/s (100 runs over 1000 unique samples each)
```

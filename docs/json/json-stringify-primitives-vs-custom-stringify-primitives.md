...
```typescript
Custom stringify for primitives: 8223027.585 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4522294.232 ops/s (100 runs over 1000 unique samples each)
```

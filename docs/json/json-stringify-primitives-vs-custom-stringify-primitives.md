...
```typescript
Custom stringify for primitives: 10795311.078 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5383782.969 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/2/2025 1:16:45`

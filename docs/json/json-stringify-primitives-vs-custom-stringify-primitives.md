...
```typescript
Custom stringify for primitives: 5118891.633 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3884560.194 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4429712.206 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3360411.303 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4532490.182 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3349472.880 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4782208.653 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3187946.501 ops/s (100 runs over 1000 unique samples each)
```

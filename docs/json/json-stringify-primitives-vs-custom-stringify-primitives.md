...
```typescript
Custom stringify for primitives: 5810096.193 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4797507.982 ops/s (100 runs over 1000 unique samples each)
```

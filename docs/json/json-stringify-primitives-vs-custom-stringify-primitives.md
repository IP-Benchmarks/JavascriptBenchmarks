...
```typescript
Custom stringify for primitives: 11752339.656 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 8184210.873 ops/s (100 runs over 1000 unique samples each)
```

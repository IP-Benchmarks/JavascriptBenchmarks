...
```typescript
Custom stringify for primitives: 4248700.397 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3255507.179 ops/s (100 runs over 1000 unique samples each)
```

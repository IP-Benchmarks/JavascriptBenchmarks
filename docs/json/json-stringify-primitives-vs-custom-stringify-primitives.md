...
```typescript
Custom stringify for primitives: 6023106.202 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4552325.453 ops/s (100 runs over 1000 unique samples each)
```

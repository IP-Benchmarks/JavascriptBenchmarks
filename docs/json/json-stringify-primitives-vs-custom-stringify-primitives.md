...
```typescript
Custom stringify for primitives: 9291046.683 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4583824.701 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/22/2023 0:57:6`

...
```typescript
Custom stringify for primitives: 8986877.003 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5803588.011 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/25/2023 0:52:36`

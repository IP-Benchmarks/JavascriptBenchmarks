...
```typescript
Custom stringify for primitives: 4925646.140 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3678711.492 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.93x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 8361262.038 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4334685.394 ops/s (100 runs over 1000 unique samples each)
```

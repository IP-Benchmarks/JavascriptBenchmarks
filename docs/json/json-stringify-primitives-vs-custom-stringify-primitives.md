...
```typescript
Custom stringify for primitives: 8939715.741 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6232229.964 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5069400.858 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4511163.551 ops/s (100 runs over 1000 unique samples each)
```

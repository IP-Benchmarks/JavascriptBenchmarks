...
```typescript
Custom stringify for primitives: 5775642.509 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4175991.831 ops/s (100 runs over 1000 unique samples each)
```

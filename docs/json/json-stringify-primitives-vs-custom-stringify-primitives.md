...
```typescript
Custom stringify for primitives: 4498008.327 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3583331.888 ops/s (100 runs over 1000 unique samples each)
```

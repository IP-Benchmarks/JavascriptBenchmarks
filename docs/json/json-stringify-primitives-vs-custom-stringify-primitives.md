...
```typescript
Custom stringify for primitives: 10209900.234 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6759927.071 ops/s (100 runs over 1000 unique samples each)
```

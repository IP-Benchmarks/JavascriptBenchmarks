...
```typescript
Custom stringify for primitives: 8683683.037 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6011423.869 ops/s (100 runs over 1000 unique samples each)
```

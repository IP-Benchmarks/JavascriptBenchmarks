...
```typescript
Custom stringify for primitives: 7842119.317 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4295129.147 ops/s (100 runs over 1000 unique samples each)
```

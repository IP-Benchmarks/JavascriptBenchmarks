...
```typescript
Custom stringify for primitives: 7039985.852 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5191512.832 ops/s (100 runs over 1000 unique samples each)
```

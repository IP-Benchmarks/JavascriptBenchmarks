...
```typescript
Custom stringify for primitives: 4738534.760 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3791193.784 ops/s (100 runs over 1000 unique samples each)
```

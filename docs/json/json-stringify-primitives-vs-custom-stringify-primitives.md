...
```typescript
Custom stringify for primitives: 9911502.179 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6425943.539 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5966115.091 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4356324.708 ops/s (100 runs over 1000 unique samples each)
```

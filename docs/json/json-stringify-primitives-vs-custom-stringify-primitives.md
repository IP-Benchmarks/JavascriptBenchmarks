...
```typescript
Custom stringify for primitives: 9704580.911 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5310032.627 ops/s (100 runs over 1000 unique samples each)
```

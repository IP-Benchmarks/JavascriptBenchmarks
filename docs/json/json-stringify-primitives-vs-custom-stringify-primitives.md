...
```typescript
Custom stringify for primitives: 8633529.792 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5154874.066 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/18/2024 0:58:59`

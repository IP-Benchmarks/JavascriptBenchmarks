...
```typescript
Custom stringify for primitives: 9613418.487 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5190720.570 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/31/2025 1:18:20`

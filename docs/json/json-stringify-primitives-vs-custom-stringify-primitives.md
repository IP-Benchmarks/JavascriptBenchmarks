...
```typescript
Custom stringify for primitives: 5943465.401 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4198152.636 ops/s (100 runs over 1000 unique samples each)
```

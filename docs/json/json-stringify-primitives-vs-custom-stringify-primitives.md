...
```typescript
Custom stringify for primitives: 10231549.166 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7395321.808 ops/s (100 runs over 1000 unique samples each)
```

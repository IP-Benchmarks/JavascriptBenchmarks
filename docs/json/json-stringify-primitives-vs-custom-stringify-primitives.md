...
```typescript
Custom stringify for primitives: 3331078.193 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3309315.644 ops/s (100 runs over 1000 unique samples each)
```

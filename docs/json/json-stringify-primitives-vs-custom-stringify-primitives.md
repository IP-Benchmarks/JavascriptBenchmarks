...
```typescript
Custom stringify for primitives: 10523787.865 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5261158.931 ops/s (100 runs over 1000 unique samples each)
```

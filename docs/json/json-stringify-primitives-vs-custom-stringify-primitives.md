...
```typescript
Custom stringify for primitives: 10597770.420 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5444707.956 ops/s (100 runs over 1000 unique samples each)
```

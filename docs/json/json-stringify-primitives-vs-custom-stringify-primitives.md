...
#### **Custom stringify for primitives** is **_`1.83x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 8729764.300 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4776244.183 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/24/2023 0:57:44`

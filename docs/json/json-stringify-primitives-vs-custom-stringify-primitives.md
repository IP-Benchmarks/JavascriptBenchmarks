...
```typescript
Custom stringify for primitives: 4719539.255 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3660963.179 ops/s (100 runs over 1000 unique samples each)
```

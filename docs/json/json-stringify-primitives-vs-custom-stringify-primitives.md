...
```typescript
Custom stringify for primitives: 5018520.095 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3911683.573 ops/s (100 runs over 1000 unique samples each)
```

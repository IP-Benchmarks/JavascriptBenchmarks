...
```typescript
Custom stringify for primitives: 10441941.604 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6493837.089 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/15/2025 1:17:38`

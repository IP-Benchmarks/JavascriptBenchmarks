...
```typescript
Custom stringify for primitives: 4485761.095 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3317983.896 ops/s (100 runs over 1000 unique samples each)
```

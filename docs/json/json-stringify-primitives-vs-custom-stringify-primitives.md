...
```typescript
Custom stringify for primitives: 5626870.512 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4300559.941 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/23/2022 1:7:5`

...
```typescript
Custom stringify for primitives: 8685091.857 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6680625.611 ops/s (100 runs over 1000 unique samples each)
```

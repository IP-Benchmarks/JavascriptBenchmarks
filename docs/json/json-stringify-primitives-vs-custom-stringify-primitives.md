...
```typescript
Custom stringify for primitives: 8718053.024 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6085696.465 ops/s (100 runs over 1000 unique samples each)
```

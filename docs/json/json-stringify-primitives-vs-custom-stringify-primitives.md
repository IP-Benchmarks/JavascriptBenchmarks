...
```typescript
Custom stringify for primitives: 5653648.237 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3939452.662 ops/s (100 runs over 1000 unique samples each)
```

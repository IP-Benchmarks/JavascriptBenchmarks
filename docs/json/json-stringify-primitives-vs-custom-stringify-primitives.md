...
```typescript
Custom stringify for primitives: 4676506.846 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3550265.439 ops/s (100 runs over 1000 unique samples each)
```

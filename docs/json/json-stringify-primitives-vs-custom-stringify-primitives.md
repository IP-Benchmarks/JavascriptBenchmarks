...
```typescript
Custom stringify for primitives: 8600869.853 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6041237.851 ops/s (100 runs over 1000 unique samples each)
```

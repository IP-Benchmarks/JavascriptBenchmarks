...
```typescript
Custom stringify for primitives: 8669861.984 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4436011.292 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8120926.443 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5391510.753 ops/s (100 runs over 1000 unique samples each)
```

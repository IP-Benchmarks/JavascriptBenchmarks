...
```typescript
Custom stringify for primitives: 10271878.125 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5725588.025 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4889041.490 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3660269.321 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8399774.853 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5003676.452 ops/s (100 runs over 1000 unique samples each)
```

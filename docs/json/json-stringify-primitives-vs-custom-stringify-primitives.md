...
```typescript
Custom stringify for primitives: 8427772.130 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6193718.455 ops/s (100 runs over 1000 unique samples each)
```

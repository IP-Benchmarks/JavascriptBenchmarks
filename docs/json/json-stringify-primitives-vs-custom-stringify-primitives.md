...
```typescript
Custom stringify for primitives: 5616563.290 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4304671.568 ops/s (100 runs over 1000 unique samples each)
```

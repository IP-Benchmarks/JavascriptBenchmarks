...
```typescript
Custom stringify for primitives: 10014168.045 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6506583.882 ops/s (100 runs over 1000 unique samples each)
```

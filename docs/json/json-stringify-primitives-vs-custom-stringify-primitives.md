...
```typescript
Custom stringify for primitives: 10375016.379 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5321250.830 ops/s (100 runs over 1000 unique samples each)
```

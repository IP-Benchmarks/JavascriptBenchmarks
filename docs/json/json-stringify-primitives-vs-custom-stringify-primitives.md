...
```typescript
Custom stringify for primitives: 10035423.036 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6500707.505 ops/s (100 runs over 1000 unique samples each)
```

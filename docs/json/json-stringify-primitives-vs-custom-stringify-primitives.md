...
```typescript
Custom stringify for primitives: 6421845.372 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4215633.356 ops/s (100 runs over 1000 unique samples each)
```

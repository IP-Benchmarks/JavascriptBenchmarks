...
```typescript
Custom stringify for primitives: 5441294.418 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4405477.895 ops/s (100 runs over 1000 unique samples each)
```

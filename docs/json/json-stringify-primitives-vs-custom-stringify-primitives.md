...
```typescript
Custom stringify for primitives: 5218033.169 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3566363.954 ops/s (100 runs over 1000 unique samples each)
```

...
#### **Custom stringify for primitives** is **_`1.82x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10219605.004 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5629091.505 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/26/2025 1:22:12`

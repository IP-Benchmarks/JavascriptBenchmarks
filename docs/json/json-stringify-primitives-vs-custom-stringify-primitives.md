...
#### **Custom stringify for primitives** is **_`1.96x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10389898.608 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5287854.122 ops/s (100 runs over 1000 unique samples each)
```

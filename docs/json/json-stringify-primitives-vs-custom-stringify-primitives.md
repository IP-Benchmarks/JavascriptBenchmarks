...
```typescript
Custom stringify for primitives: 5109331.257 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3926002.546 ops/s (100 runs over 1000 unique samples each)
```

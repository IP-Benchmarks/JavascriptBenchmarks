...
```typescript
Custom stringify for primitives: 5406589.012 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4418876.042 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/3/2023 1:0:51`

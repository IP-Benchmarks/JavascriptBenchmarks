...
```typescript
Custom stringify for primitives: 6153405.380 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4311165.621 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 12/13/2022 1:8:55`

...
```typescript
Custom stringify for primitives: 9465407.957 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5659179.534 ops/s (100 runs over 1000 unique samples each)
```

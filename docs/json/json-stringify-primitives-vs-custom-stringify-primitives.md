...
```typescript
Custom stringify for primitives: 5212898.420 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4054486.459 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/8/2022 1:26:41`

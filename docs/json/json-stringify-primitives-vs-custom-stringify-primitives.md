...
```typescript
Custom stringify for primitives: 6584999.502 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4388755.429 ops/s (100 runs over 1000 unique samples each)
```

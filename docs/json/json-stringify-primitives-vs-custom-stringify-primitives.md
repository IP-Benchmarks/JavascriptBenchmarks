...
```typescript
Custom stringify for primitives: 5569516.167 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4395467.604 ops/s (100 runs over 1000 unique samples each)
```

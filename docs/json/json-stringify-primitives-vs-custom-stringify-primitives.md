...
```typescript
Custom stringify for primitives: 5341120.830 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4236490.562 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 6/19/2023 1:7:54`

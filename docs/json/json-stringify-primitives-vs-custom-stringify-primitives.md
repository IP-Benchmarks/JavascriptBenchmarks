...
```typescript
Custom stringify for primitives: 5945149.102 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4352610.173 ops/s (100 runs over 1000 unique samples each)
```

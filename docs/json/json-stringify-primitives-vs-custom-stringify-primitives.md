...
```typescript
Custom stringify for primitives: 8867791.428 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4968203.004 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10320577.787 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6693992.436 ops/s (100 runs over 1000 unique samples each)
```

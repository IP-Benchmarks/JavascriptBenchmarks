...
```typescript
Custom stringify for primitives: 6424786.311 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4185820.983 ops/s (100 runs over 1000 unique samples each)
```

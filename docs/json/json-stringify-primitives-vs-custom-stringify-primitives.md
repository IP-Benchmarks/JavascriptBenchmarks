...
```typescript
Custom stringify for primitives: 5487418.281 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4180777.837 ops/s (100 runs over 1000 unique samples each)
```

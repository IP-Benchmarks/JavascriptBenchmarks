...
#### **Custom stringify for primitives** is **_`1.95x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10312122.157 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5298805.469 ops/s (100 runs over 1000 unique samples each)
```

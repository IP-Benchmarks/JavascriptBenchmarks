...
```typescript
Custom stringify for primitives: 5383810.794 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4290299.513 ops/s (100 runs over 1000 unique samples each)
```

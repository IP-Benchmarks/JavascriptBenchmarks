...
```typescript
Custom stringify for primitives: 8737903.361 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5414633.984 ops/s (100 runs over 1000 unique samples each)
```

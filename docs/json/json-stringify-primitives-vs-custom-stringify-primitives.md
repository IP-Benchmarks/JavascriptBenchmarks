...
```typescript
Custom stringify for primitives: 5745373.106 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4523050.848 ops/s (100 runs over 1000 unique samples each)
```

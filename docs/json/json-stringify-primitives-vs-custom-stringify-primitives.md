...
```typescript
Custom stringify for primitives: 8544243.716 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5925498.237 ops/s (100 runs over 1000 unique samples each)
```

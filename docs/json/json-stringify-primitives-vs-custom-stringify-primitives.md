...
```typescript
Custom stringify for primitives: 9716653.635 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5836714.639 ops/s (100 runs over 1000 unique samples each)
```

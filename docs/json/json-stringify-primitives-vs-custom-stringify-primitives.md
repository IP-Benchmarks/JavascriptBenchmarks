...
```typescript
Custom stringify for primitives: 10415914.768 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5274607.958 ops/s (100 runs over 1000 unique samples each)
```

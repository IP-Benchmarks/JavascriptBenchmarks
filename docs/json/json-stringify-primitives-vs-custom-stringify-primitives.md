...
```typescript
Custom stringify for primitives: 8536604.856 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4745227.097 ops/s (100 runs over 1000 unique samples each)
```

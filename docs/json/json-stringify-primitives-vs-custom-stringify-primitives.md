...
```typescript
Custom stringify for primitives: 8120376.462 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5941194.885 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/13/2024 0:52:52`

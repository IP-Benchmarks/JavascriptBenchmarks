...
```typescript
Custom stringify for primitives: 5765785.380 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4421687.493 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10164745.106 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5415348.864 ops/s (100 runs over 1000 unique samples each)
```

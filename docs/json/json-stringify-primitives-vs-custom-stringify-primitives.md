...
```typescript
Custom stringify for primitives: 9859978.446 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6835448.939 ops/s (100 runs over 1000 unique samples each)
```

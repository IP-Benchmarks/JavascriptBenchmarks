...
```typescript
Custom stringify for primitives: 8706028.246 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5998903.880 ops/s (100 runs over 1000 unique samples each)
```

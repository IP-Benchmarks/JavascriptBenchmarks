...
```typescript
Custom stringify for primitives: 5387495.914 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3687737.441 ops/s (100 runs over 1000 unique samples each)
```

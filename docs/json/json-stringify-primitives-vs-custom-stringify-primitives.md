...
```typescript
Custom stringify for primitives: 4581138.702 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3456555.982 ops/s (100 runs over 1000 unique samples each)
```

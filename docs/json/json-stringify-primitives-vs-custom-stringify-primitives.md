...
```typescript
Custom stringify for primitives: 8229662.221 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6009519.319 ops/s (100 runs over 1000 unique samples each)
```

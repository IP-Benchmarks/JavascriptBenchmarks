...
```typescript
Custom stringify for primitives: 5352337.127 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4612643.144 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/10/2023 0:51:45`

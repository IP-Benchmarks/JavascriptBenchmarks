...
```typescript
Custom stringify for primitives: 4263876.476 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3329217.311 ops/s (100 runs over 1000 unique samples each)
```

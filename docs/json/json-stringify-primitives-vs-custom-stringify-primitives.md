...
```typescript
Custom stringify for primitives: 10516728.961 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5265229.901 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6321409.807 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3747335.597 ops/s (100 runs over 1000 unique samples each)
```

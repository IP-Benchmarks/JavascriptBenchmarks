...
```typescript
Custom stringify for primitives: 9599268.920 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6721256.262 ops/s (100 runs over 1000 unique samples each)
```

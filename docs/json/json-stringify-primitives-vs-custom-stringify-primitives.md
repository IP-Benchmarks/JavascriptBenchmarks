...
```typescript
Custom stringify for primitives: 4663463.490 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3643325.303 ops/s (100 runs over 1000 unique samples each)
```

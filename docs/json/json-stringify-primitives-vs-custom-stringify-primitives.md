...
```typescript
Custom stringify for primitives: 10656134.428 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6451407.707 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5375966.902 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4581144.997 ops/s (100 runs over 1000 unique samples each)
```

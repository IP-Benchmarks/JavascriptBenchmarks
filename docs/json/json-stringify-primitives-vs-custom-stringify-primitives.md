...
```typescript
Custom stringify for primitives: 4182553.574 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3638868.766 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10867324.422 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6916495.558 ops/s (100 runs over 1000 unique samples each)
```

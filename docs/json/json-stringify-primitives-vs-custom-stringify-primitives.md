...
```typescript
Custom stringify for primitives: 6018097.503 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4329806.936 ops/s (100 runs over 1000 unique samples each)
```

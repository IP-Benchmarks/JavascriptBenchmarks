...
```typescript
Custom stringify for primitives: 9081790.973 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6821753.316 ops/s (100 runs over 1000 unique samples each)
```

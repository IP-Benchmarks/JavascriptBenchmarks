...
```typescript
Custom stringify for primitives: 10175446.058 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5979973.905 ops/s (100 runs over 1000 unique samples each)
```

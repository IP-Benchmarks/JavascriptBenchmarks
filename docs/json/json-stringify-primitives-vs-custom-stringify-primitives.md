...
```typescript
Custom stringify for primitives: 5880543.464 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4469032.065 ops/s (100 runs over 1000 unique samples each)
```

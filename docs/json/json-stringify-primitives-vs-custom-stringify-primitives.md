...
```typescript
Custom stringify for primitives: 6172606.699 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4247417.687 ops/s (100 runs over 1000 unique samples each)
```

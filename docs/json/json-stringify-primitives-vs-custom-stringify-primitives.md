...
```typescript
Custom stringify for primitives: 9943672.081 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6896048.550 ops/s (100 runs over 1000 unique samples each)
```

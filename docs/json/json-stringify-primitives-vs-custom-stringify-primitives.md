...
```typescript
Custom stringify for primitives: 8374539.559 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6306879.379 ops/s (100 runs over 1000 unique samples each)
```

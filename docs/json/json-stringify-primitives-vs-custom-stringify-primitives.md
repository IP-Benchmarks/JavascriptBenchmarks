...
```typescript
Custom stringify for primitives: 5261827.762 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3678758.858 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5248189.781 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4142932.497 ops/s (100 runs over 1000 unique samples each)
```

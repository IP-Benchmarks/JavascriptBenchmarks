...
```typescript
Custom stringify for primitives: 10519328.741 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5825190.009 ops/s (100 runs over 1000 unique samples each)
```

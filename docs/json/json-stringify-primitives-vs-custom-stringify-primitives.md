...
```typescript
Custom stringify for primitives: 9844112.571 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6911410.303 ops/s (100 runs over 1000 unique samples each)
```

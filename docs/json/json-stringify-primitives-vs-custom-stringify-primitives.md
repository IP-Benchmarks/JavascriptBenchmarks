...
```typescript
Custom stringify for primitives: 5718828.425 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3846798.037 ops/s (100 runs over 1000 unique samples each)
```

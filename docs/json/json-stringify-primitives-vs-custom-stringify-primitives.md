...
```typescript
Custom stringify for primitives: 9161385.128 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6101119.342 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/29/2026 2:23:29`

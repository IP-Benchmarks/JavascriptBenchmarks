...
```typescript
Custom stringify for primitives: 5650795.637 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4223760.290 ops/s (100 runs over 1000 unique samples each)
```

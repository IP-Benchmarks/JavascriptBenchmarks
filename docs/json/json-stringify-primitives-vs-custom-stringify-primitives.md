...
```typescript
Custom stringify for primitives: 4119135.447 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3427884.089 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4871615.872 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3094582.574 ops/s (100 runs over 1000 unique samples each)
```

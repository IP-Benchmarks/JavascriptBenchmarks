...
```typescript
Custom stringify for primitives: 8521223.471 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5958441.539 ops/s (100 runs over 1000 unique samples each)
```

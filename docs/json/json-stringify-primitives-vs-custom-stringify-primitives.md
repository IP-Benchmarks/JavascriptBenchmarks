...
```typescript
Custom stringify for primitives: 4919479.922 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3580606.177 ops/s (100 runs over 1000 unique samples each)
```

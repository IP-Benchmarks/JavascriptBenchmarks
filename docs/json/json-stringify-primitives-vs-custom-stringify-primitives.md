...
```typescript
Custom stringify for primitives: 8648197.633 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5536821.719 ops/s (100 runs over 1000 unique samples each)
```

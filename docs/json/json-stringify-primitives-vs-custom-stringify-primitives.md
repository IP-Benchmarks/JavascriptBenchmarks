...
```typescript
Custom stringify for primitives: 9713271.038 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5750390.279 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4934715.199 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3590705.272 ops/s (100 runs over 1000 unique samples each)
```

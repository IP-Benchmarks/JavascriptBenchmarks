...
```typescript
Custom stringify for primitives: 5628815.527 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4289774.803 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/22/2023 0:51:46`

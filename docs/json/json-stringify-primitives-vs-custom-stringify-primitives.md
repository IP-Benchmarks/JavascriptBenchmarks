...
```typescript
Custom stringify for primitives: 8352931.402 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5545026.166 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5947962.466 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4592850.887 ops/s (100 runs over 1000 unique samples each)
```

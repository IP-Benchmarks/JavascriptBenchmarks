...
```typescript
Custom stringify for primitives: 9742858.680 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5858313.867 ops/s (100 runs over 1000 unique samples each)
```

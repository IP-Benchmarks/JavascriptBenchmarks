...
```typescript
Custom stringify for primitives: 8178952.207 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5696427.576 ops/s (100 runs over 1000 unique samples each)
```

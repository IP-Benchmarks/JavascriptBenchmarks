...
#### **Custom stringify for primitives** is **_`1.87x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10360509.468 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5554451.454 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4926190.154 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3344874.712 ops/s (100 runs over 1000 unique samples each)
```

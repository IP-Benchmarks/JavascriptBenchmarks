...
```typescript
Custom stringify for primitives: 5808930.454 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4380349.036 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 3600008.655 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3076285.197 ops/s (100 runs over 1000 unique samples each)
```

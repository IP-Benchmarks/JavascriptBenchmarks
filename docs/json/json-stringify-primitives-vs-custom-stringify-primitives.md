...
```typescript
Custom stringify for primitives: 5745671.197 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4426764.928 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5554126.295 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4476678.119 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10135662.806 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6767420.932 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/15/2024 1:9:49`

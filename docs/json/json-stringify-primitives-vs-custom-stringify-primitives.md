...
```typescript
Custom stringify for primitives: 9686236.642 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6456109.271 ops/s (100 runs over 1000 unique samples each)
```

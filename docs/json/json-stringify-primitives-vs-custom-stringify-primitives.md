...
```typescript
Custom stringify for primitives: 8411104.506 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4723129.221 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/30/2024 0:54:13`

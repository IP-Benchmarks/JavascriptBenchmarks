...
#### **Custom stringify for primitives** is **_`2.00x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 10593409.988 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5285604.187 ops/s (100 runs over 1000 unique samples each)
```

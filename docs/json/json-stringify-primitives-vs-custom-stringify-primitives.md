...
```typescript
Custom stringify for primitives: 10030370.960 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6349565.150 ops/s (100 runs over 1000 unique samples each)
```

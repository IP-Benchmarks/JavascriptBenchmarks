...
```typescript
Custom stringify for primitives: 5064171.408 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4394021.003 ops/s (100 runs over 1000 unique samples each)
```

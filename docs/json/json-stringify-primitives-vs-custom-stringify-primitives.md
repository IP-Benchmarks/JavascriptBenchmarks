...
```typescript
Custom stringify for primitives: 7026452.415 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5806556.206 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8469366.897 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5462556.144 ops/s (100 runs over 1000 unique samples each)
```

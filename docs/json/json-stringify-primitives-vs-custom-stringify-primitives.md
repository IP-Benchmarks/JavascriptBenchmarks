...
```typescript
Custom stringify for primitives: 9349429.311 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5205129.739 ops/s (100 runs over 1000 unique samples each)
```

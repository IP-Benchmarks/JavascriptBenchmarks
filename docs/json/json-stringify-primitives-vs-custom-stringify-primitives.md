...
```typescript
Custom stringify for primitives: 5590192.075 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3876307.494 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5628610.226 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4326952.117 ops/s (100 runs over 1000 unique samples each)
```

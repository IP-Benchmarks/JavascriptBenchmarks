...
```typescript
Custom stringify for primitives: 5677042.692 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4462421.059 ops/s (100 runs over 1000 unique samples each)
```

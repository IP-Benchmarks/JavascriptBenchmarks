...
```typescript
Custom stringify for primitives: 9932027.192 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5119091.308 ops/s (100 runs over 1000 unique samples each)
```

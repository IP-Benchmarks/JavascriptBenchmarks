...
```typescript
Custom stringify for primitives: 8578429.798 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5972073.508 ops/s (100 runs over 1000 unique samples each)
```

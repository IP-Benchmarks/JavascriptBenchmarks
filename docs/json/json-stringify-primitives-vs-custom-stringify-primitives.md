...
```typescript
Custom stringify for primitives: 5355243.275 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3064733.453 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5680194.808 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4111749.286 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 4376346.164 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3646182.873 ops/s (100 runs over 1000 unique samples each)
```

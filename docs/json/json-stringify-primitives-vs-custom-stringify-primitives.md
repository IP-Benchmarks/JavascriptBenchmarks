...
```typescript
Custom stringify for primitives: 9852854.515 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6641528.922 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 8/19/2025 1:19:43`

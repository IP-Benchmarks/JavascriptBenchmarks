...
```typescript
Custom stringify for primitives: 4868505.086 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3495528.537 ops/s (100 runs over 1000 unique samples each)
```

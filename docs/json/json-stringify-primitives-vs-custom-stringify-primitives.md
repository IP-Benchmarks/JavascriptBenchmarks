...
```typescript
Custom stringify for primitives: 9920242.244 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5272741.241 ops/s (100 runs over 1000 unique samples each)
```

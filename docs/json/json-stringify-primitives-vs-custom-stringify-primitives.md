...
```typescript
Custom stringify for primitives: 4579052.091 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3752607.264 ops/s (100 runs over 1000 unique samples each)
```

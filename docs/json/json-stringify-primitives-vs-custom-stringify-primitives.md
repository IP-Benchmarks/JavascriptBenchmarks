...
```typescript
Custom stringify for primitives: 10106514.578 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6880043.889 ops/s (100 runs over 1000 unique samples each)
```

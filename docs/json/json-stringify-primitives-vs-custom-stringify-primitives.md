...
```typescript
Custom stringify for primitives: 10616322.086 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6854355.837 ops/s (100 runs over 1000 unique samples each)
```

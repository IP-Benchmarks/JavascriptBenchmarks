...
```typescript
Custom stringify for primitives: 10138139.244 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6742149.071 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 8834104.091 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6200672.871 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/25/2024 1:9:45`

...
```typescript
Custom stringify for primitives: 4492237.862 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3291755.824 ops/s (100 runs over 1000 unique samples each)
```

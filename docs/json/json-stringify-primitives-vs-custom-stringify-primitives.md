...
```typescript
Custom stringify for primitives: 10201548.942 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4853293.668 ops/s (100 runs over 1000 unique samples each)
```

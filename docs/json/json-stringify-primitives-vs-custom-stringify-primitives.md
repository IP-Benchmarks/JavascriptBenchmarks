...
```typescript
Custom stringify for primitives: 5593201.843 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4332545.012 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5614002.309 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3976598.988 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 3930568.241 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3198059.469 ops/s (100 runs over 1000 unique samples each)
```

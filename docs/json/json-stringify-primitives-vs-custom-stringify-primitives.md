...
```typescript
Custom stringify for primitives: 5775989.455 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4351613.503 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 7/3/2023 1:17:2`

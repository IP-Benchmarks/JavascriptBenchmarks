...
```typescript
Custom stringify for primitives: 8492961.373 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6346477.163 ops/s (100 runs over 1000 unique samples each)
```

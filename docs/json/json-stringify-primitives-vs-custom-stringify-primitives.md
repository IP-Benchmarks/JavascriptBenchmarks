...
```typescript
Custom stringify for primitives: 5699649.341 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4376065.408 ops/s (100 runs over 1000 unique samples each)
```

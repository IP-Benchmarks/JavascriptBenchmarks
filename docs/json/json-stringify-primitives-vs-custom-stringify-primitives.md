...
```typescript
Custom stringify for primitives: 4633476.488 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3465835.458 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5377780.473 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4612442.515 ops/s (100 runs over 1000 unique samples each)
```

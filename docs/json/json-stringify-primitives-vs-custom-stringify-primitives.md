...
```typescript
Custom stringify for primitives: 4916616.881 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3863583.213 ops/s (100 runs over 1000 unique samples each)
```

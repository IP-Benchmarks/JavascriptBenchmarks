...
```typescript
Custom stringify for primitives: 10339922.897 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5933596.880 ops/s (100 runs over 1000 unique samples each)
```

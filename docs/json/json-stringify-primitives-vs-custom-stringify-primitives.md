...
```typescript
Custom stringify for primitives: 5888824.761 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4385249.809 ops/s (100 runs over 1000 unique samples each)
```

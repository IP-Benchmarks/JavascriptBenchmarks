...
```typescript
Custom stringify for primitives: 8758057.526 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5516674.646 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/28/2024 1:8:6`

...
```typescript
Custom stringify for primitives: 5284523.222 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3528909.248 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 6246678.719 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4277534.844 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 11/24/2022 1:13:19`

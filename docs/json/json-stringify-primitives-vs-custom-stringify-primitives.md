...
```typescript
Custom stringify for primitives: 10669286.474 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6755621.082 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 4/7/2025 1:17:18`

...
```typescript
Custom stringify for primitives: 10224543.239 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6645170.868 ops/s (100 runs over 1000 unique samples each)
```

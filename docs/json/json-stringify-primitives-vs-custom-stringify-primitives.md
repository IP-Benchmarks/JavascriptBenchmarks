...
```typescript
Custom stringify for primitives: 6484972.018 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4455307.276 ops/s (100 runs over 1000 unique samples each)
```

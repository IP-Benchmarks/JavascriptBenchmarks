...
```typescript
Custom stringify for primitives: 10519405.094 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6492794.394 ops/s (100 runs over 1000 unique samples each)
```

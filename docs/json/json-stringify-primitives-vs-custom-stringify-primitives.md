...
```typescript
Custom stringify for primitives: 4410658.214 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3474072.407 ops/s (100 runs over 1000 unique samples each)
```

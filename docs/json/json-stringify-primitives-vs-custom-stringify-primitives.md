...
```typescript
Custom stringify for primitives: 6378912.641 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4323140.578 ops/s (100 runs over 1000 unique samples each)
```

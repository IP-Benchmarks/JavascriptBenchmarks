...
```typescript
Custom stringify for primitives: 5946847.552 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4471680.957 ops/s (100 runs over 1000 unique samples each)
```

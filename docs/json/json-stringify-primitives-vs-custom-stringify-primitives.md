...
```typescript
Custom stringify for primitives: 5016452.962 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3690409.482 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5317385.714 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4211253.133 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/12/2022 0:50:42`

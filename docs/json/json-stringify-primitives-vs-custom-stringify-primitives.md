...
```typescript
Custom stringify for primitives: 5298419.995 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4072521.841 ops/s (100 runs over 1000 unique samples each)
```

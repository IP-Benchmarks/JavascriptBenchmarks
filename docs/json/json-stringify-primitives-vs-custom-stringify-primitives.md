...
```typescript
Custom stringify for primitives: 12837120.434 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6815875.264 ops/s (100 runs over 1000 unique samples each)
```

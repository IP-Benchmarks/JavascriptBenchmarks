...
```typescript
Custom stringify for primitives: 6430173.047 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3893045.580 ops/s (100 runs over 1000 unique samples each)
```

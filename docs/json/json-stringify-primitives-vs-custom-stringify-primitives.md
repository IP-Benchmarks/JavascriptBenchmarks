...
```typescript
Custom stringify for primitives: 7370349.832 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4164582.468 ops/s (100 runs over 1000 unique samples each)
```

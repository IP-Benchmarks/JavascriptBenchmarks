...
```typescript
Custom stringify for primitives: 8632844.850 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5865577.734 ops/s (100 runs over 1000 unique samples each)
```

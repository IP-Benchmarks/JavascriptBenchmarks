...
#### **Custom stringify for primitives** is **_`1.62x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 11738223.070 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 7229935.519 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10014943.297 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6556839.173 ops/s (100 runs over 1000 unique samples each)
```

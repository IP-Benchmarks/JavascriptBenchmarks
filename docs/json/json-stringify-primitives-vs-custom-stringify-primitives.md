...
```typescript
Custom stringify for primitives: 7440433.567 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6172551.068 ops/s (100 runs over 1000 unique samples each)
```

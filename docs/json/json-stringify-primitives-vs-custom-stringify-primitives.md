...
```typescript
Custom stringify for primitives: 10523673.793 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6595208.027 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5380789.601 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3209402.780 ops/s (100 runs over 1000 unique samples each)
```

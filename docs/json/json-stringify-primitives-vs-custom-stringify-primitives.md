...
```typescript
Custom stringify for primitives: 4925634.738 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4288626.631 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 9995625.914 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6631003.362 ops/s (100 runs over 1000 unique samples each)
```

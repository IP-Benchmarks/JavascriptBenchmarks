...
```typescript
Custom stringify for primitives: 8821021.911 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6154822.970 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 3/8/2024 0:51:48`

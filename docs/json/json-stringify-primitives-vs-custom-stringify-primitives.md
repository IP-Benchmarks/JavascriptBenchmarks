...
```typescript
Custom stringify for primitives: 9604773.188 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6832753.597 ops/s (100 runs over 1000 unique samples each)
```

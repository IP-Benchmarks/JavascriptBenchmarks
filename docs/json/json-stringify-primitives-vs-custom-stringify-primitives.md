...
```typescript
Custom stringify for primitives: 5223248.973 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4495896.483 ops/s (100 runs over 1000 unique samples each)
```

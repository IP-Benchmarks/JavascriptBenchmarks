...
```typescript
Custom stringify for primitives: 9595091.919 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5825796.791 ops/s (100 runs over 1000 unique samples each)
```

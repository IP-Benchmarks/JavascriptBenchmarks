...
```typescript
Custom stringify for primitives: 6365869.568 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4396452.959 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5942453.517 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4380659.512 ops/s (100 runs over 1000 unique samples each)
```

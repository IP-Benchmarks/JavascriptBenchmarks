...
```typescript
Custom stringify for primitives: 8875453.431 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5952172.979 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 10/11/2024 1:8:34`

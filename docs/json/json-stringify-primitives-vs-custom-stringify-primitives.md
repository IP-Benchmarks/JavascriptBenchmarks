...
```typescript
Custom stringify for primitives: 8400668.894 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5637534.707 ops/s (100 runs over 1000 unique samples each)
```

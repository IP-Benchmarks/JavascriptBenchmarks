...
#### **Custom stringify for primitives** is **_`1.23x`_** faster than **JSON stringify**

```typescript
Custom stringify for primitives: 5436882.016 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4406208.347 ops/s (100 runs over 1000 unique samples each)
```

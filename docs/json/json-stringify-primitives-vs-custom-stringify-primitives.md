...
```typescript
Custom stringify for primitives: 5479686.855 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4685782.442 ops/s (100 runs over 1000 unique samples each)
```

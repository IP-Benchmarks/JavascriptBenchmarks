...
```typescript
Custom stringify for primitives: 4715364.785 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3568794.674 ops/s (100 runs over 1000 unique samples each)
```

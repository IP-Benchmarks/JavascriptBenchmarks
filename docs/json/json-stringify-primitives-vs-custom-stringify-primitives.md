...
```typescript
Custom stringify for primitives: 10135052.617 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 5593923.969 ops/s (100 runs over 1000 unique samples each)
```

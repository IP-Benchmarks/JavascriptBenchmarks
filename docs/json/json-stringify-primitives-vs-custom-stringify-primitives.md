...
```typescript
Custom stringify for primitives: 10023561.383 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6727417.489 ops/s (100 runs over 1000 unique samples each)
```

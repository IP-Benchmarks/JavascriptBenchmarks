...
```typescript
Custom stringify for primitives: 6565809.702 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4208848.093 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 1/19/2023 1:4:44`

...
```typescript
Custom stringify for primitives: 4455183.615 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 2700109.065 ops/s (100 runs over 1000 unique samples each)
```

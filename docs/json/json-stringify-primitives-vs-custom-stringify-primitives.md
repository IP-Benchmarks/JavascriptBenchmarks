...
```typescript
Custom stringify for primitives: 9792627.405 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6770604.931 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 10581273.812 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6622937.179 ops/s (100 runs over 1000 unique samples each)
```

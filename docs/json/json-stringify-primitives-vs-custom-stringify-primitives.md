...
```typescript
Custom stringify for primitives: 9639037.330 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6224082.531 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 9/14/2025 1:18:30`

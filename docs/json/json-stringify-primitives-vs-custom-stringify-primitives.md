...
```typescript
Custom stringify for primitives: 10301390.883 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 6750610.508 ops/s (100 runs over 1000 unique samples each)
```

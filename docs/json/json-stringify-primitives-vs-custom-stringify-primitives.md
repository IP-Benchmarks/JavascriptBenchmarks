...
```typescript
Custom stringify for primitives: 6192805.955 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3231567.085 ops/s (100 runs over 1000 unique samples each)
```

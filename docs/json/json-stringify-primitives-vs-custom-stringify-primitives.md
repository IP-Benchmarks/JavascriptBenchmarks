...
```typescript
Custom stringify for primitives: 5889986.711 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4244421.101 ops/s (100 runs over 1000 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5662415.721 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 4434774.075 ops/s (100 runs over 1000 unique samples each)
```
...
#### `Last updated on: 2/10/2022 0:48:4`

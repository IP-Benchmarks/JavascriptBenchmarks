...
```typescript
JSON stringify: 9621.801 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6629.392 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/18/2022 1:2:57`

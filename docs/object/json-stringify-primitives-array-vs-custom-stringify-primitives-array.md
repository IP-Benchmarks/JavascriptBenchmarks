...
```typescript
JSON stringify: 11686.426 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8499.097 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/21/2022 1:52:2`

...
```typescript
JSON stringify: 16007.290 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13659.957 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/10/2024 1:8:14`

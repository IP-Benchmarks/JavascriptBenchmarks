...
```typescript
JSON stringify: 9174.301 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6058.207 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/12/2023 0:50:22`

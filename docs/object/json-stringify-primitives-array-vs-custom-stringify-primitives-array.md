...
```typescript
JSON stringify: 15138.249 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13537.180 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/6/2024 0:57:30`

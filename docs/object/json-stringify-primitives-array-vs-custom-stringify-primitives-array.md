...
```typescript
JSON stringify: 11784.004 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9285.276 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/11/2023 1:3:44`

...
```typescript
JSON stringify: 17413.218 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14045.395 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/13/2026 2:28:30`

...
```typescript
JSON stringify: 11098.864 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6858.087 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/13/2023 1:17:25`

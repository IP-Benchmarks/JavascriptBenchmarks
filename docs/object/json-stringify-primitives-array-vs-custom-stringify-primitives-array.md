...
```typescript
JSON stringify: 9950.808 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6836.741 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/13/2022 1:46:18`

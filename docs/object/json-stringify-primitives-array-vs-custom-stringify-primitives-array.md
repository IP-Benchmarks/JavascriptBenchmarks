...
#### **JSON stringify** is **_`1.25x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 17567.970 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14088.237 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/11/2024 1:15:36`

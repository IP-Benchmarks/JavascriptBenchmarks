...
```typescript
JSON stringify: 17763.279 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13759.517 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/3/2025 1:21:52`

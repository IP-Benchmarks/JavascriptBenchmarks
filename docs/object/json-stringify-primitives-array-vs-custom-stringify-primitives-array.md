...
```typescript
JSON stringify: 11383.747 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8219.123 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/27/2022 1:0:57`

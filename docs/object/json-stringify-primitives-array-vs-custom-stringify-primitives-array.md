...
```typescript
JSON stringify: 15496.261 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13721.977 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/15/2024 0:58:6`

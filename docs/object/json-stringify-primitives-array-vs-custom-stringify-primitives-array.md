...
```typescript
JSON stringify: 17661.711 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13829.913 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/8/2025 1:15:15`

...
```typescript
JSON stringify: 24368.494 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14047.652 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/8/2026 3:42:43`

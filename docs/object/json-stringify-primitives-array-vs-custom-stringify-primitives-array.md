...
```typescript
JSON stringify: 17550.838 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13305.635 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/17/2025 1:20:55`

...
```typescript
JSON stringify: 9588.949 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6908.606 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/2/2023 1:2:52`

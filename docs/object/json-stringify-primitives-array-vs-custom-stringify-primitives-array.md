...
```typescript
JSON stringify: 11799.026 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9554.652 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/13/2022 0:50:41`

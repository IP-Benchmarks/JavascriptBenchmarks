...
```typescript
JSON stringify: 12202.134 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8001.159 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/7/2023 1:3:7`

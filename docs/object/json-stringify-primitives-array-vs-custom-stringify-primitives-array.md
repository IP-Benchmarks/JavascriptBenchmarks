...
```typescript
JSON stringify: 17947.806 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13876.351 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/5/2025 1:22:17`

...
```typescript
JSON stringify: 16279.518 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12450.650 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/28/2026 1:58:23`

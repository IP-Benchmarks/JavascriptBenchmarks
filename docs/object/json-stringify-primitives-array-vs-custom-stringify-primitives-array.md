...
```typescript
JSON stringify: 31952.377 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 17245.400 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/29/2026 2:56:9`

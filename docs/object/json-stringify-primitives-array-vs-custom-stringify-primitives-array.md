...
```typescript
JSON stringify: 12773.185 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8661.420 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/8/2022 1:6:21`

...
```typescript
JSON stringify: 15648.124 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13281.656 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/21/2024 1:1:31`

...
```typescript
JSON stringify: 12093.015 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7637.824 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/27/2023 0:52:12`

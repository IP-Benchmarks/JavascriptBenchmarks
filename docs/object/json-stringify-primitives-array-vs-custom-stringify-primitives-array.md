...
```typescript
JSON stringify: 15262.214 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13435.253 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/30/2024 1:12:20`

...
```typescript
JSON stringify: 23410.244 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13781.216 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/9/2026 2:59:45`

...
```typescript
JSON stringify: 15893.750 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13189.782 ops/s (100 runs over 100 unique samples each)
```

...
#### **JSON stringify** is **_`1.49x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10512.975 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7065.920 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/19/2021 0:48:56`

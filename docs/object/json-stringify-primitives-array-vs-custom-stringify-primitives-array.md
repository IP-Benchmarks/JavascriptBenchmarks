...
#### **JSON stringify** is **_`1.33x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 17903.128 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13430.294 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/22/2025 1:16:24`

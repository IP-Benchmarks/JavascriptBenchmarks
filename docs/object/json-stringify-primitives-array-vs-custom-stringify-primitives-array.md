...
```typescript
JSON stringify: 12563.570 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9975.798 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/14/2023 1:2:36`

...
```typescript
JSON stringify: 17559.355 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13895.762 ops/s (100 runs over 100 unique samples each)
```

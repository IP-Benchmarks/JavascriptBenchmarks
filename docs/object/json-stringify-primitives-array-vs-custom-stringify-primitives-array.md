...
```typescript
JSON stringify: 9950.201 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6707.509 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/25/2022 1:48:57`

...
```typescript
JSON stringify: 12351.130 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9778.816 ops/s (100 runs over 100 unique samples each)
```

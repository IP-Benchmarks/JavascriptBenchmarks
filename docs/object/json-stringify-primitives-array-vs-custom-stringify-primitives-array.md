...
```typescript
JSON stringify: 15851.075 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13281.362 ops/s (100 runs over 100 unique samples each)
```

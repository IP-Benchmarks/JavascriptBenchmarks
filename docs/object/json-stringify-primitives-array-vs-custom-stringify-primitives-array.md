...
```typescript
JSON stringify: 11654.150 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8071.472 ops/s (100 runs over 100 unique samples each)
```

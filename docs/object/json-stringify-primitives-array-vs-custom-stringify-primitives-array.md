...
```typescript
JSON stringify: 10225.023 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6917.490 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/16/2023 1:6:18`

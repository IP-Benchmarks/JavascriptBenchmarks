...
```typescript
JSON stringify: 15334.822 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13461.145 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/20/2024 1:14:47`

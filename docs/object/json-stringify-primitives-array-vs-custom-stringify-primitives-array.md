...
```typescript
JSON stringify: 11063.251 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8151.155 ops/s (100 runs over 100 unique samples each)
```

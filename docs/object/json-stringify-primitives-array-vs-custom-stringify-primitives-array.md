...
```typescript
JSON stringify: 11453.963 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10245.404 ops/s (100 runs over 100 unique samples each)
```

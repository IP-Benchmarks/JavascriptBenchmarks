...
```typescript
JSON stringify: 17371.248 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14004.558 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/27/2025 1:22:37`

...
```typescript
JSON stringify: 11595.350 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8107.233 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/31/2022 1:55:7`

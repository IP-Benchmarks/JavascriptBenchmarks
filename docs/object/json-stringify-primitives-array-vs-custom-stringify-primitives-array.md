...
```typescript
JSON stringify: 12002.012 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8242.685 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/28/2022 1:44:52`

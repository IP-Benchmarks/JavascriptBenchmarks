...
```typescript
JSON stringify: 12546.687 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9602.124 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/9/2023 0:59:45`

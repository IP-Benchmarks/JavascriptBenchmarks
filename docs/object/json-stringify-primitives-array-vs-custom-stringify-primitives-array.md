...
```typescript
JSON stringify: 15574.366 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13023.605 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/2/2024 0:50:37`

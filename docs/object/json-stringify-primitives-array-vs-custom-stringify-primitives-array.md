...
```typescript
JSON stringify: 11381.058 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7939.567 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/4/2022 1:4:16`

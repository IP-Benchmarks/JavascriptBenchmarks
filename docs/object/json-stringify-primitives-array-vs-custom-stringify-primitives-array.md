...
```typescript
JSON stringify: 9685.226 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6601.082 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/21/2022 1:17:33`

...
#### **JSON stringify** is **_`1.29x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15888.123 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12319.968 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/14/2023 0:53:22`

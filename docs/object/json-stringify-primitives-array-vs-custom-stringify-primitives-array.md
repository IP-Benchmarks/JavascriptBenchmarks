...
```typescript
JSON stringify: 24185.989 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14120.938 ops/s (100 runs over 100 unique samples each)
```

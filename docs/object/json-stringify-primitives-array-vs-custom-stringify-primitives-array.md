...
```typescript
JSON stringify: 12838.952 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9787.667 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/22/2023 0:55:33`

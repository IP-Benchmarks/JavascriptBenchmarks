...
#### **JSON stringify** is **_`1.50x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 12009.732 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7980.396 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/16/2022 1:14:46`

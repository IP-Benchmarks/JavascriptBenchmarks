...
```typescript
JSON stringify: 12115.301 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7793.392 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/18/2023 0:51:35`

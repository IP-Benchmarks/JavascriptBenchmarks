...
```typescript
JSON stringify: 9857.062 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6838.650 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/20/2022 0:54:43`

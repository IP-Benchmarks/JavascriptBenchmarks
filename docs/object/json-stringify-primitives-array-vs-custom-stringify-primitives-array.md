...
```typescript
JSON stringify: 17425.151 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13481.265 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/15/2026 2:7:34`

...
```typescript
JSON stringify: 15608.626 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13183.503 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/5/2024 1:4:59`

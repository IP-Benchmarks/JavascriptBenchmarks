...
```typescript
JSON stringify: 15181.201 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11870.228 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/1/2024 1:15:12`

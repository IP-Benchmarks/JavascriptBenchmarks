...
```typescript
JSON stringify: 17923.188 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14027.618 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/25/2025 1:14:37`

...
```typescript
JSON stringify: 9395.952 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6648.662 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/4/2022 0:59:26`

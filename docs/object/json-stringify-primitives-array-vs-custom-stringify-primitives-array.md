...
```typescript
JSON stringify: 17897.649 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13278.232 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 11558.308 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8258.147 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/12/2022 1:50:26`

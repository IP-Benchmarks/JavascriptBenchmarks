...
```typescript
JSON stringify: 11621.769 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8099.702 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/26/2022 0:48:40`

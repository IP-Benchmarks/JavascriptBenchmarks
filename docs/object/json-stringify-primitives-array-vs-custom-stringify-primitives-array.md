...
```typescript
JSON stringify: 17199.753 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14044.271 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/1/2025 1:24:27`

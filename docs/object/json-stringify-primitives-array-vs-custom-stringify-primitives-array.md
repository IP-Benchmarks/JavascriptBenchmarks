...
```typescript
JSON stringify: 17566.812 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13931.644 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/13/2025 1:19:15`

...
```typescript
JSON stringify: 18028.886 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13895.755 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/25/2025 1:27:5`

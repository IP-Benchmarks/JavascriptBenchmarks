...
#### **JSON stringify** is **_`1.16x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15491.284 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13371.838 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/28/2024 1:12:10`

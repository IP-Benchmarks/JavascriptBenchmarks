...
```typescript
JSON stringify: 24267.430 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13897.716 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/3/2026 2:42:10`

...
```typescript
JSON stringify: 16013.807 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13587.186 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/20/2024 0:55:27`

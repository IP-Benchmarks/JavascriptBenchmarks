...
```typescript
JSON stringify: 16654.390 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13508.445 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/4/2025 1:18:44`

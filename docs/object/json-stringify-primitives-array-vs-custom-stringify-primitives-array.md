...
```typescript
JSON stringify: 11104.121 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7677.850 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/23/2022 1:5:36`

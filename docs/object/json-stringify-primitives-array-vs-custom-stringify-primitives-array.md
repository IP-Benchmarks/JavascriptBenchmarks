...
```typescript
JSON stringify: 12559.909 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9845.586 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/2/2023 1:9:48`

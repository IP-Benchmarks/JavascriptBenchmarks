...
```typescript
JSON stringify: 15923.503 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13470.761 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/6/2024 1:14:48`

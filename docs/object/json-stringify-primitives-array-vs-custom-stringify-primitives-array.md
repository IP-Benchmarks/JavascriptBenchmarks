...
```typescript
JSON stringify: 15870.183 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13600.457 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/31/2023 0:58:22`

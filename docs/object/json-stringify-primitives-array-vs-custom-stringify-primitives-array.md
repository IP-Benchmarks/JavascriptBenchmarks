...
```typescript
JSON stringify: 17607.719 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13676.875 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/5/2026 2:11:29`

...
```typescript
JSON stringify: 11563.457 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8154.905 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/27/2021 0:46:5`

...
```typescript
JSON stringify: 15661.716 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13483.963 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/13/2024 1:5:29`

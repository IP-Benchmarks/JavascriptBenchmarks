...
```typescript
JSON stringify: 12395.385 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8247.233 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/5/2023 0:56:27`

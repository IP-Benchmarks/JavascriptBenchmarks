...
```typescript
JSON stringify: 15621.837 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13235.658 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/6/2024 0:51:59`

...
```typescript
JSON stringify: 17716.750 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14256.494 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/30/2025 1:18:38`

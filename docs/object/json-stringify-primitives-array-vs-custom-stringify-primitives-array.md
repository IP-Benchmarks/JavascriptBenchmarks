...
```typescript
JSON stringify: 17919.842 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14018.653 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/30/2026 1:51:19`

...
```typescript
JSON stringify: 17888.875 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13912.063 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/23/2026 2:26:43`

...
```typescript
JSON stringify: 11435.408 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8266.727 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/5/2022 1:2:35`

...
```typescript
JSON stringify: 9642.647 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6486.506 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/4/2022 0:47:21`

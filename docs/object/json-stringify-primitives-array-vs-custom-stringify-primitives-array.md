...
```typescript
JSON stringify: 17144.019 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13057.064 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/1/2026 2:48:59`

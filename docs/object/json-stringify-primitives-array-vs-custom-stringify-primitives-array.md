...
```typescript
JSON stringify: 9151.958 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6519.239 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/30/2022 1:2:29`

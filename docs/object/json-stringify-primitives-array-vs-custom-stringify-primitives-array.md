...
```typescript
JSON stringify: 17784.808 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13857.070 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/18/2025 1:26:49`

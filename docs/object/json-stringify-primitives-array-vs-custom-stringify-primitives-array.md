...
#### **JSON stringify** is **_`1.42x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 17971.975 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12629.173 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/7/2025 1:18:58`

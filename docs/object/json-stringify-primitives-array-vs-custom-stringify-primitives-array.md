...
```typescript
JSON stringify: 12108.872 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8377.410 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/5/2022 1:12:30`

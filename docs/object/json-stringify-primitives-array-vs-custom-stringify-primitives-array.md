...
```typescript
JSON stringify: 11975.231 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9710.530 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/10/2022 0:59:56`

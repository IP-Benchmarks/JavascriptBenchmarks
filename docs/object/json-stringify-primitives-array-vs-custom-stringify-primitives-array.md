...
```typescript
JSON stringify: 15557.274 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13556.928 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/7/2024 1:14:27`

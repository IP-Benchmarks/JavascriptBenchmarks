...
```typescript
JSON stringify: 15197.741 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12448.795 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/2/2024 0:59:21`

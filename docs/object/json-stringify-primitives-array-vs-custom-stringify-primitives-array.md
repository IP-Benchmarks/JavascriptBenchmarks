...
```typescript
JSON stringify: 11083.269 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8137.732 ops/s (100 runs over 100 unique samples each)
```

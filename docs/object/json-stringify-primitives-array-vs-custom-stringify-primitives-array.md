...
```typescript
JSON stringify: 17904.472 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13749.984 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/15/2025 1:8:16`

...
```typescript
JSON stringify: 15409.111 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13224.388 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/13/2024 0:58:9`

...
```typescript
JSON stringify: 15807.053 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13596.630 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/25/2024 0:57:15`

...
```typescript
JSON stringify: 17832.967 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14363.974 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/18/2025 1:9:14`

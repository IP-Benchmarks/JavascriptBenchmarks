...
```typescript
JSON stringify: 11856.248 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8232.305 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/12/2022 0:48:10`

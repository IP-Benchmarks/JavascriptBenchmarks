...
```typescript
JSON stringify: 15685.385 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12915.357 ops/s (100 runs over 100 unique samples each)
```

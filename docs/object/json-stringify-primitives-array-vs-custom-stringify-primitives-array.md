...
```typescript
JSON stringify: 14625.971 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13227.759 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/20/2024 0:59:16`

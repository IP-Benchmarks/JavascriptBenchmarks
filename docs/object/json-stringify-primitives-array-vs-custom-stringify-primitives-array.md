...
```typescript
JSON stringify: 17244.319 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14241.125 ops/s (100 runs over 100 unique samples each)
```

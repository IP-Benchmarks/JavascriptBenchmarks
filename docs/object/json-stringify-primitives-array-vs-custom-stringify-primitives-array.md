...
```typescript
JSON stringify: 10626.727 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6911.297 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/28/2023 1:16:39`

...
```typescript
JSON stringify: 12492.798 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9810.218 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/4/2023 1:4:5`

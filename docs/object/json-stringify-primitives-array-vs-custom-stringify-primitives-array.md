...
```typescript
JSON stringify: 17724.981 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13754.124 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/16/2025 1:14:36`

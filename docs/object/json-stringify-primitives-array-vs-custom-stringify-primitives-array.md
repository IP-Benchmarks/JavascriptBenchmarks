...
```typescript
JSON stringify: 11044.029 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7682.222 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/16/2021 0:44:9`

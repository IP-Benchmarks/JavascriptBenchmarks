...
```typescript
JSON stringify: 17885.548 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13803.521 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/10/2026 2:22:20`

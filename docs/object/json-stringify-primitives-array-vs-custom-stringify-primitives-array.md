...
```typescript
JSON stringify: 12487.118 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8238.288 ops/s (100 runs over 100 unique samples each)
```

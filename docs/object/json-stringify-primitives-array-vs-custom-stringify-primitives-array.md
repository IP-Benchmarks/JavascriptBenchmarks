...
```typescript
JSON stringify: 11730.060 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8406.477 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/18/2022 0:53:58`

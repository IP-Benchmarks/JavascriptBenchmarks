...
```typescript
JSON stringify: 9923.893 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 5657.573 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/23/2023 0:50:17`

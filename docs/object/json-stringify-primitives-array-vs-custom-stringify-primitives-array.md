...
```typescript
JSON stringify: 17851.913 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13427.445 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/12/2025 1:11:45`

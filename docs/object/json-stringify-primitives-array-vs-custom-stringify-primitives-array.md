...
```typescript
JSON stringify: 17736.193 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13413.947 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/5/2026 1:53:41`

...
```typescript
JSON stringify: 17541.877 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13525.580 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/20/2026 2:29:23`

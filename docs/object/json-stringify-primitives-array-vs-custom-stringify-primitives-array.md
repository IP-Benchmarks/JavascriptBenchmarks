...
```typescript
JSON stringify: 15976.977 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13820.962 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/22/2024 0:58:52`

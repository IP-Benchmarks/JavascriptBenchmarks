...
```typescript
JSON stringify: 17946.479 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14087.169 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/21/2026 1:49:24`

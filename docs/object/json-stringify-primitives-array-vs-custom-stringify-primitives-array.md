...
```typescript
JSON stringify: 23909.140 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14145.174 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/21/2026 3:14:39`

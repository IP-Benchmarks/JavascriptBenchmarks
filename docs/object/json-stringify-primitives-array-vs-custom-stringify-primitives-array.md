...
```typescript
JSON stringify: 15526.073 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13598.826 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/25/2024 1:0:53`

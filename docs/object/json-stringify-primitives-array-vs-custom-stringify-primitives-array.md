...
```typescript
JSON stringify: 11418.571 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7679.198 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/18/2022 1:53:55`

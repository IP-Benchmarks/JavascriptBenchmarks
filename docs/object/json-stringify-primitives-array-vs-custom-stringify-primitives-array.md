...
```typescript
JSON stringify: 12177.524 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7671.688 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/27/2023 1:6:41`

...
```typescript
JSON stringify: 15750.078 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13153.180 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/4/2024 0:52:42`

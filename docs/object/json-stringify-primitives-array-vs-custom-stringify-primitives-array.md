...
```typescript
JSON stringify: 24683.827 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13353.673 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/26/2026 3:26:45`

...
```typescript
JSON stringify: 11156.266 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8181.556 ops/s (100 runs over 100 unique samples each)
```

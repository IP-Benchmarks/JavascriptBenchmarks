...
```typescript
JSON stringify: 17559.057 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14024.975 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/4/2026 2:38:27`

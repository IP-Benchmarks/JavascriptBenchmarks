...
```typescript
JSON stringify: 10039.005 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7328.128 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/28/2022 1:18:33`

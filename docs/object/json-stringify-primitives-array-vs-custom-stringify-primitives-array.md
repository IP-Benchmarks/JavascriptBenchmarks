...
```typescript
JSON stringify: 15757.766 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13126.179 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/25/2024 0:56:13`

...
```typescript
JSON stringify: 11942.301 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8349.240 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/8/2022 0:46:56`

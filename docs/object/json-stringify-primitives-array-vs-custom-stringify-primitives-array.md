...
```typescript
JSON stringify: 11766.639 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8048.528 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/4/2023 0:52:53`

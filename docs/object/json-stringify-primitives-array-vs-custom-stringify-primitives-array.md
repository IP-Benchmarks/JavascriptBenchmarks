...
```typescript
JSON stringify: 15879.335 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13690.648 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/2/2024 0:53:47`

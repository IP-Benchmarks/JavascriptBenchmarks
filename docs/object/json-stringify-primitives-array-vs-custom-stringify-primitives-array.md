...
#### **JSON stringify** is **_`1.47x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10767.385 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7303.973 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/21/2022 1:15:26`

...
```typescript
JSON stringify: 16152.471 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13909.883 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/15/2023 0:56:1`

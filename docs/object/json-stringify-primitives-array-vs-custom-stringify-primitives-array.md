...
```typescript
JSON stringify: 10118.825 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6682.258 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/5/2023 0:52:22`

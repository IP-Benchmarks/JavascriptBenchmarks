...
```typescript
JSON stringify: 11847.984 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9902.123 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/5/2023 1:8:41`

...
```typescript
JSON stringify: 24530.713 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14114.570 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/5/2026 2:11:18`

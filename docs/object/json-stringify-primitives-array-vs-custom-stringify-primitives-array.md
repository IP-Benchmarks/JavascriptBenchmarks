...
```typescript
JSON stringify: 15845.073 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13140.285 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/28/2024 0:58:25`

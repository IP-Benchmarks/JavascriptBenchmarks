...
```typescript
JSON stringify: 15809.567 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12630.266 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/12/2024 1:5:22`

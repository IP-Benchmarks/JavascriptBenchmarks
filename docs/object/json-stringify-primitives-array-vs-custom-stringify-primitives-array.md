...
```typescript
JSON stringify: 10027.375 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6401.703 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/9/2023 1:11:39`

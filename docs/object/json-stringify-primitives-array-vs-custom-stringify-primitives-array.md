...
```typescript
JSON stringify: 17439.030 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13408.588 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/3/2025 1:9:47`

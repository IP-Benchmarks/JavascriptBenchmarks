...
```typescript
JSON stringify: 9674.190 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6955.018 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/7/2022 1:4:56`

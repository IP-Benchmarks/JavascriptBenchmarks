...
```typescript
JSON stringify: 10796.335 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7140.924 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/15/2023 1:6:42`

...
```typescript
JSON stringify: 16016.822 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13549.346 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/16/2023 0:54:23`

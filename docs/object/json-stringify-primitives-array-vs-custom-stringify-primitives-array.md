...
```typescript
JSON stringify: 10676.124 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8679.003 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/27/2023 0:53:4`

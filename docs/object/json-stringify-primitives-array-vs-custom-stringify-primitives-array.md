...
```typescript
JSON stringify: 23824.850 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13466.716 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/16/2026 3:15:14`

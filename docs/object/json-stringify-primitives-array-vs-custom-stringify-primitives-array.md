...
```typescript
JSON stringify: 17652.946 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13561.160 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/16/2026 2:27:59`

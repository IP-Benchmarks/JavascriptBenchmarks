...
```typescript
JSON stringify: 15130.653 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13074.836 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/15/2024 0:52:46`

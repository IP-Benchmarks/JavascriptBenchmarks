...
```typescript
JSON stringify: 16203.524 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13627.514 ops/s (100 runs over 100 unique samples each)
```

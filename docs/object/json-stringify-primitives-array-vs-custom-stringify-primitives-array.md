...
```typescript
JSON stringify: 17834.361 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13706.270 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/18/2025 1:12:39`

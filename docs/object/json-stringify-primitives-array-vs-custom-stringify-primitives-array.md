...
```typescript
JSON stringify: 17022.663 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13830.043 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/15/2024 1:21:4`

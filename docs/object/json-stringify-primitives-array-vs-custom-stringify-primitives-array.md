...
```typescript
JSON stringify: 15647.352 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13205.430 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/14/2024 0:56:27`

...
```typescript
JSON stringify: 15610.177 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13271.025 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/21/2024 0:52:25`

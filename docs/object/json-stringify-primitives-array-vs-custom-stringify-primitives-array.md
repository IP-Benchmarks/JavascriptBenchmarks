...
#### **JSON stringify** is **_`1.60x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10170.124 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6366.436 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/21/2023 0:50:56`

...
```typescript
JSON stringify: 17852.356 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14296.532 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/5/2025 1:20:43`

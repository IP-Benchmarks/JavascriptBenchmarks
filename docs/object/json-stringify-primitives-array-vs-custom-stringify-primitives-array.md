...
```typescript
JSON stringify: 11245.792 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7659.416 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/9/2022 0:55:28`

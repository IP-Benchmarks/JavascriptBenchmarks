...
```typescript
JSON stringify: 15776.203 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12985.092 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 9644.766 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6579.363 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/15/2022 1:15:24`

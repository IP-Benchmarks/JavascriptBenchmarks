...
```typescript
JSON stringify: 12453.805 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9689.729 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/14/2023 1:16:31`

...
#### **JSON stringify** is **_`1.14x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15749.553 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13793.004 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/21/2023 0:55:58`

...
```typescript
JSON stringify: 17535.959 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14177.015 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/30/2024 1:11:38`

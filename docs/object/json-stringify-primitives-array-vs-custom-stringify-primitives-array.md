...
```typescript
JSON stringify: 17654.072 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14073.120 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/2/2025 1:11:16`

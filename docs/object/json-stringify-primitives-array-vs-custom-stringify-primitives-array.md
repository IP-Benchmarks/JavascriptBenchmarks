...
```typescript
JSON stringify: 15486.497 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12617.784 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/2/2024 1:0:44`

...
```typescript
JSON stringify: 15509.145 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12655.073 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/29/2024 1:4:22`

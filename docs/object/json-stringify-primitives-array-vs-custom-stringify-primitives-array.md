...
```typescript
JSON stringify: 17804.863 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13856.173 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/23/2025 1:17:16`

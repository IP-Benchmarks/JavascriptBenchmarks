...
```typescript
JSON stringify: 17512.281 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14089.538 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/8/2025 1:38:53`

...
```typescript
JSON stringify: 15749.819 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13240.185 ops/s (100 runs over 100 unique samples each)
```

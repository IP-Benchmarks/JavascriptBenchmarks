...
```typescript
JSON stringify: 11763.302 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9676.115 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/8/2023 1:4:26`

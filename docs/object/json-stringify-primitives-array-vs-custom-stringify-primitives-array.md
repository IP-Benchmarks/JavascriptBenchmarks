...
```typescript
JSON stringify: 24797.929 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14254.391 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/18/2026 2:9:42`

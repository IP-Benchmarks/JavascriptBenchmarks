...
```typescript
JSON stringify: 12020.896 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7875.165 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/3/2023 0:53:23`

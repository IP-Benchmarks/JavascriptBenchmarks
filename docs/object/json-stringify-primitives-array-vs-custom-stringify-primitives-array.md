...
```typescript
JSON stringify: 10241.564 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6841.930 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/4/2023 0:59:21`

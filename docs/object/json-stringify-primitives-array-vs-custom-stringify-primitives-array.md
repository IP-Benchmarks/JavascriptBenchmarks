...
```typescript
JSON stringify: 17577.858 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13877.064 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/20/2025 1:8:44`

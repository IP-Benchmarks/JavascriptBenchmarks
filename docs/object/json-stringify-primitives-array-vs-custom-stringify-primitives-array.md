...
```typescript
JSON stringify: 11824.729 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9732.698 ops/s (100 runs over 100 unique samples each)
```

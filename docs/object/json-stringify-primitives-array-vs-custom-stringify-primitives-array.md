...
```typescript
JSON stringify: 12114.616 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7963.372 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/10/2023 1:1:9`

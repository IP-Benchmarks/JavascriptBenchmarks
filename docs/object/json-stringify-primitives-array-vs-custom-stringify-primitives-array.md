...
```typescript
JSON stringify: 15451.089 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13118.893 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/12/2024 0:59:54`

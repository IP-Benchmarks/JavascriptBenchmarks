...
```typescript
JSON stringify: 12155.373 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7754.836 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/24/2023 0:49:28`

...
```typescript
JSON stringify: 11700.854 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9672.724 ops/s (100 runs over 100 unique samples each)
```

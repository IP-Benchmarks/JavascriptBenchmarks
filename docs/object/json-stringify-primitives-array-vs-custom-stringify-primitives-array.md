...
```typescript
JSON stringify: 17649.245 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13448.442 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/8/2025 1:13:31`

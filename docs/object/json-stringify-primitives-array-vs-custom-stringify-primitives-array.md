...
```typescript
JSON stringify: 10097.058 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6473.892 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/16/2023 0:49:22`

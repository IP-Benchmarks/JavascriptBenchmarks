...
```typescript
JSON stringify: 9877.566 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7136.887 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/5/2023 1:4:6`

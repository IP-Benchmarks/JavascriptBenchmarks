...
```typescript
JSON stringify: 11528.831 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7887.889 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/19/2022 0:52:58`

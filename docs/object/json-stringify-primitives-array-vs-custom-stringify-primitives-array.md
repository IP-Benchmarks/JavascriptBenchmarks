...
#### **JSON stringify** is **_`1.48x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10577.834 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7169.037 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/27/2022 1:12:53`

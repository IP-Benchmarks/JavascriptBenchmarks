...
```typescript
JSON stringify: 9396.014 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6662.299 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/17/2022 0:43:37`

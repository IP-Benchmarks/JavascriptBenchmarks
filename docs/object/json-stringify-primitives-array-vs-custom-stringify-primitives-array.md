...
```typescript
JSON stringify: 11270.891 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7030.418 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/14/2023 0:50:41`

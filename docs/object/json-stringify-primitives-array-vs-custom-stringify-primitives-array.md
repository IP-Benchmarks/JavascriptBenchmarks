...
```typescript
JSON stringify: 17821.291 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13689.217 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/14/2026 1:51:44`

...
```typescript
JSON stringify: 16838.260 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13977.990 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/5/2025 1:20:46`

...
```typescript
JSON stringify: 15642.045 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12891.133 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/23/2024 0:55:58`

...
```typescript
JSON stringify: 10467.596 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6575.825 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/25/2023 0:52:7`

...
```typescript
JSON stringify: 12534.863 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9901.536 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/21/2023 0:58:18`

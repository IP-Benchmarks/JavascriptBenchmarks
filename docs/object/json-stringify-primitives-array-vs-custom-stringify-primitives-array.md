...
```typescript
JSON stringify: 11869.314 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8254.605 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/5/2022 1:24:48`

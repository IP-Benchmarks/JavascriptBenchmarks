...
```typescript
JSON stringify: 17535.426 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14095.845 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/6/2025 1:9:8`

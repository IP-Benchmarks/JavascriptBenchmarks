...
```typescript
JSON stringify: 11586.802 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8365.204 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/29/2021 0:45:8`

...
```typescript
JSON stringify: 12406.046 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8427.539 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/27/2022 1:0:57`

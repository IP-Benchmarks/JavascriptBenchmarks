...
```typescript
JSON stringify: 17204.350 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13484.215 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/9/2026 2:38:5`

...
```typescript
JSON stringify: 17432.094 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13989.407 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/1/2026 1:43:56`

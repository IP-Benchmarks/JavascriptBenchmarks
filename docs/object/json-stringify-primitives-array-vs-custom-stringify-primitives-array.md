...
```typescript
JSON stringify: 17650.471 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14067.552 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/19/2025 1:14:59`

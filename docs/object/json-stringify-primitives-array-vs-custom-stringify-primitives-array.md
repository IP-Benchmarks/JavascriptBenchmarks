...
```typescript
JSON stringify: 12506.319 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9765.388 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/14/2023 0:56:14`

...
```typescript
JSON stringify: 23553.965 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13463.415 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/28/2026 2:52:32`

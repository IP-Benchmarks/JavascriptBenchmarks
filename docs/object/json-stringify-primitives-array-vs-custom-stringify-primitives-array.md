...
```typescript
JSON stringify: 11585.267 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7980.419 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/26/2022 1:25:20`

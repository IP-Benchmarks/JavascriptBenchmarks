...
```typescript
JSON stringify: 17501.164 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13978.734 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/26/2025 1:22:1`

...
#### **JSON stringify** is **_`1.89x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 24766.788 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13132.620 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/27/2026 3:32:53`

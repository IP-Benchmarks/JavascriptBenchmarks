...
```typescript
JSON stringify: 16061.873 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13603.729 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/27/2023 0:53:6`

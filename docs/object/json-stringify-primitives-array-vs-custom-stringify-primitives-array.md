...
#### **JSON stringify** is **_`1.17x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15761.939 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13492.936 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/22/2023 0:53:55`

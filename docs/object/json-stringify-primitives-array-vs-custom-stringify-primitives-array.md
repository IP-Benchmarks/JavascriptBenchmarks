...
```typescript
JSON stringify: 12209.324 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9715.511 ops/s (100 runs over 100 unique samples each)
```

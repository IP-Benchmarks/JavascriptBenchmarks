...
```typescript
JSON stringify: 11382.496 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8197.581 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/25/2022 1:17:20`

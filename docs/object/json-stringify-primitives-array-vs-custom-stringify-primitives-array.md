...
```typescript
JSON stringify: 15602.826 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13174.451 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/27/2024 1:14:22`

...
```typescript
JSON stringify: 11654.231 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9885.045 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/5/2022 1:46:35`

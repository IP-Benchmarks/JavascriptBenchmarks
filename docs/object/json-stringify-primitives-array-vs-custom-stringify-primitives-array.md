...
```typescript
JSON stringify: 11258.206 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8247.571 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/12/2022 1:23:45`

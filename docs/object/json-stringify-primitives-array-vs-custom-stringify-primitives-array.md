...
```typescript
JSON stringify: 16977.227 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13880.451 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/14/2025 1:19:2`

...
```typescript
JSON stringify: 15997.621 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12858.326 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/20/2024 0:51:18`

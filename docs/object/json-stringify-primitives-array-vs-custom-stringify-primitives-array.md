...
```typescript
JSON stringify: 15312.674 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12888.739 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17900.742 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13329.807 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/22/2026 1:39:26`

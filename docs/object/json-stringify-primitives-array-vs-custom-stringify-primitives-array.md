...
```typescript
JSON stringify: 12747.614 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9562.880 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/3/2023 0:57:55`

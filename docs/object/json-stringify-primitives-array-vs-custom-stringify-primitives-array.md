...
```typescript
JSON stringify: 10307.601 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6906.395 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/19/2022 0:43:8`

...
```typescript
JSON stringify: 12128.363 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7859.296 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/2/2023 1:18:45`

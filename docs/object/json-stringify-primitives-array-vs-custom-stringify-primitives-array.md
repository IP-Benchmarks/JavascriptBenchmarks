...
```typescript
JSON stringify: 17925.665 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13810.351 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/20/2025 1:20:18`

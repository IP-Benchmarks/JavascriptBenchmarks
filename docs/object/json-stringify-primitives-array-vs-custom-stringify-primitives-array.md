...
```typescript
JSON stringify: 15813.396 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13338.960 ops/s (100 runs over 100 unique samples each)
```

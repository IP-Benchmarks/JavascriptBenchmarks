...
```typescript
JSON stringify: 15232.070 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13105.109 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/26/2024 1:2:46`

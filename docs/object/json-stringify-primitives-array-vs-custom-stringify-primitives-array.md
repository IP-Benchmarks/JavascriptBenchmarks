...
#### **JSON stringify** is **_`1.98x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 44220.871 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 22377.825 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/19/2026 1:3:9`

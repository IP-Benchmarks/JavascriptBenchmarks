...
```typescript
JSON stringify: 12616.253 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9941.394 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/30/2023 1:2:1`

...
```typescript
JSON stringify: 9330.746 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6939.671 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/29/2022 1:1:59`

...
```typescript
JSON stringify: 15305.035 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12913.890 ops/s (100 runs over 100 unique samples each)
```

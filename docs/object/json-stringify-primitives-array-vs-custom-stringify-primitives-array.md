...
```typescript
JSON stringify: 16024.325 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13714.992 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/1/2024 1:14:57`

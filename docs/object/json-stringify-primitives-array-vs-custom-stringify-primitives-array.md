...
#### **JSON stringify** is **_`1.57x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 12110.948 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7716.542 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/27/2023 0:51:18`

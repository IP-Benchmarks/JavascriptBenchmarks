...
```typescript
JSON stringify: 11983.711 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7749.241 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/11/2023 0:59:3`

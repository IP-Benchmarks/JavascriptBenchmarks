...
```typescript
JSON stringify: 11201.203 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8236.765 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/25/2022 0:49:31`

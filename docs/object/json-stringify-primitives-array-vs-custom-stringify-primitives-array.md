...
```typescript
JSON stringify: 15775.293 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13187.681 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/20/2024 1:1:31`

...
```typescript
JSON stringify: 9887.027 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7239.035 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/25/2023 1:1:8`

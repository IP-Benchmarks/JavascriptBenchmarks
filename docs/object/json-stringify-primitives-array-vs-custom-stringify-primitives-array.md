...
```typescript
JSON stringify: 17336.573 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14128.419 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/2/2025 1:23:55`

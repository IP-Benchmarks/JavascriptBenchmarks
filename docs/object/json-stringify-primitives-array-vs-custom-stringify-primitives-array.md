...
```typescript
JSON stringify: 14950.001 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12649.202 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/30/2024 1:11:3`

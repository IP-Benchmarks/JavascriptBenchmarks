...
```typescript
JSON stringify: 15706.049 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12442.078 ops/s (100 runs over 100 unique samples each)
```

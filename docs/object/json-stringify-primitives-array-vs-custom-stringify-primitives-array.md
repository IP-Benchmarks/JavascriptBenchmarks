...
```typescript
JSON stringify: 23160.967 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13090.528 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/30/2026 3:25:11`

...
```typescript
JSON stringify: 17699.703 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14122.819 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/4/2025 1:12:20`

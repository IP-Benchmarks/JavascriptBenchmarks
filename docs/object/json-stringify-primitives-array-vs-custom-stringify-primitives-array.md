...
```typescript
JSON stringify: 12197.524 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8423.972 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/23/2023 1:2:2`

...
```typescript
JSON stringify: 11909.964 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8266.037 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/7/2022 1:22:29`

...
```typescript
JSON stringify: 17157.719 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13508.974 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/19/2025 1:23:16`

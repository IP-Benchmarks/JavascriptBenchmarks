...
```typescript
JSON stringify: 15888.733 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13153.754 ops/s (100 runs over 100 unique samples each)
```

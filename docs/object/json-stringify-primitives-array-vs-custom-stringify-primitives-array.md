...
```typescript
JSON stringify: 15594.438 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13376.473 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/22/2024 1:13:12`

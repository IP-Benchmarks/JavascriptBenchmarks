...
```typescript
JSON stringify: 12268.682 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7935.809 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/5/2023 1:15:24`

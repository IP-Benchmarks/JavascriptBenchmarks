...
```typescript
JSON stringify: 15727.940 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13407.891 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/16/2024 0:51:30`

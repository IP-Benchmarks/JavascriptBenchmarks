...
```typescript
JSON stringify: 11827.855 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9127.326 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/5/2022 1:20:36`

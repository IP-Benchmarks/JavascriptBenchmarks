...
```typescript
JSON stringify: 8910.475 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6368.651 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/14/2022 1:23:35`

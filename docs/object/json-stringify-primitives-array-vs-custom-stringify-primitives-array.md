...
```typescript
JSON stringify: 17582.364 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14265.559 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/11/2026 2:2:12`

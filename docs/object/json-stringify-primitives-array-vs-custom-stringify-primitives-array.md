...
```typescript
JSON stringify: 12058.131 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8485.578 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/29/2022 1:1:39`

...
#### **JSON stringify** is **_`1.80x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 24287.663 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13456.018 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/11/2026 1:24:10`

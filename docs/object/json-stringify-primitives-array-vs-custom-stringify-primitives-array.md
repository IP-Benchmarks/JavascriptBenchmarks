...
```typescript
JSON stringify: 17116.545 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12379.919 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/14/2026 2:52:31`

...
```typescript
JSON stringify: 17095.571 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14016.982 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/25/2025 1:26:44`

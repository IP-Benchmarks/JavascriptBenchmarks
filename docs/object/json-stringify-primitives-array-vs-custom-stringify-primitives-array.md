...
```typescript
JSON stringify: 17194.245 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13836.713 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/23/2026 1:58:33`

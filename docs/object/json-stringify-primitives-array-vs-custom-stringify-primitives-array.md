...
```typescript
JSON stringify: 11458.689 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9289.376 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/24/2023 1:5:33`

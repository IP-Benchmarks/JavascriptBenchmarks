...
```typescript
JSON stringify: 17236.569 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12271.314 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/22/2026 2:22:59`

...
```typescript
JSON stringify: 23473.505 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13499.041 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/26/2026 2:31:11`

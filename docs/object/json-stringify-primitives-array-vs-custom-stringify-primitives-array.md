...
```typescript
JSON stringify: 17399.993 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13803.566 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17625.866 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13938.731 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 16112.446 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13071.504 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/19/2024 0:53:42`

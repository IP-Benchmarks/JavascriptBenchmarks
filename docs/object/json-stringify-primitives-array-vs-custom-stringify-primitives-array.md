...
```typescript
JSON stringify: 23748.098 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13901.369 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/11/2026 2:56:9`

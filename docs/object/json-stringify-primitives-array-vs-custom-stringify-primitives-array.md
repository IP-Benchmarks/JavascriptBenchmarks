...
```typescript
JSON stringify: 17516.655 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13209.809 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/24/2025 1:12:1`

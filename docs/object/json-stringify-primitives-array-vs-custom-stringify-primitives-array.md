...
```typescript
JSON stringify: 11711.139 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8472.679 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/20/2022 1:41:45`

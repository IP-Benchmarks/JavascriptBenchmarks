...
```typescript
JSON stringify: 12565.894 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9778.572 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/23/2023 1:14:59`

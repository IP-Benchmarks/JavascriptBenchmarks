...
```typescript
JSON stringify: 11684.653 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9714.534 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/29/2022 1:15:6`

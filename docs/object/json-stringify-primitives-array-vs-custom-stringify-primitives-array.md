...
```typescript
JSON stringify: 16030.471 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13305.747 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/7/2023 0:53:33`

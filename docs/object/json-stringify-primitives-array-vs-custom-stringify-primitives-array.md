...
```typescript
JSON stringify: 17573.995 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13945.459 ops/s (100 runs over 100 unique samples each)
```

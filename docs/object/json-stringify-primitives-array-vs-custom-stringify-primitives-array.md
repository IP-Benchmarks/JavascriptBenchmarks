...
```typescript
JSON stringify: 17420.963 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13245.968 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/6/2025 1:19:35`

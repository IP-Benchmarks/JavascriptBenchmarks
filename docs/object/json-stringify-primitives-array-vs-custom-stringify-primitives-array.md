...
```typescript
JSON stringify: 11697.857 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7374.338 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/26/2023 1:0:1`

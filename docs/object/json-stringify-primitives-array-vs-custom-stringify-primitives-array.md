...
```typescript
JSON stringify: 17513.442 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14051.860 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/4/2025 1:25:14`

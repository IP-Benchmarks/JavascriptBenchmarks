...
```typescript
JSON stringify: 17943.830 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14327.468 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/12/2026 2:23:59`

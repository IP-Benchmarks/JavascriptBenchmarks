...
```typescript
JSON stringify: 11481.863 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7285.855 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/15/2023 0:55:49`

...
```typescript
JSON stringify: 11264.233 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7802.042 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/16/2022 0:56:58`

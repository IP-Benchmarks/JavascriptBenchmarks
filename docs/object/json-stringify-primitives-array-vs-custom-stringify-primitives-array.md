...
```typescript
JSON stringify: 12348.544 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8235.105 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/31/2023 1:0:34`

...
```typescript
JSON stringify: 25782.841 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13652.283 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/26/2026 3:26:25`

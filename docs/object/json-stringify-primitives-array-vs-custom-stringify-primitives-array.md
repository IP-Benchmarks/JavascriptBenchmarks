...
```typescript
JSON stringify: 11918.722 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8221.384 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/22/2023 1:6:14`

...
#### **JSON stringify** is **_`1.46x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 11979.163 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8213.851 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/10/2022 1:18:58`

...
```typescript
JSON stringify: 12503.165 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9643.309 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/21/2023 1:5:52`

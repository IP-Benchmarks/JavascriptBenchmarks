...
```typescript
JSON stringify: 11652.915 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9410.747 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/24/2022 1:16:37`

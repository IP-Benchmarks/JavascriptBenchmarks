...
```typescript
JSON stringify: 17126.296 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11700.470 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/12/2026 1:59:47`

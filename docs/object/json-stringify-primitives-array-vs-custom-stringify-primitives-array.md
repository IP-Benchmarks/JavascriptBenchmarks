...
```typescript
JSON stringify: 23611.108 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12833.479 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/22/2026 2:24:9`

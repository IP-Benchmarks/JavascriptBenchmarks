...
```typescript
JSON stringify: 15585.465 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12882.224 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/13/2024 0:57:2`

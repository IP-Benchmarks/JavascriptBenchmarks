...
```typescript
JSON stringify: 11900.065 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9560.043 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/6/2023 1:4:3`

...
```typescript
JSON stringify: 17426.924 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13436.934 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/9/2025 1:25:29`

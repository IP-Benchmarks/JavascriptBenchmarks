...
```typescript
JSON stringify: 12722.935 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10011.322 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/13/2023 0:56:51`

...
```typescript
JSON stringify: 11924.747 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8012.106 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/6/2022 1:2:46`

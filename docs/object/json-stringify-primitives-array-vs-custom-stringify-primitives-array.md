...
```typescript
JSON stringify: 15965.786 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11998.313 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/23/2024 1:10:24`

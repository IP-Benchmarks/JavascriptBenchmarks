...
```typescript
JSON stringify: 17884.995 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14120.640 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/8/2025 1:15:10`

...
```typescript
JSON stringify: 15881.319 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13341.180 ops/s (100 runs over 100 unique samples each)
```

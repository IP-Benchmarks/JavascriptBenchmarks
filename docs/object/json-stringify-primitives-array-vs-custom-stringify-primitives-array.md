...
```typescript
JSON stringify: 15988.335 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12879.088 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/2/2024 0:54:3`

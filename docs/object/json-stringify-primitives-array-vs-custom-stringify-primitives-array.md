...
#### **JSON stringify** is **_`1.31x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 17566.556 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13423.652 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/24/2025 1:23:21`

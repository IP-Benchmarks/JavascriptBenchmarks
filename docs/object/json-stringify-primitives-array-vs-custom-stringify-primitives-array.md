...
```typescript
JSON stringify: 15868.167 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13496.226 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/9/2024 0:51:22`

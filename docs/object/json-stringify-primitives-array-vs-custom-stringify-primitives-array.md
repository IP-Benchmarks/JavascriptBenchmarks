...
```typescript
JSON stringify: 11134.374 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8005.019 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/11/2022 0:51:59`

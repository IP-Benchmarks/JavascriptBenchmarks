...
```typescript
JSON stringify: 13095.523 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8722.970 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/14/2022 0:56:28`

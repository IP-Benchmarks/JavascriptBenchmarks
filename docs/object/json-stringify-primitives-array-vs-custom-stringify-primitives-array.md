...
```typescript
JSON stringify: 17654.158 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13824.168 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/18/2025 1:20:56`

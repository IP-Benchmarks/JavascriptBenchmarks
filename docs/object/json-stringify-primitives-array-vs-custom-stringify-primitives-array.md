...
```typescript
JSON stringify: 18703.891 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13235.291 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/13/2026 2:50:11`

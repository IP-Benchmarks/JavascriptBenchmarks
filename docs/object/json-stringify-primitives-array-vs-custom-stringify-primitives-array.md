...
```typescript
JSON stringify: 11892.532 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8820.416 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 12158.482 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7994.430 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17327.110 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13435.569 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/14/2024 1:10:47`

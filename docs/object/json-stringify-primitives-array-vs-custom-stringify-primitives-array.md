...
```typescript
JSON stringify: 11889.060 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8330.686 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/18/2022 1:17:52`

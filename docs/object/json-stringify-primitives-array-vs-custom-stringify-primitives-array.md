...
```typescript
JSON stringify: 8345.565 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 5720.589 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/2/2022 1:25:38`

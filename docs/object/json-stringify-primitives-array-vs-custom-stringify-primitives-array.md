...
```typescript
JSON stringify: 17958.581 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14222.958 ops/s (100 runs over 100 unique samples each)
```

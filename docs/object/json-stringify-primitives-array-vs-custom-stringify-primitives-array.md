...
```typescript
JSON stringify: 12301.572 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9448.668 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/22/2023 1:3:40`

...
```typescript
JSON stringify: 10991.926 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7643.531 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/27/2022 1:21:45`

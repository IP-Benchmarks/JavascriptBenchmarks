...
```typescript
JSON stringify: 15806.878 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13029.274 ops/s (100 runs over 100 unique samples each)
```

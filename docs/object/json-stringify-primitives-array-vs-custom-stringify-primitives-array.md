...
```typescript
JSON stringify: 16000.746 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13513.193 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/30/2024 1:0:57`

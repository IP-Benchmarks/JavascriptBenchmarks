...
```typescript
JSON stringify: 18240.266 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13941.181 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/12/2025 1:21:1`

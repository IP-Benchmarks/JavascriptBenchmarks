...
```typescript
JSON stringify: 12276.962 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7807.307 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/13/2023 1:4:39`

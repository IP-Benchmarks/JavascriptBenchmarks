...
```typescript
JSON stringify: 24448.125 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13088.177 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/26/2026 1:6:41`

...
```typescript
JSON stringify: 15832.442 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13416.166 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/25/2024 0:55:25`

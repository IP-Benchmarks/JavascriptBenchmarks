...
```typescript
JSON stringify: 17542.563 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13631.301 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/22/2025 1:19:9`

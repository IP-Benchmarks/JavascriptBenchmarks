...
```typescript
JSON stringify: 17868.562 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12980.630 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/26/2026 2:31:39`

...
```typescript
JSON stringify: 10081.959 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6836.349 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/15/2023 1:6:27`

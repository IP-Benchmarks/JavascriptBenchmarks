...
```typescript
JSON stringify: 17588.761 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13685.137 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/22/2026 2:1:13`

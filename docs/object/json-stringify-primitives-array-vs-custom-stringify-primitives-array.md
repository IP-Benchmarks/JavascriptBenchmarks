...
```typescript
JSON stringify: 12184.994 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8006.179 ops/s (100 runs over 100 unique samples each)
```

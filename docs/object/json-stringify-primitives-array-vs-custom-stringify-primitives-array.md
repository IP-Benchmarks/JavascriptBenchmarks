...
```typescript
JSON stringify: 17577.597 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13894.054 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/13/2025 1:9:26`

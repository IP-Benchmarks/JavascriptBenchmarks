...
```typescript
JSON stringify: 11308.180 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8118.980 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/9/2023 1:1:48`

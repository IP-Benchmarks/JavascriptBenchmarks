...
```typescript
JSON stringify: 13385.498 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8361.976 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/31/2021 0:47:28`

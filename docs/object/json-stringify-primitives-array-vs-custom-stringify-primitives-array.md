...
```typescript
JSON stringify: 25544.194 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14100.576 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/16/2026 1:6:44`

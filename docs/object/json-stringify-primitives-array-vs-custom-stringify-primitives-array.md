...
```typescript
JSON stringify: 15293.700 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13090.457 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/22/2024 0:51:39`

...
```typescript
JSON stringify: 15844.473 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13527.526 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/18/2024 1:9:8`

...
```typescript
JSON stringify: 12418.234 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8480.398 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/28/2023 1:6:0`

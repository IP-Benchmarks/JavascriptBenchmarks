...
#### **JSON stringify** is **_`1.84x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 24402.661 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13293.861 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/14/2026 1:41:49`

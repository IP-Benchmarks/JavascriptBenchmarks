...
```typescript
JSON stringify: 17397.686 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14043.379 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/30/2025 1:37:24`

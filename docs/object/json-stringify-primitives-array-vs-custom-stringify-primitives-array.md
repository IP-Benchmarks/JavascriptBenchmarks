...
```typescript
JSON stringify: 16943.202 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13818.941 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/5/2025 1:19:58`

...
```typescript
JSON stringify: 17408.477 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13105.351 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/28/2026 1:43:30`

...
```typescript
JSON stringify: 16821.665 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14069.151 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/16/2024 1:18:7`

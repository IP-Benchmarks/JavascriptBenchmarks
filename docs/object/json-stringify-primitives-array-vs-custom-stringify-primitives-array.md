...
```typescript
JSON stringify: 11736.464 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9709.408 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/21/2022 1:24:9`

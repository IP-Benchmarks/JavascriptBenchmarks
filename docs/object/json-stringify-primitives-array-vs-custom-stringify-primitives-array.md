...
```typescript
JSON stringify: 9627.238 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6800.125 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/13/2022 1:17:17`

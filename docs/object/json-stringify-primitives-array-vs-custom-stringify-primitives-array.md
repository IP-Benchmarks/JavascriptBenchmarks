...
```typescript
JSON stringify: 15474.880 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13456.845 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/14/2024 0:52:4`

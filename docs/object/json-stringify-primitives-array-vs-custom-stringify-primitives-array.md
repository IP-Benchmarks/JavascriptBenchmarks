...
```typescript
JSON stringify: 15904.946 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13608.429 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/1/2024 1:14:57`

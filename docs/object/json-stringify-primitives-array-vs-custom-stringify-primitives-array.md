...
```typescript
JSON stringify: 29342.161 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 15481.645 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/23/2026 3:14:5`

...
```typescript
JSON stringify: 15684.372 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13300.458 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/7/2024 1:2:8`

...
```typescript
JSON stringify: 17814.099 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13978.530 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/27/2026 1:42:33`

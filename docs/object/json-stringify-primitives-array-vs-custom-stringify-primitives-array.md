...
```typescript
JSON stringify: 17679.324 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13538.586 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/26/2025 1:20:9`

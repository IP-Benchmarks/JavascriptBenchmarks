...
```typescript
JSON stringify: 10203.183 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6758.029 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/17/2023 0:48:28`

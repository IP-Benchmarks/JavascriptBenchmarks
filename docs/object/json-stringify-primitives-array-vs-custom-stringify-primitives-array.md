...
```typescript
JSON stringify: 10574.511 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7160.459 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/1/2023 1:2:58`

...
```typescript
JSON stringify: 15814.707 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13638.180 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/30/2024 0:50:55`

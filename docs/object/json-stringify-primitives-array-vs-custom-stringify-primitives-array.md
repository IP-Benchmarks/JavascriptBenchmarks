...
```typescript
JSON stringify: 15955.799 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13431.801 ops/s (100 runs over 100 unique samples each)
```

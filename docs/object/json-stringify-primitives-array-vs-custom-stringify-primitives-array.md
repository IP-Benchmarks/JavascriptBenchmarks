...
```typescript
JSON stringify: 11952.534 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8157.126 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/29/2022 1:10:31`

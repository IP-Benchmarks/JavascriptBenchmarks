...
```typescript
JSON stringify: 15232.994 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13199.232 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/19/2024 0:59:58`

...
```typescript
JSON stringify: 15404.162 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13105.683 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/11/2024 1:9:40`

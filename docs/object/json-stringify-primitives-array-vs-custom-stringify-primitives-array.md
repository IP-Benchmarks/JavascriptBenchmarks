...
```typescript
JSON stringify: 17948.367 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14110.523 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/3/2025 1:14:40`

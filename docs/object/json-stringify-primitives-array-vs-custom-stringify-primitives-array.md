...
```typescript
JSON stringify: 17998.489 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13807.399 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/4/2025 1:45:43`

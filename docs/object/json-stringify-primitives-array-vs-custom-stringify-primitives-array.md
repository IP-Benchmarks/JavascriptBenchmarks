...
```typescript
JSON stringify: 16252.331 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13308.015 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/28/2023 0:53:4`

...
```typescript
JSON stringify: 17891.713 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14027.697 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/27/2025 1:11:12`

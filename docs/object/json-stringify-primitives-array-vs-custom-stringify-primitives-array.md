...
```typescript
JSON stringify: 23307.983 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 16816.803 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/18/2026 2:7:7`

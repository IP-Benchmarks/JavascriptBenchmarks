...
#### **JSON stringify** is **_`1.01x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 13451.923 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13296.372 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/14/2022 1:25:24`

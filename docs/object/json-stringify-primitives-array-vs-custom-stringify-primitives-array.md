...
```typescript
JSON stringify: 12356.647 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8391.787 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/6/2023 0:55:21`

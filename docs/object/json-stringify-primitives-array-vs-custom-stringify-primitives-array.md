...
```typescript
JSON stringify: 17359.874 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13215.299 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/19/2026 2:1:13`

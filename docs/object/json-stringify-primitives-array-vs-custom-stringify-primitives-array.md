...
```typescript
JSON stringify: 17842.074 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14121.168 ops/s (100 runs over 100 unique samples each)
```

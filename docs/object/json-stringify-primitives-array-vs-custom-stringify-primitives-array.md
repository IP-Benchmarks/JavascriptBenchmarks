...
```typescript
JSON stringify: 17658.019 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13676.385 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/3/2026 2:41:0`

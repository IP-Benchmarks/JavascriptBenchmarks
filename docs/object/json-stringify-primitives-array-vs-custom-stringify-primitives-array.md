...
```typescript
JSON stringify: 11234.450 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8304.182 ops/s (100 runs over 100 unique samples each)
```

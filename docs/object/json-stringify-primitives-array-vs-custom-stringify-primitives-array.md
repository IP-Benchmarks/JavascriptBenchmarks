...
```typescript
JSON stringify: 17652.564 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13810.868 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/6/2025 1:18:31`

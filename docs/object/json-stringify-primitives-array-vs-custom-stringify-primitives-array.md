...
```typescript
JSON stringify: 22442.742 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 16740.079 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/29/2026 2:41:5`

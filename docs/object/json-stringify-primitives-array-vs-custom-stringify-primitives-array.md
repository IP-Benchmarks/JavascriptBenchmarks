...
```typescript
JSON stringify: 17458.898 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13743.619 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/2/2026 1:58:37`

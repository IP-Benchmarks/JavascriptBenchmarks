...
```typescript
JSON stringify: 9287.487 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6546.270 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/11/2022 1:21:33`

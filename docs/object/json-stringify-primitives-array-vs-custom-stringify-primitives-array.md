...
#### **JSON stringify** is **_`1.55x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10146.299 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6528.553 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/18/2022 1:18:44`

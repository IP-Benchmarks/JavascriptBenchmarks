...
```typescript
JSON stringify: 23921.627 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13686.796 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/20/2026 3:36:42`

...
```typescript
JSON stringify: 17652.829 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13496.712 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/4/2025 1:21:54`

...
```typescript
JSON stringify: 11794.342 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8170.741 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/2/2022 1:29:24`

...
#### **JSON stringify** is **_`1.45x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10514.361 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7244.544 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/18/2023 0:57:52`

...
```typescript
JSON stringify: 12502.248 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9177.721 ops/s (100 runs over 100 unique samples each)
```

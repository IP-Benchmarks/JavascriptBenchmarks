...
```typescript
JSON stringify: 18414.350 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14029.695 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/13/2025 1:41:42`

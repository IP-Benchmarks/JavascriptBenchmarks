...
```typescript
JSON stringify: 8967.904 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6296.425 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/18/2022 1:47:34`

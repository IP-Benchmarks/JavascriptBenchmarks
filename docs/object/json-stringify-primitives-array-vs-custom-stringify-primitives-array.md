...
```typescript
JSON stringify: 10411.212 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6479.875 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/11/2023 0:52:8`

...
```typescript
JSON stringify: 17949.348 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13857.421 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/19/2025 1:19:29`

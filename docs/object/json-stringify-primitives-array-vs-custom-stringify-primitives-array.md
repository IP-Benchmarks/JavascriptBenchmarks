...
```typescript
JSON stringify: 16051.718 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13269.400 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 18086.315 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14000.521 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/20/2025 1:21:35`

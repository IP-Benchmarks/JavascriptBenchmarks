...
```typescript
JSON stringify: 12652.662 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9838.010 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/8/2023 1:16:17`

...
```typescript
JSON stringify: 17735.337 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13867.194 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/1/2025 1:40:58`

...
```typescript
JSON stringify: 17762.941 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14148.855 ops/s (100 runs over 100 unique samples each)
```

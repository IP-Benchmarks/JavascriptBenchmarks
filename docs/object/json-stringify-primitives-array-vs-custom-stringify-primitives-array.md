...
```typescript
JSON stringify: 15731.493 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13150.701 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/17/2023 0:59:9`

...
```typescript
JSON stringify: 18045.949 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14182.844 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/26/2025 1:9:59`

...
```typescript
JSON stringify: 23935.659 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14154.312 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/22/2026 1:2:51`

...
```typescript
JSON stringify: 15002.252 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13178.144 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/9/2024 0:56:9`

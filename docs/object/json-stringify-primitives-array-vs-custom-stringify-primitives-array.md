...
```typescript
JSON stringify: 12382.596 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9029.960 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/20/2023 0:57:48`

...
```typescript
JSON stringify: 10309.752 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6154.687 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/24/2023 1:5:58`

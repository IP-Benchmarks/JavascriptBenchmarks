...
```typescript
JSON stringify: 12476.119 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9466.667 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/31/2023 0:50:57`

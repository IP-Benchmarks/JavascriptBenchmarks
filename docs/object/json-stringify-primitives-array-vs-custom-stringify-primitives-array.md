...
```typescript
JSON stringify: 11313.389 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7883.121 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/2/2022 0:56:4`

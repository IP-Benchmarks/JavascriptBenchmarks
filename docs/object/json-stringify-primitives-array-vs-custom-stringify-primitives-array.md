...
```typescript
JSON stringify: 11310.832 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8230.273 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/26/2022 1:18:46`

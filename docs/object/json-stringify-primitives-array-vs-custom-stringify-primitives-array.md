...
```typescript
JSON stringify: 15686.560 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13377.700 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/18/2023 0:54:6`

...
```typescript
JSON stringify: 15607.113 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13490.394 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/17/2024 0:59:51`

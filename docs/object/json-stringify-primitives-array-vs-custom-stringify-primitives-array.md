...
```typescript
JSON stringify: 11976.506 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8082.253 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/1/2022 1:47:17`

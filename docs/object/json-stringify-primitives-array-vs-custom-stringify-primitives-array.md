...
```typescript
JSON stringify: 17751.391 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13755.623 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/11/2025 1:11:33`

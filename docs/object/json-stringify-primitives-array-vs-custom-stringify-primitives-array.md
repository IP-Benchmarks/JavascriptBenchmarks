...
```typescript
JSON stringify: 16018.779 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13473.273 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17467.503 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13578.967 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/24/2026 1:55:41`

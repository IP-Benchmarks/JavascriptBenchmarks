...
```typescript
JSON stringify: 9671.904 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6780.254 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 11645.396 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9346.675 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/27/2022 1:9:28`

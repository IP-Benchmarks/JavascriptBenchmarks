...
```typescript
JSON stringify: 18213.843 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13874.544 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/17/2025 1:20:7`

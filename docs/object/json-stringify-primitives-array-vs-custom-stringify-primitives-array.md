...
```typescript
JSON stringify: 17214.879 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13930.183 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/12/2025 1:24:4`

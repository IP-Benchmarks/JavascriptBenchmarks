...
```typescript
JSON stringify: 12170.353 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7979.364 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/13/2023 0:53:24`

...
```typescript
JSON stringify: 17482.076 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13306.225 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/26/2025 1:21:54`

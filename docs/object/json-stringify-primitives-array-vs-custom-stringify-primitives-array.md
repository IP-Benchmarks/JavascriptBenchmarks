...
```typescript
JSON stringify: 15745.774 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13546.281 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/31/2024 1:4:13`

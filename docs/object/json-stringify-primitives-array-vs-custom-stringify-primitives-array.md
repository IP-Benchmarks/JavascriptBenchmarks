...
```typescript
JSON stringify: 17825.464 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14262.217 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/8/2025 1:19:29`

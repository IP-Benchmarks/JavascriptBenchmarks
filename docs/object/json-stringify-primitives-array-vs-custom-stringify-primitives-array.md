...
```typescript
JSON stringify: 11851.127 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9902.988 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/26/2022 1:0:55`

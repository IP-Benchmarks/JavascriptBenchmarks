...
```typescript
JSON stringify: 12190.683 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8153.718 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/6/2023 0:51:1`

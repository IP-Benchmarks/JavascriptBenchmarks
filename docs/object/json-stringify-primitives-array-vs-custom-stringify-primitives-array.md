...
```typescript
JSON stringify: 12478.963 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8687.307 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/6/2023 0:56:41`

...
```typescript
JSON stringify: 11177.105 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8231.598 ops/s (100 runs over 100 unique samples each)
```

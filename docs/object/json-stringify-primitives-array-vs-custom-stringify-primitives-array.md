...
```typescript
JSON stringify: 17625.217 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13771.093 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/18/2026 1:42:58`

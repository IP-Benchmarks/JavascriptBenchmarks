...
```typescript
JSON stringify: 15281.061 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13646.874 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/27/2024 0:51:51`

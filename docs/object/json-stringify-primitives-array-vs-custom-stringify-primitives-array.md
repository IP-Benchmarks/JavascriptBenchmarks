...
```typescript
JSON stringify: 12233.704 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8297.000 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/7/2023 1:0:41`

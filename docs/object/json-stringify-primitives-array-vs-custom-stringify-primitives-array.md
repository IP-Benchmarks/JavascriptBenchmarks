...
```typescript
JSON stringify: 15539.422 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13479.319 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/11/2024 0:58:36`

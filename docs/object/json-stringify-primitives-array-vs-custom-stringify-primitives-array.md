...
```typescript
JSON stringify: 10744.505 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7608.936 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/25/2022 1:40:19`

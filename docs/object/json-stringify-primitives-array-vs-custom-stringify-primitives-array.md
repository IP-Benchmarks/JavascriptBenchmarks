...
```typescript
JSON stringify: 17699.466 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14060.319 ops/s (100 runs over 100 unique samples each)
```

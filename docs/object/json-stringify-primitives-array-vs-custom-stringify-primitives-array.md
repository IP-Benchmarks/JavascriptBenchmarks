...
```typescript
JSON stringify: 11512.197 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7456.911 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/1/2023 0:55:48`

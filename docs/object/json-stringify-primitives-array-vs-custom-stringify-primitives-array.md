...
```typescript
JSON stringify: 17590.579 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13931.482 ops/s (100 runs over 100 unique samples each)
```

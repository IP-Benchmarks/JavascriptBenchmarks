...
```typescript
JSON stringify: 11546.383 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7836.362 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/19/2022 1:53:25`

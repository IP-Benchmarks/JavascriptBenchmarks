...
```typescript
JSON stringify: 11820.524 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8035.069 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/22/2022 1:24:0`

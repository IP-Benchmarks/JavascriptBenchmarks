...
```typescript
JSON stringify: 17884.756 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14145.439 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 15703.443 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13579.524 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/17/2024 1:9:0`

...
```typescript
JSON stringify: 9559.122 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6365.740 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/26/2022 0:56:44`

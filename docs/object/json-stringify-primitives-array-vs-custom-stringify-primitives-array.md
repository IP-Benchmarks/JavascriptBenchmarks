...
```typescript
JSON stringify: 11762.465 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9525.265 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/30/2023 1:0:16`

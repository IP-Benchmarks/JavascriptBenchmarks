...
```typescript
JSON stringify: 12570.719 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9774.344 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/17/2023 0:59:21`

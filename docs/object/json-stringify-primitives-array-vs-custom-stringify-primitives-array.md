...
```typescript
JSON stringify: 9162.526 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6246.959 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/3/2022 1:22:55`

...
```typescript
JSON stringify: 17737.025 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14223.466 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/23/2025 1:16:48`

...
```typescript
JSON stringify: 15877.516 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13351.991 ops/s (100 runs over 100 unique samples each)
```

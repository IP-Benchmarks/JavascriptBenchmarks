...
```typescript
JSON stringify: 11853.807 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7859.182 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/13/2022 1:10:3`

...
```typescript
JSON stringify: 13689.013 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9183.805 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/20/2021 0:46:26`

...
```typescript
JSON stringify: 17483.391 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13330.435 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/28/2025 1:19:28`

...
```typescript
JSON stringify: 12098.814 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8099.189 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/26/2023 0:48:13`

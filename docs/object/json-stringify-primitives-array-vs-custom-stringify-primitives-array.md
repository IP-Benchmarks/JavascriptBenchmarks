...
```typescript
JSON stringify: 9627.160 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6840.858 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/29/2022 1:48:17`

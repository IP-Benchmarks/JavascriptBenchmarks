...
#### **JSON stringify** is **_`1.41x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10265.276 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7260.804 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/14/2021 0:47:44`

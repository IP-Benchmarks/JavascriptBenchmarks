...
```typescript
JSON stringify: 17582.446 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14315.885 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/21/2026 2:25:16`

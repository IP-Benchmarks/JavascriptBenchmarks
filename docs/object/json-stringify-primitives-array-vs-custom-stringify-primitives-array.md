...
```typescript
JSON stringify: 16219.075 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13345.732 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/8/2024 0:56:25`

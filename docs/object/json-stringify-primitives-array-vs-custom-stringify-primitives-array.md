...
```typescript
JSON stringify: 9173.086 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6315.424 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/16/2022 1:0:39`

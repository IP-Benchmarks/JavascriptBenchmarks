...
```typescript
JSON stringify: 17367.496 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13863.549 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/3/2026 1:57:19`

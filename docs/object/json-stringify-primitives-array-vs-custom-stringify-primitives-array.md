...
```typescript
JSON stringify: 11296.324 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8354.245 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/20/2022 1:18:6`

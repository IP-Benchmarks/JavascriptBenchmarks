...
```typescript
JSON stringify: 15524.561 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13004.924 ops/s (100 runs over 100 unique samples each)
```

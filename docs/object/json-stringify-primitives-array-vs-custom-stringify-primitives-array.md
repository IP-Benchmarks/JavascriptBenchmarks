...
```typescript
JSON stringify: 12162.718 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7621.114 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/13/2023 0:54:50`

...
```typescript
JSON stringify: 17882.353 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13591.214 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/23/2026 2:2:17`

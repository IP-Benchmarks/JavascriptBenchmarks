...
```typescript
JSON stringify: 23805.333 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13119.618 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/21/2026 1:6:2`

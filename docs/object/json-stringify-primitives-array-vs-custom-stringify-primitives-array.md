...
```typescript
JSON stringify: 12203.335 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8049.665 ops/s (100 runs over 100 unique samples each)
```

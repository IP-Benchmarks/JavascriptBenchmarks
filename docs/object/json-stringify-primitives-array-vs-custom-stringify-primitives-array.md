...
```typescript
JSON stringify: 17712.427 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13768.558 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/25/2026 1:57:48`

...
```typescript
JSON stringify: 10891.718 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6717.113 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/6/2023 1:10:44`

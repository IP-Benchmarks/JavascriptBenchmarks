...
```typescript
JSON stringify: 18230.180 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13854.226 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/9/2025 1:24:16`

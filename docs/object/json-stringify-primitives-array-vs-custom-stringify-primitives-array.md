...
```typescript
JSON stringify: 18121.433 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13923.907 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/28/2025 1:42:30`

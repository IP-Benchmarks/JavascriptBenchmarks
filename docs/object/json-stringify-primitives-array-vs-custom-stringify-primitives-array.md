...
```typescript
JSON stringify: 11597.440 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7331.343 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/6/2022 0:51:44`

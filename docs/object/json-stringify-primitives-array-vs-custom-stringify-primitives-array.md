...
```typescript
JSON stringify: 15819.306 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12278.499 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/15/2024 0:58:14`

...
```typescript
JSON stringify: 17372.943 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13804.012 ops/s (100 runs over 100 unique samples each)
```

...
#### **JSON stringify** is **_`1.59x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 12652.069 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7939.842 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/28/2023 0:50:17`

...
```typescript
JSON stringify: 9815.371 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6457.196 ops/s (100 runs over 100 unique samples each)
```

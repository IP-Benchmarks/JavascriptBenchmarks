...
```typescript
JSON stringify: 17804.957 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14068.595 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/25/2025 1:23:13`

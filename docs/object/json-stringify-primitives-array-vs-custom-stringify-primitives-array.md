...
```typescript
JSON stringify: 17544.466 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14158.229 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/24/2025 1:17:15`

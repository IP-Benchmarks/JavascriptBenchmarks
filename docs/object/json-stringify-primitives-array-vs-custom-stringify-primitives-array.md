...
```typescript
JSON stringify: 17588.127 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14061.346 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/13/2026 2:2:42`

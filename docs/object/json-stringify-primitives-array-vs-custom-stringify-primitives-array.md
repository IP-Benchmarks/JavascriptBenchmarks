...
```typescript
JSON stringify: 11838.375 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9705.278 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/12/2023 1:4:5`

...
```typescript
JSON stringify: 17978.014 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14066.763 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/22/2025 1:27:13`

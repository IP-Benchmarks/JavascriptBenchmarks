...
```typescript
JSON stringify: 17670.460 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13987.252 ops/s (100 runs over 100 unique samples each)
```

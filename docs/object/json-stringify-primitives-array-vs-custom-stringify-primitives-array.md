...
```typescript
JSON stringify: 12413.910 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8628.672 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/30/2023 1:2:57`

...
```typescript
JSON stringify: 11064.546 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7421.105 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/17/2021 0:47:5`

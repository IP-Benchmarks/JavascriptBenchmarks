...
```typescript
JSON stringify: 10005.126 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6859.026 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/4/2022 1:42:21`

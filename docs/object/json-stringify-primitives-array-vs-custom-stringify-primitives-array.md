...
```typescript
JSON stringify: 11896.057 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8140.317 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/31/2022 1:28:28`

...
```typescript
JSON stringify: 11593.506 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7932.933 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/6/2022 0:53:16`

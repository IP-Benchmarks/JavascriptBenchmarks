...
```typescript
JSON stringify: 11643.467 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9968.978 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/19/2022 1:14:46`

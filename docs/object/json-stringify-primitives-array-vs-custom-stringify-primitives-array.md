...
```typescript
JSON stringify: 16237.319 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13281.145 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/16/2024 0:55:59`

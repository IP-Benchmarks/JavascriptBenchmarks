...
```typescript
JSON stringify: 17874.350 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13462.807 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/7/2025 1:27:16`

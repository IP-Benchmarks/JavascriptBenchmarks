...
```typescript
JSON stringify: 17479.198 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13921.223 ops/s (100 runs over 100 unique samples each)
```

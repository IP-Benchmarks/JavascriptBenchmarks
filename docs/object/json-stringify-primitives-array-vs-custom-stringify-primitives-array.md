...
```typescript
JSON stringify: 11985.221 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9811.594 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/27/2022 1:24:20`

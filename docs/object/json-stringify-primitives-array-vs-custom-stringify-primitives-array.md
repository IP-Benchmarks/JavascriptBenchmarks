...
```typescript
JSON stringify: 9983.495 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7220.551 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/6/2023 1:2:30`

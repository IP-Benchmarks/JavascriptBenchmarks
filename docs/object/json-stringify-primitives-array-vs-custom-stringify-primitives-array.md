...
```typescript
JSON stringify: 11634.767 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8092.258 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/11/2022 0:58:32`

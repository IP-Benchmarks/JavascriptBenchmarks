...
```typescript
JSON stringify: 11105.637 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7850.469 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 10267.353 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6727.037 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/20/2022 1:18:33`

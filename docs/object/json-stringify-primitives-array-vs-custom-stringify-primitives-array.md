...
```typescript
JSON stringify: 17437.069 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13134.245 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/10/2025 1:22:32`

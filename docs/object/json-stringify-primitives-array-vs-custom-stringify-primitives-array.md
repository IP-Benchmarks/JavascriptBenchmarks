...
```typescript
JSON stringify: 11932.627 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8174.596 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/20/2022 1:17:49`

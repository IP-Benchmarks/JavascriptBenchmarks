...
```typescript
JSON stringify: 15755.095 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13347.711 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/10/2023 0:59:3`

...
```typescript
JSON stringify: 15751.605 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13359.725 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/13/2024 1:3:1`

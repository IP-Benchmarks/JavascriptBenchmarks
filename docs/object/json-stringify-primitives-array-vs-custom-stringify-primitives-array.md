...
```typescript
JSON stringify: 17490.033 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13901.299 ops/s (100 runs over 100 unique samples each)
```

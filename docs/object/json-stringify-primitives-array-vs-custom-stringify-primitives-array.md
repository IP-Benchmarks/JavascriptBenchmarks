...
```typescript
JSON stringify: 12440.146 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9830.262 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/2/2023 0:48:41`

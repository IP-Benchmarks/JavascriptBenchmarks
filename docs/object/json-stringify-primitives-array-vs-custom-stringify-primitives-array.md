...
#### **JSON stringify** is **_`1.65x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 10569.825 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6407.584 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/28/2023 1:6:39`

...
```typescript
JSON stringify: 17833.430 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13271.928 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/8/2026 2:43:39`

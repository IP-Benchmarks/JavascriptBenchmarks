...
```typescript
JSON stringify: 17466.978 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14265.408 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/1/2025 1:23:11`

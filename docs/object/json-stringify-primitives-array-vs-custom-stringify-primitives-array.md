...
```typescript
JSON stringify: 15573.326 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13060.955 ops/s (100 runs over 100 unique samples each)
```

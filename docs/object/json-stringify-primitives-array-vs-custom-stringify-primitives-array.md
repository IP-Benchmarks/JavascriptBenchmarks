...
```typescript
JSON stringify: 15946.777 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12954.235 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/4/2024 0:54:8`

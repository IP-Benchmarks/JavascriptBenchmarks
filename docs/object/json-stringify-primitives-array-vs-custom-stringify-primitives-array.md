...
```typescript
JSON stringify: 15468.072 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13139.235 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/8/2024 1:8:0`

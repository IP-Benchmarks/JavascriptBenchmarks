...
```typescript
JSON stringify: 17444.112 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13880.509 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 30392.396 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14679.984 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/24/2026 3:4:22`

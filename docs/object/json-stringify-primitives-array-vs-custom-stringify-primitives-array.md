...
```typescript
JSON stringify: 16144.775 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12853.845 ops/s (100 runs over 100 unique samples each)
```

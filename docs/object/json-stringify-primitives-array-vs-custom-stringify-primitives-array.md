...
```typescript
JSON stringify: 12033.660 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8326.623 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/15/2022 1:3:51`

...
```typescript
JSON stringify: 12075.300 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8687.634 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/5/2022 0:59:15`

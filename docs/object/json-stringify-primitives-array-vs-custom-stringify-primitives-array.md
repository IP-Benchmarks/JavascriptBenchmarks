...
```typescript
JSON stringify: 18378.783 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14147.855 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/17/2026 1:55:33`

...
```typescript
JSON stringify: 15625.441 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13498.820 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/5/2024 1:7:53`

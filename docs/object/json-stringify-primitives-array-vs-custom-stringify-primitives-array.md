...
```typescript
JSON stringify: 16010.159 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13258.359 ops/s (100 runs over 100 unique samples each)
```

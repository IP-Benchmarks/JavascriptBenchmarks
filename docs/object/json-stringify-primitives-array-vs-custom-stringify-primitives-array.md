...
```typescript
JSON stringify: 17981.729 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14381.463 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/4/2025 1:14:34`

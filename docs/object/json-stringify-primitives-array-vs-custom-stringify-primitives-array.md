...
```typescript
JSON stringify: 15137.422 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12883.931 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/1/2024 1:6:13`

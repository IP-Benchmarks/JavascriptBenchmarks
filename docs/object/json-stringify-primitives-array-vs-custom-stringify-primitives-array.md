...
```typescript
JSON stringify: 10123.322 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6947.588 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/16/2023 1:0:45`

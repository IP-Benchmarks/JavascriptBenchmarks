...
```typescript
JSON stringify: 11866.130 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9762.922 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/6/2022 1:27:14`

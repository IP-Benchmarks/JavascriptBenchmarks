...
```typescript
JSON stringify: 15517.384 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13303.226 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/3/2024 1:0:12`

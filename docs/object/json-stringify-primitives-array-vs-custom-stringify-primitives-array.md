...
```typescript
JSON stringify: 17497.154 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13967.259 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/9/2025 1:12:34`

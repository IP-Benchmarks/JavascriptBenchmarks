...
```typescript
JSON stringify: 16330.264 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13621.445 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/9/2024 1:7:14`

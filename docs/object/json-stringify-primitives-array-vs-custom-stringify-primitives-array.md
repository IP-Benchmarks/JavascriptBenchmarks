...
#### **JSON stringify** is **_`1.53x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 12183.876 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7961.943 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/23/2023 0:52:27`

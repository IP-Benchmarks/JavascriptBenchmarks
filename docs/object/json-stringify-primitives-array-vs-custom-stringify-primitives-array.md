...
```typescript
JSON stringify: 17256.293 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13990.128 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/1/2025 1:15:14`

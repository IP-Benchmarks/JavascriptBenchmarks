...
```typescript
JSON stringify: 12231.472 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8223.731 ops/s (100 runs over 100 unique samples each)
```

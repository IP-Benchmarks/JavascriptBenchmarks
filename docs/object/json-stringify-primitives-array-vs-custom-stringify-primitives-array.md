...
```typescript
JSON stringify: 17781.717 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13995.819 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/5/2025 1:8:55`

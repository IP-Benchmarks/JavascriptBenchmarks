...
```typescript
JSON stringify: 11543.559 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8250.805 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/13/2022 0:52:48`

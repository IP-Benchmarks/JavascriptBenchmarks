...
```typescript
JSON stringify: 11465.332 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8306.026 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/23/2022 1:3:6`

...
```typescript
JSON stringify: 15344.786 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13559.276 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/4/2024 1:5:45`

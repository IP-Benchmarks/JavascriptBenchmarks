...
```typescript
JSON stringify: 12438.408 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10023.157 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/21/2023 1:3:55`

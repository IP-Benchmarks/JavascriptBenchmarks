...
```typescript
JSON stringify: 12377.152 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8310.577 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/29/2023 1:2:30`

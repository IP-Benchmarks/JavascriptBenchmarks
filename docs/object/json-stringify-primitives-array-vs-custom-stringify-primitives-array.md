...
```typescript
JSON stringify: 11553.947 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8090.995 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/17/2022 1:28:38`

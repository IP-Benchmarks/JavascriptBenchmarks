...
```typescript
JSON stringify: 11013.930 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7695.372 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/24/2021 0:44:54`

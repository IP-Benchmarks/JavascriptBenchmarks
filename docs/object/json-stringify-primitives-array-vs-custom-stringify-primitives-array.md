...
```typescript
JSON stringify: 10237.740 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6888.763 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/2/2022 1:10:22`

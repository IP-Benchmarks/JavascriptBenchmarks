...
```typescript
JSON stringify: 15756.984 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13567.381 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/29/2024 1:14:27`

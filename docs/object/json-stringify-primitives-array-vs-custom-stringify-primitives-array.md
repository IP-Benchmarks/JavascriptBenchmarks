...
```typescript
JSON stringify: 17921.440 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13674.253 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/13/2025 1:22:16`

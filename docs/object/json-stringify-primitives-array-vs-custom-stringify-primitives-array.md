...
```typescript
JSON stringify: 10548.485 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7258.684 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/8/2022 1:1:14`

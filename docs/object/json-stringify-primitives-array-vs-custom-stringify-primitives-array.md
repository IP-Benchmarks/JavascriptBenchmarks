...
```typescript
JSON stringify: 15386.524 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13055.048 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/1/2024 1:25:51`

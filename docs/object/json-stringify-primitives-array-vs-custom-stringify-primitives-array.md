...
```typescript
JSON stringify: 17843.323 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13830.185 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/16/2025 1:7:22`

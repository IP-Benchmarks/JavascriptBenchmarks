...
```typescript
JSON stringify: 17961.673 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13884.560 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/3/2025 1:22:53`

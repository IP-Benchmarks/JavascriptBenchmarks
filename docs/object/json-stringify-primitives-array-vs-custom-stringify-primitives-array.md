...
```typescript
JSON stringify: 15595.492 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13562.290 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/19/2024 1:2:43`

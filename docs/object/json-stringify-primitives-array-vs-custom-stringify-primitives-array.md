...
```typescript
JSON stringify: 11440.803 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8277.391 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/6/2022 1:2:31`

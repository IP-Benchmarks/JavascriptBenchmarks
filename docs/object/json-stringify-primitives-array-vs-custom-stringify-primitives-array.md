...
```typescript
JSON stringify: 15807.461 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13056.019 ops/s (100 runs over 100 unique samples each)
```

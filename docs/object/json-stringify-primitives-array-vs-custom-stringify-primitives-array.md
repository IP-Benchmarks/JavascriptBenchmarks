...
```typescript
JSON stringify: 23981.100 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13974.538 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/4/2026 2:55:24`

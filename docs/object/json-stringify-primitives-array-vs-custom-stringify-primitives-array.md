...
```typescript
JSON stringify: 11281.945 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8168.686 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/3/2022 1:20:39`

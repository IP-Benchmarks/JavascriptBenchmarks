...
```typescript
JSON stringify: 12255.087 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8121.047 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/21/2023 0:49:46`

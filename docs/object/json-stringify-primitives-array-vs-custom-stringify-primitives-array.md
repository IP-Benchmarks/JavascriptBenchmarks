...
```typescript
JSON stringify: 12107.272 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8028.971 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/16/2023 1:23:40`

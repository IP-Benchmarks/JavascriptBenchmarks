...
```typescript
JSON stringify: 17346.681 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13609.783 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/6/2025 1:12:21`

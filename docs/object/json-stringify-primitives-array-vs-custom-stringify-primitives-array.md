...
```typescript
JSON stringify: 15949.017 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13227.567 ops/s (100 runs over 100 unique samples each)
```

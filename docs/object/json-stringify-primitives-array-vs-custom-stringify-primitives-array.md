...
```typescript
JSON stringify: 9131.432 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6558.928 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/24/2022 0:43:52`

...
```typescript
JSON stringify: 9938.195 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6502.358 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/29/2023 0:51:12`

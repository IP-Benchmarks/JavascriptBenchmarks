...
```typescript
JSON stringify: 9582.026 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6422.265 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/14/2022 1:23:20`

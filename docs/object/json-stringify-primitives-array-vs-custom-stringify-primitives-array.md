...
```typescript
JSON stringify: 17758.993 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14207.424 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/10/2025 1:14:20`

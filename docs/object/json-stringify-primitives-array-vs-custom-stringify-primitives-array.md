...
```typescript
JSON stringify: 11852.966 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7203.273 ops/s (100 runs over 100 unique samples each)
```

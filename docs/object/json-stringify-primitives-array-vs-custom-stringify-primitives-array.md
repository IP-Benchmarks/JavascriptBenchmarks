...
```typescript
JSON stringify: 15935.480 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13339.214 ops/s (100 runs over 100 unique samples each)
```

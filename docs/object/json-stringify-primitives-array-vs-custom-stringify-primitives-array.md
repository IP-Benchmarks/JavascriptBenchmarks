...
```typescript
JSON stringify: 17996.309 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14141.639 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/25/2025 1:20:46`

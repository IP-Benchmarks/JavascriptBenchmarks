...
```typescript
JSON stringify: 11926.268 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8101.288 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/27/2022 1:23:58`

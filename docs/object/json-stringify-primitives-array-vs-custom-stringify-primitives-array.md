...
```typescript
JSON stringify: 17808.608 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13828.236 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/20/2026 1:53:54`

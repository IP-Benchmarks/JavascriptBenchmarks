...
```typescript
JSON stringify: 9763.623 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6693.769 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/28/2023 1:3:44`

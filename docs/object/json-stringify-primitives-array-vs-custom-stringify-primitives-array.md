...
```typescript
JSON stringify: 9405.224 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6489.172 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/17/2022 1:10:50`

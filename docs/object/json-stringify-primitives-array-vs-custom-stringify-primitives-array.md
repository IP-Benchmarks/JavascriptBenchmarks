...
```typescript
JSON stringify: 12265.913 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8208.239 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/1/2023 1:13:47`

...
```typescript
JSON stringify: 11347.447 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8102.091 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/28/2022 1:0:2`

...
```typescript
JSON stringify: 17556.819 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13694.634 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/15/2025 1:16:2`

...
```typescript
JSON stringify: 10902.695 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6825.343 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/17/2023 1:2:18`

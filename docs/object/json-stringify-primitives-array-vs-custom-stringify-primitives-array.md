...
```typescript
JSON stringify: 17812.147 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13812.002 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/20/2025 1:21:2`

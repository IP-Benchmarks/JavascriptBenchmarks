...
```typescript
JSON stringify: 11659.020 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8131.759 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/31/2022 0:59:56`

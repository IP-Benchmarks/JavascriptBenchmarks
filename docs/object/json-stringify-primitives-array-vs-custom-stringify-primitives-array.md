...
```typescript
JSON stringify: 18007.712 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13911.146 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/23/2025 1:26:48`

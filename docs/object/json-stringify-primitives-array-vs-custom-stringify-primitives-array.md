...
```typescript
JSON stringify: 11678.618 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7952.122 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/18/2021 0:48:5`

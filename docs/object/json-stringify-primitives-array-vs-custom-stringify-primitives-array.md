...
```typescript
JSON stringify: 11412.244 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8522.831 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/23/2022 0:59:49`

...
```typescript
JSON stringify: 11805.337 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8188.867 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/10/2022 0:45:30`

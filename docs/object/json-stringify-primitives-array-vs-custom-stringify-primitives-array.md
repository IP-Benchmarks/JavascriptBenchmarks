...
```typescript
JSON stringify: 11682.638 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9446.107 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/4/2022 1:27:14`

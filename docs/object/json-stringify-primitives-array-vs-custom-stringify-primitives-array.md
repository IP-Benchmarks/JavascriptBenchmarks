...
```typescript
JSON stringify: 18372.551 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14175.659 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/27/2025 1:16:12`

...
```typescript
JSON stringify: 15847.504 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13805.197 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/15/2024 1:2:23`

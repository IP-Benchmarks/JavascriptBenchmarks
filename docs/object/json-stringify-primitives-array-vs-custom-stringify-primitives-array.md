...
```typescript
JSON stringify: 24528.158 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12733.829 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/1/2026 3:46:36`

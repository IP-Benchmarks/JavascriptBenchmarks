...
```typescript
JSON stringify: 9964.988 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7008.776 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/17/2022 0:58:56`

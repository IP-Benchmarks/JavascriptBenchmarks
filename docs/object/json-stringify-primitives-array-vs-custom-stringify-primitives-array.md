...
```typescript
JSON stringify: 17871.111 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14095.639 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/10/2026 1:49:39`

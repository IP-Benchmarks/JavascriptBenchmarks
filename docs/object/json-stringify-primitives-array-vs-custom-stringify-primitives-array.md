...
```typescript
JSON stringify: 11265.097 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9326.040 ops/s (100 runs over 100 unique samples each)
```

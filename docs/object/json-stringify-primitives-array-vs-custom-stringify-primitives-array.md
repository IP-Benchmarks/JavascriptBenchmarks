...
```typescript
JSON stringify: 15781.969 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13655.191 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/23/2024 1:2:21`

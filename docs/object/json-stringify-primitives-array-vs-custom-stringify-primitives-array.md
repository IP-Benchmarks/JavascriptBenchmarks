...
```typescript
JSON stringify: 15679.041 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13355.004 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/28/2024 1:5:31`

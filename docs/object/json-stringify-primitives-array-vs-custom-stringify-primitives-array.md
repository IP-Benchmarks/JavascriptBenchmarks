...
```typescript
JSON stringify: 15744.159 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13103.548 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/26/2024 0:54:16`

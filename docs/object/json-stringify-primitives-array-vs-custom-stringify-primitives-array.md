...
```typescript
JSON stringify: 10217.844 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7078.565 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/16/2022 1:50:3`

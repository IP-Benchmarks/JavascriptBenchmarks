...
#### **JSON stringify** is **_`1.24x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 15914.824 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12885.279 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/20/2023 0:44:23`

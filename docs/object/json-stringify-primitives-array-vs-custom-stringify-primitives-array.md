...
```typescript
JSON stringify: 11965.574 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7873.148 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17559.985 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13729.874 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/27/2025 1:21:36`

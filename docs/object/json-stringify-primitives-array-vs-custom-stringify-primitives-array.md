...
```typescript
JSON stringify: 9700.963 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6786.675 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/7/2022 0:54:14`

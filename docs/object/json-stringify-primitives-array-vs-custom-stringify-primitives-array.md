...
```typescript
JSON stringify: 15734.679 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12906.488 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/20/2024 0:56:43`

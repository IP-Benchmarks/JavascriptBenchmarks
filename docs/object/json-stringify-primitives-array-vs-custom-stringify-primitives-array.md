...
```typescript
JSON stringify: 15445.242 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13298.682 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/6/2024 1:1:13`

...
```typescript
JSON stringify: 9911.656 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6801.542 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/26/2022 1:11:22`

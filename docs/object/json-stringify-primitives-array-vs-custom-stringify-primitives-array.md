...
```typescript
JSON stringify: 17369.056 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13934.184 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/29/2024 1:15:36`

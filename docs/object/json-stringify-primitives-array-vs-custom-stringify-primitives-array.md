...
```typescript
JSON stringify: 17565.885 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13815.436 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/20/2024 1:9:49`

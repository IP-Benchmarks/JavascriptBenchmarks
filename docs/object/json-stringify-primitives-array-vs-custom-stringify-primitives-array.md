...
```typescript
JSON stringify: 13642.318 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8655.485 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/14/2023 0:57:41`

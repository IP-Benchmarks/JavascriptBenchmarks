...
```typescript
JSON stringify: 17560.785 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13717.468 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/29/2025 1:7:33`

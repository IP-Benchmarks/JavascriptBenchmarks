...
```typescript
JSON stringify: 16940.788 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13701.377 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/14/2024 1:13:14`

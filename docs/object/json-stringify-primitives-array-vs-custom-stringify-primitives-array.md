...
```typescript
JSON stringify: 18145.593 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13832.015 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/18/2025 1:13:18`

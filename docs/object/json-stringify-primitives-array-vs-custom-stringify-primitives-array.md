...
```typescript
JSON stringify: 17795.091 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13717.301 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/6/2025 1:12:44`

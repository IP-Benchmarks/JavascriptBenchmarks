...
```typescript
JSON stringify: 17600.783 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13836.691 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/26/2024 1:8:53`

...
```typescript
JSON stringify: 24062.768 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13893.380 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/11/2026 2:24:45`

...
```typescript
JSON stringify: 15522.492 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13424.486 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/8/2024 0:54:7`

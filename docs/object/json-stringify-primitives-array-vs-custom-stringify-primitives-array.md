...
```typescript
JSON stringify: 15819.299 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13423.140 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/12/2024 1:7:15`

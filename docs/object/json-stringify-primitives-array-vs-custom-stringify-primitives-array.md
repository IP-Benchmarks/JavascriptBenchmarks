...
```typescript
JSON stringify: 17511.803 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14004.813 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/7/2025 1:9:15`

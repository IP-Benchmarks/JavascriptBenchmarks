...
```typescript
JSON stringify: 31059.999 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 16254.534 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/12/2026 2:29:55`

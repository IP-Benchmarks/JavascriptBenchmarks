...
```typescript
JSON stringify: 12141.482 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8334.517 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/29/2023 1:8:37`

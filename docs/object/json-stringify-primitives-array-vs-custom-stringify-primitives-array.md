...
```typescript
JSON stringify: 17868.926 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13654.296 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/1/2025 1:11:49`

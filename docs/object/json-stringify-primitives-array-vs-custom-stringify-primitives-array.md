...
```typescript
JSON stringify: 17869.406 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13695.794 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/1/2025 1:27:27`

...
```typescript
JSON stringify: 12731.483 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8755.774 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/11/2022 1:20:20`

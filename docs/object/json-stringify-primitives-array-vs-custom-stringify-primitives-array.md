...
```typescript
JSON stringify: 9916.184 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6689.947 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/15/2023 1:15:43`

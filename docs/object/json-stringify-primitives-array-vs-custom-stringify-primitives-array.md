...
```typescript
JSON stringify: 11934.132 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7941.126 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/25/2022 1:2:31`

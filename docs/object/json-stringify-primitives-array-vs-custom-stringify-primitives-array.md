...
```typescript
JSON stringify: 12739.619 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9905.016 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/2/2023 0:52:33`

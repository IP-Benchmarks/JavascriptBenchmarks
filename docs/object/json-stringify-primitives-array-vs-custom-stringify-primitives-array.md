...
```typescript
JSON stringify: 11413.741 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7928.031 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/31/2022 1:0:13`

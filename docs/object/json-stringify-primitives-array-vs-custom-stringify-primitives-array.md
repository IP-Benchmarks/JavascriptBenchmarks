...
```typescript
JSON stringify: 17992.897 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14071.174 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/22/2025 1:27:55`

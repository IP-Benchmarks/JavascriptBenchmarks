...
```typescript
JSON stringify: 11800.239 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9899.327 ops/s (100 runs over 100 unique samples each)
```

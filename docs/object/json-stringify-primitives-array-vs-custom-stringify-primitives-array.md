...
```typescript
JSON stringify: 10254.200 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6902.128 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/29/2023 1:13:41`

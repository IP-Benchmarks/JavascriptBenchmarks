...
```typescript
JSON stringify: 31410.300 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 16946.221 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/17/2026 3:20:53`

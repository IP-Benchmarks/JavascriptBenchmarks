...
```typescript
JSON stringify: 15970.137 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13626.747 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/7/2024 0:59:42`

...
```typescript
JSON stringify: 12294.109 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9630.117 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/24/2023 0:54:21`

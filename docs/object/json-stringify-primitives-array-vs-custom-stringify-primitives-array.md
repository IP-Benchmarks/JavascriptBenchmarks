...
```typescript
JSON stringify: 24879.291 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12982.486 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/31/2026 3:33:44`

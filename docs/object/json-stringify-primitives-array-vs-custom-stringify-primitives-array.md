...
```typescript
JSON stringify: 15725.892 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13300.849 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/21/2024 1:5:35`

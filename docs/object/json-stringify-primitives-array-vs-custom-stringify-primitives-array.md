...
```typescript
JSON stringify: 24248.769 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14030.610 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/3/2026 2:32:32`

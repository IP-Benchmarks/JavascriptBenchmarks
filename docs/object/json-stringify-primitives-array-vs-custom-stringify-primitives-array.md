...
```typescript
JSON stringify: 10397.922 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7697.443 ops/s (100 runs over 100 unique samples each)
```

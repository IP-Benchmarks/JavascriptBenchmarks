...
```typescript
JSON stringify: 17560.539 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14046.106 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/22/2025 1:7:58`

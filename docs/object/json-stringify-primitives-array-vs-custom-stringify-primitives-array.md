...
```typescript
JSON stringify: 24221.213 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13444.347 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/13/2026 3:3:35`

...
```typescript
JSON stringify: 12273.885 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8227.933 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/16/2023 1:6:53`

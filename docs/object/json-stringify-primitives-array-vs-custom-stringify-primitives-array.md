...
```typescript
JSON stringify: 17186.764 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13657.964 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/14/2025 1:18:29`

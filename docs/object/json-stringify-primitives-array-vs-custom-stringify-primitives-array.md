...
```typescript
JSON stringify: 10521.507 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7084.573 ops/s (100 runs over 100 unique samples each)
```

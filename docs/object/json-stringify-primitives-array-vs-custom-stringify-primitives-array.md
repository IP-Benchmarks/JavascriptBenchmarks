...
```typescript
JSON stringify: 12505.771 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9222.882 ops/s (100 runs over 100 unique samples each)
```

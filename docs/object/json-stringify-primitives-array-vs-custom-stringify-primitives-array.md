...
```typescript
JSON stringify: 12531.256 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10114.437 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/2/2023 1:0:30`

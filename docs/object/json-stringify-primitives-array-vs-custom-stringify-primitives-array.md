...
#### **JSON stringify** is **_`1.30x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 17712.545 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13657.884 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/30/2025 1:20:35`

...
```typescript
JSON stringify: 10802.440 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7651.882 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/20/2023 1:3:58`

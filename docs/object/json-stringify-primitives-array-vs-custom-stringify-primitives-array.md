...
```typescript
JSON stringify: 24771.006 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14207.905 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/12/2026 1:41:34`

...
```typescript
JSON stringify: 11096.560 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7775.781 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/16/2022 1:21:16`

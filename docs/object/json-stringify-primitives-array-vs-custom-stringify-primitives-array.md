...
```typescript
JSON stringify: 17007.210 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13970.094 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/12/2025 1:17:39`

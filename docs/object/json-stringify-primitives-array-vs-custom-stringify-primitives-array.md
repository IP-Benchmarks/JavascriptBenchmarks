...
```typescript
JSON stringify: 11350.881 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7900.279 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/11/2022 1:5:38`

...
```typescript
JSON stringify: 24051.596 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13311.258 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/12/2026 3:2:45`

...
```typescript
JSON stringify: 25074.944 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13068.121 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/19/2026 4:2:7`

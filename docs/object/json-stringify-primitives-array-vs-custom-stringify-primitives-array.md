...
```typescript
JSON stringify: 17669.148 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14069.739 ops/s (100 runs over 100 unique samples each)
```

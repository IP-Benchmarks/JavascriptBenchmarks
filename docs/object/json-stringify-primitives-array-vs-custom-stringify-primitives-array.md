...
```typescript
JSON stringify: 10378.065 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6756.726 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/20/2023 1:5:26`

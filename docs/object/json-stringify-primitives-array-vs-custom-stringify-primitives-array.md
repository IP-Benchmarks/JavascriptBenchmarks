...
```typescript
JSON stringify: 15629.445 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12938.836 ops/s (100 runs over 100 unique samples each)
```

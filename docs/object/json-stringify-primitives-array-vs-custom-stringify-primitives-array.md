...
```typescript
JSON stringify: 23499.080 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14103.167 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/2/2026 2:58:0`

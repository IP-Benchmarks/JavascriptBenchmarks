...
```typescript
JSON stringify: 23501.107 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13300.114 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/14/2026 3:17:19`

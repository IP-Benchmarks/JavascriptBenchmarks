...
```typescript
JSON stringify: 11669.607 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9517.358 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/4/2022 1:5:4`

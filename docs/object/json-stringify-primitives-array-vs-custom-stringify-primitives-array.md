...
```typescript
JSON stringify: 17606.651 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13837.663 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/9/2025 1:14:23`

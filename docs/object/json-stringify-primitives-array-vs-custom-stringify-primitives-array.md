...
```typescript
JSON stringify: 17436.277 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13756.404 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/26/2025 1:14:23`

...
```typescript
JSON stringify: 15137.350 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13122.558 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/17/2024 1:0:43`

...
```typescript
JSON stringify: 16042.937 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13819.049 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/21/2024 1:0:38`

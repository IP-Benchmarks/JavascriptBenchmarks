...
```typescript
JSON stringify: 15656.560 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13281.929 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/3/2024 1:8:59`

...
```typescript
JSON stringify: 17161.173 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13907.133 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/16/2025 1:17:11`

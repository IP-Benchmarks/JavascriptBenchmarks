...
```typescript
JSON stringify: 15546.231 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13215.513 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/16/2024 1:1:22`

...
```typescript
JSON stringify: 15733.393 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13105.049 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/4/2024 1:15:54`

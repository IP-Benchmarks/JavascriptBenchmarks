...
```typescript
JSON stringify: 12802.900 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9739.621 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/15/2023 1:0:13`

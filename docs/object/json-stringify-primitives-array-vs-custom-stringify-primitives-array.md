...
```typescript
JSON stringify: 11781.236 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8285.637 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/1/2022 0:47:41`

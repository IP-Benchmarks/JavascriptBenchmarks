...
```typescript
JSON stringify: 24342.459 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13198.580 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/16/2026 3:50:31`

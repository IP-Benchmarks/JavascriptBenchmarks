...
```typescript
JSON stringify: 17661.040 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14273.129 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/28/2025 1:20:47`

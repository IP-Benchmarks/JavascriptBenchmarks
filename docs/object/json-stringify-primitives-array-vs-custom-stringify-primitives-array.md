...
```typescript
JSON stringify: 10176.041 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6632.918 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/22/2022 1:16:4`

...
```typescript
JSON stringify: 15775.936 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12907.050 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/24/2024 0:53:54`

...
```typescript
JSON stringify: 15556.258 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13507.452 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/17/2024 1:0:31`

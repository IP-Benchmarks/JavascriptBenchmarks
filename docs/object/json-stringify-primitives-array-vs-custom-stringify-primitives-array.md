...
```typescript
JSON stringify: 9278.868 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6168.338 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/6/2022 1:48:1`

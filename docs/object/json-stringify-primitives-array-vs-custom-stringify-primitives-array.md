...
```typescript
JSON stringify: 11297.700 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8274.990 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/6/2022 1:54:31`

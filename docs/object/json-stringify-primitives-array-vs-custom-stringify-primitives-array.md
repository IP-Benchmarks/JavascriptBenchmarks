...
```typescript
JSON stringify: 15970.552 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13481.951 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/6/2024 1:13:45`

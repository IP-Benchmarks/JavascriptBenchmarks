...
```typescript
JSON stringify: 16164.485 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13665.170 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/3/2024 0:59:3`

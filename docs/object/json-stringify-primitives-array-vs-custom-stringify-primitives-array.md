...
```typescript
JSON stringify: 17922.838 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13779.410 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/25/2026 1:59:36`

...
```typescript
JSON stringify: 17730.452 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14023.626 ops/s (100 runs over 100 unique samples each)
```

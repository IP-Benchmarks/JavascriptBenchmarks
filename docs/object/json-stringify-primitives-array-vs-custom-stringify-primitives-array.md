...
```typescript
JSON stringify: 17475.365 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13409.165 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/10/2026 2:43:22`

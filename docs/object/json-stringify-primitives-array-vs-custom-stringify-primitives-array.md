...
```typescript
JSON stringify: 15983.788 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13391.614 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/27/2024 1:3:21`

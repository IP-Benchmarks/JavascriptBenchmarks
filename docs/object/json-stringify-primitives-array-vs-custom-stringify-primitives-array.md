...
```typescript
JSON stringify: 18219.810 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 11236.695 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/19/2026 2:28:51`

...
```typescript
JSON stringify: 15012.151 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13243.535 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/14/2024 1:4:49`

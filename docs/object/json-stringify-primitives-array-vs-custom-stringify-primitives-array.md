...
```typescript
JSON stringify: 17838.632 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13796.446 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/1/2025 1:47:33`

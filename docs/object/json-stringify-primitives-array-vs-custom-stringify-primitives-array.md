...
```typescript
JSON stringify: 11760.779 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9883.464 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/4/2022 1:23:44`

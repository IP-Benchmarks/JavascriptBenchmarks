...
```typescript
JSON stringify: 12628.308 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10136.682 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/20/2023 0:58:10`

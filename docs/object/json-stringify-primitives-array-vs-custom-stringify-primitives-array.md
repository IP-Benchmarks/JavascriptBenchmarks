...
```typescript
JSON stringify: 15628.842 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13362.296 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/27/2024 0:52:16`

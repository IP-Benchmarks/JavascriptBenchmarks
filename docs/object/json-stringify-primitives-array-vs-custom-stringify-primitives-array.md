...
```typescript
JSON stringify: 11979.143 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7711.781 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/17/2023 0:54:39`

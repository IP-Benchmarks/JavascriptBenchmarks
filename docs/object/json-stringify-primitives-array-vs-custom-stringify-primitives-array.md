...
```typescript
JSON stringify: 17733.740 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14073.595 ops/s (100 runs over 100 unique samples each)
```

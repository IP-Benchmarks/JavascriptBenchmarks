...
```typescript
JSON stringify: 11934.841 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9877.632 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/4/2023 1:2:30`

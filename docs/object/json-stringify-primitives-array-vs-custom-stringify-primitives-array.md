...
```typescript
JSON stringify: 10408.427 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7110.125 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/30/2023 1:5:6`

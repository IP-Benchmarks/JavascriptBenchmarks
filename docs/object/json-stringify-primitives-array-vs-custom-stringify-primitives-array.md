...
```typescript
JSON stringify: 16635.616 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13433.389 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/25/2025 1:11:18`

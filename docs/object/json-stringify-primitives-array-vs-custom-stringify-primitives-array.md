...
```typescript
JSON stringify: 17802.689 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13794.814 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/13/2025 1:8:53`

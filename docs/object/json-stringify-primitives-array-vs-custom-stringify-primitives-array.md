...
```typescript
JSON stringify: 15714.963 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12995.939 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 11842.585 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8038.507 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/18/2022 1:28:56`

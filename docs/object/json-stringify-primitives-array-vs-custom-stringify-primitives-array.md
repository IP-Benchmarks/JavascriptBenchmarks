...
```typescript
JSON stringify: 15719.524 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13463.504 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/18/2024 0:52:47`

...
```typescript
JSON stringify: 17823.397 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13532.869 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/22/2025 1:19:42`

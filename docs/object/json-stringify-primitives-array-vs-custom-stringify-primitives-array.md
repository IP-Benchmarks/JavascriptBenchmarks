...
```typescript
JSON stringify: 10228.301 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6999.614 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/10/2023 1:4:44`

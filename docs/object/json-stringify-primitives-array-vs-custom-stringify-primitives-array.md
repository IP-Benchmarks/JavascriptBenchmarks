...
```typescript
JSON stringify: 15654.721 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12866.251 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/9/2024 1:17:39`

...
```typescript
JSON stringify: 11671.967 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8277.596 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/4/2022 1:23:52`

...
```typescript
JSON stringify: 17104.283 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13800.367 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/31/2025 1:18:47`

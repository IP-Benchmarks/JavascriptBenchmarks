...
```typescript
JSON stringify: 16043.208 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12949.740 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/25/2024 1:14:6`

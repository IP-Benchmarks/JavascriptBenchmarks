...
```typescript
JSON stringify: 13364.075 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9168.604 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/23/2022 0:57:8`

...
#### **JSON stringify** is **_`1.77x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 24470.299 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13853.337 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/22/2026 3:57:26`

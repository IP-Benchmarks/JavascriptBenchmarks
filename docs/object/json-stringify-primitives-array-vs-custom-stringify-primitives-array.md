...
```typescript
JSON stringify: 15574.780 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12613.497 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/1/2024 1:5:36`

...
```typescript
JSON stringify: 17815.176 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14171.745 ops/s (100 runs over 100 unique samples each)
```

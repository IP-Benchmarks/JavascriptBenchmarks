...
```typescript
JSON stringify: 12315.910 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9939.957 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/14/2023 1:6:1`

...
```typescript
JSON stringify: 16075.669 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13662.069 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/9/2024 1:3:7`

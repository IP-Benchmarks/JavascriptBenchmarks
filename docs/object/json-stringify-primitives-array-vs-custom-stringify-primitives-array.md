...
```typescript
JSON stringify: 15677.694 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13622.712 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/6/2024 1:7:45`

...
```typescript
JSON stringify: 17982.584 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13953.535 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/17/2026 2:50:14`

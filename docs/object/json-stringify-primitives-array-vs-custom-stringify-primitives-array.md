...
```typescript
JSON stringify: 17789.302 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13909.509 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/12/2024 1:15:15`

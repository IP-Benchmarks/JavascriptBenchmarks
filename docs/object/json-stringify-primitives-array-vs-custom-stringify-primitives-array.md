...
```typescript
JSON stringify: 14125.984 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12959.441 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/19/2024 1:0:20`

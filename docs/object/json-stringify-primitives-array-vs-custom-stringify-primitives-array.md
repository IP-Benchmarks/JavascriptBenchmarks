...
```typescript
JSON stringify: 15608.239 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12539.170 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/5/2024 1:7:53`

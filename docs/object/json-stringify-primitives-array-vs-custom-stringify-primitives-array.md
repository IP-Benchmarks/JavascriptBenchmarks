...
```typescript
JSON stringify: 11995.017 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8268.285 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/7/2023 1:3:18`

...
```typescript
JSON stringify: 17469.423 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13931.743 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/3/2025 1:21:50`

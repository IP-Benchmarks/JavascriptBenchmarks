...
```typescript
JSON stringify: 17635.149 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14103.110 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/25/2026 1:45:30`

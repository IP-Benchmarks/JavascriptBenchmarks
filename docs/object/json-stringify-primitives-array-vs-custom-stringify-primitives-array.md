...
```typescript
JSON stringify: 12427.040 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9449.262 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/11/2023 0:51:16`

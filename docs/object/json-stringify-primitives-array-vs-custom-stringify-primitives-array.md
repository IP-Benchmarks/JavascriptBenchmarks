...
```typescript
JSON stringify: 11330.319 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8359.890 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/16/2022 1:12:55`

...
```typescript
JSON stringify: 11432.271 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9716.844 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/30/2022 1:14:50`

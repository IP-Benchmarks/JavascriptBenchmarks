...
```typescript
JSON stringify: 17254.061 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13799.431 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/26/2026 2:5:57`

...
```typescript
JSON stringify: 18086.234 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13924.174 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/7/2025 1:19:23`

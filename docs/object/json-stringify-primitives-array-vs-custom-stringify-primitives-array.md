...
```typescript
JSON stringify: 15519.580 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13122.625 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/28/2024 0:52:44`

...
```typescript
JSON stringify: 11148.750 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8092.244 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/2/2022 0:46:45`

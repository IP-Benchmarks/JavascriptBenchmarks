...
```typescript
JSON stringify: 18007.504 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13865.623 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/19/2025 1:13:57`

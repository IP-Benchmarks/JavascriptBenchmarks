...
```typescript
JSON stringify: 18212.713 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13969.636 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/15/2025 1:38:2`

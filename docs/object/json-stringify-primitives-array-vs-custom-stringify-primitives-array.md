...
```typescript
JSON stringify: 15317.821 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13461.877 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/30/2024 0:56:58`

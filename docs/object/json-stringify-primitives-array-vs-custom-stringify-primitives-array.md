...
```typescript
JSON stringify: 17650.478 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13822.561 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/25/2026 2:9:1`

...
```typescript
JSON stringify: 10618.529 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6415.872 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 9987.995 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6778.817 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/9/2022 1:18:26`

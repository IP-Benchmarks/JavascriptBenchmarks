...
```typescript
JSON stringify: 11602.363 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8294.188 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/31/2022 1:15:24`

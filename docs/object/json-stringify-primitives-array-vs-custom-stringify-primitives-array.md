...
```typescript
JSON stringify: 9522.726 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6535.694 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/4/2023 0:51:54`

...
#### **JSON stringify** is **_`1.28x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 16651.503 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13049.562 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/24/2022 1:54:52`

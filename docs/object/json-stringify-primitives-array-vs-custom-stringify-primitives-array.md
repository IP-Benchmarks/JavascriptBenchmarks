...
```typescript
JSON stringify: 11016.138 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6843.887 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/15/2023 0:49:50`

...
```typescript
JSON stringify: 17589.411 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12806.025 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/30/2025 1:38:31`

...
```typescript
JSON stringify: 24433.906 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13391.312 ops/s (100 runs over 100 unique samples each)
```

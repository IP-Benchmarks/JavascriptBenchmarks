...
```typescript
JSON stringify: 11278.522 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7940.667 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/25/2022 1:3:23`

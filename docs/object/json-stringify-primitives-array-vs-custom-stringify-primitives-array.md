...
```typescript
JSON stringify: 12449.816 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8724.105 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/30/2023 1:2:22`

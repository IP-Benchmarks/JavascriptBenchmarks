...
```typescript
JSON stringify: 17604.782 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13900.225 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/21/2025 1:14:17`

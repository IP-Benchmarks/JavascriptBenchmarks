...
```typescript
JSON stringify: 10497.589 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6932.088 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/5/2022 0:39:28`

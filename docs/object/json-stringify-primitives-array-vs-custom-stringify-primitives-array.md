...
```typescript
JSON stringify: 15944.585 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13004.000 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/9/2024 0:53:10`

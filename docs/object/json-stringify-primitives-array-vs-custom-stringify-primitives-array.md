...
```typescript
JSON stringify: 9636.344 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6609.921 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/25/2023 1:9:29`

...
```typescript
JSON stringify: 15846.098 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13470.890 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/30/2024 1:4:30`

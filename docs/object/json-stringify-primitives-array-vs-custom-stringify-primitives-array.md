...
```typescript
JSON stringify: 17916.173 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13896.417 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/13/2025 1:13:35`

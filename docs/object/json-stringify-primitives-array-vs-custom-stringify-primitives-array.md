...
```typescript
JSON stringify: 11133.257 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7679.928 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/21/2023 1:0:23`

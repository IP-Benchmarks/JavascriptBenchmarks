...
```typescript
JSON stringify: 15415.412 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13269.270 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/27/2024 0:58:50`

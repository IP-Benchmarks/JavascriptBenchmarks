...
```typescript
JSON stringify: 23710.128 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13580.188 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/6/2026 2:20:4`

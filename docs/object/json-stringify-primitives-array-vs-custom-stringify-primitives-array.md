...
```typescript
JSON stringify: 16082.240 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13341.822 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 17658.995 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14055.893 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/26/2025 1:25:9`

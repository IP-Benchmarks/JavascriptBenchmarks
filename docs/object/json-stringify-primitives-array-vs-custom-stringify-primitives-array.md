...
```typescript
JSON stringify: 10323.068 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6463.199 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/6/2023 1:7:15`

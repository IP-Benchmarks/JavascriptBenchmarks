...
```typescript
JSON stringify: 24300.075 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13218.545 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/20/2026 1:2:57`

...
```typescript
JSON stringify: 17789.994 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13886.895 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/14/2026 1:50:48`

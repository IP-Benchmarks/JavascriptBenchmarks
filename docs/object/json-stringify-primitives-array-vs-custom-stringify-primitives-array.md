...
```typescript
JSON stringify: 17559.598 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14188.985 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/22/2025 1:9:13`

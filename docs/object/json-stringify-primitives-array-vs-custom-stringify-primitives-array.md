...
```typescript
JSON stringify: 17623.967 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13848.305 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/30/2025 1:6:30`

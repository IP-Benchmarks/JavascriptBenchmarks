...
```typescript
JSON stringify: 17812.976 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13249.235 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/16/2025 1:25:5`

...
```typescript
JSON stringify: 24510.861 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14297.927 ops/s (100 runs over 100 unique samples each)
```

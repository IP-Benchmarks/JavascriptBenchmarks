...
```typescript
JSON stringify: 17905.314 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13985.135 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/2/2025 1:23:19`

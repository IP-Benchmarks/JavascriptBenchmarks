...
```typescript
JSON stringify: 17460.831 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14111.201 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/9/2025 1:18:53`

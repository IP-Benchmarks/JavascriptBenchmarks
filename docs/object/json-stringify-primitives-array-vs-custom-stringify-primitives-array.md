...
```typescript
JSON stringify: 15531.676 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12927.785 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/12/2024 0:58:48`

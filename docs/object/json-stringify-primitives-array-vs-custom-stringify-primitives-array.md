...
```typescript
JSON stringify: 17420.259 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12034.880 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/9/2025 1:9:25`

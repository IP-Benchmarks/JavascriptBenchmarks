...
```typescript
JSON stringify: 10508.286 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7070.314 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/11/2023 0:59:39`

...
```typescript
JSON stringify: 24719.514 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14252.853 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/17/2026 3:52:25`

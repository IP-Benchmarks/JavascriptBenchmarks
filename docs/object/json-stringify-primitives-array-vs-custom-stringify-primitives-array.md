...
```typescript
JSON stringify: 24051.709 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13131.713 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/21/2026 3:55:28`

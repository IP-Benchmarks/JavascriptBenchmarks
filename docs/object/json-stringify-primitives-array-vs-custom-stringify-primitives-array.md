...
```typescript
JSON stringify: 9927.813 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6560.614 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/5/2023 0:58:47`

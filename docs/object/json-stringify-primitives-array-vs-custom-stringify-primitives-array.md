...
```typescript
JSON stringify: 18045.762 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13731.011 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/23/2025 1:28:13`

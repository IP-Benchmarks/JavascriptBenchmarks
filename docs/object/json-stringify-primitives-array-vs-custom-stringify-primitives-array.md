...
```typescript
JSON stringify: 16066.849 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13280.586 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/1/2023 1:0:3`

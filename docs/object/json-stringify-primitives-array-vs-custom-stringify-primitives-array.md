...
```typescript
JSON stringify: 12441.652 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9517.301 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/12/2023 1:8:40`

...
```typescript
JSON stringify: 18219.193 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14076.549 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/14/2025 1:19:8`

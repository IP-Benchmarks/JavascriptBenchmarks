...
```typescript
JSON stringify: 12257.095 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8198.936 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/19/2023 2:14:47`

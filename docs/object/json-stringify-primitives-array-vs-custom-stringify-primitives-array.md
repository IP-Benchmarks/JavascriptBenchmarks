...
```typescript
JSON stringify: 17300.648 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14061.565 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/14/2025 1:38:15`

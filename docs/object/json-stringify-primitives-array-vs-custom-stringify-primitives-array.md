...
```typescript
JSON stringify: 11541.523 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7849.817 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/5/2022 1:16:45`

...
```typescript
JSON stringify: 17479.802 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13985.918 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/3/2025 1:21:47`

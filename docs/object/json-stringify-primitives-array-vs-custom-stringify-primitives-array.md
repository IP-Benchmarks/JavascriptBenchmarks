...
```typescript
JSON stringify: 17549.217 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12816.203 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/16/2026 1:57:51`

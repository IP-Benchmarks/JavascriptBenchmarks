...
```typescript
JSON stringify: 12253.426 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7671.808 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/24/2023 1:0:21`

...
```typescript
JSON stringify: 11888.401 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8038.367 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/3/2022 1:14:54`

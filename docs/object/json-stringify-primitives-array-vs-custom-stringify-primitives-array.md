...
```typescript
JSON stringify: 17988.870 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14120.659 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/22/2025 1:37:19`

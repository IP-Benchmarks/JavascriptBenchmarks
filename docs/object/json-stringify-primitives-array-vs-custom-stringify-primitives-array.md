...
```typescript
JSON stringify: 15599.126 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13417.563 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/4/2024 0:57:59`

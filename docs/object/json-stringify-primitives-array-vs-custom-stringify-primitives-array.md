...
```typescript
JSON stringify: 10005.826 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6930.690 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/16/2022 1:26:37`

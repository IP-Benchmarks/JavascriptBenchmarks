...
```typescript
JSON stringify: 17719.612 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13713.153 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/17/2025 1:15:29`

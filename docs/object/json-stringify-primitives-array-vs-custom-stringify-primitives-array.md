...
```typescript
JSON stringify: 15786.290 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13318.458 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 12524.132 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9496.744 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/14/2023 0:50:48`

...
```typescript
JSON stringify: 11916.574 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7554.557 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 9/15/2023 0:51:57`

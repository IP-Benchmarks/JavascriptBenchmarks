...
```typescript
JSON stringify: 9816.445 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6917.389 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/20/2022 0:55:51`

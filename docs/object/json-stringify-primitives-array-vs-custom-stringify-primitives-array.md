...
```typescript
JSON stringify: 12432.816 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9828.243 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/9/2023 1:9:24`

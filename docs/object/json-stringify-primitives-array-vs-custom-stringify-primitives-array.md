...
#### **JSON stringify** is **_`1.44x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 11736.802 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8144.944 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/21/2021 0:48:40`

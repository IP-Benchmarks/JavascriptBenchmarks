...
```typescript
JSON stringify: 18067.036 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14065.020 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/17/2025 1:37:0`

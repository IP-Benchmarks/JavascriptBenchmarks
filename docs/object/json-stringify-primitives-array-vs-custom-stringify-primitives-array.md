...
```typescript
JSON stringify: 11643.129 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8217.850 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/24/2022 0:53:39`

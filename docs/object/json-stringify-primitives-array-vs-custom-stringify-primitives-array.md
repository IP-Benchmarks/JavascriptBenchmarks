...
```typescript
JSON stringify: 15091.902 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12384.687 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/15/2024 0:56:10`

...
```typescript
JSON stringify: 12206.930 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8459.666 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/8/2022 0:53:24`

...
```typescript
JSON stringify: 15431.963 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13460.879 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/18/2024 1:14:25`

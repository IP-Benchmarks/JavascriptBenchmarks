...
```typescript
JSON stringify: 12521.493 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9749.058 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/11/2023 1:15:45`

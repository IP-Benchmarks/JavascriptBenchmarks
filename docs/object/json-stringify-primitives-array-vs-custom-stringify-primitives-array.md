...
```typescript
JSON stringify: 15278.669 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 12490.651 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/7/2024 1:10:58`

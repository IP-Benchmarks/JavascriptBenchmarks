...
```typescript
JSON stringify: 17464.857 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13862.023 ops/s (100 runs over 100 unique samples each)
```

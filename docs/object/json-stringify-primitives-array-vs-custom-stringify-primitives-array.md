...
```typescript
JSON stringify: 12132.840 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7853.451 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/2/2023 0:58:6`

...
```typescript
JSON stringify: 11766.425 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8000.577 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/19/2022 1:22:14`

...
```typescript
JSON stringify: 15911.444 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13380.981 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 15386.320 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13453.242 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/29/2024 1:2:36`

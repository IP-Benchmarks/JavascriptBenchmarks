...
```typescript
JSON stringify: 9760.651 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6491.302 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/17/2023 0:52:48`

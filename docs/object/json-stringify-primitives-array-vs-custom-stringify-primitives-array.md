...
```typescript
JSON stringify: 17416.632 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13162.381 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/4/2026 1:43:52`

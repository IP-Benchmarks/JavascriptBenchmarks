...
```typescript
JSON stringify: 12358.565 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9878.370 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/5/2023 1:8:38`

...
```typescript
JSON stringify: 16019.570 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13447.218 ops/s (100 runs over 100 unique samples each)
```

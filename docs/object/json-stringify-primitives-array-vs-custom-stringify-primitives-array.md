...
```typescript
JSON stringify: 18336.860 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14427.101 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/28/2025 1:20:13`

...
```typescript
JSON stringify: 15864.379 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13325.201 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
JSON stringify: 10916.563 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6500.299 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/1/2023 0:58:50`

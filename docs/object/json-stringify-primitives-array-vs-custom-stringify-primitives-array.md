...
```typescript
JSON stringify: 17218.420 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14241.722 ops/s (100 runs over 100 unique samples each)
```

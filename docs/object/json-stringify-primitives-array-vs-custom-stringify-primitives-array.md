...
```typescript
JSON stringify: 12031.444 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8115.557 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/29/2023 1:0:9`

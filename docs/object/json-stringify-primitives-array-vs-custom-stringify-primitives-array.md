...
```typescript
JSON stringify: 17346.855 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 14023.985 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/11/2026 1:49:44`

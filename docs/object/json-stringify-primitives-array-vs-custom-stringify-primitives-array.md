...
```typescript
JSON stringify: 18079.736 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13490.857 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/14/2026 1:39:42`

...
#### **JSON stringify** is **_`1.75x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 24283.626 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13889.475 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/25/2026 2:56:11`

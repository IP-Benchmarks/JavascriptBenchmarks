...
```typescript
JSON stringify: 17742.222 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13884.061 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/9/2025 1:22:41`

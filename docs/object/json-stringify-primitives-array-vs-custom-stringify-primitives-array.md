...
```typescript
JSON stringify: 17999.032 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13579.134 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/10/2026 1:24:39`

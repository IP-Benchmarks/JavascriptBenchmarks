...
```typescript
JSON stringify: 11392.965 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9880.054 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/19/2022 0:51:46`

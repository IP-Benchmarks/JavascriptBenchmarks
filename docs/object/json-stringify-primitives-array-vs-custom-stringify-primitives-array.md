...
```typescript
JSON stringify: 17698.552 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13625.668 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/20/2025 1:10:2`

...
```typescript
JSON stringify: 15880.702 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13512.542 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/21/2023 0:54:11`

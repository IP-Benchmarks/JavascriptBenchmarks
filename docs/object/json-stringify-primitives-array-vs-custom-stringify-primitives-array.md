...
```typescript
JSON stringify: 11631.393 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 8196.834 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 5/10/2022 1:3:29`

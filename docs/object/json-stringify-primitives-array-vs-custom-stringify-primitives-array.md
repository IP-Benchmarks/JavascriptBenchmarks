...
```typescript
JSON stringify: 9474.548 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6498.131 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/1/2022 1:53:34`

...
```typescript
JSON stringify: 10191.788 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6799.893 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/29/2023 0:58:4`

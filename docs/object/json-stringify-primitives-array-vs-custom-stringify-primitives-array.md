...
```typescript
JSON stringify: 17556.951 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13362.916 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/13/2025 2:43:3`

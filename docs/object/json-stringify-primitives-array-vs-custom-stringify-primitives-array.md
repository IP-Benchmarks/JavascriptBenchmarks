...
```typescript
JSON stringify: 15350.607 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13420.165 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/2/2023 0:53:38`

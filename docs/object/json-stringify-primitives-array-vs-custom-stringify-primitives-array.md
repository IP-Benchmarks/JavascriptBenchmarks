...
```typescript
JSON stringify: 15914.902 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13611.548 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 1/19/2024 0:56:30`

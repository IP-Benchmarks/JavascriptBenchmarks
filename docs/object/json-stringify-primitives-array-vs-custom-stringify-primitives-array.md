...
#### **JSON stringify** is **_`1.18x`_** faster than **Custom stringify for array of primitives**

```typescript
JSON stringify: 16005.901 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13559.375 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/25/2023 0:55:25`

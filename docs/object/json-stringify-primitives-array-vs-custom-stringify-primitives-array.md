...
```typescript
JSON stringify: 24047.030 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13889.405 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/20/2026 3:25:55`

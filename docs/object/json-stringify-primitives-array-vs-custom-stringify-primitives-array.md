...
```typescript
JSON stringify: 11897.265 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7645.134 ops/s (100 runs over 100 unique samples each)
```

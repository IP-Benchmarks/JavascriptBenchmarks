...
```typescript
JSON stringify: 12003.819 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7371.679 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 10/9/2023 0:52:30`

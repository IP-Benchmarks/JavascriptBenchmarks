...
```typescript
JSON stringify: 15791.335 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13541.613 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/7/2023 0:55:12`

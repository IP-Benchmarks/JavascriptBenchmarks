...
```typescript
JSON stringify: 18016.831 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13993.112 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 7/15/2025 1:38:22`

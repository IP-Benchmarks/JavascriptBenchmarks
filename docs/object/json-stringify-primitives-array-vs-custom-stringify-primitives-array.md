...
```typescript
JSON stringify: 15540.176 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13792.363 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/9/2023 0:54:15`

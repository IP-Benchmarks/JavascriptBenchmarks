...
```typescript
JSON stringify: 10220.682 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 5894.957 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/8/2023 0:56:44`

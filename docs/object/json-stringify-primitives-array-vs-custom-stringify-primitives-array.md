...
```typescript
JSON stringify: 17782.304 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13687.847 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 4/2/2025 1:15:38`

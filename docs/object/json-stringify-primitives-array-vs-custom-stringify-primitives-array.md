...
```typescript
JSON stringify: 9843.410 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6540.268 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/30/2022 1:48:23`

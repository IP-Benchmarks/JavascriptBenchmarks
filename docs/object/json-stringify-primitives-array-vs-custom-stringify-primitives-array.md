...
```typescript
JSON stringify: 9705.918 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6798.709 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/12/2022 1:14:24`

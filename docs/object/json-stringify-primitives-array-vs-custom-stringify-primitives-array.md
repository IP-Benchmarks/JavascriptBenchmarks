...
```typescript
JSON stringify: 15793.991 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13415.510 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 11/29/2023 0:55:26`

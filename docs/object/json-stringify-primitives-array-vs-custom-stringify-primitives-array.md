...
```typescript
JSON stringify: 17155.147 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13793.957 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/6/2026 1:52:44`

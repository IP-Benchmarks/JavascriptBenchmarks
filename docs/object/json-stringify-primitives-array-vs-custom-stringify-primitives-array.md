...
```typescript
JSON stringify: 17319.851 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 10142.305 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 12/23/2025 1:24:33`

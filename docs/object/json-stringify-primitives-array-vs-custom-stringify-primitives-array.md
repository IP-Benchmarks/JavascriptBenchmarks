...
```typescript
JSON stringify: 15822.886 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13579.388 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/25/2024 1:7:14`

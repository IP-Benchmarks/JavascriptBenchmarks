...
```typescript
JSON stringify: 17549.287 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13741.636 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 3/8/2026 1:55:48`

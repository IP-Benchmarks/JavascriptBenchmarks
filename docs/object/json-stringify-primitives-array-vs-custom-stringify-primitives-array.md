...
```typescript
JSON stringify: 12559.912 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9885.954 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 2/23/2023 1:3:39`

...
```typescript
JSON stringify: 11541.197 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 9628.474 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 8/4/2022 1:24:27`

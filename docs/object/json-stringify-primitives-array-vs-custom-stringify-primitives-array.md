...
```typescript
JSON stringify: 15506.859 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 13239.544 ops/s (100 runs over 100 unique samples each)
```
...
#### `Last updated on: 6/24/2024 0:59:58`

...
```typescript
JSON stringify: 11732.600 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 7924.201 ops/s (100 runs over 100 unique samples each)
```
...
### `Last updated on:` `12/11/2021 0:42:56`

...
```typescript
JSON stringify: 9845.424 ops/s (100 runs over 100 unique samples each)
```

```typescript
Custom stringify for array of primitives: 6890.696 ops/s (100 runs over 100 unique samples each)
```

...
```typescript
Custom stringify for primitives: 5030282.047 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3174550.064 ops/s (100 runs over 1000 unique samples each)
```

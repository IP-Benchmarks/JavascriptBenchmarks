...
```typescript
Custom stringify for primitives: 5265701.783 ops/s (100 runs over 1000 unique samples each)
```

```typescript
JSON stringify: 3709396.254 ops/s (100 runs over 1000 unique samples each)
```
